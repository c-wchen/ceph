...
namespace rbd {
    namespace mirror {
        namespace image_replayer {
            ...
            template < typename I >
                CreateImageRequest <
                I >::CreateImageRequest(librados::IoCtx & local_io_ctx,
            ...
            template < typename I >
                ...
                Context *ctx =
                    ...
                    &klass::handle_create_image > (this);
                ...
                image_options.set(RBD_IMAGE_OPTION_ORDER,
                                  m_remote_image_ctx->order);
                ...
                auto remote_md_pool =
                    m_remote_image_ctx->md_ctx.get_pool_name();
                auto remote_data_pool =
                ...
                librbd::image::CreateRequest < I > *req =
                    librbd::image::CreateRequest < I >::create(m_local_io_ctx,
                                                               m_local_image_name,
                                                               m_local_image_id,
                                                               m_remote_image_ctx->
                                                               size,
            ...
            template < typename I >
                ...
                librados::AioCompletion * aio_comp = create_rados_callback <
                    ...
                    &CreateImageRequest <
                    I >::handle_get_parent_global_image_id > (this);
                m_out_bl.clear();
                int r =
                    m_remote_parent_io_ctx.aio_operate(RBD_MIRRORING, aio_comp,
                                                       &op,
                                                       &m_out_bl);
                assert(r == 0);
                aio_comp->release();
            ...
            template < typename I >
                ...
                I >::handle_get_parent_global_image_id(int r) {
                dout(20) << ": r=" << r << dendl;
                if (r == 0) {
                    ...
                    if (r == 0) {
                        ...
                        dout(20) << ": parent_global_image_id=" <<
                            m_parent_global_image_id << dendl;
                    }
                }

                if (r == -ENOENT) {
                    dout(10) << ": parent image " << m_remote_parent_spec.
                        image_id << " not mirrored" << dendl;
                    finish(r);
                    return;
                }
                else if (r < 0) {
            ...
            template < typename I >
                ...
                librados::ObjectReadOperation op;
                librbd::cls_client::mirror_image_get_image_id_start(&op,
                                                                    m_parent_global_image_id);

                librados::AioCompletion * aio_comp = create_rados_callback <
                    CreateImageRequest < I >,
                    &CreateImageRequest <
                    I >::handle_get_local_parent_image_id > (this);
                m_out_bl.clear();
                int r =
                    m_local_parent_io_ctx.aio_operate(RBD_MIRRORING, aio_comp,
                                                      &op,
                                                      &m_out_bl);
                assert(r == 0);
                aio_comp->release();
            ...
            template < typename I >
                void CreateImageRequest <
                I >::handle_get_local_parent_image_id(int r) {
                dout(20) << ": r=" << r << dendl;

                if (r == 0) {
                    bufferlist::iterator iter = m_out_bl.begin();
                    r = librbd::cls_client::
                        mirror_image_get_image_id_finish(&iter,
                                                         &m_local_parent_spec.
                                                         image_id);
                }

                if (r == -ENOENT) {
                    dout(10) << ": parent image " << m_parent_global_image_id <<
                        " not " << "registered locally" << dendl;
                    finish(r);
                    return;
                }
                else if (r < 0) {
                    derr <<
                        ...
                        << m_parent_global_image_id << ": " << cpp_strerror(r)
                        << dendl;
                    finish(r);
                    return;
                }
            ...
            template < typename I >
                ...
                Context *ctx = create_context_callback <
                    CreateImageRequest < I >,
                    &CreateImageRequest < I >::handle_open_remote_parent_image >
                    (this);
                OpenImageRequest < I > *request =
                    OpenImageRequest < I >::create(m_remote_parent_io_ctx,
            ...
            template < typename I >
                void CreateImageRequest <
                I >::handle_open_remote_parent_image(int r) {
                dout(20) << ": r=" << r << dendl;
                if (r < 0) {
                    derr << ": failed to open remote parent image " <<
                        m_parent_pool_name << "/" << m_remote_parent_spec.
                        image_id << dendl;
                    finish(r);
                    return;
                }
            ...
            template < typename I >
                ...
                Context *ctx = create_context_callback <
                    CreateImageRequest < I >,
                    &CreateImageRequest < I >::handle_open_local_parent_image >
                    (this);
                OpenImageRequest < I > *request =
                    OpenImageRequest < I >::create(m_local_parent_io_ctx,
            ...
            template < typename I >
                void CreateImageRequest <
                I >::handle_open_local_parent_image(int r) {
                dout(20) << ": r=" << r << dendl;
                if (r < 0) {
                    derr << ": failed to open local parent image " <<
                        m_parent_pool_name << "/" << m_local_parent_spec.
                        image_id << dendl;
                    m_ret_val = r;
            ...
            template < typename I >
                ...
                {
                    RWLock::
                        RLocker remote_snap_locker(m_remote_parent_image_ctx->
                                                   snap_lock);
                    auto it =
                        m_remote_parent_image_ctx->snap_info.
                        find(m_remote_parent_spec.snap_id);
                ...
                dout(20) << ": parent_snap_name=" << m_parent_snap_name <<
                    dendl;

                Context *ctx = create_context_callback <
                    CreateImageRequest < I >,
                    &CreateImageRequest < I >::handle_set_local_parent_snap >
                    (this);
                m_local_parent_image_ctx->state->
            ...
            template < typename I >
                void CreateImageRequest <
                I >::handle_set_local_parent_snap(int r) {
                dout(20) << ": r=" << r << dendl;
                if (r < 0) {
                    derr << ": failed to set parent snapshot " <<
                        m_parent_snap_name << ": " << cpp_strerror(r) << dendl;
                    m_ret_val = r;
                    close_local_parent_image();
                    return;
                }
            ...
            template < typename I > void CreateImageRequest < I >::clone_image() {
                ...
                opts.set(RBD_IMAGE_OPTION_FEATURES,
                         m_remote_image_ctx->features);
                opts.set(RBD_IMAGE_OPTION_ORDER, m_remote_image_ctx->order);
                opts.set(RBD_IMAGE_OPTION_STRIPE_UNIT,
                         m_remote_image_ctx->stripe_unit);
                opts.set(RBD_IMAGE_OPTION_STRIPE_COUNT,
                         m_remote_image_ctx->stripe_count);

                using klass = CreateImageRequest < I >;
                Context *ctx =
                    create_context_callback < klass,
                    &klass::handle_clone_image > (this);

                librbd::image::CloneRequest < I > *req =
                    librbd::image::CloneRequest <
                    I >::create(m_local_parent_image_ctx, m_local_io_ctx,
                                m_local_image_name, m_local_image_id, opts,
            ...
            template < typename I >
                ...
                if (r < 0) {
                    derr << ": failed to clone image " << m_parent_pool_name <<
                        "/" << m_local_parent_image_ctx->
                        name << " to " << m_local_image_name << dendl;
                    m_ret_val = r;
                }
            ...
            template < typename I >
                ...
                Context *ctx = create_context_callback <
                    CreateImageRequest < I >,
                    &CreateImageRequest < I >::handle_close_local_parent_image >
                    (this);
                CloseImageRequest < I > *request =
                    CloseImageRequest < I >::create(&m_local_parent_image_ctx,
                                                    ctx);
                request->send();
            }
            ...
            template < typename I >
                void CreateImageRequest <
                I >::handle_close_local_parent_image(int r) {
                dout(20) << ": r=" << r << dendl;
                if (r < 0) {
            ...
            template < typename I >
                ...
                Context *ctx = create_context_callback <
                    CreateImageRequest < I >,
                    &CreateImageRequest <
                    I >::handle_close_remote_parent_image > (this);
                CloseImageRequest < I > *request =
                    CloseImageRequest < I >::create(&m_remote_parent_image_ctx,
                                                    ctx);
                request->send();
            }
            ...
            template < typename I >
                void CreateImageRequest <
                I >::handle_close_remote_parent_image(int r) {
                dout(20) << ": r=" << r << dendl;
                if (r < 0) {
            ...
            template < typename I > void CreateImageRequest < I >::error(int r) {
                ...
                m_work_queue->queue(create_context_callback <
                                    CreateImageRequest < I >,
                                    &CreateImageRequest < I >::finish > (this),
                                    r);
            }
            ...
            template < typename I >
              ...
              for (auto & snap_info_pair:m_remote_image_ctx->
                     snap_info) {
                ...
                if (r < 0) {
                    derr << ": failed to open remote parent pool " <<
                        m_remote_parent_spec.
                ...
                if (r < 0) {
                    derr << ": failed to open local parent pool " <<
                        m_parent_pool_name << ": " << cpp_strerror(r) << dendl;
                    return r;
                }
