...
class SQLiteDB:public DB, virtual public DBOp {
  ...
  public:
    ...
    SQLiteDB(sqlite3 * dbi, std::string db_name, CephContext * _cct):DB(db_name,
                                                                        _cct),
        cct(_cct) {
        db = (void *)dbi;
    } SQLiteDB(std::string db_name, CephContext * _cct):DB(db_name, _cct),
        cct(_cct) {
    }
    ~SQLiteDB() {
    }
    ...
    int InitPrepareParams(const DoutPrefixProvider * dpp,
    ...
    int createObjectDataTable(const DoutPrefixProvider * dpp,
                              DBOpParams * params);
    int createObjectView(const DoutPrefixProvider * dpp, DBOpParams * params);
    int createObjectTableTrigger(const DoutPrefixProvider * dpp,
                                 DBOpParams * params);
    ...
    int DeleteObjectDataTable(const DoutPrefixProvider * dpp,
                              DBOpParams * params);
    ...
    int ListAllBuckets(const DoutPrefixProvider * dpp,
                       DBOpParams * params) override;
    int ListAllUsers(const DoutPrefixProvider * dpp,
                     DBOpParams * params) override;
    int ListAllObjects(const DoutPrefixProvider * dpp,
                       DBOpParams * params) override;
};
...
class SQLObjectOp:public ObjectOp {
  ...
  public:
    ...
    int InitializeObjectOps(std::string db_name,
...
class SQLInsertUser:public SQLiteDB, public InsertUserOp {
  ...
  public:
    SQLInsertUser(void **db, std::string db_name,
                  CephContext * cct):SQLiteDB((sqlite3 *) (*db), db_name, cct),
        sdb((sqlite3 **) db) {
    } ~SQLInsertUser() {
        if (stmt)
...
class SQLRemoveUser:public SQLiteDB, public RemoveUserOp {
  ...
  public:
    SQLRemoveUser(void **db, std::string db_name,
                  CephContext * cct):SQLiteDB((sqlite3 *) (*db), db_name, cct),
        sdb((sqlite3 **) db) {
    } ~SQLRemoveUser() {
        if (stmt)
...
class SQLGetUser:public SQLiteDB, public GetUserOp {
  ...
  public:
    SQLGetUser(void **db, std::string db_name,
               CephContext * cct):SQLiteDB((sqlite3 *) (*db), db_name, cct),
        sdb((sqlite3 **) db) {
    } ~SQLGetUser() {
        if (stmt)
...
class SQLInsertBucket:public SQLiteDB, public InsertBucketOp {
  ...
  public:
    SQLInsertBucket(void **db, std::string db_name,
                    CephContext * cct):SQLiteDB((sqlite3 *) (*db), db_name,
                                                cct), sdb((sqlite3 **) db) {
    } ~SQLInsertBucket() {
        if (stmt)
            sqlite3_finalize(stmt);
...
class SQLUpdateBucket:public SQLiteDB, public UpdateBucketOp {
  ...
  public:
    SQLUpdateBucket(void **db, std::string db_name,
                    CephContext * cct):SQLiteDB((sqlite3 *) (*db), db_name,
                                                cct), sdb((sqlite3 **) db) {
    } ~SQLUpdateBucket() {
        if (info_stmt)
...
class SQLRemoveBucket:public SQLiteDB, public RemoveBucketOp {
  ...
  public:
    SQLRemoveBucket(void **db, std::string db_name,
                    CephContext * cct):SQLiteDB((sqlite3 *) (*db), db_name,
                                                cct), sdb((sqlite3 **) db) {
    } ~SQLRemoveBucket() {
        if (stmt)
...
class SQLGetBucket:public SQLiteDB, public GetBucketOp {
  ...
  public:
    SQLGetBucket(void **db, std::string db_name,
                 CephContext * cct):SQLiteDB((sqlite3 *) (*db), db_name, cct),
        sdb((sqlite3 **) db) {
    } ~SQLGetBucket() {
        if (stmt)
...
class SQLListUserBuckets:public SQLiteDB, public ListUserBucketsOp {
  ...
  public:
    SQLListUserBuckets(void **db, std::string db_name,
                       CephContext * cct):SQLiteDB((sqlite3 *) (*db), db_name,
                                                   cct), sdb((sqlite3 **) db) {
    } ~SQLListUserBuckets() {
        if (stmt)
...
class SQLPutObject:public SQLiteDB, public PutObjectOp {
  ...
  public:
    SQLPutObject(void **db, std::string db_name,
                 CephContext * cct):SQLiteDB((sqlite3 *) (*db), db_name, cct),
        sdb((sqlite3 **) db) {
    } SQLPutObject(sqlite3 ** sdbi, std::string db_name,
                   CephContext * cct):SQLiteDB(*sdbi, db_name, cct), sdb(sdbi) {
    }
...
class SQLDeleteObject:public SQLiteDB, public DeleteObjectOp {
  ...
  public:
    SQLDeleteObject(void **db, std::string db_name,
                    CephContext * cct):SQLiteDB((sqlite3 *) (*db), db_name,
                                                cct), sdb((sqlite3 **) db) {
    } SQLDeleteObject(sqlite3 ** sdbi, std::string db_name,
                      CephContext * cct):SQLiteDB(*sdbi, db_name, cct),
        sdb(sdbi) {
    }
...
class SQLGetObject:public SQLiteDB, public GetObjectOp {
  ...
  public:
    SQLGetObject(void **db, std::string db_name,
                 CephContext * cct):SQLiteDB((sqlite3 *) (*db), db_name, cct),
        sdb((sqlite3 **) db) {
    } SQLGetObject(sqlite3 ** sdbi, std::string db_name,
                   CephContext * cct):SQLiteDB(*sdbi, db_name, cct), sdb(sdbi) {
    }
...
class SQLUpdateObject:public SQLiteDB, public UpdateObjectOp {
  ...
  public:
    SQLUpdateObject(void **db, std::string db_name,
                    CephContext * cct):SQLiteDB((sqlite3 *) (*db), db_name,
                                                cct), sdb((sqlite3 **) db) {
    } SQLUpdateObject(sqlite3 ** sdbi, std::string db_name,
                      CephContext * cct):SQLiteDB(*sdbi, db_name, cct),
        sdb(sdbi) {
    }
...
class SQLListBucketObjects:public SQLiteDB, public ListBucketObjectsOp {
  ...
  public:
    SQLListBucketObjects(void **db, std::string db_name,
                         CephContext * cct):SQLiteDB((sqlite3 *) (*db), db_name,
                                                     cct),
        sdb((sqlite3 **) db) {
    } SQLListBucketObjects(sqlite3 ** sdbi, std::string db_name,
                           CephContext * cct):SQLiteDB(*sdbi, db_name, cct),
        sdb(sdbi) {
    }
...
class SQLListVersionedObjects:public SQLiteDB, public ListVersionedObjectsOp {
  ...
  public:
    SQLListVersionedObjects(void **db, std::string db_name,
                            CephContext * cct):SQLiteDB((sqlite3 *) (*db),
                                                        db_name, cct),
        sdb((sqlite3 **) db) {
    } SQLListVersionedObjects(sqlite3 ** sdbi, std::string db_name,
                              CephContext * cct):SQLiteDB(*sdbi, db_name, cct),
        sdb(sdbi) {
    }
...
class SQLPutObjectData:public SQLiteDB, public PutObjectDataOp {
  ...
  public:
    SQLPutObjectData(void **db, std::string db_name,
                     CephContext * cct):SQLiteDB((sqlite3 *) (*db), db_name,
                                                 cct), sdb((sqlite3 **) db) {
    } SQLPutObjectData(sqlite3 ** sdbi, std::string db_name,
                       CephContext * cct):SQLiteDB(*sdbi, db_name, cct),
        sdb(sdbi) {
    }
...
class SQLUpdateObjectData:public SQLiteDB, public UpdateObjectDataOp {
  ...
  public:
    SQLUpdateObjectData(void **db, std::string db_name,
                        CephContext * cct):SQLiteDB((sqlite3 *) (*db), db_name,
                                                    cct), sdb((sqlite3 **) db) {
    } SQLUpdateObjectData(sqlite3 ** sdbi, std::string db_name,
                          CephContext * cct):SQLiteDB(*sdbi, db_name, cct),
        sdb(sdbi) {
    }
...
class SQLGetObjectData:public SQLiteDB, public GetObjectDataOp {
  ...
  public:
    SQLGetObjectData(void **db, std::string db_name,
                     CephContext * cct):SQLiteDB((sqlite3 *) (*db), db_name,
                                                 cct), sdb((sqlite3 **) db) {
    } SQLGetObjectData(sqlite3 ** sdbi, std::string db_name,
                       CephContext * cct):SQLiteDB(*sdbi, db_name, cct),
        sdb(sdbi) {
    }
...
class SQLDeleteObjectData:public SQLiteDB, public DeleteObjectDataOp {
  ...
  public:
    SQLDeleteObjectData(void **db, std::string db_name,
                        CephContext * cct):SQLiteDB((sqlite3 *) (*db), db_name,
                                                    cct), sdb((sqlite3 **) db) {
    } SQLDeleteObjectData(sqlite3 ** sdbi, std::string db_name,
                          CephContext * cct):SQLiteDB(*sdbi, db_name, cct),
        sdb(sdbi) {
    }
...
class SQLDeleteStaleObjectData:public SQLiteDB, public DeleteStaleObjectDataOp {
  ...
  public:
    SQLDeleteStaleObjectData(void **db, std::string db_name,
                             CephContext * cct):SQLiteDB((sqlite3 *) (*db),
                                                         db_name, cct),
        sdb((sqlite3 **) db) {
    } SQLDeleteStaleObjectData(sqlite3 ** sdbi, std::string db_name,
                               CephContext * cct):SQLiteDB(*sdbi, db_name, cct),
        sdb(sdbi) {
    }
...
class SQLInsertLCEntry:public SQLiteDB, public InsertLCEntryOp {
  ...
  public:
    SQLInsertLCEntry(void **db, std::string db_name,
                     CephContext * cct):SQLiteDB((sqlite3 *) (*db), db_name,
                                                 cct), sdb((sqlite3 **) db) {
    } ~SQLInsertLCEntry() {
        if (stmt)
...
class SQLRemoveLCEntry:public SQLiteDB, public RemoveLCEntryOp {
  ...
  public:
    SQLRemoveLCEntry(void **db, std::string db_name,
                     CephContext * cct):SQLiteDB((sqlite3 *) (*db), db_name,
                                                 cct), sdb((sqlite3 **) db) {
    } ~SQLRemoveLCEntry() {
        if (stmt)
...
class SQLGetLCEntry:public SQLiteDB, public GetLCEntryOp {
  ...
  public:
    SQLGetLCEntry(void **db, std::string db_name,
                  CephContext * cct):SQLiteDB((sqlite3 *) (*db), db_name, cct),
        sdb((sqlite3 **) db) {
    } ~SQLGetLCEntry() {
        if (stmt)
...
class SQLListLCEntries:public SQLiteDB, public ListLCEntriesOp {
  ...
  public:
    SQLListLCEntries(void **db, std::string db_name,
                     CephContext * cct):SQLiteDB((sqlite3 *) (*db), db_name,
                                                 cct), sdb((sqlite3 **) db) {
    } ~SQLListLCEntries() {
        if (stmt)
...
class SQLInsertLCHead:public SQLiteDB, public InsertLCHeadOp {
  ...
  public:
    SQLInsertLCHead(void **db, std::string db_name,
                    CephContext * cct):SQLiteDB((sqlite3 *) (*db), db_name,
                                                cct), sdb((sqlite3 **) db) {
    } ~SQLInsertLCHead() {
        if (stmt)
...
class SQLRemoveLCHead:public SQLiteDB, public RemoveLCHeadOp {
  ...
  public:
    SQLRemoveLCHead(void **db, std::string db_name,
                    CephContext * cct):SQLiteDB((sqlite3 *) (*db), db_name,
                                                cct), sdb((sqlite3 **) db) {
    } ~SQLRemoveLCHead() {
        if (stmt)
...
class SQLGetLCHead:public SQLiteDB, public GetLCHeadOp {
  ...
  public:
    SQLGetLCHead(void **db, std::string db_name,
                 CephContext * cct):SQLiteDB((sqlite3 *) (*db), db_name, cct),
        sdb((sqlite3 **) db) {
    } ~SQLGetLCHead() {
        if (stmt)
