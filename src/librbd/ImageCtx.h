...
namespace librbd {
     ...
     */
        ...
        static bool _filter_metadata_confs(const string & prefix,
     ...
     */
            ImageCtx(const std::string & image_name,
                             const std::string & image_id,
                     const char *snap, IoCtx & p, bool read_only);
        ~ImageCtx();
        void init();
        ...
        void snap_unset();
        librados::snap_t get_snap_id(cls::rbd::
        ...
        int update_flags(librados::snap_t in_snap_id, uint64_t flag,
                         bool enabled);
        ...
        void aio_read_from_cache(object_t o, uint64_t object_no,
                                 bufferlist * bl, size_t len, uint64_t off,
                                 Context * onfinish, int fadvise_flags,
                                 ZTracer::Trace * trace);
        ...
        uint64_t prune_parent_extents(vector < pair < uint64_t,
                                      uint64_t > >&objectx, uint64_t overlap);
