...
static int set_version(cls_method_context_t hctx, struct obj_version *objv)
{
    ...
    CLS_LOG(20, "cls_version: set_version %s:%d", objv->tag.c_str(),
            (int)objv->ver);
...
#define TAG_LEN 24
    ...
    CLS_LOG(20, "cls_version: init_version %s:%d", objv->tag.c_str(),
            (int)objv->ver);
                        ...
                        bool implicit_create)
{
    ...
    CLS_LOG(20, "cls_version: read_version %s:%d", objv->tag.c_str(),
            (int)objv->ver);
...
CLS_INIT(version)
{
    ...
    cls_register_cxx_method(h_class, "set", CLS_METHOD_RD | CLS_METHOD_WR,
                            cls_version_set, &h_version_set);
    cls_register_cxx_method(h_class, "inc", CLS_METHOD_RD | CLS_METHOD_WR,
                            cls_version_inc, &h_version_inc);
    cls_register_cxx_method(h_class, "inc_conds", CLS_METHOD_RD | CLS_METHOD_WR,
                            cls_version_inc, &h_version_inc_conds);
    cls_register_cxx_method(h_class, "read", CLS_METHOD_RD, cls_version_read,
                            &h_version_read);
    cls_register_cxx_method(h_class, "check_conds", CLS_METHOD_RD,
                            cls_version_check, &h_version_check_conds);
