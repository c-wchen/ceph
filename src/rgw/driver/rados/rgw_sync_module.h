...
class RGWDataSyncModule {
  public:
    ...
    virtual RGWCoroutine *init_sync(const DoutPrefixProvider * dpp,
                                    RGWDataSyncCtx * sc) {
        return nullptr;
    }

    virtual RGWCoroutine *start_sync(const DoutPrefixProvider * dpp,
                                     RGWDataSyncCtx * sc) {
        return nullptr;
    }
...
class RGWSyncModule {
  ...
  public:
    ...
    virtual int create_instance(const DoutPrefixProvider * dpp,
                                CephContext * cct,
...
class RGWSyncModulesManager {
  ...
  public:
    ...
    void register_module(const std::string & name, RGWSyncModuleRef & module,
