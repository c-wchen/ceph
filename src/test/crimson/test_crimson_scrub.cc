...
public:
    constexpr static unsigned get_max_pos()
    {
        return MAX_POS;
    }
...
TEST(TestSnapSet, Stats)
{
    ...
    {
        auto &so = add_simple_head(32, [](auto ret) {
            return ret;
        });
    ...
    {
        auto &so = add_simple_head(64, [](auto ret) {
            return ret;
        });
