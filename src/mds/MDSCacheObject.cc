...
std::string_view MDSCacheObject::generic_pin_name(int p) const const
{
    switch (p) {
        case PIN_REPLICATED:
            return "replicated";
...
void MDSCacheObject::dump(ceph::Formatter *f) const const
{
 ...
 * states too.
 */
void MDSCacheObject::dump_states(ceph::Formatter *f) const const
{
