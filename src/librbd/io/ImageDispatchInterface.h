...
namespace librbd {
    namespace io {
        ...
        struct ImageDispatchInterface {
            ...
            virtual bool read(AioCompletion * aio_comp, Extents
                ...
                0;
            virtual bool write(AioCompletion * aio_comp, Extents
                               ...
                               Context ** on_finish, Context * on_dispatched) =
                0;
            virtual bool discard(AioCompletion * aio_comp, Extents
                                 && image_extents,
            ...
            virtual bool write_same(AioCompletion * aio_comp, Extents
                                    && image_extents, bufferlist
                                    && bl, int op_flags,
                                    const ZTracer::Trace & parent_trace,
                                    uint64_t tid,
                                    ...
                                    *image_dispatch_flags,
                                    ...
                                    Context ** on_finish,
                                    Context * on_dispatched) = 0;
            virtual bool compare_and_write(AioCompletion * aio_comp, Extents
                                           && image_extents, bufferlist
                                           && cmp_bl, bufferlist
                                           ...
                                           *image_dispatch_flags,
                                           ...
                                           Context ** on_finish,
                                           Context * on_dispatched) = 0;
            virtual bool flush(AioCompletion * aio_comp,
            ...
            virtual bool list_snaps(AioCompletion * aio_comp, Extents
