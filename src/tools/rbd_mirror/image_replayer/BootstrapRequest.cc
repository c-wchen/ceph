    ...
    namespace mirror {
        namespace image_replayer {
            ...
            using librbd::util::unique_lock_name;
             ...
             template < typename I >
                BootstrapRequest <
                I >::BootstrapRequest(librados::IoCtx & local_io_ctx,
            ...
            :BaseRequest("rbd::mirror::image_replayer::BootstrapRequest",
                         ...
                         on_finish), m_local_io_ctx(local_io_ctx),
                ...
                m_journaler(journaler), m_client_state(client_state),
            ...
            } template < typename I > BootstrapRequest <
                I >::~BootstrapRequest() {
            ...
            template < typename I >
                ...
                Context *ctx = create_context_callback <
                    BootstrapRequest < I >,
                    &BootstrapRequest < I >::handle_get_remote_tag_class >
                    (this);
                m_journaler->get_client(librbd::Journal <>::IMAGE_CLIENT_ID,
                                        &m_client, ctx);
            }

            template < typename I >
                void BootstrapRequest <
                I >::handle_get_remote_tag_class(int r) {
                dout(20) << ": r=" << r << dendl;

                if (r < 0) {
                    derr << ": failed to retrieve remote client: " <<
                ...
                try {
                    ...
                    derr << ": failed to decode remote client meta data: " <<
                        err.what()
                        << dendl;
                    finish(-EBADMSG);
                    return;
                ...
                dout(10) << ": remote tag class=" << m_remote_tag_class <<
                    dendl;
            ...
            template < typename I >
                ...
                OpenImageRequest < I > *request =
                    OpenImageRequest < I >::create(m_remote_io_ctx,
                                                   &m_remote_image_ctx,
                                                   m_remote_image_id, false,
                                                   ctx);
                request->send();
            }
            ...
            template < typename I >
                ...
                if (r < 0) {
                    derr << ": failed to open remote image: " << cpp_strerror(r)
                        << dendl;
                    assert(m_remote_image_ctx == nullptr);
                    finish(r);
                    return;
            ...
            template < typename I > void BootstrapRequest < I >::is_primary() {
                dout(20) << dendl;
                ...
                Context *ctx = create_context_callback <
                    BootstrapRequest < I >,
                    &BootstrapRequest < I >::handle_is_primary > (this);
                IsPrimaryRequest < I > *request =
                    IsPrimaryRequest < I >::create(m_remote_image_ctx,
                                                   &m_primary, ctx);
                request->send();
            }
            ...
            template < typename I >
                ...
                if (r == -ENOENT) {
                    ...
                    derr << ": error querying remote image primary status: " <<
                        cpp_strerror(r)
                        << dendl;
                    m_ret_val = r;
                    close_remote_image();
                ...
                if (!m_primary) {
                    if (m_local_image_id.empty()) {
                        ...
                        dout(5) <<
                            ": remote image is not primary -- not syncing" <<
                            dendl;
                        m_ret_val = -EREMOTEIO;
                        close_remote_image();
                        return;
                        ...
                        dout(5) <<
                            ": remote image is not primary -- sync interrupted"
                            << dendl;
                        m_ret_val = -EREMOTEIO;
                        update_client_state();
                        return;
            ...
            template < typename I >
                ...
                librbd::journal::
                    MirrorPeerClientMeta client_meta(*m_client_meta);
                client_meta.state =
                    librbd::journal::MIRROR_PEER_STATE_REPLAYING;
                ...
                Context *ctx = create_context_callback <
                    BootstrapRequest < I >,
                    &BootstrapRequest < I >::handle_update_client_state >
                    (this);
            ...
            template < typename I >
                ...
                dout(20) << ": r=" << r << dendl;
                if (r < 0) {
                    derr << ": failed to update client: " << cpp_strerror(r) <<
                        dendl;
                }
                else {
                    m_client_meta->state =
            ...
            template < typename I >
                ...
                Context *ctx = create_context_callback <
                    BootstrapRequest < I >,
                    &BootstrapRequest < I >::handle_open_local_image > (this);
                OpenLocalImageRequest < I > *request =
                    OpenLocalImageRequest < I >::create(m_local_io_ctx,
                                                        m_local_image_ctx,
                                                        m_local_image_id,
                                                        m_work_queue, ctx);
                request->send();
            ...
            template < typename I >
                ...
                if (r == -ENOENT) {
                    ...
                    assert(*m_local_image_ctx == nullptr);
                    dout(10) <<
                        "local image is primary -- skipping image replay" <<
                        dendl;
                    m_ret_val = r;
                    close_remote_image();
                    return;
                    ...
                    assert(*m_local_image_ctx == nullptr);
                    derr << ": failed to open local image: " << cpp_strerror(r)
                        << dendl;
                    m_ret_val = r;
                    close_remote_image();
                    return;
                ...
                I *local_image_ctx = (*m_local_image_ctx);
                {
                    ...
                    r = (*m_local_image_ctx)->journal->
                        is_resync_requested(m_do_resync);
                    if (r < 0) {
                        local_image_ctx->snap_lock.put_read();

                        derr << ": failed to check if a resync was requested" <<
                            dendl;
                        m_ret_val = r;
                        close_local_image();
                        return;
                ...
                if (m_local_tag_data.mirror_uuid != m_remote_mirror_uuid
                    ...
                    dout(5) <<
                        ": remote image is not primary -- skipping image replay"
                        << dendl;
                    m_ret_val = -EREMOTEIO;
                    close_local_image();
                    return;
                ...
                if (*m_client_state == cls::journal::CLIENT_STATE_DISCONNECTED) {
                    dout(10) <<
                        ": client flagged disconnected -- skipping bootstrap" <<
                        dendl;
            ...
            template < typename I >
                ...
                Context *ctx = create_context_callback <
                    BootstrapRequest < I >,
                    &BootstrapRequest < I >::handle_unregister_client > (this);
            ...
            template < typename I >
                ...
                dout(20) << ": r=" << r << dendl;
                if (r < 0) {
                    derr << ": failed to unregister with remote journal: " <<
                        cpp_strerror(r)
                        << dendl;
                    m_ret_val = r;
                    close_remote_image();
            ...
            template < typename I >
                ...
                Context *ctx = create_context_callback <
                    BootstrapRequest < I >,
                    &BootstrapRequest < I >::handle_register_client > (this);
            ...
            template < typename I >
                ...
                if (r < 0) {
                    derr << ": failed to register with remote journal: " <<
                        cpp_strerror(r)
                        << dendl;
                    m_ret_val = r;
                    close_remote_image();
            ...
            template < typename I >
                ...
                Context *ctx = create_context_callback <
                    BootstrapRequest < I >,
                    &BootstrapRequest < I >::handle_update_client_image >
                    (this);
                m_journaler->update_client(data_bl, ctx);
            }
            ...
            template < typename I >
                ...
                CreateImageRequest < I > *request =
                    CreateImageRequest < I >::create(m_local_io_ctx,
                                                     m_work_queue,
                                                     m_global_image_id,
            ...
            template < typename I >
                ...
                if (r < 0) {
                    derr << ": failed to create local image: " <<
                        cpp_strerror(r) << dendl;
                    m_ret_val = r;
                    close_remote_image();
                    return;
            ...
            template < typename I >
                ...
                Context *ctx = create_context_callback <
                    BootstrapRequest < I >,
                    &BootstrapRequest < I >::handle_get_remote_tags > (this);
            ...
            template < typename I >
                ...
                if (r < 0) {
                    derr << ": failed to retrieve remote tags: " <<
                        cpp_strerror(r) << dendl;
                    m_ret_val = r;
                    close_local_image();
                    return;
              ...
              for (auto & remote_tag:m_remote_tags) {
                    if (m_local_tag_data.predecessor.commit_valid &&
                        ...
                        remote_tag.tid) {
                        dout(15) <<
                            ": skipping processed predecessor remote tag " <<
                    ...
                    try {
                        ...
                        derr << ": failed to decode remote tag " << remote_tag.
                            tid << ": " << err.what() << dendl;
                        m_ret_val = -EBADMSG;
                        close_local_image();
                        return;
                    ...
                    dout(10) << ": decoded remote tag " << remote_tag.
                        tid << ": " << remote_tag_data << dendl;

                    if (!m_local_tag_data.predecessor.commit_valid) {
                        // newly synced local image (no predecessor) replays from the first tag
                        if (remote_tag_data.mirror_uuid !=
                            librbd::Journal <>::LOCAL_MIRROR_UUID) {
                            dout(20) << ": skipping non-primary remote tag" <<
                                dendl;
                            continue;
                        }

                        dout(20) << ": using initial primary remote tag" <<
                            dendl;
                        break;
                    }

                    if (m_local_tag_data.mirror_uuid ==
                        ...
                        if (remote_tag_data.mirror_uuid ==
                            ...
                            if (remote_tag_data.predecessor.mirror_uuid ==
                                m_local_mirror_uuid
                                && m_local_tag_data.predecessor.mirror_uuid ==
                                librbd::Journal <>::LOCAL_MIRROR_UUID) {
                            ...
                            if (m_local_tag_data.predecessor.mirror_uuid ==
                                ...
                                dout(20) <<
                                    ": found matching remote demotion tag" <<
                                    dendl;
                                remote_orphan_tag_tid = remote_tag.tid;
                                continue;
                            }
                        ...
                        if (remote_tag_data.mirror_uuid ==
                            ...
                            *remote_orphan_tag_tid) {
                            ...
                            dout(20) << ": found chained remote promotion tag"
                                << dendl;
                ...
                if (remote_tag_data_valid &&
                    ...
                    dout(10) << ": local image is in clean replay state" <<
                        dendl;
                }
                    ...
                    derr << ": split-brain detected -- skipping image replay" <<
                        dendl;
                    m_ret_val = -EEXIST;
                    close_local_image();
                    return;
            ...
            template < typename I > void BootstrapRequest < I >::image_sync() {
                ...
                dout(20) << dendl;
                {
                    ...
                    if (m_canceled) {
                        ...
                        Context *ctx = create_context_callback <
                            BootstrapRequest < I >,
                            &BootstrapRequest < I >::handle_image_sync > (this);
                        m_image_sync =
                            ImageSync < I >::create(*m_local_image_ctx,
                                                    m_remote_image_ctx, m_timer,
                                                    m_timer_lock,
                                                    m_local_mirror_uuid,
                                                    m_journaler, m_client_meta,
                                                    m_work_queue,
                                                    m_instance_watcher, ctx,
                                                    m_progress_ctx);
            ...
            template < typename I >
...

                {
                    ...
                    if (r < 0) {
                        derr << ": failed to sync remote image: " <<
                            cpp_strerror(r) << dendl;
                        m_ret_val = r;
                    }
                }
            ...
            template < typename I >
                ...
                Context *ctx = create_context_callback <
                    BootstrapRequest < I >,
                    &BootstrapRequest < I >::handle_close_local_image > (this);
            ...
            template < typename I >
                ...
                if (r < 0) {
                    derr << ": error encountered closing local image: " <<
                        cpp_strerror(r)
                        << dendl;
                }
            ...
            template < typename I >
                ...
                CloseImageRequest < I > *request =
                    CloseImageRequest < I >::create(&m_remote_image_ctx, ctx);
                request->send();
            }
            ...
            template < typename I >
                ...
                if (r < 0) {
                    derr << ": error encountered closing remote image: " <<
                        cpp_strerror(r)
                        << dendl;
                }
            ...
            template < typename I >
                void BootstrapRequest <
                I >::update_progress(const std::string & description) {
...
template class rbd::mirror::image_replayer::BootstrapRequest <
    librbd::ImageCtx >;
