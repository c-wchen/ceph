...
static std::list < std::pair < ghobject_t, ghobject_t >> get_ranges(CollectionRef ch,
        ghobject_t start,
...
SeaStore::Shard::read_errorator::future < ceph::bufferlist > SeaStore::Shard::read(CollectionRef ch,
...
SeaStore::Shard::_omap_get_value_ret SeaStore::Shard::_omap_get_value(Transaction &t,
        omap_root_t && root,
...
SeaStore::Shard::_omap_get_values_ret SeaStore::Shard::_omap_get_values(Transaction &t,
        omap_root_t && omap_root,
...
SeaStore::Shard::omap_list_ret SeaStore::Shard::omap_list(Onode &onode,
...
SeaStore::Shard::omap_get_values_ret_t SeaStore::Shard::omap_get_values(CollectionRef ch,
        const ghobject_t &oid,
...
SeaStore::Shard::tm_ret SeaStore::Shard::_do_transaction_step(internal_context_t &ctx,
        CollectionRef &col,
...
SeaStore::Shard::tm_ret SeaStore::Shard::_write(internal_context_t &ctx,
        OnodeRef &onode,
...
SeaStore::Shard::tm_ret SeaStore::Shard::_zero(internal_context_t &ctx,
        OnodeRef &onode,
...
SeaStore::Shard::omap_set_kvs_ret SeaStore::Shard::_omap_set_kvs(OnodeRef &onode,
        const omap_root_le_t &omap_root,
        Transaction &t,
...
SeaStore::Shard::tm_ret SeaStore::Shard::_omap_set_values(internal_context_t &ctx,
        OnodeRef &onode,
        std::map < std::string,
...
SeaStore::Shard::tm_ret SeaStore::Shard::_omap_set_header(internal_context_t &ctx,
        OnodeRef &onode,
...
SeaStore::Shard::tm_ret SeaStore::Shard::_omap_clear(internal_context_t &ctx,
        OnodeRef &onode)
{
...
SeaStore::Shard::tm_ret SeaStore::Shard::_omap_rmkeys(internal_context_t &ctx,
...
SeaStore::Shard::tm_ret SeaStore::Shard::_omap_rmkeyrange(internal_context_t &ctx,
        OnodeRef &onode,
...
SeaStore::Shard::tm_ret SeaStore::Shard::_truncate(internal_context_t &ctx,
...
SeaStore::Shard::tm_ret SeaStore::Shard::_setattrs(internal_context_t &ctx,
        OnodeRef &onode,
...
SeaStore::Shard::tm_ret SeaStore::Shard::_rmattr(internal_context_t &ctx,
...
SeaStore::Shard::tm_ret SeaStore::Shard::_xattr_rmattr(internal_context_t &ctx,
        OnodeRef &onode, std::string && name)
{
...
SeaStore::Shard::tm_ret SeaStore::Shard::_xattr_clear(internal_context_t &ctx,
        OnodeRef &onode)
{
...
SeaStore::Shard::tm_ret SeaStore::Shard::_create_collection(internal_context_t &ctx,
...
SeaStore::Shard::tm_ret SeaStore::Shard::_remove_collection(internal_context_t &ctx,
        const coll_t &cid)
{
    return transaction_manager->read_collection_root(*ctx.transaction).
    si_then([ =, this, &ctx](auto _cmroot) {
