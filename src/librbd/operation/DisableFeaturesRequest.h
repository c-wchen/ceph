...
namespace librbd {
    ...
    namespace operation {
      ...
      template < typename ImageCtxT = ImageCtx > class DisableFeaturesRequest:public Request < ImageCtxT >
        {
          public:
            static DisableFeaturesRequest *create(ImageCtxT & image_ctx,
                                                  Context * on_finish,
                                                  uint64_t journal_op_tid,
                                                  uint64_t features,
                                                  bool force) {
                return new DisableFeaturesRequest(image_ctx, on_finish,
...
extern template class librbd::operation::DisableFeaturesRequest <
    librbd::ImageCtx >;
