...
namespace crimson {
    namespace test_simple_scheduler {
        ...
        } // namespace crimson int main(int argc, char *argv[])
{
    // server params
    ...
    static std::vector < sim::CliInst > no_wait =
        { {sim::req_op, client_total_ops, client_iops_goal,
                       ...
                       int head_w, int data_w, int data_prec)
{
    ...
    out << "Server request_complete_timer: count:" << rct_combiner.
        get_count() << ", mean:" << rct_combiner.
        get_mean() << ", std_dev:" << rct_combiner.
        get_std_dev() << ", low:" << rct_combiner.
        get_low() << ", high:" << rct_combiner.get_high() << std::endl;
    out << "Server combined mean: " << (art_combiner.get_mean() +
                                        rct_combiner.get_mean()) << std::endl;
#endif
}
