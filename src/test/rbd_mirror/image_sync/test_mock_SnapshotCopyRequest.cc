...
template class rbd::mirror::image_sync::SnapshotCopyRequest <
    ...
    namespace mirror {
        namespace image_sync {
              ...
              public:
                                       ...
                                       MockExclusiveLock & mock_exclusive_lock)
                {
                    ...
                    EXPECT_CALL(mock_image_ctx, get_snap_namespace(snap_id, _))
                        ...
                        WillOnce(DoAll
                                 (SetArgPointee < 1 >
                                  ...
                                  Return(0)));
                } void expect_snap_create(librbd::
                    ...
                    EXPECT_CALL(mock_snapshot_create_request, send())
                        ...
                        WillOnce(DoAll
                                 (Invoke
                                  ([&mock_image_ctx, snap_id, snap_name] () {
                ...
                void expect_snap_remove(librbd::
                                        MockTestImageCtx & mock_image_ctx,
                ...
                void expect_snap_protect(librbd::
                                         MockTestImageCtx & mock_image_ctx,
                                         const std::string & snap_name, int r) {
                    EXPECT_CALL(*mock_image_ctx.operations,
                ...
                static void inject_snap(librbd::
                                        MockTestImageCtx & mock_image_ctx,
                                        uint64_t snap_id,
                                        const std::string & snap_name) {
                ...
                void validate_snap_seqs(const librbd::journal::
                                        MirrorPeerClientMeta::
                                        SnapSeqs & snap_seqs) {
                    ASSERT_EQ(snap_seqs, m_client_meta.snap_seqs);
                }

                void validate_snap_map(const MockSnapshotCopyRequest::
                                       SnapMap & snap_map) {
            ...
            TEST_F(TestMockImageSyncSnapshotCopyRequest, SnapCreate) {
                ...
                uint64_t remote_snap_id1 = m_remote_image_ctx->snap_ids[{ cls::
                                                                        rbd::
                                                                        UserSnapshotNamespace
                                                                        (),
                                                                        "snap1"
                                                                        }];
                uint64_t remote_snap_id2 =
                    m_remote_image_ctx->
                    snap_ids[{ cls::rbd::UserSnapshotNamespace(), "snap2" }];
                ...
                InSequence seq;
                expect_get_snap_namespace(mock_remote_image_ctx,
                                          remote_snap_id1);
                expect_start_op(mock_exclusive_lock);
                expect_snap_create(mock_local_image_ctx,
                                   mock_snapshot_create_request, "snap1", 12,
                                   0);
                expect_get_snap_namespace(mock_remote_image_ctx,
                                          remote_snap_id2);
                expect_start_op(mock_exclusive_lock);
                expect_snap_create(mock_local_image_ctx,
                                   mock_snapshot_create_request, "snap2", 14,
                                   0);
                expect_snap_is_protected(mock_remote_image_ctx, remote_snap_id1,
                                         false, 0);
                expect_snap_is_protected(mock_remote_image_ctx, remote_snap_id2,
                                         false, 0);
                expect_update_client(mock_journaler, 0);
            ...
            TEST_F(TestMockImageSyncSnapshotCopyRequest, SnapRemoveAndCreate) {
                ...
                uint64_t local_snap_id1 =
                    m_local_image_ctx->
                    snap_ids[{ cls::rbd::UserSnapshotNamespace(), "snap1" }];
            ...
            TEST_F(TestMockImageSyncSnapshotCopyRequest, SnapRemoveError) {
                ...
                uint64_t local_snap_id1 = m_local_image_ctx->snap_ids[{ cls::
                                                                      rbd::
                                                                      UserSnapshotNamespace
                                                                      (),
                                                                      "snap1"
            ...
            TEST_F(TestMockImageSyncSnapshotCopyRequest, SnapUnprotect) {
                ...
                InSequence seq;
                expect_snap_is_unprotected(mock_local_image_ctx, local_snap_id1,
                                           false, 0);
                expect_snap_is_unprotected(mock_remote_image_ctx,
                                           remote_snap_id1, true, 0);
                expect_start_op(mock_exclusive_lock);
                ...
                validate_snap_map( { {
                                  ...
                                  local_snap_id1}}});
                validate_snap_seqs( { {
                                   remote_snap_id1, local_snap_id1}});
            }
            ...
            TEST_F(TestMockImageSyncSnapshotCopyRequest, SnapProtect) {
                ...
                expect_snap_is_protected(mock_remote_image_ctx, remote_snap_id1,
                                         true, 0);
                expect_snap_is_protected(mock_local_image_ctx, local_snap_id1,
                                         false, 0);
                expect_start_op(mock_exclusive_lock);
                expect_snap_protect(mock_local_image_ctx, "snap1", 0);
                expect_update_client(mock_journaler, 0);
