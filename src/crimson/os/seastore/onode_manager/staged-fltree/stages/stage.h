 ...
 */
    template < typename Params > struct staged {
        ...
        template < bool GET_POS, bool GET_KEY, bool GET_VAL > static void get_largest_slot(const container_t & container,   // IN
        ...
        template < typename T = bool >
            ...
            compensate_insert_position_at(match_stage_t stage,
                                          position_t & position) {
            auto & index = position.index;
            if (stage == STAGE) {
                assert(index == 0);
      ...
      template < KeyT KT > class StagedAppender:std::conditional_t < IS_BOTTOM, _BaseEmpty,
        ...
        static std::tuple < TrimType, node_offset_t >
            recursively_trim(NodeExtentMutable & mut,
        ...
        static std::optional < std::tuple < match_stage_t, node_offset_t, bool >> proceed_erase_recursively(NodeExtentMutable & mut, const container_t & container, // IN
