        ...
        namespace instance_watcher {
            ...
            namespace {
                ...
                class EncodePayloadVisitor:public boost::static_visitor < void > {
                  public:
                    explicit EncodePayloadVisitor(bufferlist & bl):m_bl(bl) {
                        ...
                        using ceph::encode;
                         encode(static_cast < uint32_t > (Payload::NOTIFY_OP),
                                m_bl);
                         payload.encode(m_bl);
                  } private:
                     bufferlist & m_bl;
                ...
                class DecodePayloadVisitor:public boost::static_visitor < void > {
                  public:
                    DecodePayloadVisitor(__u8 version,
            ...
            } void PayloadBase::decode(__u8 version,
                                       bufferlist::const_iterator & iter) {
                using ceph::decode;
            ...
            } void ImagePayloadBase::decode(__u8 version,
                                            bufferlist::const_iterator & iter) {
                using ceph::decode;
            ...
            } void PeerImageRemovedPayload::decode(__u8 version,
                                                   bufferlist::
                                                   const_iterator & iter) {
                using ceph::decode;
                PayloadBase::decode(version, iter);
            ...
            void PeerImageRemovedPayload::dump(Formatter * f) const {
                ...
                using ceph::encode;
                 PayloadBase::encode(bl);
                 encode(sync_id, bl);
            } void SyncPayloadBase::decode(__u8 version,
                                           bufferlist::const_iterator & iter) {
                using ceph::decode;
                PayloadBase::decode(version, iter);
                decode(sync_id, iter);
            ...
            void NotifyMessage::dump(Formatter * f) const {
                ...
                o.push_back(new
                            NotifyMessage(SyncRequestPayload(1, "sync_id")));
...
}} // namespace instance_watcher } // namespace mirror }    // namespace rbd
