...
TEST(LibCephFS, LayoutVerifyDefaultLayout)
{
...

    {
        ...
        r = ceph_getxattr(cmount, "/", "ceph.dir.layout.json", (void *)value,
                          sizeof(value));
        ASSERT_GT(r, 0);
        ASSERT_LT(r, sizeof value);
        std::clog << "layout:" << value << std::endl;
        ASSERT_STRNE((char *)NULL,
                     strstr(value, "\"inheritance\": \"@default\""));
    }
...
TEST(LibCephFS, LayoutSetAndVerifyNewAndInheritedLayout)
{
...

    {
        ...
        ASSERT_EQ(0,
                  ceph_setxattr(cmount, "test/d0", "ceph.dir.layout.json",
                                (void *)new_layout.c_str(), new_layout.length(),
                                XATTR_CREATE));
    }

    {
        ...
        r = ceph_getxattr(cmount, "test/d0", "ceph.dir.layout.json",
        ...
        JSONDecoder::decode_json("pool_name", pool_name, &json_parser, true);
        JSONDecoder::decode_json("object_size", object_size, &json_parser,
                                 true);
        JSONDecoder::decode_json("stripe_unit", stripe_unit, &json_parser,
                                 true);
        JSONDecoder::decode_json("stripe_count", stripe_count, &json_parser,
                                 true);
        JSONDecoder::decode_json("inheritance", inheritance, &json_parser,
                                 true);
...

    {
        ...
        r = ceph_getxattr(cmount, "test/d0/subdir", "ceph.dir.layout.json",
                          (void *)value, sizeof(value));
        ASSERT_GT(r, 0);
        ASSERT_LT(r, sizeof value);
        std::clog << "layout:" << value << std::endl;
...
TEST(LibCephFS, LayoutSetBadJSON)
{
...

    {
        ...
        ASSERT_EQ(-CEPHFS_EINVAL,
                  ceph_setxattr(cmount, "test/d0", "ceph.dir.layout.json",
                                (void *)new_layout, strlen(new_layout),
                                XATTR_CREATE));
    }
...
TEST(LibCephFS, LayoutSetBadPoolId)
{
...

    {
        ...
        ASSERT_EQ(-CEPHFS_EINVAL,
                  ceph_setxattr(cmount, "test/d0", "ceph.dir.layout.pool_id",
...
TEST(LibCephFS, LayoutSetInvalidFieldName)
{
...

    {
        ...
        ASSERT_EQ(-CEPHFS_ENODATA,
                  ceph_setxattr(cmount, "test/d0", "ceph.dir.layout.bad_field",
                                (void *)"300", 3, XATTR_CREATE));
    }
...
TEST(LibCephFS, GetAndSetDirPin)
{
...

    {
        char value[1024] = "";
        int r =
            ceph_getxattr(cmount, "test/d1", "ceph.dir.pin", (void *)value,
                          sizeof(value));
        ASSERT_GT(r, 0);
        ASSERT_LT(r, sizeof value);
...

    {
        ...
        ASSERT_EQ(0,
                  ceph_setxattr(cmount, "test/d1", "ceph.dir.pin", (void *)"1",
                                1, XATTR_CREATE));

        r = ceph_getxattr(cmount, "test/d1", "ceph.dir.pin", (void *)value,
                          sizeof(value));
        ASSERT_GT(r, 0);
        ASSERT_LT(r, sizeof value);
        ASSERT_STREQ("1", value);
...
TEST(LibCephFS, GetAndSetDirDistribution)
{
...

    {
        char value[1024] = "";
        int r =
            ceph_getxattr(cmount, "test/d2", "ceph.dir.pin.distributed",
                          (void *)value, sizeof(value));
        ASSERT_GT(r, 0);
        ASSERT_LT(r, sizeof value);
...

    {
        ...
        ASSERT_EQ(0,
                  ceph_setxattr(cmount, "test/d2", "ceph.dir.pin.distributed",
                                (void *)"1", 1, XATTR_CREATE));

        r = ceph_getxattr(cmount, "test/d2", "ceph.dir.pin.distributed",
                          (void *)value, sizeof(value));
        ASSERT_GT(r, 0);
        ASSERT_LT(r, sizeof value);
        ASSERT_STREQ("1", value);
...
TEST(LibCephFS, GetAndSetDirRandom)
{
...

    {
        char value[1024] = "";
        int r =
            ceph_getxattr(cmount, "test/d3", "ceph.dir.pin.random",
                          (void *)value, sizeof(value));
        ASSERT_GT(r, 0);
        ASSERT_LT(r, sizeof value);
        ASSERT_STREQ("0", value);
...

    {
        ...
        ss << val;
        ASSERT_EQ(0,
                  ceph_setxattr(cmount, "test/d3", "ceph.dir.pin.random",
                                (void *)ss.str().c_str(),
        ...
        r = ceph_getxattr(cmount, "test/d3", "ceph.dir.pin.random",
                          (void *)value, sizeof(value));
        ASSERT_GT(r, 0);
        ASSERT_LT(r, sizeof value);
