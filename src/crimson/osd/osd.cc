...
std::pair < entity_addrvec_t, bool > replace_unknown_addrs(entity_addrvec_t maybe_unknowns,
         ...
         version_t newest)
{
    ...
    } else if (osdmap->require_osd_release <
...
bool OSD::should_restart()const
{
    if (!osdmap->is_up(whoami)) {
        ...
        return true;
    } else if (osdmap->get_addrs(whoami) !=
               public_msgr->get_myaddrs()) {
        logger().
        error
