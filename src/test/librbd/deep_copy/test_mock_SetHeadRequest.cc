...
namespace librbd {
    ...
    namespace image {
        ...
        DetachParentRequest < MockTestImageCtx > *DetachParentRequest <
...
namespace librbd {
    namespace deep_copy {
        ...
        class TestMockDeepCopySetHeadRequest:public TestMockFixture {
          public:
            typedef SetHeadRequest < librbd::MockTestImageCtx >
                MockSetHeadRequest;
            typedef image::AttachParentRequest < MockTestImageCtx >
                MockAttachParentRequest;
            typedef image::DetachParentRequest < MockTestImageCtx >
            ...
            void expect_set_size(librbd::MockTestImageCtx & mock_image_ctx,
                                 int r) {
            ...
            MockSetHeadRequest *create_request(librbd::
                                               MockTestImageCtx &
                                               ...
                                               uint64_t parent_overlap,
                                               Context * on_finish) {
                return new MockSetHeadRequest(&mock_local_image_ctx, size,
        ...
        TEST_F(TestMockDeepCopySetHeadRequest, SetParentOverlap) {
            ...
            C_SaferCond ctx;
            auto request = create_request(mock_image_ctx, 123,
                                          mock_image_ctx.parent_md.spec, 123,
                                          &ctx);
            request->send();
            ASSERT_EQ(0, ctx.wait());
