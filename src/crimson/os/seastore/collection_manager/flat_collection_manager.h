...
namespace crimson::os::seastore::collection_manager {
    ...
    class FlatCollectionManager:public CollectionManager {
      ...
      public:
        ...
        remove_ret remove(const coll_root_t & coll_root, Transaction & t,
                          coll_t cid) final;

        update_ret update(const coll_root_t & coll_root, Transaction & t,
                          coll_t cid, coll_info_t info) final;
    };
