    ...
    namespace sal {
        ...
        class RGWRole {
          ...
          public:
            ...
            } const std::string & get_assume_role_policy() const {
                return info.trust_policy;
            } const uint64_t & get_max_session_duration() const {
                return info.max_session_duration;
            } const RGWObjVersionTracker & get_objv_tracker() const {
                return info.objv_tracker;
            } const real_time & get_mtime() const {
                return info.mtime;
            } std::map < std::string, bufferlist > &get_attrs() {
                return info.attrs;
            }
            RGWRoleInfo & get_info() {
                return info;
            }
            ...
            void set_mtime(const real_time & mtime) {
        ...
        class RGWRoleMetadataObject:public RGWMetadataObject {
          ...
          public:
             ...
             RGWRoleMetadataObject(RGWRoleInfo & info,
                                   const obj_version & v,
                                   real_time m,
                                   Driver * driver):RGWMetadataObject(v, m),
                info(info), driver(driver) {
        ...
        class RGWRoleMetadataHandler:public RGWMetadataHandler_GenericMetaBE {
          public:
            RGWRoleMetadataHandler(Driver * driver,
