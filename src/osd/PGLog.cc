            ...
            return seastar::do_with(std::move(ch),
                                    ...
                                    repeat([this, &ch, &pgmeta_oid, &start] () {
                                           ...
                                           safe_then([this,
                                                     ...
                                                     {
                      const auto &[done, kvs] = ret; for (const auto &[key, value]:kvs)
                                                     {
