...
{
    context_thread t;
    ba::steady_timer timer(t.io_context(), 50 ms);
...
{
    context_thread t;
    ba::steady_timer timer(t.io_context(), 1 s);
    bs::error_code ec;
...
TEST(BlockedCompletion, DefaultLess)
{
    ...
    {
        auto l =
            id(t.get_executor(), ca::use_blocked, bs::error_code { },
               defaultless { 5 });
        EXPECT_EQ(5, l.a);
    }
    {
        auto l =
            id(t.get_executor(), ca::use_blocked[ec], bs::error_code { },
               defaultless { 7 });
        EXPECT_EQ(7, l.a);
    }
