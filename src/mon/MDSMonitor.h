...
class MDSMonitor:public PaxosService, public PaxosFSMap,
   ...
   */
    ...
    int filesystem_command(FSMap & fsmap,
                           MonOpRequestRef op,
    ...
    struct beacon_info_t {
        ...
        uint64_t seq = 0;
         beacon_info_t() {
        } beacon_info_t(ceph::mono_time stamp, uint64_t seq):stamp(stamp),
            seq(seq) {
        }
    };
