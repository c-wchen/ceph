...
namespace librbd {
    ...
    namespace mirror {
       ...
       template < typename ImageCtxT = librbd::ImageCtx > class InstanceWatcher:protected librbd::
            Watcher
        {
          ...
          public:
            ...
            static InstanceWatcher *create(librados::IoCtx & io_ctx,
                                           librbd::AsioEngine & asio_engine,
                                           InstanceReplayer < ImageCtxT >
                                           *instance_replayer,
                                           Throttler < ImageCtxT >
                                           *image_sync_throttler);
            void destroy() {
                delete this;
            } InstanceWatcher(librados::IoCtx & io_ctx,
                              librbd::AsioEngine & asio_engine,
            ...
            void notify_sync_request(const std::string & sync_id,
   ...
   */
            ...
            struct HandlePayloadVisitor:public boost::static_visitor < void > {
                ...
                :instance_watcher(instance_watcher), instance_id(instance_id),
                    ...
                    instance_watcher->handle_payload(instance_id, payload,
                                                     on_notify_ack);
            }};
            ...
            std::set < std::pair < std::string,
                C_NotifyInstanceRequest * >>m_notify_ops;
            ...
            void notify_sync_complete(const ceph::mutex & lock,
            ...
            Context *prepare_request(const std::string & instance_id,
                                     uint64_t request_id,
                                     C_NotifyAck * on_notify_ack);
            void complete_request(const std::string & instance_id,
            ...
            void handle_payload(const std::string & instance_id,
                                const instance_watcher::
                                ImageAcquirePayload & payload,
                                C_NotifyAck * on_notify_ack);
            void handle_payload(const std::string & instance_id,
                                const instance_watcher::
                                ImageReleasePayload & payload,
                                C_NotifyAck * on_notify_ack);
            void handle_payload(const std::string & instance_id,
                                const instance_watcher::
                                PeerImageRemovedPayload & payload,
                                C_NotifyAck * on_notify_ack);
            void handle_payload(const std::string & instance_id,
                                const instance_watcher::
