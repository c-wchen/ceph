...
RemoveRequest < I >::RemoveRequest(IoCtx &ioctx, I *image_ctx,
                                   bool force,
                                   bool from_trash_remove,
                                   ProgressContext &prog_ctx,
                                   ContextWQ *op_work_queue,
                                   Context *on_finish)
    : m_ioctx(ioctx), m_image_name(image_ctx->name),
      m_image_id(image_ctx->id), m_image_ctx(image_ctx), m_force(force),
...
template < typename I > void RemoveRequest < I >::open_image()
{
    ...
    m_image_ctx =
        I::create(m_image_id.empty() ? m_image_name : "", m_image_id,
...
template < typename I > void RemoveRequest < I >::pre_remove_image()
{
    ...
    auto ctx = create_context_callback <
               RemoveRequest < I >,
               &RemoveRequest < I >::handle_pre_remove_image > (this);
    auto req =
        PreRemoveRequest < I >::create(m_image_ctx, m_force, ctx);
    req->send();
}
...
template < typename I > void RemoveRequest < I >::detach_child()
{
    ...
    auto ctx = create_context_callback <
               RemoveRequest < I >,
               &RemoveRequest < I >::handle_detach_child > (this);
