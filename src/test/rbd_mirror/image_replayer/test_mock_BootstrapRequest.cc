...
namespace librbd {
    ...
    } // namespace journal namespace util {

        static std::string s_image_id;

         template <>
            std::string generate_image_id < MockTestImageCtx >
            (librados::IoCtx &) {
            assert(!s_image_id.empty());
            return s_image_id;
}} // namespace util } // namespace librbd namespace rbd {
    namespace mirror {
        ...
        class ProgressContext;
         ...
         template <> struct ImageSync <librbd::MockTestImageCtx > {
            ...
            static ImageSync *create(librbd::MockTestImageCtx * local_image_ctx,
                                     ...
                                     remote_image_ctx, SafeTimer * timer,
                                     Mutex * timer_lock,
                                     const std::string & mirror_uuid,::journal::
                                     MockJournaler * journaler,
                                     librbd::journal::MirrorPeerClientMeta *
                                     client_meta, ContextWQ * work_queue,
                                     InstanceWatcher <
                                     librbd::MockTestImageCtx >
                                     *instance_watcher, Context * on_finish,
        ...
        ImageSync < librbd::MockTestImageCtx > *ImageSync <
        ...
        namespace image_replayer {
            ...
            template <> struct CloseImageRequest <librbd::MockTestImageCtx > {
                ...
                MOCK_METHOD1(construct,
                             void (librbd::MockTestImageCtx * image_ctx));
                MOCK_METHOD0(send, void ());
            };
            ...
            template <> struct IsPrimaryRequest <librbd::MockTestImageCtx > {
                static IsPrimaryRequest *s_instance;
                bool *primary = nullptr;
                Context *on_finish = nullptr;

                static IsPrimaryRequest *create(librbd::MockTestImageCtx *
                                                image_ctx, bool * primary,
                                                Context * on_finish) {
                    assert(s_instance != nullptr);
            ...
            CreateImageRequest < librbd::MockTestImageCtx >
                *CreateImageRequest < librbd::MockTestImageCtx >::s_instance =
                nullptr;
            IsPrimaryRequest < librbd::MockTestImageCtx > *IsPrimaryRequest <
                librbd::MockTestImageCtx >::s_instance = nullptr;
            OpenImageRequest < librbd::MockTestImageCtx > *OpenImageRequest <
                librbd::MockTestImageCtx >::s_instance = nullptr;
    ...
    namespace mirror {
        namespace image_replayer {
            ...
            MATCHER_P(IsSameIoCtx, io_ctx, "") {
              ...
              public:
                typedef BootstrapRequest < librbd::MockTestImageCtx >
                    MockBootstrapRequest;
                typedef CloseImageRequest < librbd::MockTestImageCtx >
                    MockCloseImageRequest;
                typedef CreateImageRequest < librbd::MockTestImageCtx >
                ...
                typedef InstanceWatcher < librbd::MockTestImageCtx >
                    MockInstanceWatcher;
                typedef IsPrimaryRequest < librbd::MockTestImageCtx >
                    MockIsPrimaryRequest;
                typedef OpenImageRequest < librbd::MockTestImageCtx >
                ...
                void SetUp() override {
                    ...
                    ASSERT_EQ(0,
                              open_image(m_local_io_ctx, m_image_name,
                                         &m_local_image_ctx));
                } void expect_journaler_get_client(::journal::
                                                   MockJournaler &
                                                   mock_journaler,
                                                   const std::
                                                   string & client_id,
                    ...
                    EXPECT_CALL(mock_journaler,
                                get_client(StrEq(client_id), _, _))
                        .
                        WillOnce(DoAll
                                 (WithArg < 1 >
                                  (Invoke
                                   ([client] (cls::journal::Client * out_client)
                                    {
                                    *out_client =
                                    client;})), WithArg < 2 > (Invoke([this,
                                                                       r]
                                                                      (Context *
                                                                       on_finish)
                                                                      {
                ...
                void expect_journaler_get_tags(::journal::
                                               MockJournaler & mock_journaler,
                                               uint64_t tag_class,
                                               const Tags & tags, int r) {
                    EXPECT_CALL(mock_journaler, get_tags(tag_class, _, _))
                        .
                        WillOnce(DoAll
                                 (WithArg < 1 >
                                  (Invoke([tags] (Tags * out_tags) {
                                          *out_tags =
                                          tags;})), WithArg < 2 > (Invoke([this,
                                                                           r]
                                                                          (Context
                                                                           *
                                                                           on_finish)
                ...
                void expect_journaler_register_client(::journal::
                                                      MockJournaler &
                                                      mock_journaler,
                    ...
                    EXPECT_CALL(mock_journaler,
                                register_client(ContentsEqual(bl), _))
                        .WillOnce(WithArg < 1 >
                                  (Invoke([this, r] (Context * on_finish) {
                                          m_threads->work_queue->
                                          queue(on_finish, r);})));
                }

                void expect_journaler_unregister_client(::journal::
                                                        MockJournaler &
                ...
                void expect_journaler_update_client(::journal::
                                                    MockJournaler &
                                                    mock_journaler,
                                                    const librbd::journal::
                                                    ClientData & client_data,
                    ...
                    EXPECT_CALL(mock_journaler,
                                update_client(ContentsEqual(bl), _))
                        .WillOnce(WithArg < 1 >
                                  (Invoke([this, r] (Context * on_finish) {
                                          m_threads->work_queue->
                                          queue(on_finish, r);})));
                ...
                void expect_open_image(MockOpenImageRequest &
                    ...
                    EXPECT_CALL(mock_open_image_request, send())
                        .
                        WillOnce(Invoke
                                 ([this, &mock_open_image_request,
                                   &mock_image_ctx, r] () {
                                  *mock_open_image_request.image_ctx =
                                  &mock_image_ctx;
                                  m_threads->work_queue->
                                  queue(mock_open_image_request.on_finish,
                                        r);}));
                }

                void expect_open_local_image(MockOpenLocalImageRequest &
                    ...
                    EXPECT_CALL(mock_open_local_image_request, send())
                        .
                        WillOnce(Invoke
                                 ([this, &mock_open_local_image_request,
                                   mock_image_ctx, r] () {
                                  *mock_open_local_image_request.image_ctx =
                                  mock_image_ctx;
                                  m_threads->work_queue->
                                  queue(mock_open_local_image_request.on_finish,
                                        r);}));
                }

                void expect_close_image(MockCloseImageRequest &
                                        mock_close_image_request,
                                        librbd::
                                        MockTestImageCtx & mock_image_ctx,
                                        int r) {
                    EXPECT_CALL(mock_close_image_request,
                ...
                void expect_is_primary(MockIsPrimaryRequest &
                                       mock_is_primary_request, bool primary,
                                       int r) {
                    EXPECT_CALL(mock_is_primary_request, send())
                        .
                        WillOnce(Invoke
                                 ([this, &mock_is_primary_request, primary,
                                   r] () {
                                  *mock_is_primary_request.primary = primary;
                                  m_threads->work_queue->
                                  queue(mock_is_primary_request.on_finish,
                                        r);}));
                }

                void expect_journal_get_tag_tid(librbd::
                ...
                void expect_journal_get_tag_data(librbd::
                                                 MockJournal & mock_journal,
                                                 const librbd::journal::
                                                 TagData & tag_data) {
                    EXPECT_CALL(mock_journal,
                ...
                void expect_create_image(MockCreateImageRequest &
                    ...
                    EXPECT_CALL(mock_create_image_request, send())
                        .
                        WillOnce(Invoke
                                 ([this, &mock_create_image_request, r] () {
                                  m_threads->work_queue->
                                  queue(mock_create_image_request.on_finish,
                                        r);}));
                }
                ...
                void expect_image_sync(MockImageSync & mock_image_sync, int r) {
                    ...
                    EXPECT_CALL(mock_image_sync, send())
                        .WillOnce(Invoke([this, &mock_image_sync, r] () {
                                         m_threads->work_queue->
                                         queue(mock_image_sync.on_finish,
                                               r);}));
                ...
                MockBootstrapRequest *create_request(MockInstanceWatcher *
            ...
            TEST_F(TestMockImageReplayerBootstrapRequest,
                ...
                expect_close_image(mock_close_image_request,
                                   mock_remote_image_ctx, 0);
                ...
                MockBootstrapRequest *request =
                    create_request(&mock_instance_watcher, mock_journaler,
                                   mock_local_image_ctx.id,
                                   mock_remote_image_ctx.id, "global image id",
                                   "local mirror uuid",
                                   "remote mirror uuid", &client_state,
            ...
            TEST_F(TestMockImageReplayerBootstrapRequest,
                ...
                expect_open_local_image(mock_open_local_image_request,
                                        m_local_io_ctx, mock_local_image_ctx.id,
            ...
            TEST_F(TestMockImageReplayerBootstrapRequest, RemoteDemotePromote) {
                ...
                Tags tags = {
                    {2, 123,
                     encode_tag_data({librbd::Journal <>::LOCAL_MIRROR_UUID,
                                      librbd::Journal <>::LOCAL_MIRROR_UUID,
                                      true, 1, 99}
                     )}
                    ,
                    {3, 123,
                     encode_tag_data({librbd::Journal <>::ORPHAN_MIRROR_UUID,
                                      librbd::Journal <>::LOCAL_MIRROR_UUID,
                                      true, 2, 1}
                     )}
                    ,
            ...
            TEST_F(TestMockImageReplayerBootstrapRequest,
                ...
                expect_journal_get_tag_data(mock_journal, {
                                            ...
                                            ORPHAN_MIRROR_UUID,
                                            librbd::Journal <>::
                                            LOCAL_MIRROR_UUID, true, 345, 1}
                );

                // remote demotion / promotion event
                Tags tags = {
                    {2, 123,
                     encode_tag_data({"local mirror uuid", "local mirror uuid",
                                      true, 344, 99}
                     )}
                    ,
                    {3, 123,
            ...
            TEST_F(TestMockImageReplayerBootstrapRequest,
                ...
                MockOpenLocalImageRequest mock_open_local_image_request;
                expect_open_local_image(mock_open_local_image_request,
                                        m_local_io_ctx, "missing image id",
                                        nullptr, -ENOENT);
                ...
                mirror_peer_client_meta.state =
                    librbd::journal::MIRROR_PEER_STATE_REPLAYING;
                client_data.client_meta = mirror_peer_client_meta;
                expect_journaler_register_client(mock_journaler, client_data,
                                                 0);
