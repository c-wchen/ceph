...
class Transaction {
  ...
  public:
    ...
    static void dump_stat() {
        ...
        cerr << " omap_rmkeys op: " << Cycles::to_microseconds(Transaction::
                                                               omap_rmkeys_ticks.
                                                               ticks) <<
            "us count: " << Transaction::omap_rmkeys_ticks.count << std::endl;
...
Transaction::Tick Transaction::write_ticks, Transaction::setattr_ticks,
    Transaction::omap_setkeys_ticks, Transaction::omap_rmkeys_ticks;
