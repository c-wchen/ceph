...
namespace ceph::osd::scheduler {
    ...
    struct client_profile_id_t {
        ...
        friend std::ostream & operator<<(std::ostream & out,
                                         const client_profile_id_t &
                                         client_profile) {
            out << " client_id: " << client_profile.
                client_id << " profile_id: " << client_profile.profile_id;
            return out;
    }};
 ...
 */
   ...
   */
        ...
        class ClientRegistry {
            ...
            crimson::dmclock::ClientInfo default_external_client_info = {
            1, 1, 1};
     ...
     */
        ...
        using mclock_queue_t = crimson::dmclock::PullPriorityQueue <
            scheduler_id_t, OpSchedulerItem, true, true, 2 >;
        using priority_t = unsigned;
        using SubQueue = std::map < priority_t,
            std::list < OpSchedulerItem >, std::greater < priority_t >>;
   ...
   */
        ...
        static unsigned int get_io_prio_cut(CephContext * cct) {
            if (cct->_conf->osd_op_queue_cut_off == "debug_random") {
                ...
                return (random_gen() % 2 <
                        1) ? CEPH_MSG_PRIO_HIGH : CEPH_MSG_PRIO_LOW;
            }
   ...
   */
      ...
      private:
        ...
        void enqueue_high(unsigned prio, OpSchedulerItem
