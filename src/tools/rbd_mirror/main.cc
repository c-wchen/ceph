...
int main(int argc, const char **argv)
{
        ...
        ("rbd_mirror_perf_stats_prio");
    {
        ...
        plb.add_u64_counter(rbd::mirror::l_rbd_mirror_journal_entries,
                            "entries", "Number of entries replayed", nullptr,
                            prio);
        plb.add_u64_counter(rbd::mirror::l_rbd_mirror_journal_replay_bytes,
                            "replay_bytes", "Total bytes replayed", nullptr,
    ...
    }
    {
        ...
        plb.add_u64_counter(rbd::mirror::l_rbd_mirror_snapshot_snapshots,
                            ...
                            prio);
        plb.add_time_avg(rbd::mirror::l_rbd_mirror_snapshot_sync_time,
                         "sync_time", "Average sync time", nullptr, prio);
