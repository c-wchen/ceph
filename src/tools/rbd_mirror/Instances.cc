    ...
    namespace mirror {
        ...
        template < typename I >
            ...
            Context *ctx = new FunctionContext([this] (int r){
              Mutex::Locker timer_locker(m_threads->timer_lock); Mutex::Locker locker(m_lock); for (auto it:m_instances)
                                               {
        ...
        template < typename I >
            void Instances <
            I >::handle_notify(const std::string & instance_id) {
            dout(20) << instance_id << dendl;
            ...
            auto & instance =
                m_instances.
                insert(std::make_pair(instance_id, Instance(instance_id))).
                first->second;
        ...
        template < typename I >
            ...
            instance.timer_task = new FunctionContext([this, &instance] (int r) {
                                                      assert(m_threads->
                                                             timer_lock.
                                                             is_locked());
                                                      Mutex::
            ...
            dout(20) << "scheduling instance " << instance.
                id << " remove after " << after << " sec (task " << instance.
                timer_task << ")" << dendl;
