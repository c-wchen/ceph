...
namespace librados {
    ...
    class TestWatchNotify:boost::noncopyable {
      public:
        ...
        typedef std::map < std::pair < uint64_t, uint64_t >,
            bufferlist > NotifyResponses;
        ...
        void notify_ack(TestRadosClient * rados_client, const std::string & o,
                        ...
                        bufferlist & bl);
        int watch(TestRadosClient * rados_client, const std::string & o,
                  uint64_t gid, uint64_t * handle, librados::WatchCtx * ctx,
      ...
      private:
        ...
        void execute_notify(TestRadosClient * rados_client,
        ...
        void ack_notify(TestRadosClient * rados_client, const std::string & oid,
                        ...
                        const bufferlist & bl);
        void finish_notify(TestRadosClient * rados_client,
