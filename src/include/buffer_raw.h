    ...
    inline namespace v15_2_0 {
        ...
        class raw {
          ...
          :    data(nullptr), len(l), nref(0), mempool(mempool) {
                mempool::get_pool(mempool::pool_index_t(mempool)).
                    adjust_count(1, len);
            } raw(char *c, unsigned l, int mempool =
          ...
          :    data(c), len(l), nref(0), mempool(mempool) {
            ...
            void reassign_to_mempool(int pool) {
                ...
                mempool::get_pool(mempool::pool_index_t(mempool)).
                    adjust_count(-1, -(int)len);
                mempool = pool;
                mempool::get_pool(mempool::pool_index_t(pool)).adjust_count(1,
                                                                            len);
            }
