...
namespace crimson::os::seastore::collection_manager {
    ...
    FlatCollectionManager::get_root_ret
        FlatCollectionManager::get_coll_root(const coll_root_t & coll_root,
                                             Transaction & t) {
        logger().debug("FlatCollectionManager: {}", __func__);
...
case CollectionNode::create_result_t::OVERFLOW:                        {
                                                                        logger().debug("FlatCollectionManager: {} overflow!", __func__); auto new_size = coll_root.get_size() * 2;  // double each time
...
case CollectionNode::create_result_t::SUCCESS:                         {
    ...
    FlatCollectionManager::list_ret
        FlatCollectionManager::list(const coll_root_t & coll_root,
                                    Transaction & t) {
        logger().debug("FlatCollectionManager: {}", __func__);
    ...
    FlatCollectionManager::update_ret
        FlatCollectionManager::update(const coll_root_t & coll_root,
    ...
    FlatCollectionManager::remove_ret
        FlatCollectionManager::remove(const coll_root_t & coll_root,
                                      Transaction & t, coll_t cid) {
        logger().debug("FlatCollectionManager: {}", __func__);
