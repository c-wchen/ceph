...
namespace librbd {
    ...
    namespace managed_lock {
        ...
        GetLockerRequest < librbd::MockTestImageCtx > *GetLockerRequest <
    ...
    namespace managed_lock {
          ...
          public:
            ...
            void expect_list_watchers(MockTestImageCtx & mock_image_ctx, int r,
                ...
                if (r < 0) {
                    ...
                    obj_watch_t watcher;
                     strncpy(watcher.addr, (address + ":0/0").c_str(),
                             sizeof(watcher.addr) - 1);
                     ...
                     expect.
                        WillOnce(DoAll
                                 (SetArgPointee < 1 > (watchers), Return(0)));
                ...
                EXPECT_CALL(mock_get_locker_request, send())
                    ...
                    WillOnce(Invoke
                              ...
                              *mock_get_locker_request.locker = locker;
                              ...
                              queue(mock_get_locker_request.on_finish, r);}));
            }
            ...
            void expect_blocklist_add(MockTestImageCtx & mock_image_ctx, int r) {
                ...
                EXPECT_CALL(mock_rados_client,
                            blocklist_add(_, _)).WillOnce(Return(r));
            }

            void expect_wait_for_latest_osd_map(MockTestImageCtx &
            ...
            void expect_get_instance_id(MockTestImageCtx & mock_image_ctx,
                                        uint64_t id) {
                EXPECT_CALL(get_mock_io_ctx(mock_image_ctx.md_ctx),
                            get_instance_id())
                    .WillOnce(Return(id));
        ...
        TEST_F(TestMockManagedLockBreakRequest, DeadLockOwner) {
            ...
            expect_get_locker(mock_image_ctx, mock_get_locker_request, {
                              entity_name_t::CLIENT(1), "auto 123",
                              "1.2.3.4:0/0", 123}, 0);
            ...
            MockBreakRequest *req =
                MockBreakRequest::create(mock_image_ctx.md_ctx,
                                         *ictx->asio_engine,
        ...
        TEST_F(TestMockManagedLockBreakRequest, GetLockerUpdated) {
            ...
            MockGetLockerRequest mock_get_locker_request;
            expect_get_locker(mock_image_ctx, mock_get_locker_request, {
                              entity_name_t::CLIENT(2), "auto 123",
                              "1.2.3.4:0/0", 123}, 0);
        ...
        TEST_F(TestMockManagedLockBreakRequest, BlocklistSelf) {
            ...
            MockGetLockerRequest mock_get_locker_request;
            expect_get_locker(mock_image_ctx, mock_get_locker_request, {
                              entity_name_t::CLIENT(456), "auto 123",
                              "1.2.3.4:0/0", 123}, 0);
