...
public:
    ...
    public:
        ...
        explicit Incremental(epoch_t e = 0) : encode_features(0),
...
public:
    ...
    void get_full_osd_util(const mempool::pgmap::unordered_map<int32_t,
                                                               osd_stat_t> &osd_stat,
                           map<int, float> *full,
                           map<int, float> *backfill, map<int, float> *nearfull) const;
    ...
    void set_primary_affinity(int o, int w)
    {
        ...
        if (!osd_primary_affinity)
            osd_primary_affinity.reset(new mempool::osdmap::vector<__u32>(max_osd,
