...
class MDSRank {
  ...
  protected:
    ...
    list < MDSInternalContextBase * >waiting_for_active, waiting_for_replay,
    ...
    map < mds_rank_t,
        list < MDSInternalContextBase * > >waiting_for_active_peer;
  ...
  protected:
    ...
    void command_scrub_path(Formatter * f, boost::string_view path,
    ...
    void cache_drop_send_reply(Formatter * f, C_MDS_Send_Command_Reply * reply,
                               int r);
...
class MDSRankDispatcher:public MDSRank {
  public:
    ...
    bool handle_command(const cmdmap_t & cmdmap,
                        MCommand * m,
                        int *r,
                        std::stringstream * ds,
                        std::stringstream * ss,
