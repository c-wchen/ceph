...
/// fio configuration options read from the job file
    ...
    static std::vector < fio_option > ceph_options {
        make_option([](fio_option & o) {
            ...
            make_option([](fio_option & o) {
                        ...
                        o.type = FIO_OPT_STR_STORE;
                        o.help =
                        "Path to which to write json formatted perf output";
                        ...
                        o.def = 0;}), make_option([](fio_option & o) {
                                                  ...
                                                  o.help =
                                                  "Set OI(aka '_') attribute to specified length";
                                                  o.off1 =
                                                  offsetof(Options,
                                                           oi_attr_len_low);
                                                  o.off2 =
            ...
            make_option([](fio_option & o) {
                        ...
                        o.def = 0;
                        o.minval = 0;}), make_option([](fio_option & o) {
                                                     o.name =
                                                     "_fastinfo_omap_len";
                                                     o.lname =
                                                     "'_fastinfo' omap entry length";
                                                     o.type = FIO_OPT_STR_VAL;
                                                     o.help =
                                                     "Set '_fastinfo' OMAP attribute to specified length";
                                                     o.off1 =
                                                     offsetof(Options,
            ...
            make_option([](fio_option & o) {
                        ...
                        o.def = "0";}), make_option([](fio_option & o) {
                                                    ...
                                                    o.lname =
                                                    "pglog omap entry length";
                                                    o.type = FIO_OPT_STR_VAL;
                                                    o.help =
                                                    "Set pglog omap entry to specified length";
                                                    o.off1 =
                                                    offsetof(Options,
                                                             pglog_omap_len_low);
                                                    o.off2 =
            ...
            make_option([](fio_option & o) {
                        ...
                        o.type = FIO_OPT_STR_VAL;
                        o.help =
                        "Set duplicate pglog omap entry to specified length";
                        ...
                        o.minval = 0;}), make_option([](fio_option & o) {
                                                     ...
                                                     "single_pool_mode";
                                                     o.lname =
                                                     "single(shared among jobs) pool mode";
                                                     o.type = FIO_OPT_BOOL;
                                                     o.help =
                                                     "Enables the mode when all jobs run against the same pool";
                                                     o.off1 =
                                                     offsetof(Options,
                                                              single_pool_mode);
                                                     o.def =
            ...
            make_option([](fio_option & o) {
                        ...
                        o.type = FIO_OPT_BOOL;
                        o.help =
                        "Enables/disables file preallocation (touch and resize) on init";
                        o.off1 = offsetof(Options, preallocate_files);
                        o.def = "1";}), make_option([](fio_option & o) {
                                                    o.name = "check_files";
                                                    o.lname =
                                                    "ensure files exist and are correct on init";
                                                    o.type = FIO_OPT_BOOL;
                                                    o.help =
                                                    "Enables/disables checking of files on init";
                                                    o.off1 =
                                                    offsetof(Options,
                                                             check_files);
                                                    o.def =
            ...
            make_option([](fio_option & o) {
                        ...
                        o.type = FIO_OPT_STR_STORE;
                        o.help =
                        "comma delimited list of throttle values", o.off1 =
                        offsetof(Options, throttle_values);
                        o.def = 0;}), make_option([](fio_option & o) {
                                                  o.name =
                                                  "bluestore_deferred_throttle";
                                                  o.lname =
                                                  "set bluestore deferred throttle";
                                                  o.type = FIO_OPT_STR_STORE;
                                                  o.help =
                                                  "comma delimited list of throttle values",
                                                  o.off1 =
                                                  offsetof(Options,
            ...
            make_option([](fio_option & o) {
                        ...
                        o.type = FIO_OPT_STR_VAL;
                        o.help =
                        "set to non-zero value to periodically cycle through throttle options";
    ...
    int destroy_collections(std::unique_ptr < ObjectStore > &os,
      ...
      for (auto & coll:collections) {
            ...
            if (r && !failed) {
                derr << "Engine cleanup failed with " << cpp_strerror(-r) <<
                    dendl;
                failed = true;
            }
        }
    ...
    int init_collections(std::unique_ptr < ObjectStore > &os,
...

        {
            ...
            if (!exists) {
                ...
                if (r < 0) {
                    derr << "Failure to write OSD superblock: " <<
        ...
        for (uint32_t i = 0; i < count; i++) {
            ...
            bool exists = os->collection_exists(cid);
            auto ch = exists ?
                os->open_collection(cid) : os->create_new_collection(cid);
            ...
            if (!exists) {
                ...
                int r = os->queue_transaction(coll.ch, std::move(t));
                if (r) {
                    derr << "Engine init failed with " << cpp_strerror(-r) <<
                        dendl;
...
/// includes g_ceph_context and the ObjectStore instance
    struct Engine {
        ...
        void deref() {
            ...
            if (!ref_count) {
                ostringstream ostr;
                Formatter *f =
                    Formatter::create("json-pretty", "json-pretty",
                                      "json-pretty");
  ...
  :    
    ...
    perf_output_file(static_cast < Options * >(td->eo)->perf_output_file ?
                     std::make_optional(static_cast <
                                        Options *
                                        >(td->eo)->
                                        perf_output_file) : std::nullopt) {
        // add the ceph command line arguments
        auto o = static_cast < Options * >(td->eo);
        if (!o->conf) {
            throw std::
                runtime_error
                ("missing conf option for ceph configuration file");
        }
        ...
        TracepointProvider::initialize < bluestore_tracepoint_traits >
            (g_ceph_context);
        ...
        os = ObjectStore::create(g_ceph_context,
                                 ...
                                 ("osd journal"));
        if (!os)
            throw std::runtime_error("bad objectstore type " +
        ...
        if (o->single_pool_mode) {
            uint64_t count =
                g_conf().get_val < uint64_t > ("osd_pool_default_pg_num");
    ...
    struct Object {
        ...
        :oid(hobject_t
             (name, "", CEPH_NOSNAP, coll.pg.ps(), coll.pg.pool(), "")),
            coll(coll) {
    }};
...
/// or just a client using its own objects from the shared pool
    ...
    :engine(engine),
        ...
        events(td->o.iodepth),
        unlink(td->o.unlink),
        throttle_values(parse_throttle_str
                        (static_cast < Options * >(td->eo)->throttle_values)),
        deferred_throttle_values(parse_throttle_str
                                 (static_cast <
                                  Options *
                                  >(td->eo)->deferred_throttle_values)),
        cycle_throttle_period(static_cast <
                              Options * >(td->eo)->cycle_throttle_period) {
        engine->ref();
        auto o = static_cast < Options * >(td->eo);
        ...
        if (!o->single_pool_mode) {
            ...
            const uint64_t pool =
                Collection::MIN_POOL_ID + td->thread_number + 1;
        ...
        if (o->preallocate_files) {
            derr << "fio_ceph_objectstore preallocated " <<
                checked_or_preallocated << " files" << dendl;
        }
    }
    ...
    Job::~Job() {
        if (unlink) {
          ...
          for (auto & obj:objects) {
                ...
                int r =
                    engine->os->queue_transaction(obj.coll.ch, std::move(t));
                if (r && !failed) {
                    derr << "job cleanup failed with " << cpp_strerror(-r) <<
                        dendl;
                    failed = true;
                }
            }
    ...
    void Job::check_throttle() {
        ...
        if (ceph::mono_clock::is_zero(last) ||
            ...
            unsigned dtvals =
                deferred_throttle_values.size()? deferred_throttle_values.
                size() : 1;
            if (!throttle_values.empty()) {
                std::string val =
                    std::to_string(throttle_values[index % tvals]);
                std::
                    cerr << "Setting bluestore_throttle_bytes to " << val <<
                    std::endl;
                int r = engine->cct->_conf.set_val("bluestore_throttle_bytes",
                                                   val,
                                                   nullptr);
                ceph_assert(r == 0);
            }
            if (!deferred_throttle_values.empty()) {
                std::string val =
                    ...
                    to_string(deferred_throttle_values
                              [(index / tvals) % dtvals]);
                std::
                    cerr << "Setting bluestore_deferred_throttle_bytes to " <<
                    val << std::endl;
                int r =
                    engine->cct->_conf.
                    set_val("bluestore_throttle_deferred_bytes",
                            val,
                            nullptr);
                ceph_assert(r == 0);
            }
    ...
    enum fio_q_status fio_ceph_os_queue(thread_data * td, io_u * u) {
        ...
        if (u->ddir == DDIR_WRITE) {
            ...
            if (o->oi_attr_len_high) {
                ...
                job->one_for_all_data.
                    set_length(ceph::util::
                               generate_random_number(o->oi_attr_len_low,
                                                      o->oi_attr_len_high));
                attrset["_"] = job->one_for_all_data;
            }
            if (o->snapset_attr_len_high) {
                ceph_assert(o->snapset_attr_len_high >=
                            o->snapset_attr_len_low);
                job->one_for_all_data.
                    set_length(ceph::util::
                               generate_random_number(o->snapset_attr_len_low,
                                                      o->
                                                      snapset_attr_len_high));
            ...
            if (o->_fastinfo_omap_len_high) {
                ceph_assert(o->_fastinfo_omap_len_high >=
                            o->_fastinfo_omap_len_low);
                // fill with the garbage as we do not care of the actual content...
                job->one_for_all_data.
                    set_length(ceph::util::
                               generate_random_number(o->_fastinfo_omap_len_low,
                                                      o->
                                                      _fastinfo_omap_len_high));
            ...
            if (o->simulate_pglog) {
                ...
                if (o->pglog_omap_len_high) {
                    ceph_assert(o->pglog_omap_len_high >=
                                o->pglog_omap_len_low);
                    snprintf(ver_key, sizeof(ver_key), "0000000011.%020llu",
                             (unsigned long long)pglog_ver_cnt);
                    // fill with the garbage as we do not care of the actual content...
                    job->one_for_all_data.
                        set_length(ceph::util::
                                   generate_random_number(o->pglog_omap_len_low,
                                                          o->
                                                          pglog_omap_len_high));
                ...
                if (o->pglog_dup_omap_len_high) {
                    //insert dup
                    ceph_assert(o->pglog_dup_omap_len_high >=
                                o->pglog_dup_omap_len_low);
                    for (auto i = pglog_trim_tail; i < pglog_trim_head; ++i) {
                        snprintf(ver_key, sizeof(ver_key),
                                 "dup_0000000011.%020llu",
                                 (unsigned long long)i);
                        // fill with the garbage as we do not care of the actual content...
                        job->one_for_all_data.
                            set_length(ceph::util::
                                       generate_random_number(o->
                                                              pglog_dup_omap_len_low,
                                                              o->
                                                              pglog_dup_omap_len_high));
                        omaps[ver_key].append(job->one_for_all_data);
        ...
        if (u->ddir == DDIR_READ) {
            ...
            bufferlist bl;
            int r =
                os->read(coll.ch, object.oid, u->offset, u->xfer_buflen, bl);
            if (r < 0) {
                u->error = r;
                td_verror(td, u->error, "xfer");
            }
            else {
                bl.begin().copy(bl.length(),
        ...
        derr << "WARNING: Only DDIR_READ and DDIR_WRITE are supported!" <<
            dendl;
        u->error = -EINVAL;
        td_verror(td, u->error, "xfer");
        return FIO_Q_COMPLETED;
