 ...
 */
   ...
   */
        ...
        struct IoActionBase:public ImageActionBase {
            ...
            uint64_t length;
             ...
             IoActionBase():offset(0), length(0) {
                           ...
                           const Dependencies & dependencies,
                           imagectx_id_t imagectx_id, uint64_t offset,
                           uint64_t length)
        ...
        struct ReadAction:public IoActionBase {
            static const ActionType ACTION_TYPE = ACTION_TYPE_READ;
             ...
             ReadAction() {
                         ...
                         imagectx_id_t imagectx_id, uint64_t offset,
                         uint64_t length)
            :IoActionBase(id, thread_id, dependencies, imagectx_id, offset,
                          length) {
            }
        };
        ...
        typedef boost::variant < StartThreadAction,
            ...
            OpenImageAction,
            CloseImageAction,
            AioOpenImageAction, AioCloseImageAction, UnknownAction > Action;
        ...
        class ActionEntry {
          ...
          private:
            void decode_versioned(__u8 version,
