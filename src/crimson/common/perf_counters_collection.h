...
namespace crimson::common {
    class PerfCountersCollection:public seastar::sharded <
        PerfCountersCollection > {
        using ShardedPerfCountersCollection =
            seastar::sharded < PerfCountersCollection >;
    ...
    inline PerfCountersCollection::
        ShardedPerfCountersCollection & sharded_perf_coll() {
...
using PerfCountersRef =
    std::unique_ptr < crimson::common::PerfCounters,
