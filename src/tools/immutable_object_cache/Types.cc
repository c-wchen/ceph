...
void ObjectCacheRegReplyData::decode_payload(bufferlist::
        const_iterator bl,
        __u8 encode_version)
{
}
...
ObjectCacheReadReplyData::ObjectCacheReadReplyData(uint16_t t,
        uint64_t s,
        std::
        string cache_path)
...
void ObjectCacheReadReplyData::decode_payload(bufferlist::
        const_iterator i,
        __u8 encode_version)
{
...
ObjectCacheReadRadosData::ObjectCacheReadRadosData(uint16_t t,
        uint64_t s)
    :    ObjectCacheRequest(t, s)
{
}
...
void ObjectCacheReadRadosData::decode_payload(bufferlist::
        const_iterator i,
        __u8 encode_version)
{
}

ObjectCacheRequest *decode_object_cache_request(bufferlist
        payload_buffer)
{
