...
void ci_ref_test(object_manifest_t l,
                 ...
                 object_manifest_t g, object_ref_delta_t expected_delta)
{
    {
...
void ci_ref_test_on_modify(object_manifest_t l,
                           object_manifest_t to_remove,
                           ObjectCleanRegions clean_regions,
...
void ci_ref_test_inc_on_set(object_manifest_t l,
...
object_manifest_t mk_manifest(std::map < uint64_t, std::tuple < uint64_t,
                              uint64_t, string >> m)
{
