...
#define dout_prefix *_dout << "librbd::journal::Replay: " << this << " " \
      ...
      :    m_image_ctx(image_ctx), m_lock("Replay<I>::m_lock") {
        ...
        template < typename I >
            int Replay < I >::decode(bufferlist::iterator * it,
        ...
        template < typename I >
            ...
            // is processed
            op_event.on_op_finish_event = new FunctionContext([on_resume]
                                                              (int r) {
                                                              on_resume->
                                                              complete(r);});
                                                          ...
                                                          writeback_cache_enabled)
        {
            ...
            if (writeback_cache_enabled) {
                ...
                ldout(cct,
                      20) << ": completing safe context: " << on_safe << dendl;
                m_image_ctx.op_work_queue->queue(on_safe, 0);
            }
        }
        ...
        template < typename I >
            ...
            bool writeback_cache_enabled =
                m_image_ctx.is_writeback_cache_enabled();
            if (writeback_cache_enabled) {
