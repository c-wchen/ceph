 ...
 */ template < typename ImageCtxT = librbd::ImageCtx >
          ...
          public:
            static ImageDeleter *create(librados::IoCtx & local_io_ctx,
                                        ...
                                        *service_daemon) {
                return new ImageDeleter(local_io_ctx, threads,
                                        image_deletion_throttler,
                                        service_daemon);
            ...
            struct TrashListener:public image_deleter::TrashListener {
                ImageDeleter *image_deleter;
                 ...
                 TrashListener(ImageDeleter *
                               image_deleter):image_deleter(image_deleter) {
                } void handle_trash_image(const std::string & image_id,
                                          const ceph::real_clock::
                                          time_point & deferment_end_time)
                    override {
                    image_deleter->handle_trash_image(image_id,
                                                      deferment_end_time);
                }
            };
            ...
            image_deleter::TrashWatcher < ImageCtxT > *m_trash_watcher =
                nullptr;
            ...
            void enqueue_failed_delete(DeleteInfoRef * delete_info,
