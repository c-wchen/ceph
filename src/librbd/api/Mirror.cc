...
struct C_ImageGetGlobalStatus:                         public
    ...
    *
    ...
    override
    {
        ...
        mirror_image_global_status->site_statuses.reserve(mirror_image_status_internal.mirror_image_site_statuses.size());
 ...
 token)
{
    ...
    * cct =
    ...
    bufferlist token_bl;
    token_bl.append(R "({)" R "(" fsid ":") " + fsid + R"(",)" + R "(" client_id ":") " + peer_client_id + R"(",)" + R "("
            key ":") " + cephx_key + R"(",)" + R "(" mon_host ":") " + \
