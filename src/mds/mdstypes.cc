...
void client_writeable_range_t::generate_test_instances(list <
                                                       client_writeable_range_t
                                                       * >&ls)
{
...
void session_info_t::dump(Formatter * f) const const
{
    ...
    for (map < ceph_tid_t, inodeno_t >::const_iterator p =
         completed_requests.begin(); p != completed_requests.end(); ++p) {
...
void MDSCacheObjectInfo::generate_test_instances(list <
...
void mds_table_pending_t::generate_test_instances(list <
...
void dirfrag_load_vec_t::dump(Formatter * f, utime_t now,
                              const DecayRate & rate)
{
...
void dirfrag_load_vec_t::generate_test_instances(list <
