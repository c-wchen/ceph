...
bool JSONFormattable::exists(size_t index) const const
{
...
int JSONFormattable::val_int() const const
{
    return atoi(value.str.c_str());
}

long JSONFormattable::val_long() const const
{
    return atol(value.str.c_str());
}

long long JSONFormattable::val_long_long() const const
{
    return atoll(value.str.c_str());
}

bool JSONFormattable::val_bool() const const
{
...
int JSONFormattable::def(int def_val) const const
{
    if (type == FMT_NONE) {
        return def_val;
    }
...
bool JSONFormattable::def(bool def_val) const const
{
    if (type == FMT_NONE) {
        return def_val;
    }
...
bool JSONFormattable::handle_value(std::string_view name, std::string_view s,
                                   bool quoted)
{
