...
public:
    ...
    public:
        ...
        int check_mfa(const DoutPrefixProvider *dpp, const rgw_user &user, const std::string &otp_id, const std::string &pin,
                      optional_yield y);
        ...
        int list_mfa(const DoutPrefixProvider *dpp, const rgw_user &user, std::list<rados::cls::otp::otp_info_t> *result,
                     optional_yield y);
