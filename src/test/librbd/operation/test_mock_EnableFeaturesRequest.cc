...
namespace librbd {
    ...
    namespace journal {
        ...
        CreateRequest < MockOperationImageCtx > *CreateRequest <
            MockOperationImageCtx >::s_instance = nullptr;
    ...
    namespace mirror {
        ...
        EnableRequest < MockOperationImageCtx > *EnableRequest <
            MockOperationImageCtx >::s_instance = nullptr;
    ...
    namespace object_map {
        ...
        template <> class CreateRequest < MockOperationImageCtx > {
          public:
            ...
            static CreateRequest *create(MockOperationImageCtx * image_ctx,
                                         Context * on_finish) {
                ceph_assert(s_instance != nullptr);
                s_instance->on_finish = on_finish;
                return s_instance;
    ...
    namespace operation {
        ...
        class TestMockOperationEnableFeaturesRequest:public TestMockFixture {
          public:
            ...
            typedef EnableFeaturesRequest < MockOperationImageCtx >
                MockEnableFeaturesRequest;

            class MirrorModeEnabler {
              public:
                MirrorModeEnabler(librados::IoCtx & ioctx,
            ...
            void ensure_features_disabled(librbd::ImageCtx * ictx,
                ...
                if (!features_to_disable) {
                    return;
                            ...
                            ictx->operations->
                            update_features(features_to_disable, false));
                ASSERT_EQ(0, librbd::get_features(ictx, &features));
            ...
            void expect_create_journal_request_send(MockOperationImageCtx &
                                                    mock_image_ctx,
                                                    MockCreateJournalRequest &
                                                    mock_create_journal_request,
                                                    int r) {
            ...
            void expect_enable_mirror_request_send(MockOperationImageCtx &
                                                   mock_image_ctx,
                                                   MockEnableMirrorRequest &
                                                   mock_enable_mirror_request,
                                                   int r) {
            ...
            void expect_create_object_map_request_send(MockOperationImageCtx &
                                                       mock_image_ctx,
                                                       MockCreateObjectMapRequest
                                                       &
                                                       mock_create_object_map_request,
                                                       int r) {
        ...
        TEST_F(TestMockOperationEnableFeaturesRequest, All) {
            ...
            MockEnableFeaturesRequest *req =
                new MockEnableFeaturesRequest(mock_image_ctx, &cond_ctx, 0,
                                              features_to_enable);
            {
        ...
        TEST_F(TestMockOperationEnableFeaturesRequest, Mirroring) {
            ...
            MirrorModeEnabler mirror_mode_enabler(m_ioctx,
