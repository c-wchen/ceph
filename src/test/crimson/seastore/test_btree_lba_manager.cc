...
struct btree_lba_manager_test:              btree_test_base {
    ...
    auto alloc_mapping(test_transaction_t &
                       t, laddr_t hint,
                       size_t len)
    {
        auto ret =
    ...
    auto decref_mapping(test_transaction_t &
                        t, laddr_t addr)
    {
    ...
    void decref_mapping(test_transaction_t &
                        t,
                        test_lba_mapping_t::
                        iterator target)
    {
    ...
    auto incref_mapping(test_transaction_t &
                        t, laddr_t addr)
    {
    ...
    void incref_mapping(test_transaction_t &
                        t,
                        test_lba_mapping_t::
                        iterator target)
    {
    ...
    void check_mappings(test_transaction_t &
                        t)
    {
        (void)with_trans_intr(*t.t,
                              [ =,
