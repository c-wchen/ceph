        ...
        do {
          ...
          for (auto & val:vals) {
              ...
              for (auto object_position:client.commit_position.
                ...
                {
                    minimum_tag_tid =
                        MIN(minimum_tag_tid, object_position.tag_tid);
                }
            }
            if (!vals.empty()) {
...
CLS_INIT(journal)
{
    ...
    cls_register_cxx_method(h_class, "get_pool_id", CLS_METHOD_RD,
                            journal_get_pool_id, &h_journal_get_pool_id);
    cls_register_cxx_method(h_class, "get_minimum_set", CLS_METHOD_RD,
    ...
    cls_register_cxx_method(h_class, "get_active_set", CLS_METHOD_RD,
                            journal_get_active_set, &h_journal_get_active_set);
    ...
    cls_register_cxx_method(h_class, "client_list", CLS_METHOD_RD,
    ...
    cls_register_cxx_method(h_class, "get_tag",
                            CLS_METHOD_RD, journal_get_tag, &h_journal_get_tag);
