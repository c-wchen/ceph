...
namespace librbd {
    ...
    namespace crypto {
        ...
        } // anonymous namespace namespace util {
        ...
        }} // namespace util using::testing::_;
        ...
        struct TestMockCryptoFormatRequest:public TestMockFixture {
            typedef FormatRequest < librbd::MockTestImageCtx >
                MockFormatRequest;
            ...
            void SetUp() override {
                ...
                mock_format_request = MockFormatRequest::create(mock_image_ctx,
                                                                std::
                                                                unique_ptr <
            ...
            void expect_shutdown_crypto(int r = 0) {
                EXPECT_CALL(mock_shutdown_crypto_request,
                            send()).WillOnce(Invoke([this, r] () {
                                                    if (r == 0) {
                                                    mock_image_ctx->
            ...
            void expect_encryption_format() {
                EXPECT_CALL(*new_encryption_format,
                            format(mock_image_ctx,
                                   _)).WillOnce(WithArg < 1 >
        ...
        TEST_F(TestMockCryptoFormatRequest, JournalEnabled) {
            ...
            ASSERT_EQ(old_encryption_format,
        ...
        TEST_F(TestMockCryptoFormatRequest, Success) {
            ...
            ASSERT_EQ(new_encryption_format,
                      mock_image_ctx->encryption_format.get());
        }
