...
void Message::dump(Formatter * f) const const
{
    stringstream ss;
    print(ss);
...
void Message::encode_trace(bufferlist & bl, uint64_t features) const const
{
