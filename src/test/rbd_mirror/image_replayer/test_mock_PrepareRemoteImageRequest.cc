...
namespace librbd {
    ...
    } // namespace journal namespace mirror {
    ...
    namespace mirror {
        ...
        namespace image_replayer {
            ...
            namespace journal {
                ...
                template <>
                    struct StateBuilder <librbd::
                    MockTestImageCtx >:public image_replayer::StateBuilder <
...
namespace rbd {
    namespace mirror {
        namespace image_replayer {
            ...
            class TestMockImageReplayerPrepareRemoteImageRequest:public
                TestMockFixture {
              public:
                ...
                typedef StateBuilder < librbd::MockTestImageCtx >
                    MockStateBuilder;
                typedef journal::StateBuilder < librbd::MockTestImageCtx >
                ...
                void expect_get_mirror_image_mode(MockStateBuilder &
                                                  mock_state_builder,
                                                  cls::rbd::
                                                  MirrorImageMode
                                                  mirror_image_mode) {
                ...
                } void expect_get_mirror_image_id(MockGetMirrorImageIdRequest &
                    ...
                    EXPECT_CALL(mock_get_mirror_image_id_request, send())
                        .
                        WillOnce(Invoke
                                 ([&mock_get_mirror_image_id_request, image_id,
                                   r] () {
                                  *mock_get_mirror_image_id_request.image_id =
                                  image_id;
                                  mock_get_mirror_image_id_request.on_finish->
                                  complete(r);}));
            ...
            TEST_F(TestMockImageReplayerPrepareRemoteImageRequest,
                   SuccessJournal) {
                ...
                ASSERT_TRUE(mock_journal_state_builder.remote_journaler !=
                            nullptr);
            ...
            TEST_F(TestMockImageReplayerPrepareRemoteImageRequest,
                ...
                librbd::journal::ClientData client_data {
                mirror_peer_client_meta};
                expect_journaler_register_client(mock_remote_journaler,
                                                 client_data, 0);
