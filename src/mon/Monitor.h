...
class C_MonContext final:public FunctionContext {
    const Monitor *mon;
  public:
     explicit C_MonContext(Monitor * m,
...
class Monitor:public Dispatcher, public md_config_obs_t {
   ...
   */
    ...
    bool _scrub(ScrubResult * r, pair < string, string > *start, int *num_keys);
  ...
  public:
    ...
    const set < int >&get_quorum() const {
        return quorum;
  ...
  public:
    ...
    void lose_election(epoch_t epoch, set < int >&q, int l,
                       uint64_t features, const mon_feature_t & mon_features);
    // end election (called by Elector)
   ...
   */
    ...
    health_status_t get_health_status(bool want_detail,
                                      Formatter * f,
                                      std::string * plain,
                                      const char *sep1 = " ",
                                      const char *sep2 = "; ");
  ...
  public:
    ...
    void reply_command(MonOpRequestRef op, int rc, const string & rs,
                       version_t version);
    void reply_command(MonOpRequestRef op, int rc, const string & rs,
   ...
   */
    ...
    void send_command(const entity_inst_t & inst, const vector < string > &com);
  ...
  public:
    struct C_Command:public C_MonOp {
        ...
        bufferlist rdata;
        version_t version;
         C_Command(Monitor * _mm, MonOpRequestRef _op, int r, string s,
                   version_t v):C_MonOp(_op), mon(_mm), rc(r), rs(s),
            version(v) {
        } C_Command(Monitor * _mm, MonOpRequestRef _op, int r, string s,
                    bufferlist rd, version_t v):C_MonOp(_op), mon(_mm), rc(r),
            rs(s), rdata(rd), version(v) {
        }
