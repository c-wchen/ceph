...
seastar::future<> ChainedDispatchers::ms_dispatch(ConnectionRef conn,
        MessageRef m)
{
    try {
...
void ChainedDispatchers::ms_handle_shard_change(
    ConnectionRef conn,
...
void ChainedDispatchers::ms_handle_accept(
    ConnectionRef conn,
...
void ChainedDispatchers::ms_handle_connect(
    ConnectionRef conn,
    seastar::shard_id prv_shard)
{
    try {
