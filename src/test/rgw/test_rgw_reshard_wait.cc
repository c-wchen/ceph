...
{
    constexpr ceph::timespan wait_duration = 10 ms;
...
{
    constexpr ceph::timespan short_duration = 10 ms;
    constexpr ceph::timespan long_duration = 10 s;
...
{
    constexpr ceph::timespan wait_duration = 50 ms;
    RGWReshardWait waiter(wait_duration);
...
{
    constexpr ceph::timespan short_duration = 50 ms;
    constexpr ceph::timespan long_duration = 10 s;
