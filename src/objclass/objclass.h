...
extern int cls_read(cls_method_context_t hctx, int ofs, int len,
                    char **outdata, int *outdatalen);
extern int cls_call(cls_method_context_t hctx, const char *cls,
                    const char *method, char *indata, int datalen,
                    char **outdata, int *outdatalen);
...
extern int cls_register_method(cls_handle_t hclass, const char *method,
                               int flags, cls_method_call_t class_call,
...
extern int cls_link(cls_method_handle_t handle, int priority,
...
extern int cls_cxx_stat2(cls_method_context_t hctx, uint64_t *size,
...
extern int cls_cxx_write2(cls_method_context_t hctx, int ofs, int len,
                          ceph::buffer::list *bl, uint32_t op_flags);
extern int cls_cxx_write_full(cls_method_context_t hctx,
                              ceph::buffer::list *bl);
...
extern int cls_cxx_map_get_all_vals(cls_method_context_t hctx,
                                    std::map < std::string,
                                    ceph::buffer::list > *vals, bool *more);
...
extern int cls_cxx_map_get_vals(cls_method_context_t hctx,
                                ...
                                uint64_t max_to_get, std::map < std::string,
                                ceph::buffer::list > *vals, bool *more);
...
extern int cls_cxx_map_get_vals_by_keys(cls_method_context_t hctx,
                                        ...
                                        std::map < std::string,
                                        bufferlist > *map);
extern int cls_cxx_map_read_header(cls_method_context_t hctx,
                                   ceph::buffer::list *outbl);
extern int cls_cxx_map_set_vals(cls_method_context_t hctx,
                                const std::map < std::string,
                                ceph::buffer::list > *map);
extern int cls_cxx_map_write_header(cls_method_context_t hctx,
                                    ceph::buffer::list *inbl);
extern int cls_cxx_map_remove_key(cls_method_context_t hctx,
...
extern int cls_cxx_map_update(cls_method_context_t hctx,
                              ceph::buffer::list *inbl);
...
/* gather */
extern int cls_cxx_gather(cls_method_context_t hctx,
                          const std::set < std::string > &src_objs,
                          const std::string &pool, const char *cls,
                          const char *method, bufferlist &inbl);

extern int cls_cxx_get_gathered_data(cls_method_context_t hctx,
                                     std::map < std::string,
                                     bufferlist > *results);
...
int cls_cxx_chunk_write_and_set(cls_method_context_t hctx, int ofs, int len,
                                ...
                                uint32_t op_flags,
                                ceph::buffer::list *set_inbl, int set_len);
