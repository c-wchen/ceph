...
namespace ScrubDatasets {
    ...
    static RealObj corrupt_object_size(const RealObj & s,
...
// object with head & two snaps
    ...
    SnapsetMockData::CookedCloneSnaps ms1_fn() {
        ...
        return {
        clnsz, clnsn, overlaps};
    }

    static SnapsetMockData hobj_ms1_snapset {   /* seq */
        0x40,
            /* snaps */  {
        0x30, 0x20},
            /* clones */  {
    ...
    ScrubGenerator::RealObjsConf minimal_snaps_configuration {
        /* RealObjsConf::objs */  {
            ...
            /* Clone 30  */  {
                ghobject_t {
                    hobj_ms1_snp30, 0, shard_id_t {
                0}}, RealData {
                    333, 0x17, 17, 21, attr_t { /*{"_om1k", "om1v"}, {"om1k", "om1v"}, */  {
                    "om3k", "om3v"}}, attr_t { {
                    "_at1k", "_at1v"}, {
                    "_at2k", "at2v"}, {
            "at3k", "at3v"}}}, &crpt_funcs_set0, nullptr},
                /* Clone 20  */
            {
                ghobject_t {
                    hobj_ms1_snp20, 0, shard_id_t {
                0}}, RealData {
                    222, 0x17, 17, 21, attr_t { /*{"_om1k", "om1v"}, {"om1k", "om1v"}, */  {
                    "om3k", "om3v"}}, attr_t { {
                    "_at1k", "_at1v"}, {
                    "_at2k", "at2v"}, {
            "at3k", "at3v"}}}, &crpt_funcs_set0, nullptr},
            ...
            {
                ghobject_t {
                    hobj_ms1, 0, shard_id_t {
                0}}, RealData {
                    100, 0x17, 17, 21, attr_t { {
                    "_om1k", "om1v"}, {
                    "om1k", "om1v"}, {
                    "om3k", "om3v"}}, attr_t { {
                    "_at1k", "_at1v"}, {
