...
public:
    ...
    void remove_mirror_image_status(const std::string &global_image_id,
                                    bool immediate_update,
                                    Context *on_finish);
    void remove_refresh_mirror_image_status(const std::
...
private:
    ...
    MirrorStatusWatcher < ImageCtxT > *m_mirror_status_watcher =
        nullptr;
    ...
    bool try_remove_mirror_image_status(const std::
                                        string &global_image_id,
                                        bool queue_update,
                                        bool immediate_update,
                                        Context *on_finish);
    ...
    void handle_shut_down_mirror_status_watcher(int r,
            Context *on_finish);
