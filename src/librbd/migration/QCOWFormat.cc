...
private:
    ...
    void execute_request()
    {
        ...
        if (r < 0) {
            ...
            return;
        } else if (request.cluster_offset !=
                   nullptr) {
            auto cluster_offset =
...
private:
    ...
    void read_clusters()
    {
        ...
        for (auto &cluster_extent : cluster_extents) {
            ...
            auto log_ctx = new LambdaContext([this, cct = qcow_format->m_image_ctx->cct, image_offset = cluster_extent.image_offset,
    ...
    void handle_read_cluster(CephContext *
                             cct, int r,
                             uint64_t
                             image_offset,
                             uint64_t
