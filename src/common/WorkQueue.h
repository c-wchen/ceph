...
class ThreadPool:public md_config_obs_t {
  ...
  template < typename T, typename U = T > class WorkQueueVal:public WorkQueue_
    {
      ...
      public:
        WorkQueueVal(std::string n,
                     ceph::timespan ti, ceph::timespan sti, ThreadPool * p)
  ...
  public:
    ThreadPool(CephContext * cct_, std::string nm, std::string tn, int n,
...
class ShardedThreadPool {
  ...
  public:
    ...
    ShardedThreadPool(CephContext * cct_, std::string nm, std::string tn,
