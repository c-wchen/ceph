...
private:
    ...
    READ_BPTR_HANDLER_CONTINUATION_DECL(ProtocolV2,
    ...
    Ct < ProtocolV2 > *_handle_peer_banner_payload(rx_buffer_t
            && buffer, int r);
    ...
    Ct < ProtocolV2 > *handle_read_frame_preamble_main(rx_buffer_t
            && buffer, int r);
    Ct < ProtocolV2 > *read_frame_segment();
    Ct < ProtocolV2 > *handle_read_frame_segment(rx_buffer_t
            && rx_buffer, int r);
    Ct < ProtocolV2 > *_handle_read_frame_segment();
    Ct < ProtocolV2 > *handle_read_frame_epilogue_main(rx_buffer_t
            && buffer, int r);
...
private:
    ...
    Ct < ProtocolV2 > *send_auth_request(std::vector < uint32_t >
                                         &allowed_methods);
    ...
    Ct < ProtocolV2 >
    *handle_ident_missing_features(ceph::bufferlist &payload);
    ...
    Ct < ProtocolV2 > *_handle_auth_request(ceph::bufferlist &auth_payload,
                                            bool more);
    ...
    Ct < ProtocolV2 >
    *handle_existing_connection(const AsyncConnectionRef &existing);
