    ...
    namespace exclusive_lock {
        ...
        using util::create_context_callback;
         ...
         template < typename I >
            ...
            I >::create(I & image_ctx, ImageDispatch < I > *image_dispatch,
                        bool shutting_down, AsyncOpTracker & async_op_tracker,
                        Context * on_finish) {
            return new PreReleaseRequest(image_ctx, image_dispatch,
                                         shutting_down, async_op_tracker,
                                         on_finish);
        } template < typename I > PreReleaseRequest <
            I >::PreReleaseRequest(I & image_ctx,
        ...
        template < typename I >
            ...
            if (r < 0) {
                ...
                lderr(cct) << "failed to set lock: " << cpp_strerror(r) <<
                    dendl;
            }
        ...
        template < typename I >
            ...
            Context *ctx = create_context_callback <
                PreReleaseRequest < I >,
                &PreReleaseRequest < I >::handle_wait_for_ops > (this);
        ...
        template < typename I >
            ...
            Context *ctx = create_context_callback <
                PreReleaseRequest < I >,
                &PreReleaseRequest < I >::handle_prepare_lock > (this);
        ...
        template < typename I >
            void PreReleaseRequest <
            I >::handle_process_plugin_release_lock(int r) {
            CephContext *cct = m_image_ctx.cct;
            ldout(cct, 10) << "r=" << r << dendl;
        ...
        template < typename I > void PreReleaseRequest < I >::send_flush_io() {
            ...
            auto ctx = create_context_callback <
                PreReleaseRequest < I >,
                &PreReleaseRequest < I >::handle_flush_io > (this);
            auto aio_comp =
        ...
        template < typename I >
            ...
            Context *ctx =
                ...
                &klass::handle_flush_notifies > (this);
        ...
        template < typename I >
            ...
            Context *ctx =
                create_context_callback < klass,
                &klass::handle_close_journal > (this);
            m_journal->close(ctx);
        }
        ...
        template < typename I >
            ...
            if (r < 0) {
                ...
                lderr(cct) << "failed to close journal: " << cpp_strerror(r) <<
                    dendl;
            }
        ...
        template < typename I >
            ...
            if (r < 0) {
                lderr(cct) << "failed to close object map: " << cpp_strerror(r)
                    << dendl;
            }
            m_object_map->put();
