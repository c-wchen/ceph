...
namespace rbd {
    namespace mirror {
        ...
        using librbd::util::create_rados_callback;
         ...
         template < typename I >
            LeaderWatcher < I >::LeaderWatcher(Threads < I > *threads,
        ...
        :Watcher(io_ctx, threads->work_queue, RBD_MIRROR_LEADER),
            ...
            m_leader_lock(new
                          LeaderLock(m_ioctx, m_work_queue, m_oid, this, true,
        ...
        template < typename I > void LeaderWatcher < I >::create_leader_object() {
            ...
            librados::AioCompletion * aio_comp = create_rados_callback <
                LeaderWatcher < I >,
                &LeaderWatcher < I >::handle_create_leader_object > (this);
        ...
        template < typename I >
            ...
            if (r < 0) {
                derr << "error shutting down leader lock: " << cpp_strerror(r)
                    << dendl;
            }
        ...
        template < typename I > bool LeaderWatcher < I >::is_leader()const {
            ...
            bool LeaderWatcher <
            I >::get_leader_instance_id(std::string * instance_id) const {
            dout(20) << dendl;
        ...
        template < typename I >
            void LeaderWatcher < I >::list_instances(std::vector < std::string >
                                                     *instance_ids) {
            dout(20) << dendl;
        ...
        template < typename I >
            void LeaderWatcher <
            I >::schedule_timer_task(const std::string & name, int delay_factor,
            ...
            m_timer_task = new FunctionContext([this, leader,
                                                timer_callback] (int r) {
                                               assert(m_threads->timer_lock.
                                                      is_locked());
                                               m_timer_task = nullptr;
                                               ...
                                               m_timer_gate->timer_callback =
                                               timer_callback;}
            ) ;

            int after =
                delay_factor * m_cct->_conf->get_val < int64_t >
                ("rbd_mirror_leader_heartbeat_interval");

            dout(20) << "scheduling " << name << " after " << after <<
                " sec (task " << m_timer_task << ")" << dendl;
        ...
        template < typename I >
            void LeaderWatcher <
            I >::handle_pre_release_leader_lock(Context * on_finish) {
            dout(20) << dendl;
        ...
        template < typename I >
            ...
            if (r < 0 && r != -ENOENT) {
                derr << "error beaking leader lock: " << cpp_strerror(r) <<
                    dendl;
        ...
        template < typename I > void LeaderWatcher < I >::get_locker() {
            ...
            Context *ctx =
                create_async_context_callback(m_work_queue, get_locker_ctx);
        ...
        template < typename I >
            ...
            if (r == -ENOENT) {
                ...
                derr << "error retrieving leader locker: " << cpp_strerror(r) <<
                    dendl;
            ...
            if (m_locker != locker) {
                ...
                if (m_acquire_attempts > 1) {
                    dout(10) <<
                        "new lock owner detected -- resetting heartbeat counter"
                        << dendl;
                    m_acquire_attempts = 0;
                }
            }
        ...
        template < typename I >
            void LeaderWatcher <
            I >::schedule_acquire_leader_lock(uint32_t delay_factor) {
            dout(20) << dendl;
        ...
        template < typename I >
            ...
            if (r < 0) {
                if (r == -EAGAIN) {
                    ...
                    derr << "error acquiring lock: " << cpp_strerror(r) <<
                        dendl;
                }
        ...
        template < typename I > void LeaderWatcher < I >::init_status_watcher() {
            dout(20) << dendl;
            ...
            m_status_watcher =
                MirrorStatusWatcher < I >::create(m_ioctx, m_work_queue);

            Context *ctx = create_context_callback <
                LeaderWatcher < I >,
                &LeaderWatcher < I >::handle_init_status_watcher > (this);
        ...
        template < typename I >
            ...
            Context *on_finish = nullptr;
            {
                ...
                derr << "error initializing mirror status watcher: " <<
                    cpp_strerror(r)
                    << dendl;
        ...
        template < typename I >
            ...
            Context *on_finish = nullptr;
            {
                ...
                if (r < 0) {
                    derr << "error shutting mirror status watcher down: " <<
                        cpp_strerror(r)
                        << dendl;
                }
        ...
        template < typename I > void LeaderWatcher < I >::init_instances() {
            ...
            Context *ctx = create_context_callback <
                LeaderWatcher < I >,
                &LeaderWatcher < I >::handle_init_instances > (this);
        ...
        template < typename I >
            ...
            if (r < 0) {
                derr << "error initializing instances: " << cpp_strerror(r) <<
                    dendl;
                m_ret_val = r;
                m_instances->destroy();
                m_instances = nullptr;
        ...
        template < typename I >
            ...
            if (r < 0) {
                derr << "error notifying listener: " << cpp_strerror(r) <<
                    dendl;
                m_ret_val = r;
            }
        ...
        template < typename I > void LeaderWatcher < I >::notify_lock_acquired() {
            ...
            Context *ctx = create_context_callback <
                LeaderWatcher < I >,
                &LeaderWatcher < I >::handle_notify_lock_acquired > (this);
        ...
        template < typename I >
            ...
            Context *on_finish = nullptr;
            {
                Mutex::Locker locker(m_lock);
                if (r < 0 && r != -ETIMEDOUT) {
                    derr << "error notifying leader lock acquired: " <<
                        cpp_strerror(r)
                        << dendl;
                    m_ret_val = r;
                }
        ...
        template < typename I > void LeaderWatcher < I >::notify_lock_released() {
            ...
            Context *ctx = create_context_callback <
                LeaderWatcher < I >,
                &LeaderWatcher < I >::handle_notify_lock_released > (this);
        ...
        template < typename I >
            ...
            Context *on_finish = nullptr;
            {
                Mutex::Locker locker(m_lock);
                if (r < 0 && r != -ETIMEDOUT) {
                    derr << "error notifying leader lock released: " <<
                        cpp_strerror(r)
                        << dendl;
                }
        ...
        template < typename I > void LeaderWatcher < I >::notify_heartbeat() {
            ...
            Context *ctx = create_context_callback <
                LeaderWatcher < I >,
                &LeaderWatcher < I >::handle_notify_heartbeat > (this);
        ...
        template < typename I >
            void LeaderWatcher <
            I >::handle_heartbeat(Context * on_notify_ack) {
            dout(20) << dendl;

            {
                ...
                Mutex::Locker locker(m_lock);
                if (is_leader(m_lock)) {
                    dout(5) << "got another leader heartbeat, ignoring" <<
                        dendl;
                }
                else {
                    cancel_timer_task();
        ...
        template < typename I >
            void LeaderWatcher <
            I >::handle_lock_acquired(Context * on_notify_ack) {
            dout(20) << dendl;

            {
                ...
                Mutex::Locker locker(m_lock);
                if (is_leader(m_lock)) {
                    dout(5) << "got another leader lock_acquired, ignoring" <<
                        dendl;
                }
                else {
                    cancel_timer_task();
        ...
        template < typename I >
            void LeaderWatcher <
            I >::handle_lock_released(Context * on_notify_ack) {
            dout(20) << dendl;

            {
                ...
                Mutex::Locker locker(m_lock);
                if (is_leader(m_lock)) {
                    dout(5) << "got another leader lock_released, ignoring" <<
                        dendl;
                }
                else {
                    cancel_timer_task();
        ...
        template < typename I >
            void LeaderWatcher < I >::handle_notify(uint64_t notify_id,
                                                    uint64_t handle,
            ...
            apply_visitor(HandlePayloadVisitor(this, ctx),
        ...
        template < typename I >
            void LeaderWatcher <
            I >::handle_payload(const HeartbeatPayload & payload,
        ...
        template < typename I >
            void LeaderWatcher <
            I >::handle_payload(const LockAcquiredPayload & payload,
                                Context * on_notify_ack) {
        ...
        template < typename I >
            void LeaderWatcher <
            I >::handle_payload(const LockReleasedPayload & payload,
                                Context * on_notify_ack) {
        ...
        template < typename I >
            void LeaderWatcher <
            I >::handle_payload(const UnknownPayload & payload,
                                Context * on_notify_ack) {
