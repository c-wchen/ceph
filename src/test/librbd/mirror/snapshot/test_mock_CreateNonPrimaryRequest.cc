    ...
    namespace mirror {
        namespace snapshot {
            ...
            struct WriteImageStateRequest <MockTestImageCtx > {
                ...
                static WriteImageStateRequest *create(MockTestImageCtx *
                                                      image_ctx,
                                                      uint64_t snap_id,
                                                      const ImageState &
                                                      image_state,
            ...
            WriteImageStateRequest < MockTestImageCtx >
                *WriteImageStateRequest < MockTestImageCtx >::s_instance =
                nullptr;
...
namespace librbd {
    namespace mirror {
        namespace snapshot {
            ...
            class TestMockMirrorSnapshotCreateNonPrimaryRequest:public
                TestMockFixture {
              public:
                typedef CreateNonPrimaryRequest < MockTestImageCtx >
                    MockCreateNonPrimaryRequest;
                typedef WriteImageStateRequest < MockTestImageCtx >
                ...
                }} void expect_get_mirror_image(MockTestImageCtx &
                                                mock_image_ctx,
                                                const cls::rbd::
                ...
                void expect_can_create_non_primary_snapshot(MockUtils &
                                                            mock_utils,
                                                            bool result) {
                ...
                void expect_write_image_state(MockTestImageCtx & mock_image_ctx,
                    ...
                    EXPECT_CALL(mock_write_image_state_request, send())
                        ...
                        WillOnce(Invoke
                                 ([&mock_image_ctx,
                                   &mock_write_image_state_request, r] () {
                                  mock_image_ctx.image_ctx->op_work_queue->
                                  queue(mock_write_image_state_request.
                                        on_finish, r);}));
                }
            };
            ...
            TEST_F(TestMockMirrorSnapshotCreateNonPrimaryRequest, Success) {
                ...
                expect_write_image_state(mock_image_ctx,
                                         mock_write_image_state_request, 0);

                C_SaferCond ctx;
                auto req =
                    new MockCreateNonPrimaryRequest(&mock_image_ctx, false,
                                                    "mirror_uuid", 123, { {1,
                                                                           2} },
                                                    { },
                                                    nullptr, &ctx);
            ...
            TEST_F(TestMockMirrorSnapshotCreateNonPrimaryRequest,
                ...
                C_SaferCond ctx;
                auto req =
                    new MockCreateNonPrimaryRequest(&mock_image_ctx, true,
                                                    "mirror_uuid", 123, { {1,
                                                                           2} },
                                                    { },
                                                    nullptr, &ctx);
