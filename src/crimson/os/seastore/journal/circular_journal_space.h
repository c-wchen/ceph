...
namespace crimson::os::seastore {
    ...
    class CircularJournalSpace:public JournalAllocator {
      ...
      public:
        ...
        void update_modify_time(record_t & record) final {
            ...
            return write_header().safe_then([this] ()->close_ertr::future <> {
                                            initialized = false;
      ...
      public:
         ...
         *
         */
        write_ertr::future <> device_write_bl(rbm_abs_addr offset,
                                              ceph::bufferlist & bl);
   ...
   */
        ...
        seastar::future <> update_journal_tail(journal_seq_t dirty,
                                               journal_seq_t alloc) {
    ...
    std::ostream & operator<<(std::ostream & out,
                              const CircularJournalSpace::
                              cbj_header_t & header);

}

WRITE_CLASS_DENC_BOUNDED(crimson::os::seastore::journal::CircularJournalSpace::
                         cbj_header_t)
#if FMT_VERSION >= 90000
template <> struct fmt::formatter <
    crimson::os::seastore::journal::CircularJournalSpace::cbj_header_t >:fmt::
    ostream_formatter {
};
#endif
