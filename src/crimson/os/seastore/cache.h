 ...
 */
   ...
   */
        ...
        template < typename T, typename Func, typename OnCache > get_extent_ret < T > get_extent(paddr_t offset,    ///< [in] starting addr
   ...
   */
        ...
        seastar::future < CachedExtentRef >
            get_extent_viewable_by_trans(Transaction & t,
        ...
        get_extent_ertr::future < CachedExtentRef >
            _get_extent_by_type(extent_types_t type, paddr_t offset,
