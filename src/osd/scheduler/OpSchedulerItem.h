...
namespace ceph::osd::scheduler {
    ...
    std::ostream & operator<<(std::ostream & out,
                              const op_scheduler_class & class_id);
      ...
      public:
        ...
        class OpQueueable {
          public:
            ...
            virtual void run(OSD * osd, OSDShard * sdata, PGRef & pg,
   ...
   */
        ...
        OpSchedulerItem(OpQueueable::Ref && item,
                        int cost,
                        unsigned priority,
                        utime_t start_time, uint64_t owner, epoch_t e)
        :qitem(std::move(item)),
            cost(cost),
            priority(priority),
            start_time(start_time), owner(owner), map_epoch(e) {
        }
        ...
        friend std::ostream & operator<<(std::ostream & out,
                                         const OpSchedulerItem & item) {
            out << "OpSchedulerItem(" << item.
                get_ordering_token() << " " << *item.qitem;
...
/// Implements boilerplate for operations queued for the pg lock
    ...
    class PGScrubItem:public PGOpQueueable {
      protected:
        ...
        PGScrubItem(spg_t pg, epoch_t epoch_queued,
        ...
        std::ostream & print(std::ostream & rhs) const final {
            ...
            << "epoch_queued=" << epoch_queued
                << " scrub-token=" << activation_index << ")";
                   ...
                   OSDShard * sdata,
                   PGRef & pg, ThreadPool::TPHandle & handle) override = 0;
        op_scheduler_class get_scheduler_class() const final {
            return op_scheduler_class::background_best_effort;
    }};
    ...
    class PGScrubResched:public PGScrubItem {
      public:
        ...
        :PGScrubItem {
        pg, epoch_queued, "PGScrubResched"} {
        }
        void run(OSD * osd, OSDShard * sdata, PGRef & pg,
                 ThreadPool::TPHandle & handle) final;
    };
 ...
 */
    class PGScrubResourcesOK:public PGScrubItem {
      public:
        ...
        :PGScrubItem {
        pg, epoch_queued, "PGScrubResourcesOK"} {
        }
        void run(OSD * osd, OSDShard * sdata, PGRef & pg,
                 ThreadPool::TPHandle & handle) final;
    };
 ...
 */
    class PGScrubAfterRepair:public PGScrubItem {
      public:
        ...
        :PGScrubItem {
        pg, epoch_queued, "PGScrubAfterRepair"} {
        }
        void run(OSD * osd, OSDShard * sdata, PGRef & pg,
                 ThreadPool::TPHandle & handle) final;
    };
    ...
    class PGScrubPushesUpdate:public PGScrubItem {
      public:
        ...
        :PGScrubItem {
        pg, epoch_queued, "PGScrubPushesUpdate"} {
        }
        void run(OSD * osd, OSDShard * sdata, PGRef & pg,
                 ThreadPool::TPHandle & handle) final;
    };
    ...
    class PGScrubAppliedUpdate:public PGScrubItem {
      public:
        ...
        :PGScrubItem {
        pg, epoch_queued, "PGScrubAppliedUpdate"} {
        }
        void run(OSD * osd,
                 OSDShard * sdata,
                 PGRef & pg,
    ...
    class PGScrubUnblocked:public PGScrubItem {
      public:
        ...
        :PGScrubItem {
        pg, epoch_queued, "PGScrubUnblocked"} {
        }
        void run(OSD * osd,
                 OSDShard * sdata,
                 PGRef & pg,
    ...
    class PGScrubDigestUpdate:public PGScrubItem {
      public:
        ...
        :PGScrubItem {
        pg, epoch_queued, "PGScrubDigestUpdate"} {
        }
        void run(OSD * osd, OSDShard * sdata, PGRef & pg,
                 ThreadPool::TPHandle & handle) final;
    };
    ...
    class PGScrubGotLocalMap:public PGScrubItem {
      public:
        ...
        :PGScrubItem {
        pg, epoch_queued, "PGScrubGotLocalMap"} {
        }
        void run(OSD * osd, OSDShard * sdata, PGRef & pg,
                 ThreadPool::TPHandle & handle) final;
    };
    ...
    class PGScrubGotReplMaps:public PGScrubItem {
      public:
        ...
        :PGScrubItem {
        pg, epoch_queued, "PGScrubGotReplMaps"} {
        }
        void run(OSD * osd, OSDShard * sdata, PGRef & pg,
                 ThreadPool::TPHandle & handle) final;
    };
    ...
    class PGRepScrub:public PGScrubItem {
      public:
        ...
        :PGScrubItem {
        pg, epoch_queued, op_token, "PGRepScrub"} {
        }
        void run(OSD * osd, OSDShard * sdata, PGRef & pg,
                 ThreadPool::TPHandle & handle) final;
    };
    ...
    class PGRepScrubResched:public PGScrubItem {
      public:
        PGRepScrubResched(spg_t pg, epoch_t epoch_queued,
                          Scrub::act_token_t op_token)
        :PGScrubItem {
        pg, epoch_queued, op_token, "PGRepScrubResched"} {
        }
        void run(OSD * osd, OSDShard * sdata, PGRef & pg,
                 ThreadPool::TPHandle & handle) final;
    };
    ...
    class PGScrubReplicaPushes:public PGScrubItem {
      public:
        ...
        :PGScrubItem {
        pg, epoch_queued, "PGScrubReplicaPushes"} {
        }
        void run(OSD * osd, OSDShard * sdata, PGRef & pg,
                 ThreadPool::TPHandle & handle) final;
    };
    ...
    class PGScrubScrubFinished:public PGScrubItem {
      public:
        ...
        :PGScrubItem {
        pg, epoch_queued, "PGScrubScrubFinished"} {
        }
        void run(OSD * osd, OSDShard * sdata, PGRef & pg,
                 ThreadPool::TPHandle & handle) final;
    };
    ...
    class PGScrubGetNextChunk:public PGScrubItem {
      public:
        ...
        :PGScrubItem {
        pg, epoch_queued, "PGScrubGetNextChunk"} {
        }
        void run(OSD * osd, OSDShard * sdata, PGRef & pg,
                 ThreadPool::TPHandle & handle) final;
    };
    ...
    class PGScrubChunkIsBusy:public PGScrubItem {
      public:
        ...
        :PGScrubItem {
        pg, epoch_queued, "PGScrubChunkIsBusy"} {
        }
        void run(OSD * osd, OSDShard * sdata, PGRef & pg,
                 ThreadPool::TPHandle & handle) final;
    };
    ...
    class PGScrubChunkIsFree:public PGScrubItem {
      public:
        ...
        :PGScrubItem {
        pg, epoch_queued, "PGScrubChunkIsFree"} {
        }
        void run(OSD * osd, OSDShard * sdata, PGRef & pg,
                 ThreadPool::TPHandle & handle) final;
    };
    ...
    class PGRecovery:public PGOpQueueable {
      ...
      public:
        PGRecovery(spg_t pg,
                   epoch_t epoch_queued, uint64_t reserved_pushes, int priority)
        :PGOpQueueable(pg),
            time_queued(ceph_clock_now()),
            epoch_queued(epoch_queued),
            reserved_pushes(reserved_pushes), priority(priority) {
        } std::ostream & print(std::ostream & rhs) const final {
    ...
    class PGRecoveryContext:public PGOpQueueable {
      ...
      public:
        PGRecoveryContext(spg_t pgid,
                          ...
                          epoch_t epoch, int priority)
        :PGOpQueueable(pgid), time_queued(ceph_clock_now()), c(c), epoch(epoch),
            priority(priority) {
        } std::ostream & print(std::ostream & rhs) const final {
