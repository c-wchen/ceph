...
#include <boost/io/ios_state.hpp>
        ...
        class String_type > bool add_esc_char(Char_type c, String_type & s)  {
            ...
            return true;
                ...
                continue;
                        ...
                        non_printable_to_string < String_type > (unsigned_c);
                    }
                }
            }
         return result;
    }
     template < class Ostream > void append_double(Ostream & os,
                                                      const double d,
                                                      const int precision)  {
        os << std::showpoint << std::setprecision(precision) << d;
    }  template < class String_type >
        void erase_and_extract_exponent(String_type & str,
                                         String_type & exp)  {
        ...
        size_type find_first_non_zero(const String_type & str)  {
        ...
        template < class Value_type, class Ostream_type > class Generator  {
      ...
       public: Generator(const Value_type & value, Ostream_type & os,
            ...
            for (typename Array_type::const_iterator i = arr.begin();
                  i != arr.end(); ++i)
        ...
         template < class Iter > void output_composite_item(Iter i,
                                                               Iter last)  {
        ...
         template < class T > void output_array_or_obj(const T & t,
