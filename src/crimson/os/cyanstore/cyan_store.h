    ...
    class CyanStore final:public FuturizedStore {
        class Shard:public FuturizedStore::Shard {
          public:
            ...
            read_errorator::future < std::tuple < bool, omap_values_t >> omap_get_values(CollectionRef c,   ///< [in] collection
          ...
          public:
            ...
            int _omap_set_values(const coll_t & cid,
                                 const ghobject_t & oid,
                                 std::map < std::string,
                                 ceph::bufferlist > &&aset);
            int _omap_set_header(const coll_t & cid, const ghobject_t & oid,
            ...
            int _truncate(const coll_t & cid, const ghobject_t & oid,
                          uint64_t size);
          ...
          private:
            ...
            std::unordered_map < coll_t,
                boost::intrusive_ptr < Collection >> coll_map;
            std::map < coll_t,
                boost::intrusive_ptr < Collection >> new_coll_map;
        };
