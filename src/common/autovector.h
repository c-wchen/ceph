...
namespace ceph {
    ...
    template < class T, size_t kSize = 8 > class autovector {
      public:
        ...
        // This class is the base for regular/const iterator
         template < class TAutoVector, class TValueType > class iterator_impl {
          public:
            ...
            // -- Logical Operators bool operator==(const self_type & other)const {
                assert(vect_ == other.vect_);
                return index_ == other.index_;
        ...
        typedef iterator_impl < const autovector,
        ...
        // -- Mutable Operations void push_back(T && item) {
    ...
    template < class T, size_t kSize >
        autovector < T, kSize > &autovector < T,
        kSize >::assign(const autovector & other) {
