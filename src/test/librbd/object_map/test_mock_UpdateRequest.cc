...
namespace librbd {
    namespace object_map {
        ...
        TEST_F(TestMockObjectMapUpdateRequest, UpdateInMemory) {
            ...
            AsyncRequest <> *req =
                new UpdateRequest <> (*ictx, &object_map, CEPH_NOSNAP, 0,
                                      object_map.size(), OBJECT_NONEXISTENT,
                                      OBJECT_EXISTS, {
                                      }
                                      , false, &cond_ctx);
            {
        ...
        TEST_F(TestMockObjectMapUpdateRequest, UpdateSnapOnDisk) {
            ...
            C_SaferCond cond_ctx;
            AsyncRequest <> *req =
                new UpdateRequest <> (*ictx, &object_map, snap_id, 0,
                                      object_map.size(), OBJECT_NONEXISTENT,
                                      OBJECT_EXISTS, {
                                      }
                                      , false, &cond_ctx);
        ...
        TEST_F(TestMockObjectMapUpdateRequest, RebuildSnapOnDisk) {
            ...
            AsyncRequest <> *req =
                new UpdateRequest <> (*ictx, &object_map, snap_id, 0,
                                      object_map.size(), OBJECT_EXISTS_CLEAN,
