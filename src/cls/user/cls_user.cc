...
static int cls_user_set_buckets_info(cls_method_context_t hctx, bufferlist *in, bufferlist *out)
{
    ...
    CLS_LOG(20, "header: total bytes=%lld entries=%lld", (long long)header.stats.total_bytes,
...
CLS_INIT(user)
{
    ...
    cls_register_cxx_method(h_class, "remove_bucket", CLS_METHOD_RD | CLS_METHOD_WR, cls_user_remove_bucket,
    ...
    cls_register_cxx_method(h_class, "reset_user_stats", CLS_METHOD_RD | CLS_METHOD_WR, cls_user_reset_stats,
                            &h_user_reset_stats);
    cls_register_cxx_method(h_class, "reset_user_stats2", CLS_METHOD_RD | CLS_METHOD_WR, cls_user_reset_stats2,
                            &h_user_reset_stats2);
