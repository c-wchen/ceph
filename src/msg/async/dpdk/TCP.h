    ...
    class tcb:public enable_lw_shared_from_this < tcb > {
      ...
      public:
        ...
        void start_retransmit_timer() {
            ...
            retransmit_fd.construct(center->
...
template < typename InetTraits > Tub < Packet > tcp < InetTraits >::tcb::read()
{
    Tub < Packet > p;
    if (_rcv.data.empty())
        return p;
    ...
    bool tcp < InetTraits >::tcb::should_send_ack(uint16_t seg_len)
{
    ...
    _delayed_ack_fd.construct(center->
