        ...
        namespace image_sync {
            ...
            template < typename ImageCtxT = librbd::ImageCtx >
              ...
              public:
                ...
                static SyncPointPruneRequest *create(ImageCtxT *
                                                     remote_image_ctx,
                                                     bool sync_complete,
                                                     Journaler * journaler,
                                                     ...
                                                     client_meta,
                                                     Context * on_finish) {
                    return new SyncPointPruneRequest(remote_image_ctx,
                                                     sync_complete, journaler,
                                                     client_meta, on_finish);
                } SyncPointPruneRequest(ImageCtxT * remote_image_ctx,
                                        bool sync_complete,
                                        Journaler * journaler,
