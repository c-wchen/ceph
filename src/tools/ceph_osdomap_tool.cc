...
int main(int argc, char **argv)
{
    ...
    desc.add_options()
        ...
        ("oid", po::value < string > (&oid),
         "Restrict to this object id when dumping objects")
    ...
    auto cct = global_init(&def_args, ceph_options, CEPH_ENTITY_TYPE_OSD,
    ...
    std::cout << "legacy: " << (omap.state.
                                legacy ? "true" : "false") << std::endl;
