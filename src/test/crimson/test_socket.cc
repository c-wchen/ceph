...
namespace {
    ...
    static entity_addr_t get_server_addr() {
        ...
        ++port;
        ceph_assert(port < 9030
                    && "socket and messenger test ports should not overlap");
        entity_addr_t saddr;
    ...
    future < SocketRef > socket_connect(const entity_addr_t & saddr) {
        ...
        return Socket::connect(saddr).then([](auto socket) {
                                           logger.
                                           debug("socket_connect() connected");
                                           return socket;}
        );
    }
    ...
    future <> test_refused() {
        ...
        return socket_connect(saddr).discard_result().then([saddr] {
                                                           logger.
                                                           error
                                                           ("test_refused(): connection to {} is not refused",
                                                            saddr);
                                                           ceph_abort();}
        ).handle_exception_type([](const std::system_error & e) {
                                if (e.code() != std::errc::connection_refused) {
                                logger.
                                error("test_refused() got unexpeted error {}",
                                      e); ceph_abort();}
                                else {
            ...
            .handle_exception([](auto eptr) {
                              logger.
                              error("test_refused() got unexpeted exception {}",
                                    eptr); ceph_abort();}
        );
    }
    ...
    future <> test_bind_same() {
        ...
        return FixedCPUServerSocket::create().then([](auto pss1) {
                                                   ...
                                                   safe_then([saddr] {
                                                             ...
                                                             then([saddr]
                                                                  ...
                                                                  safe_then([] {
                                                                            ...
                                                                            ([]
                                                                             ...
                                                                             logger.
                                                                             error
                                                                             ("test_bind_same() got unexpected error {}",
                                                                              e);
                                                                             ceph_abort
                                                                             ();}
                                                             ...
                                                             ,
                                                             listen_ertr::
                                                             all_same_way([saddr] (const std::error_code & e) {
                                                                          logger.
                                                                          error
                                                   ...
                                                   handle_exception([]
                                                                    ...
                                                                    logger.
                                                                    error
                                                                    ("test_bind_same() got unexpeted exception {}",
                                                                     eptr);
                                                                    ceph_abort
                                                                    ();}
                                                   );}
    ...
    future <> test_accept() {
        ...
        return FixedCPUServerSocket::create().then([](auto pss) {
                                                   ...
                                                   handle_exception([]
                                                                    ...
                                                                    logger.
                                                                    error
                                                                    ("test_accept() got unexpeted exception {}",
                                                                     eptr);
                                                                    ceph_abort
                                                                    ();}
                                                   );}
    ...
    class SocketFactory {
      ...
      public:
        ...
        template < typename FuncC, typename FuncS >
            static future <> dispatch_sockets(FuncC && cb_client, FuncS
                                              && cb_server) {
            ...
            return seastar::smp::submit_to(1u,[psf, saddr] {
                                           ...
                                           then([psf, saddr] (auto pss) {
                                                ...
                                                safe_then([] {
                                                          ...
                                                          all_same_way([saddr]
                                                                       ...
                                                                       logger.
                                                                       error
                                                                       ("dispatch_sockets(): there is another instance running at {}",
                                                                        saddr);
                                                                       ceph_abort
                                                                       ();}));});}).
                then([psf, saddr] {
                     return seastar::when_all_succeed(seastar::smp::
                                                      submit_to(0u,
                                                                [psf, saddr] {
                                                                return
                                                                socket_connect
                ...
                .then([psf,
                      ...
                      logger.
                      debug
                      ("dispatch_sockets(): client/server socket are ready");
                      return seastar::when_all_succeed(seastar::smp::
                                                       submit_to(0u,
                                                                 [socket =
                                                                  psf->
    ...
    class Connection {
      ...
      Connection(Socket * socket):socket {
        ...
        future <> dispatch_write(unsigned round = 0, bool force_shut = false) {
            logger.debug("dispatch_write(round={}, force_shut={})...", round,
                         force_shut);
            return seastar::repeat([this, round, force_shut] {
                                   if (round != 0 && round <= write_count) {
                                   return seastar::
                                   futurize_invoke([this, force_shut] {
                                                   if (force_shut) {
                                                   logger.
                                                   debug
        ...
        future <> dispatch_write_unbounded() {
            return dispatch_write().then([] {
                                    ...
                                    logger.
                                    error("dispatch_write_unbounded(): "
        ...
        future <> dispatch_read(unsigned round = 0, bool force_shut = false) {
            logger.debug("dispatch_read(round={}, force_shut={})...", round,
                         force_shut);
            return seastar::repeat([this, round, force_shut] {
                                   ...
                                   futurize_invoke([this, force_shut] {
                                                   ...
                                                   logger.
                                                   debug
                                                   ("dispatch_read() done, force shutdown input");
      ...
      public:
        static future <> dispatch_rw_bounded(Socket * socket, unsigned round,
            ...
            logger.debug("dispatch_rw_bounded(round={}, force_shut={})...",
                         round, force_shut);
            return seastar::do_with(Connection {
                                    socket}
                                    ,[round, force_shut] (auto & conn) {
                                    ceph_assert(round != 0);
                                    return seastar::when_all_succeed(conn.
                                                                     dispatch_write
                                                                     (round,
                                                                      force_shut),
                                                                     conn.
        ...
        static future <> dispatch_rw_unbounded(Socket * socket,
                                               bool preemptive_shut = false) {
            logger.debug("dispatch_rw_unbounded(preemptive_shut={})...",
                         preemptive_shut);
            return seastar::do_with(Connection {
                                    socket}
                                    ,[preemptive_shut] (auto & conn) {
                                    return seastar::when_all_succeed(conn.
                                                                     ...
                                                                     ([&conn,
                                                                      ...
                                                                      then([&conn] {
                                                                           logger.
                                                                           debug
                                                                           ("dispatch_rw_unbounded() shutdown socket preemptively(100ms)");
                                                                           conn.
                                                                           shutdown
                                                                           ();}
                                                                      );}
    ...
    future <> test_read_write() {
        ...
        return SocketFactory::dispatch_sockets([](auto cs) {
                                               return Connection::
                                               dispatch_rw_bounded(cs, 128);
                                               }
                                               ,[](auto ss) {
                                               return Connection::
                                               dispatch_rw_bounded(ss, 128);
                                               }
        ).then([] {
               logger.info("test_read_write() ok\n");}
        ).handle_exception([](auto eptr) {
                           logger.
                           error("test_read_write() got unexpeted exception {}",
                                 eptr); ceph_abort();}
        );
    }
    ...
    future <> test_unexpected_down() {
        ...
        return SocketFactory::dispatch_sockets([](auto cs) {
                                               ...
                                               handle_exception_type([]
                                                                     ...
                                                                     logger.
                                                                     debug
                                                                     ("test_unexpected_down(): client get error {}",
                                                                      e);
                                                                     ceph_assert
                                                                     (e.
                                                                      code() ==
               ...
               logger.info("test_unexpected_down() ok\n");}
                           ...
                           logger.
                           error
                           ("test_unexpected_down() got unexpeted exception {}",
                            eptr); ceph_abort();}
        );
    }
    ...
    future <> test_shutdown_propagated() {
        ...
        return SocketFactory::dispatch_sockets([](auto cs) {
               ...
               logger.info("test_shutdown_propagated() ok\n");}
                           ...
                           logger.
                           error
                           ("test_shutdown_propagated() got unexpeted exception {}",
                            eptr); ceph_abort();}
        );
    }
    ...
    future <> test_preemptive_down() {
        ...
        return SocketFactory::dispatch_sockets([](auto cs) {
               ...
               logger.info("test_preemptive_down() ok\n");}
                           ...
                           logger.
                           error
                           ("test_preemptive_down() got unexpeted exception {}",
                            eptr); ceph_abort();}
        );
    }
