...
namespace {
    ...
    struct UserBufferDeleter:public deleter::impl {
        ...
        UserBufferDeleter(CephContext * cct,
                          librbd::io::AioCompletion * aio_completion)
    ...
    static auto create_write_raw(librbd::ImageCtx * ictx, const char *buf,
        ...
        return ceph::unique_leakable_ptr < ceph::buffer::raw >
            (buffer::
             claim_buffer(len, const_cast < char *>(buf),
                          deleter(new
                                  UserBufferDeleter(ictx->cct,
                                                    aio_completion))));
    }

    static int get_iovec_length(const struct iovec *iov, int iovcnt,
                                size_t & len) {
        len = 0;
    ...
    static bufferlist iovec_to_bufferlist(librbd::ImageCtx * ictx,
        ...
        for (int i = 0; i < iovcnt; ++i) {
            ...
            bl.push_back(create_write_raw
                         (ictx, static_cast < char *>(io.iov_base), io.iov_len,
                          aio_completion));
        }
        return bl;
    }
    ...
    librbd::io::AioCompletion * get_aio_completion(librbd::RBD::AioCompletion *
                                                   comp) {
    ...
    struct C_AioCompletion:public Context {
        ...
        C_AioCompletion(librbd::ImageCtx * ictx,
                        librbd::io::aio_type_t aio_type,
                        librbd::io::AioCompletion * aio_comp)
    ...
    struct C_OpenComplete:public C_AioCompletion {
        ...
        void **ictxp;
        C_OpenComplete(librbd::ImageCtx * ictx,
    ...
    struct C_UpdateWatchCB:public librbd::UpdateWatchCtx {
        ...
        C_UpdateWatchCB(rbd_update_callback_t watch_cb,
                        void *arg):watch_cb(watch_cb), arg(arg) {
    ...
    struct C_QuiesceWatchCB:public librbd::QuiesceWatchCtx {
        ...
        C_QuiesceWatchCB(rbd_update_callback_t quiesce_cb,
                         rbd_update_callback_t unquiesce_cb,
                         void *arg):quiesce_cb(quiesce_cb),
            unquiesce_cb(unquiesce_cb), arg(arg) {
    ...
    void group_image_status_cpp_to_c(const librbd::
                                     group_image_info_t & cpp_info,
    ...
    void mirror_image_info_cpp_to_c(const librbd::
                                    mirror_image_info_t & cpp_info,
    ...
    int get_local_mirror_image_site_status(const librbd::
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
    ...
    int mirror_image_global_status_cpp_to_c(const librbd::
                                            mirror_image_global_status_t &
                                            cpp_status,
...
#pragma GCC diagnostic pop
    ...
    void mirror_image_global_status_cpp_to_c(const librbd::
                                             mirror_image_global_status_t &
                                             cpp_status,
        ...
        c_status->site_statuses =
            (rbd_mirror_image_site_status_t *) calloc(cpp_status.site_statuses.
                                                      size(),
                                                      sizeof
    ...
    struct C_MirrorImageGetInfo:public Context {
        ...
        :mirror_image_info(mirror_image_info), on_finish(on_finish) {
            ...
            mirror_image_info_cpp_to_c(cpp_mirror_image_info,
                                       mirror_image_info);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
    ...
    struct C_MirrorImageGetStatus:public Context {
        ...
        } C_MirrorImageGetStatus(librbd::mirror_image_status_t *
                                 mirror_image_status, Context * on_finish)
...
namespace librbd {
    ...
    int RBD::aio_open(IoCtx & io_ctx, Image & image, const char *name,
        ...
        if (image.ctx != NULL) {
            reinterpret_cast <
                ...
                >(image.ctx)->state->
                close(new
                      C_OpenAfterCloseComplete(ictx, get_aio_completion(c),
                                               &image.ctx));
        }
        else {
    ...
    int RBD::aio_open_by_id_read_only(IoCtx & io_ctx, Image & image,
                                      const char *id, const char *snap_name,
                                      RBD::AioCompletion * c) {
        ImageCtx *ictx = new ImageCtx("", id, snap_name, io_ctx, true);
        TracepointProvider::initialize < tracepoint_traits > (get_cct(io_ctx));
        tracepoint(librbd, aio_open_image_by_id_enter, ictx, ictx->id.c_str(),
    ...
    int RBD::create2(IoCtx & io_ctx, const char *name, uint64_t size,
        ...
        int r =
            librbd::create(io_ctx, name, size, false, features, order, 0, 0);
    ...
    int RBD::clone2(IoCtx & p_ioctx, const char *p_name,
                    const char *p_snap_name, IoCtx & c_ioctx,
    ...
    int RBD::clone3(IoCtx & p_ioctx, const char *p_name,
                    const char *p_snap_name, IoCtx & c_ioctx,
    ...
    int RBD::trash_get(IoCtx & io_ctx, const char *id,
    ...
    int RBD::trash_remove(IoCtx & io_ctx, const char *image_id, bool force) {
        ...
        librbd::NoOpProgressContext prog_ctx;
        int r =
            librbd::api::Trash <>::remove(io_ctx, image_id, force, prog_ctx);
    ...
    int RBD::trash_restore(IoCtx & io_ctx, const char *id, const char *name) {
        ...
        int r =
            librbd::api::Trash <>::restore(io_ctx,
                                           librbd::api::Trash <>::
                                           ALLOWED_RESTORE_SOURCES, id, name);
    ...
    int RBD::trash_purge(IoCtx & io_ctx, time_t expire_ts, float threshold) {
        ...
        int r =
            librbd::api::Trash <>::purge(io_ctx, expire_ts, threshold,
                                         nop_pctx);
    ...
    int RBD::trash_purge_with_progress(IoCtx & io_ctx, time_t expire_ts,
        ...
        tracepoint(librbd, trash_purge_enter, io_ctx.get_pool_name().c_str(),
                   io_ctx.get_id(), expire_ts, threshold);
        int r =
            librbd::api::Trash <>::purge(io_ctx, expire_ts, threshold, pctx);
        tracepoint(librbd, trash_purge_exit, r);
        return r;
    }
    ...
    int RBD::namespace_exists(IoCtx & io_ctx, const char *namespace_name,
                              bool * exists) {
        return librbd::api::Namespace <>::exists(io_ctx, namespace_name,
                                                 exists);
    }
    ...
    int RBD::pool_stats_get(IoCtx & io_ctx, PoolStats * stats) {
        auto pool_stat_options =
            reinterpret_cast <
            librbd::api::Pool <>::StatOptions * >(stats->pool_stats);
    ...
    int RBD::rename(IoCtx & src_io_ctx, const char *srcname,
                    const char *destname) {
        TracepointProvider::initialize < tracepoint_traits >
            (get_cct(src_io_ctx));
    ...
    int RBD::migration_prepare(IoCtx & io_ctx, const char *image_name,
                               ...
                               ImageOptions & opts) {
        TracepointProvider::initialize < tracepoint_traits > (get_cct(io_ctx));
        tracepoint(librbd, migration_prepare_enter,
                   io_ctx.get_pool_name().c_str(), io_ctx.get_id(), image_name,
                   dest_io_ctx.get_pool_name().c_str(), dest_io_ctx.get_id(),
                   dest_image_name, opts.opts);
        int r =
            librbd::api::Migration <>::prepare(io_ctx, image_name, dest_io_ctx,
                                               dest_image_name, opts);
        tracepoint(librbd, migration_prepare_exit, r);
        return r;
    }

    int RBD::migration_prepare_import(const char *source_spec,
                                      IoCtx & dest_io_ctx,
                                      const char *dest_image_name,
                                      ImageOptions & opts) {
        return librbd::api::Migration <>::prepare_import(source_spec,
                                                         dest_io_ctx,
                                                         dest_image_name, opts);
    }
    ...
    int RBD::migration_execute(IoCtx & io_ctx, const char *image_name) {
        TracepointProvider::initialize < tracepoint_traits > (get_cct(io_ctx));
        tracepoint(librbd, migration_execute_enter,
                   io_ctx.get_pool_name().c_str(), io_ctx.get_id(), image_name);
        librbd::NoOpProgressContext prog_ctx;
        int r =
            librbd::api::Migration <>::execute(io_ctx, image_name, prog_ctx);
    ...
    int RBD::migration_abort(IoCtx & io_ctx, const char *image_name) {
        TracepointProvider::initialize < tracepoint_traits > (get_cct(io_ctx));
        tracepoint(librbd, migration_abort_enter,
                   io_ctx.get_pool_name().c_str(), io_ctx.get_id(), image_name);
        librbd::NoOpProgressContext prog_ctx;
    ...
    int RBD::migration_abort_with_progress(IoCtx & io_ctx,
                                           const char *image_name,
                                           librbd::ProgressContext & prog_ctx) {
        TracepointProvider::initialize < tracepoint_traits > (get_cct(io_ctx));
        tracepoint(librbd, migration_abort_enter,
    ...
    int RBD::migration_commit(IoCtx & io_ctx, const char *image_name) {
        TracepointProvider::initialize < tracepoint_traits > (get_cct(io_ctx));
        tracepoint(librbd, migration_commit_enter,
                   io_ctx.get_pool_name().c_str(), io_ctx.get_id(), image_name);
        librbd::NoOpProgressContext prog_ctx;
    ...
    int RBD::migration_commit_with_progress(IoCtx & io_ctx,
                                            const char *image_name,
                                            librbd::
    ...
    int RBD::migration_status(IoCtx & io_ctx, const char *image_name,
                              ...
                              size_t status_size) {
        TracepointProvider::initialize < tracepoint_traits > (get_cct(io_ctx));
        tracepoint(librbd, migration_status_enter,
                   io_ctx.get_pool_name().c_str(), io_ctx.get_id(), image_name);
    ...
    int RBD::mirror_peer_site_get_attributes(IoCtx & io_ctx,
                                             const std::string & uuid,
                                             std::map < std::string,
                                             std::string > *key_vals) {
    ...
    int RBD::mirror_peer_site_set_attributes(IoCtx & io_ctx,
                                             const std::string & uuid,
    ...
    int RBD::mirror_image_global_status_list(IoCtx & io_ctx,
                                             const std::string & start_id,
                                             size_t max, std::map < std::string,
                                             mirror_image_global_status_t >
                                             *global_statuses) {
        return librbd::api::Mirror <>::image_global_status_list(io_ctx,
                                                                start_id, max,
                                                                global_statuses);
    }
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
    ...
    int RBD::mirror_peer_add(IoCtx & io_ctx, std::string * uuid,
                             ...
                             const std::string & client_name) {
        return librbd::api::Mirror <>::peer_site_add(io_ctx, uuid,
    ...
    int RBD::mirror_peer_list(IoCtx & io_ctx,
      ...
      for (auto & peer_site:peer_sites) {
            peers->push_back( {
                             peer_site.uuid, peer_site.site_name,
    ...
    int RBD::mirror_peer_get_attributes(IoCtx & io_ctx,
                                        const std::string & uuid,
                                        std::map < std::string,
                                        std::string > *key_vals) {
        return librbd::api::Mirror <>::peer_site_get_attributes(io_ctx, uuid,
    ...
    int RBD::mirror_peer_set_attributes(IoCtx & io_ctx,
                                        const std::string & uuid,
                                        const std::map < std::string,
                                        std::string > &key_vals) {
        return librbd::api::Mirror <>::peer_site_set_attributes(io_ctx, uuid,
    ...
    int RBD::mirror_image_status_list(IoCtx & io_ctx,
                                      const std::string & start_id, size_t max,
                                      std::map < std::string,
                                      mirror_image_status_t > *images) {
        std::map < std::string, mirror_image_global_status_t > global_statuses;

        int r =
            librbd::api::Mirror <>::image_global_status_list(io_ctx, start_id,
                                                             max,
                                                             &global_statuses);
        if (r < 0) {
            return r;
      ...
      for (auto &[id, global_status]:global_statuses) {
            ...
            global_status.name, global_status.info, site_status.state,
                    site_status.description, site_status.last_update,
                    site_status.up};
        }
...
#pragma GCC diagnostic pop
    ...
    int RBD::mirror_image_status_summary(IoCtx & io_ctx,
                                         std::map < mirror_image_status_state_t,
                                         int >*states) {
    ...
    int RBD::mirror_image_instance_id_list(IoCtx & io_ctx,
        ...
        return librbd::api::Mirror <>::image_instance_id_list(io_ctx, start_id,
                                                              max,
                                                              instance_ids);
    }

    int RBD::mirror_image_info_list(IoCtx & io_ctx,
                                    mirror_image_mode_t * mode_filter,
                                    const std::string & start_id, size_t max,
                                    std::map < std::string,
                                    std::pair < mirror_image_mode_t,
                                    mirror_image_info_t >> *entries) {
        return librbd::api::Mirror <>::image_info_list(io_ctx, mode_filter,
                                                       start_id, max, entries);
    }
    ...
    int RBD::group_image_remove_by_id(IoCtx & group_ioctx,
        ...
        int r =
            librbd::api::Group <>::image_remove_by_id(group_ioctx, group_name,
    ...
    int RBD::group_image_list(IoCtx & group_ioctx, const char *group_name,
        ...
        int r =
            librbd::api::Group <>::image_list(group_ioctx, group_name, images);
    ...
    int RBD::group_snap_list(IoCtx & group_ioctx, const char *group_name,
        ...
        int r =
            librbd::api::Group <>::snap_list(group_ioctx, group_name, snaps);
    ...
    int RBD::config_list(IoCtx & io_ctx,
    ...
    RBD::AioCompletion::AioCompletion(void *cb_arg, callback_t complete_cb) {
        auto aio_comp =
            librbd::io::AioCompletion::create(cb_arg, complete_cb, this);
    ...
    int Image::resize_with_progress(uint64_t size,
                                    librbd::ProgressContext & pctx) {
        ImageCtx *ictx = (ImageCtx *) ctx;
        tracepoint(librbd, resize_enter, ictx, ictx->name.c_str(),
                   ictx->snap_name.c_str(), ictx->read_only, size);
    ...
    int Image::get_access_timestamp(struct timespec *timestamp) {
        ...
        tracepoint(librbd, get_access_timestamp_enter, ictx, ictx->name.c_str(),
                   ictx->read_only);
        {
            std::shared_lock timestamp_locker {
            ictx->timestamp_lock};
    ...
    int Image::get_parent(linked_image_spec_t * parent_image,
        ...
        int r =
            librbd::api::Image <>::get_parent(ictx, parent_image, parent_snap);

        tracepoint(librbd, get_parent_info_exit, r,
                   parent_image->pool_name.c_str(),
                   parent_image->image_name.c_str(),
                   parent_image->image_id.c_str(), parent_snap->name.c_str());
        return r;
    }
    ...
    int Image::lock_break(rbd_lock_mode_t lock_mode,
        ...
        ImageCtx *ictx = (ImageCtx *) ctx;
        tracepoint(librbd, lock_break_enter, ictx, lock_mode,
                   lock_owner.c_str());
    ...
    int Image::copy3(IoCtx & dest_io_ctx, const char *destname,
                     ImageOptions & opts) {
        ImageCtx *ictx = (ImageCtx *) ctx;
    ...
    int Image::copy4(IoCtx & dest_io_ctx, const char *destname,
                     ImageOptions & opts, size_t sparse_size) {
        ImageCtx *ictx = (ImageCtx *) ctx;
        ...
        librbd::NoOpProgressContext prog_ctx;
        int r =
            librbd::copy(ictx, dest_io_ctx, destname, opts, prog_ctx,
                         sparse_size);
    ...
    int Image::copy_with_progress4(IoCtx & dest_io_ctx, const char *destname,
        ...
        tracepoint(librbd, copy4_enter, ictx, ictx->name.c_str(),
                   ...
                   destname, opts.opts, sparse_size);
        int r =
            librbd::copy(ictx, dest_io_ctx, destname, opts, pctx, sparse_size);
        tracepoint(librbd, copy4_exit, r);
        return r;
    }
    ...
    int Image::deep_copy(IoCtx & dest_io_ctx, const char *destname,
        ...
        librbd::NoOpProgressContext prog_ctx;
        int r =
            librbd::api::Image <>::deep_copy(ictx, dest_io_ctx, destname, opts,
                                             prog_ctx);
        tracepoint(librbd, deep_copy_exit, r);
        return r;
    }

    int Image::deep_copy_with_progress(IoCtx & dest_io_ctx,
                                       const char *destname,
                                       ImageOptions & opts,
                                       librbd::ProgressContext & prog_ctx) {
        ImageCtx *ictx = (ImageCtx *) ctx;
    ...
    int Image::encryption_load2(const encryption_spec_t * specs,
                                size_t spec_count) {
        ImageCtx *ictx = (ImageCtx *) ctx;
    ...
    int Image::flatten() {
        ImageCtx *ictx = (ImageCtx *) ctx;
        tracepoint(librbd, flatten_enter, ictx, ictx->name.c_str(),
                   ictx->id.c_str());
        librbd::NoOpProgressContext prog_ctx;
    ...
    int Image::sparsify(size_t sparse_size) {
        ImageCtx *ictx = (ImageCtx *) ctx;
        tracepoint(librbd, sparsify_enter, ictx, ictx->name.c_str(),
                   sparse_size, ictx->id.c_str());
        librbd::NoOpProgressContext prog_ctx;
    ...
    int Image::list_children(set < pair < string, string > >*children) {
      ...
      for (auto & image:images) {
            if (!image.trash) {
                children->insert( {
                                 image.pool_name, image.image_name}
                );
            }
        }
        return 0;
    ...
    int Image::list_children2(vector < librbd::child_info_t > *children) {
      ...
      for (auto & image:images) {
            children->push_back( {
                                .pool_name = image.pool_name,.image_name =
                                image.image_name,.image_id =
                                image.image_id,.trash = image.trash}
            );
        }
    ...
    int Image::list_lockers(std::list < librbd::locker_t > *lockers,
        ...
        if (r >= 0) {
            for (std::list < librbd::locker_t >::const_iterator it =
                 lockers->begin(); it != lockers->end(); ++it) {
    ...
    int Image::snap_create(const char *snap_name) {
        ...
        librbd::NoOpProgressContext prog_ctx;
        int r =
            librbd::api::Snapshot <>::create(ictx, snap_name, flags, prog_ctx);
    ...
    int Image::snap_is_protected(const char *snap_name, bool * is_protected) {
        ...
        tracepoint(librbd, snap_is_protected_enter, ictx, ictx->name.c_str(),
                   ictx->snap_name.c_str(), ictx->read_only, snap_name);
        int r =
            librbd::api::Snapshot <>::is_protected(ictx, snap_name,
                                                   is_protected);
    ...
    bool Image::snap_exists(const char *snap_name) {
        ...
        bool exists;
        int r =
            librbd::api::Snapshot <>::exists(ictx,
    ...
    int Image::snap_get_timestamp(uint64_t snap_id, struct timespec *timestamp) {
        ...
        int r =
            librbd::api::Snapshot <>::get_timestamp(ictx, snap_id, timestamp);
    ...
    int Image::snap_get_namespace_type(uint64_t snap_id,
        ...
        ImageCtx *ictx = (ImageCtx *) ctx;
        tracepoint(librbd, snap_get_namespace_type_enter, ictx,
                   ictx->name.c_str());
        int r =
            librbd::api::Snapshot <>::get_namespace_type(ictx, snap_id,
                                                         namespace_type);
    ...
    int Image::snap_get_mirror_namespace(uint64_t snap_id,
        ...
        int r =
            librbd::api::Snapshot <>::get_mirror_namespace(ictx, snap_id,
                                                           mirror_snap);
        return r;
    }
    ...
    int Image::snap_set_limit(uint64_t limit) {
        ...
        tracepoint(librbd, snap_set_limit_enter, ictx, ictx->name.c_str(),
                   limit);
    ...
    ssize_t Image::read2(uint64_t ofs, size_t len, bufferlist & bl,
                         int op_flags) {
        ImageCtx *ictx = (ImageCtx *) ctx;
        ...
        int r =
            api::Io <>::read(*ictx, ofs, len, io::ReadResult { &bl }, op_flags);
        tracepoint(librbd, read_exit, r);
        return r;
    }
    ...
    int Image::diff_iterate(const char *fromsnapname,
        ...
        tracepoint(librbd, diff_iterate_enter, ictx, ictx->name.c_str(),
                   ictx->snap_name.c_str(), ictx->read_only, fromsnapname, ofs,
                   len, true, false);
    ...
    int Image::diff_iterate2(const char *fromsnapname, uint64_t ofs,
                             uint64_t len, bool include_parent,
                             bool whole_object, int (*cb) (uint64_t, size_t,
                                                           int, void *),
                             void *arg) {
        ImageCtx *ictx = (ImageCtx *) ctx;
        tracepoint(librbd, diff_iterate_enter, ictx, ictx->name.c_str(),
                   ictx->snap_name.c_str(), ictx->read_only, fromsnapname, ofs,
                   len, include_parent, whole_object);
        int r = librbd::api::DiffIterate <>::diff_iterate(ictx,
                                                          cls::rbd::
                                                          UserSnapshotNamespace
                                                          (),
    ...
    ssize_t Image::write2(uint64_t ofs, size_t len, bufferlist & bl,
                          int op_flags) {
        ImageCtx *ictx = (ImageCtx *) ctx;
    ...
    ssize_t Image::writesame(uint64_t ofs, size_t len, bufferlist & bl,
        ...
        if (bl.length() == 0 || len % bl.length()
            || len > static_cast < size_t > (std::numeric_limits <
                                             int >::max())) {
        ...
        int r =
            api::Io <>::write_same(*ictx, ofs, len, bufferlist { bl },
                                   op_flags);
        tracepoint(librbd, writesame_exit, r);
        return r;
    }
    ...
    ssize_t Image::compare_and_write(uint64_t ofs, size_t len,
        ...
        int r =
            api::Io <>::compare_and_write(*ictx, ofs, len,
                                          bufferlist { cmp_bl },
    ...
    int Image::aio_write(uint64_t off, size_t len, bufferlist & bl,
        ...
        api::Io <>::aio_write(*ictx, get_aio_completion(c), off, len, bufferlist {
                              bl}
                              , 0, true);
    ...
    int Image::aio_read(uint64_t off, size_t len, bufferlist & bl,
        ...
        ldout(ictx->cct,
            ...
            c_str() << "~" << (void *)(bl.c_str() + len - 1) << dendl;
    ...
    int Image::aio_write_zeroes(uint64_t off, size_t len,
                                RBD::AioCompletion * c, int zero_flags,
                                int op_flags) {
        ImageCtx *ictx = (ImageCtx *) ctx;
        api::Io <>::aio_write_zeroes(*ictx, get_aio_completion(c), off, len,
    ...
    int Image::aio_compare_and_write(uint64_t off, size_t len,
                                     ...
                                     uint64_t * mismatch_off, int op_flags) {
        ImageCtx *ictx = (ImageCtx *) ctx;
        tracepoint(librbd, aio_compare_and_write_enter, ictx,
                   ictx->name.c_str(), ictx->snap_name.c_str(), ictx->read_only,
                   off, len, cmp_bl.length() < len ? NULL : cmp_bl.c_str(),
                   bl.length() < len ? NULL : bl.c_str(), c->pc, op_flags);
        ...
        api::Io <>::aio_compare_and_write(*ictx, get_aio_completion(c), off,
                                          len, bufferlist {
                                          cmp_bl}
                                          , bufferlist {
                                          bl}
    ...
    int Image::metadata_get(const std::string & key, std::string * value) {
        ...
        if (r < 0) {
            ...
            tracepoint(librbd, metadata_get_exit, r, key.c_str(),
                       value->c_str());
        }
        return r;
    }
    ...
    int Image::metadata_set(const std::string & key, const std::string & value) {
        ImageCtx *ictx = (ImageCtx *) ctx;
        tracepoint(librbd, metadata_set_enter, ictx, key.c_str(),
                   value.c_str());
    ...
    int Image::mirror_image_create_snapshot(uint64_t * snap_id) {
        ImageCtx *ictx = (ImageCtx *) ctx;
        auto flags = librbd::util::get_default_snap_create_flags(ictx);
        return librbd::api::Mirror <>::image_snapshot_create(ictx, flags,
                                                             snap_id);
    }
    ...
    int Image::mirror_image_get_global_status(mirror_image_global_status_t *
                                              mirror_image_global_status,
                                              size_t status_size) {
        ImageCtx *ictx = (ImageCtx *) ctx;
        ...
        return librbd::api::Mirror <>::image_get_global_status(ictx,
                                                               mirror_image_global_status);
    }
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
    ...
    int Image::mirror_image_get_status(mirror_image_status_t *
                                       mirror_image_status,
                                       size_t status_size) {
        ImageCtx *ictx = (ImageCtx *) ctx;
        ...
        int r =
            librbd::api::Mirror <>::image_get_global_status(ictx,
                                                            &mirror_image_global_status);
        if (r < 0) {
            return r;
        }
...
#pragma GCC diagnostic pop
    ...
    int Image::aio_mirror_image_promote(bool force, RBD::AioCompletion * c) {
        ImageCtx *ictx = (ImageCtx *) ctx;
        librbd::api::Mirror <>::image_promote(ictx, force,
    ...
    int Image::aio_mirror_image_get_info(mirror_image_info_t *
                                         mirror_image_info, size_t info_size,
                                         RBD::AioCompletion * c) {
        ImageCtx *ictx = (ImageCtx *) ctx;
        ...
        librbd::api::Mirror <>::image_get_info(ictx, mirror_image_info,
                                               new C_AioCompletion(ictx,
                                                                   librbd::io::
                                                                   AIO_TYPE_GENERIC,
                                                                   get_aio_completion
    ...
    int Image::aio_mirror_image_get_mode(mirror_image_mode_t * mode,
        ...
        librbd::api::Mirror <>::image_get_mode(ictx, mode,
                                               new C_AioCompletion(ictx,
                                                                   librbd::io::
                                                                   AIO_TYPE_GENERIC,
                                                                   get_aio_completion
    ...
    int Image::aio_mirror_image_get_global_status(mirror_image_global_status_t *
        ...
        librbd::api::Mirror <>::image_get_global_status(ictx, status,
                                                        new
                                                        C_AioCompletion(ictx,
                                                                        librbd::
                                                                        io::
                                                                        AIO_TYPE_GENERIC,
                                                                        get_aio_completion
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
    ...
    int Image::aio_mirror_image_get_status(mirror_image_status_t * status,
        ...
        auto ctx =
            new C_MirrorImageGetStatus(status,
                                       new C_AioCompletion(ictx,
                                                           librbd::io::
                                                           AIO_TYPE_GENERIC,
                                                           get_aio_completion
...
#pragma GCC diagnostic pop
    ...
    int Image::aio_mirror_image_create_snapshot(uint32_t flags,
                                                uint64_t * snap_id,
                                                RBD::AioCompletion * c) {
        ImageCtx *ictx = (ImageCtx *) ctx;

        librbd::api::Mirror <>::image_snapshot_create(ictx, flags, snap_id,
                                                      new C_AioCompletion(ictx,
                                                                          librbd::
                                                                          io::
                                                                          AIO_TYPE_GENERIC,
    ...
    int Image::list_watchers(std::list < librbd::image_watcher_t > &watchers) {
        ...
        if (r >= 0) {
          for (auto & watcher:watchers) {
                tracepoint(librbd, list_watchers_entry, watcher.addr.c_str(),
                           watcher.id, watcher.cookie);
            }
        }
#endif
...
extern "C" int rbd_mirror_peer_bootstrap_import(rados_ioctx_t p,
                                                rbd_mirror_peer_direction_t
                                                direction, const char *token)
{
    librados::IoCtx io_ctx;
    librados::IoCtx::from_rados_ioctx_t(p, io_ctx);
...
extern "C" void rbd_mirror_peer_site_list_cleanup(rbd_mirror_peer_site_t *
                                                  peers, int max_peers)
{
...
extern "C" int rbd_mirror_peer_site_set_direction(rados_ioctx_t p,
                                                  const char *uuid,
                                                  rbd_mirror_peer_direction_t
                                                  direction)
{
...
extern "C" int rbd_mirror_peer_site_get_attributes(rados_ioctx_t p,
                                                   const char *uuid, char *keys,
                                                   size_t * max_key_len,
                                                   char *values,
                                                   size_t * max_val_len,
                                                   size_t * key_value_count)
{
    ...
    int r =
        librbd::api::Mirror <>::peer_site_get_attributes(io_ctx, uuid,
                                                         &attributes);
    if (r < 0) {
        return r;
    }
                                                   ...
                                                   * images, size_t * len)
{
    ...
    int r =
        librbd::api::Mirror <>::image_global_status_list(io_ctx, start_id, max,
                                                         &cpp_images);
    if (r < 0) {
        return r;
    }
...
extern "C" void
rbd_mirror_image_global_status_cleanup(rbd_mirror_image_global_status_t *
                                       global_status)
{
...
extern "C" void rbd_mirror_image_global_status_list_cleanup(char **image_ids,
                                                            rbd_mirror_image_global_status_t
                                                            * images,
                                                            size_t len)
{
...
extern "C" int rbd_mirror_peer_get_attributes(rados_ioctx_t p, const char *uuid,
                                              ...
                                              size_t * key_value_count)
{
    return rbd_mirror_peer_site_get_attributes(p, uuid, keys, max_key_len,
                                               values, max_val_len,
                                               key_value_count);
}
                                                 ...
                                                 size_t * len)
{
    ...
    int r =
        librbd::api::Mirror <>::image_instance_id_list(io_ctx, start_id, max,
                                                       &cpp_instance_ids);
    if (r < 0) {
        return r;
    }
...
extern "C" int rbd_mirror_image_info_list(rados_ioctx_t p,
                                          ...
                                          info_entries, size_t * num_entries)
{
    librados::IoCtx io_ctx;
    librados::IoCtx::from_rados_ioctx_t(p, io_ctx);
    ...
    int r =
        librbd::api::Mirror <>::image_info_list(io_ctx, mode_filter, start_id,
                                                max, &cpp_entries);
    if (r < 0) {
        return r;
    }
...
extern "C" void rbd_mirror_image_info_list_cleanup(char **image_ids,
                                                   rbd_mirror_image_info_t *
                                                   info_entries,
                                                   size_t num_entries)
{
...
extern "C" void rbd_linked_image_spec_list_cleanup(rbd_linked_image_spec_t *
                                                   images, size_t num_images)
{
    for (size_t idx = 0; idx < num_images; ++idx) {
...
extern "C" int rbd_create2(rados_ioctx_t p, const char *name,
                           uint64_t size, uint64_t features, int *order)
{
    librados::IoCtx io_ctx;
    librados::IoCtx::from_rados_ioctx_t(p, io_ctx);
    TracepointProvider::initialize < tracepoint_traits > (get_cct(io_ctx));
                         ...
                         const char *c_name, uint64_t features, int *c_order)
{
    ...
    tracepoint(librbd, clone_enter, p_ioc.get_pool_name().c_str(),
               p_ioc.get_id(), p_name, p_snap_name,
               c_ioc.get_pool_name().c_str(), c_ioc.get_id(), c_name, features);
                          ...
                          const char *c_name, rbd_image_options_t c_opts)
{
    ...
    tracepoint(librbd, clone3_enter, p_ioc.get_pool_name().c_str(),
               p_ioc.get_id(), p_name, p_snap_name,
               c_ioc.get_pool_name().c_str(), c_ioc.get_id(), c_name, c_opts);
...
extern "C" int rbd_trash_move(rados_ioctx_t p, const char *name, uint64_t delay)
{
    ...
    tracepoint(librbd, trash_move_enter, io_ctx.get_pool_name().c_str(),
               io_ctx.get_id(), name);
    int r =
        librbd::api::Trash <>::move(io_ctx, RBD_TRASH_IMAGE_SOURCE_USER, name,
                                    delay);
    tracepoint(librbd, trash_move_exit, r);
    return r;
}
                               ...
                               float threshold)
{
    ...
    int r =
        librbd::api::Trash <>::purge(io_ctx, expire_ts, threshold, nop_pctx);
    tracepoint(librbd, trash_purge_exit, r);
    return r;
}
                                                ...
                                                uint64_t * stat_val)
{
    auto pool_stat_options =
        reinterpret_cast < librbd::api::Pool <>::StatOptions * >(stats);
    return librbd::api::Pool <>::add_stat_option(pool_stat_options,
                                                 static_cast <
                                                 rbd_pool_stat_option_t >
                                                 (stat_option), stat_val);
}
                         ...
                         size_t sparse_size)
{
    ...
    librbd::NoOpProgressContext prog_ctx;
    int r =
        librbd::copy(ictx, dest_io_ctx, destname, c_opts_, prog_ctx,
                     sparse_size);
    tracepoint(librbd, copy4_exit, r);
    return r;
}
                                       ...
                                       librbd_progress_fn_t fn, void *data)
{
    ...
    librbd::CProgressContext prog_ctx(fn, data);
    int ret =
        librbd::copy(ictx, dest_io_ctx, destname, dest_opts_, prog_ctx, 0);
                                       ...
                                       size_t sparse_size)
{
    ...
    librbd::CProgressContext prog_ctx(fn, data);
    int ret =
        librbd::copy(ictx, dest_io_ctx, destname, dest_opts_, prog_ctx,
                     sparse_size);
                                    ...
                                    size_t status_size)
{
    ...
    if (r >= 0) {
        ...
        status->source_image_name =
            strdup(cpp_status.source_image_name.c_str());
        ...
        status->state_description =
            strdup(cpp_status.state_description.c_str());
    }
                            ...
                            rbd_completion_t c)
{
    ...
    tracepoint(librbd, aio_open_image_enter, ictx, ictx->name.c_str(),
               ...
               comp->pc);
    ictx->state->open(0,
                      new C_OpenComplete(ictx, get_aio_completion(comp),
                                         image));
    tracepoint(librbd, aio_open_image_exit, 0);
    return 0;
}
...
{
    std::stringstream err;
    std::string get_str_features =
        librbd::rbd_features_to_string(features, &err);
    if (!err.str().empty()) {
        return -EINVAL;
    }
...
extern "C" int rbd_aio_close(rbd_image_t image, rbd_completion_t c)
{
    ...
    ictx->state->
        close(new
              C_AioCompletion(ictx, librbd::io::AIO_TYPE_CLOSE,
                              ...
                              rbd_snap_spec_t * parent_snap)
{
    ...
    if (r < 0) {
        ...
        *parent_image = {
        .pool_id = cpp_parent_image.pool_id,.pool_name =
                strdup(cpp_parent_image.pool_name.c_str()),.pool_namespace =
                strdup(cpp_parent_image.pool_namespace.c_str()),.image_id =
                strdup(cpp_parent_image.image_id.c_str()),.image_name =
                strdup(cpp_parent_image.image_name.c_str()),.trash =
                cpp_parent_image.trash};
        *parent_snap = {
        .id = cpp_parent_snap.id,.namespace_type =
                cpp_parent_snap.namespace_type,.name =
                strdup(cpp_parent_snap.name.c_str())};
    }

    tracepoint(librbd, get_parent_info_exit, r,
               parent_image->pool_name,
               parent_image->image_name,
               parent_image->image_id, parent_snap->name);
    return r;
}
...
extern "C" int rbd_snap_set(rbd_image_t image, const char *snap_name)
{
    ...
    tracepoint(librbd, snap_set_enter, ictx, ictx->name.c_str(),
               ictx->snap_name.c_str(), ictx->read_only, snap_name);
    int r =
        librbd::api::Image <>::snap_set(ictx, cls::rbd::UserSnapshotNamespace(),
                                        snap_name);
    tracepoint(librbd, snap_set_exit, r);
    return r;
}
                                  ...
                                  size_t * max_images)
{
    ...
    *max_images = cpp_children.size();
    for (size_t idx = 0; idx < cpp_children.size(); ++idx) {
        images[idx] = {
        .pool_id = cpp_children[idx].pool_id,.pool_name =
                strdup(cpp_children[idx].pool_name.c_str()),.
                pool_namespace =
                strdup(cpp_children[idx].pool_namespace.c_str()),.image_id =
                strdup(cpp_children[idx].image_id.c_str()),.image_name =
                strdup(cpp_children[idx].image_name.c_str()),.trash =
                cpp_children[idx].trash};
                                    ...
                                    char *addrs, size_t * addrs_len)
{
    ...
    ldout(ictx->cct,
          20) << "list_lockers r = " << r << " lockers.size() = " << lockers.
        size() << dendl;
                            ...
                            char *buf)
{
    ...
    tracepoint(librbd, read_enter, ictx, ictx->name.c_str(),
               ictx->snap_name.c_str(), ictx->read_only, ofs, len);
    int r =
        librbd::api::Io <>::read(*ictx, ofs, len, librbd::io::ReadResult { buf,
                                 len }, 0);
    tracepoint(librbd, read_exit, r);
    return r;
}
...
extern "C" int rbd_discard(rbd_image_t image, uint64_t ofs, uint64_t len)
{
    ...
    int r =
        librbd::api::Io <>::discard(*ictx, ofs, len,
                                    ictx->discard_granularity_bytes);
    tracepoint(librbd, discard_exit, r);
    return r;
}
                                 ...
                                 const char *buf, size_t data_len, int op_flags)
{
    ...
    int r =
        librbd::api::Io <>::write_same(*ictx, ofs, len, std::move(bl),
                                       op_flags);
    tracepoint(librbd, writesame_exit, r);
    return r;
}
...
{
    librbd::ImageCtx * ictx = (librbd::ImageCtx *) image;
    return librbd::api::Io <>::write_zeroes(*ictx, ofs, len, zero_flags,
                                            op_flags);
}
                                         ...
                                         uint64_t * mismatch_off, int op_flags)
{
    ...
    int r =
        librbd::api::Io <>::compare_and_write(*ictx, ofs, len,
                             ...
                             const char *buf, rbd_completion_t c)
{
    ...
    librbd::api::Io <>::aio_write(*ictx, aio_completion, off, len,
                                  std::move(bl), 0, true);
    tracepoint(librbd, aio_write_exit, 0);
    return 0;
}
                             ...
                             int iovcnt, uint64_t off, rbd_completion_t c)
{
    ...
    if (r == 0) {
        ...
        if (iovcnt == 1) {
            read_result =
                librbd::io::ReadResult(static_cast < char *>(iov[0].iov_base),
                                       iov[0].iov_len);
        }
        else {
                                 ...
                                 rbd_completion_t c, int op_flags)
{
    ...
    bool discard_zero =
        ictx->config.get_val < bool > ("rbd_discard_on_zeroed_write_same");
    if (discard_zero && mem_is_zero(buf, data_len)) {
        librbd::api::Io <>::aio_write_zeroes(*ictx, get_aio_completion(comp),
                                             off, len, 0, op_flags, true);
        tracepoint(librbd, aio_writesame_exit, 0);
        return 0;
    }
                                              ...
                                              int op_flags)
{
    ...
    tracepoint(librbd, aio_compare_and_write_enter, ictx, ictx->name.c_str(),
               ictx->snap_name.c_str(), ictx->read_only, off, cmp_len, NULL,
               NULL, comp->pc, op_flags);
    if (r != 0) {
    ...
    auto aio_completion = get_aio_completion(comp);
    auto cmp_bl =
        iovec_to_bufferlist(ictx, cmp_iov, cmp_iovcnt, aio_completion);
    auto bl = iovec_to_bufferlist(ictx, iov, iovcnt, aio_completion);
    librbd::api::Io <>::aio_compare_and_write(*ictx, aio_completion, off,
                                              cmp_len, std::move(cmp_bl),
...
extern "C" int rbd_mirror_image_get_global_status(rbd_image_t image,
                                                  rbd_mirror_image_global_status_t
                                                  * status, size_t status_size)
{
    librbd::ImageCtx * ictx = (librbd::ImageCtx *) image;
                                                ...
                                                size_t * instance_id_max_length)
{
    ...
    int r =
        librbd::api::Mirror <>::image_get_instance_id(ictx, &cpp_instance_id);
    if (r < 0) {
        return r;
    }
                                             ...
                                             rbd_completion_t c)
{
    ...
    auto ctx =
        new C_MirrorImageGetInfo(info,
                                 new C_AioCompletion(ictx,
                                                     librbd::io::
                                                     AIO_TYPE_GENERIC,
                                                     get_aio_completion(comp)));
    librbd::api::Mirror <>::image_get_info(ictx, &ctx->cpp_mirror_image_info,
                                           ctx);
    return 0;
}
...
extern "C" int rbd_aio_mirror_image_get_global_status(rbd_image_t image,
                                                      rbd_mirror_image_global_status_t
                                                      * status,
                                                      size_t status_size,
                                                      rbd_completion_t c)
{
    ...
    auto ctx =
        new C_MirrorImageGetGlobalStatus(status,
                                         new C_AioCompletion(ictx,
                                                             librbd::io::
                                                             AIO_TYPE_GENERIC,
                                                             get_aio_completion
                                   ...
                                   const char *image_name)
{
    ...
    int r =
        librbd::api::Group <>::image_add(group_ioctx, group_name, image_ioctx,
                                         image_name);
                                      ...
                                      const char *snap_name, uint32_t flags)
{
    ...
    int r =
        librbd::api::Group <>::snap_create(group_ioctx, group_name, snap_name,
                                           flags);
    tracepoint(librbd, group_snap_create_exit, r);
                                     ...
                                     const char *snap_name)
{
    ...
    int r =
        librbd::api::Group <>::snap_remove(group_ioctx, group_name, snap_name);
                                   ...
                                   size_t * snaps_size)
{
    ...
    int r =
        librbd::api::Group <>::snap_list(group_ioctx, group_name, &cpp_snaps);
...
extern "C" int rbd_snap_group_namespace_cleanup(rbd_snap_group_namespace_t *
                                                group_snap,
                                                size_t
                                                snap_group_namespace_size)
{
    if (snap_group_namespace_size != sizeof(rbd_snap_group_namespace_t)) {
        return -ERANGE;
    }
...
extern "C" int rbd_snap_get_mirror_namespace(rbd_image_t image,
                                             uint64_t snap_id,
...
extern "C" int rbd_snap_mirror_namespace_cleanup(rbd_snap_mirror_namespace_t *
                                                 mirror_snap,
                                                 size_t mirror_snap_size)
{
    if (mirror_snap_size != sizeof(rbd_snap_mirror_namespace_t)) {
