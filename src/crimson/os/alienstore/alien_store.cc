...
namespace crimson::os {
    ...
    seastar::future < CollectionRef >
        ...
        return tp->submit([this, cid] {
               ...
               ch = new AlienCollection(c); coll_map[c->cid] = ch;}
               else {
               ch = cp->second;
    ...
    AlienStore::get_attrs_ertr::future < AlienStore::attrs_t >
        AlienStore::get_attrs(CollectionRef ch, const ghobject_t & oid) {
        logger().debug("{}", __func__);
        assert(tp);
    ...
    seastar::future <> AlienStore::do_transaction_no_callbacks(CollectionRef ch,
        ...
        return do_with_op_gate(std::move(txn),
                               ...
                               with_lock([this, ch =
                                      ...
                                      assert(r == 0); return done.get_future();}
                               );}
        );
    }
