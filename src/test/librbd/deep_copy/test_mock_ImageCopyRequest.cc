...
namespace librbd {
    ...
    namespace object_map {
        ...
        DiffRequest < MockTestImageCtx > *DiffRequest <
    ...
    namespace deep_copy {
        ...
        class TestMockDeepCopyImageCopyRequest:public TestMockFixture {
          public:
            ...
            typedef object_map::DiffRequest < librbd::MockTestImageCtx >
                MockDiffRequest;
            ...
            void SetUp() override {
            ...
            } void expect_get_image_size(librbd::
                ...
                EXPECT_CALL(mock_request, send())
                    .WillOnce(Invoke([this, &mock_request, diff_state, r] () {
                                     if (r >= 0) {
                                     *mock_request.object_diff_state =
                                     diff_state;} m_work_queue->
            ...
            bool complete_object_copy(MockObjectCopyRequest &
                ...
                while (mock_object_copy_request.object_contexts.
                       count(object_num) == 0) {
                    if (mock_object_copy_request.cond.wait_for(locker, 10 s) ==
                ...
                if (object_ctx != nullptr) {
                    *object_ctx =
                        mock_object_copy_request.object_contexts[object_num];
                }
                else {
                    m_work_queue->queue(mock_object_copy_request.
                                        object_contexts[object_num], r);
                }
                return true;
            }
        ...
        TEST_F(TestMockDeepCopyImageCopyRequest, SimpleImage) {
            ...
            expect_diff_send(mock_diff_request, {
                             }
                             , -EINVAL);
            expect_get_image_size(mock_src_image_ctx,
                                  1 << m_src_image_ctx->order);
            ...
            ASSERT_TRUE(complete_object_copy
                        (mock_object_copy_request, 0, nullptr, 0));
        ...
        TEST_F(TestMockDeepCopyImageCopyRequest, FastDiffMix) {
            ...
            struct Handler:public librbd::deep_copy::NoOpHandler {
                ...
                } int update_progress(uint64_t object_no,
                                      uint64_t end_object_no) override {
                    EXPECT_THAT(object_no,::testing::
                                AllOf(::testing::Ge(1),::testing::
                                      Le(m_seen->size())));
            ...
            ASSERT_EQ(m_snap_map, wait_for_snap_map(mock_object_copy_request));
            ASSERT_TRUE(complete_object_copy
                        (mock_object_copy_request, 1, nullptr, 0));
            ASSERT_TRUE(complete_object_copy
                        (mock_object_copy_request, 2, nullptr, 0));
            ASSERT_TRUE(complete_object_copy
                        (mock_object_copy_request, 3, nullptr, 0));
            ASSERT_TRUE(complete_object_copy
                        (mock_object_copy_request, 5, nullptr, 0));
            ASSERT_TRUE(complete_object_copy
                        (mock_object_copy_request, 8, nullptr, 0));
            ASSERT_TRUE(complete_object_copy
                        (mock_object_copy_request, 9, nullptr, 0));
            ASSERT_TRUE(complete_object_copy
                        (mock_object_copy_request, 10, nullptr, 0));
            ASSERT_EQ(0, ctx.wait());
        ...
        TEST_F(TestMockDeepCopyImageCopyRequest, OutOfOrder) {
            ...
            ASSERT_EQ(0,
                      _rados.conf_get("rbd_concurrent_management_ops",
                                      max_ops_str));
            ASSERT_EQ(0,
                      _rados.conf_set("rbd_concurrent_management_ops", "10"));
            ...
            for (uint64_t i = 0; i < object_count; ++i) {
                if (i % 10 == 0) {
                    ASSERT_TRUE(complete_object_copy
                                (mock_object_copy_request, i, &copy_contexts[i],
                                 0));
                }
                else {
                    ASSERT_TRUE(complete_object_copy
                                (mock_object_copy_request, i, nullptr, 0));
                }
            }
        ...
        TEST_F(TestMockDeepCopyImageCopyRequest, Cancel_Inflight_Sync) {
            ...
            ASSERT_TRUE(complete_object_copy
                        (mock_object_copy_request, 2, nullptr, 0));
            ASSERT_TRUE(complete_object_copy
                        (mock_object_copy_request, 3, &cancel_ctx, 0));
            ASSERT_TRUE(complete_object_copy
                        (mock_object_copy_request, 4, nullptr, 0));
            ASSERT_TRUE(complete_object_copy
                        (mock_object_copy_request, 5, nullptr, 0));
