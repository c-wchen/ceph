...
TEST(PerfCounters, SimpleTest)
{
    ...
    ASSERT_EQ("{}\n", message);
    ASSERT_EQ("",
              client.do_request("{ \"prefix\": \"counter dump\" }", &message));
    ASSERT_EQ("{}\n", message);
}
...
TEST(PerfCounters, SinglePerfCounters)
{
    ...
    ASSERT_EQ("",
              client.
              do_request("{ \"prefix\": \"perf dump\", \"format\": \"json\" }",
                         &msg));
    ASSERT_EQ(sd
              ("{\"test_perfcounter_1\":{\"element1\":0,"
    ...
    ASSERT_EQ("",
              ...
              do_request("{ \"prefix\": \"perf dump\", \"format\": \"json\" }",
                         &msg));
    ASSERT_EQ(sd
              ("{\"test_perfcounter_1\":{\"element1\":1,\"element2\":0.500000000,"
...
TEST(PerfCounters, MultiplePerfCounters)
{
    ...
    ASSERT_EQ("",
              ...
              do_request("{ \"prefix\": \"perf dump\", \"format\": \"json\" }",
                         &msg));
    ASSERT_EQ(sd
              ("{\"test_perfcounter_1\":{\"element1\":0,\"element2\":0.000000000,\"element3\":"
    ...
    ASSERT_EQ("",
              ...
              do_request("{ \"prefix\": \"perf dump\", \"format\": \"json\" }",
                         &msg));
    ASSERT_EQ(sd
              ("{\"test_perfcounter_1\":{\"element1\":6,\"element2\":0.000000000,\"element3\":"
               "{\"avgcount\":0,\"sum\":0.000000000,\"avgtime\":0.000000000}},\"test_perfcounter_2\":{\"foo\":0,\"bar\":0.000000000}}"),
              msg);
    ...
    ASSERT_EQ("",
              ...
              do_request("{ \"prefix\": \"perf dump\", \"format\": \"json\" }",
                         &msg));
    ASSERT_EQ(sd
              ("{\"test_perfcounter_1\":{\"element1\":13,\"element2\":0.000000000,\"element3\":"
               "{\"avgcount\":0,\"sum\":0.000000000,\"avgtime\":0.000000000}},\"test_perfcounter_2\":{\"foo\":0,\"bar\":0.000000000}}"),
              msg);
    ...
    ASSERT_EQ("",
              ...
              do_request("{ \"prefix\": \"perf dump\", \"format\": \"json\" }",
                         &msg));
    ASSERT_EQ(sd
              ("{\"test_perfcounter_1\":{\"element1\":13,\"element2\":0.000000000,"
...
TEST(PerfCounters, ResetPerfCounters)
{
    ...
    ASSERT_EQ("",
              client.
              do_request
              ("{ \"prefix\": \"perf reset\", \"var\": \"all\", \"format\": \"json\" }",
               &msg));
    ...
    ASSERT_EQ("",
              client.
              do_request
              ("{ \"prefix\": \"perf reset\", \"var\": \"test_perfcounter_1\", \"format\": \"json\" }",
               &msg));
