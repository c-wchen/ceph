...
namespace rbd {
    namespace mirror {
        ...
        using librbd::util::unique_lock_name;
         ...
         template < typename I >
            ImageSync < I >::ImageSync(I * local_image_ctx,
                                       I * remote_image_ctx, SafeTimer * timer,
                                       Mutex * timer_lock,
        ...
        :BaseRequest("rbd::mirror::ImageSync", local_image_ctx->cct, on_finish),
            ...
            m_remote_image_ctx(remote_image_ctx), m_timer(timer),
            m_timer_lock(timer_lock), m_mirror_uuid(mirror_uuid),
        ...
        template < typename I >
            ...
            Context *ctx = create_context_callback <
                ImageSync < I >,
                &ImageSync < I >::handle_prune_catch_up_sync_point > (this);
            SyncPointPruneRequest < I > *request =
                SyncPointPruneRequest < I >::create(m_remote_image_ctx, false,
        ...
        template < typename I > void ImageSync < I >::send_create_sync_point() {
            ...
            Context *ctx = create_context_callback <
                ImageSync < I >,
                &ImageSync < I >::handle_create_sync_point > (this);
            SyncPointCreateRequest < I > *request =
                SyncPointCreateRequest < I >::create(m_remote_image_ctx,
                                                     m_mirror_uuid, m_journaler,
                                                     m_client_meta, ctx);
            request->send();
        }
        ...
        template < typename I > void ImageSync < I >::send_copy_snapshots() {
            m_lock.Lock();
            if (m_canceled) {
                m_lock.Unlock();
                finish(-ECANCELED);
            ...
            Context *ctx = create_context_callback <
                ImageSync < I >,
                &ImageSync < I >::handle_copy_snapshots > (this);
            m_snapshot_copy_request =
                SnapshotCopyRequest < I >::create(m_local_image_ctx,
                                                  m_remote_image_ctx,
                                                  &m_snap_map, m_journaler,
                                                  m_client_meta, m_work_queue,
                                                  ctx);
        ...
        template < typename I >
            ...
            if (r == -ECANCELED) {
                ...
                derr << ": failed to copy snapshot metadata: " <<
                    cpp_strerror(r) << dendl;
                finish(r);
                return;
            }
        ...
        template < typename I > void ImageSync < I >::send_copy_image() {
            ...
            m_image_copy_request =
                ImageCopyRequest < I >::create(m_local_image_ctx,
                                               m_remote_image_ctx, m_timer,
                                               m_timer_lock, m_journaler,
                                               m_client_meta,
                                               &m_client_meta->sync_points.
                                               front(), ctx, m_progress_ctx);
        ...
        template < typename I > void ImageSync < I >::send_copy_object_map() {
            ...
            auto snap_id_it = m_local_image_ctx->snap_ids.find({ cls::rbd::
        ...
        template < typename I > void ImageSync < I >::send_refresh_object_map() {
            dout(20) << dendl;
            ...
            Context *ctx = create_context_callback <
                ImageSync < I >,
                &ImageSync < I >::handle_refresh_object_map > (this);
        ...
        template < typename I > void ImageSync < I >::send_prune_sync_points() {
            ...
            Context *ctx = create_context_callback <
                ImageSync < I >,
                &ImageSync < I >::handle_prune_sync_points > (this);
            SyncPointPruneRequest < I > *request =
                SyncPointPruneRequest < I >::create(m_remote_image_ctx, true,
                                                    m_journaler, m_client_meta,
                                                    ctx);
            request->send();
        }
        ...
        template < typename I > void ImageSync < I >::send_copy_metadata() {
            dout(20) << dendl;
            update_progress("COPY_METADATA");

            Context *ctx = create_context_callback <
                ImageSync < I >,
                &ImageSync < I >::handle_copy_metadata > (this);
            auto request =
                MetadataCopyRequest < I >::create(m_local_image_ctx,
        ...
        template < typename I >
            ...
            dout(20) << ": r=" << r << dendl;
            if (r < 0) {
                derr << ": failed to copy metadata: " << cpp_strerror(r) <<
                    dendl;
                finish(r);
                return;
            }
