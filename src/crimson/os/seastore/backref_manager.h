 ...
 */
   ...
   */
        ...
        using get_mappings_ret =
            get_mappings_iertr::future < backref_pin_list_t >;
        virtual get_mappings_ret get_mappings(Transaction & t, paddr_t offset,
                                              paddr_t end) = 0;
   ...
   */
        ...
        virtual get_mapping_ret get_mapping(Transaction & t,
                                            paddr_t offset) = 0;
   ...
   */
        ...
        virtual new_mapping_ret new_mapping(Transaction & t,
                                            paddr_t key,
                                            extent_len_t len,
                                            laddr_t val,
   ...
   */
        ...
        using init_cached_extent_ret =
            init_cached_extent_iertr::future < bool >;
        virtual init_cached_extent_ret init_cached_extent(Transaction & t,
                                                          CachedExtentRef e) =
            0;

        virtual Cache::backref_entry_query_mset_t
            get_cached_backref_entries_in_range(paddr_t start, paddr_t end) = 0;

        using retrieve_backref_extents_in_range_iertr = base_iertr;
        using retrieve_backref_extents_in_range_ret =
            retrieve_backref_extents_in_range_iertr::future < std::vector <
            CachedExtentRef >>;
        virtual retrieve_backref_extents_in_range_ret
            retrieve_backref_extents_in_range(Transaction & t, paddr_t start,
                                              paddr_t end) = 0;

        virtual void cache_new_backref_extent(paddr_t paddr,
                                              paddr_t key,
                                              extent_types_t type) = 0;
   ...
   */
        ...
        virtual merge_cached_backrefs_ret merge_cached_backrefs(Transaction & t,
                                                                const
                                                                journal_seq_t &
                                                                limit,
                                                                const uint64_t
   ...
   */
        ...
        virtual remove_mapping_ret remove_mapping(Transaction & t,
                                                  paddr_t offset) = 0;

        using check_child_trackers_ret = base_iertr::future <>;
        virtual check_child_trackers_ret check_child_trackers(Transaction & t) =
            0;
   ...
   */
        ...
        virtual scan_mapped_space_ret scan_mapped_space(Transaction & t,
                                                        scan_mapped_space_func_t
                                                        && f) = 0;
