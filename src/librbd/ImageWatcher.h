...
namespace librbd {
   ...
   template < typename ImageCtxT = ImageCtx > class ImageWatcher:public Watcher
    {
        friend struct watcher::util::HandlePayloadVisitor < ImageWatcher <
            ImageCtxT >>;
      ...
      public:
        ...
        void notify_resize(uint64_t request_id, uint64_t size,
                           ...
                           Context * on_finish);
        void notify_snap_create(const cls::rbd::
        ...
        void notify_snap_rename(const snapid_t & src_snap_id,
                                ...
                                Context * on_finish);
        void notify_snap_remove(const cls::rbd::
                                SnapshotNamespace & snap_namespace,
                                const std::string & snap_name,
                                Context * on_finish);
        void notify_snap_protect(const cls::rbd::
                                 SnapshotNamespace & snap_namespace,
                                 const std::string & snap_name,
                                 Context * on_finish);
        void notify_snap_unprotect(const cls::rbd::
                                   SnapshotNamespace & snap_namespace,
                                   const std::string & snap_name,
                                   Context * on_finish);
