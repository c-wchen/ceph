...
class RGWPutACLs_ObjStore_S3:public RGWPutACLs_ObjStore {
  public:
    ...
    int get_policy_from_state(RGWRados * store, struct req_state *s,
...
class RGWHandler_Auth_S3:public RGWHandler_REST {
  ...
  public:
    ...
    int init(RGWRados * store,
             struct req_state *s, rgw::io::BasicClient * cio) override;
...
class RGWHandler_REST_S3:public RGWHandler_REST {
    ...
    const rgw::auth::StrategyRegistry & auth_registry;
  public:
    static int init_from_header(struct req_state *s, int default_formatter,
...
static inline int valid_s3_bucket_name(const string & name, bool relaxed =
                                       false)
{
        ...
        namespace s3 {
            ...
            class AWSEngine:public rgw::auth::Engine {
              public:
                class VersionAbstractor {
                    ...
                    static constexpr size_t SIGNATURE_MAX_SIZE =
                        ceph::max(DIGEST_SIZE_V2,
                                  DIGEST_SIZE_V4) * 2 + sizeof('\0');
                  ...
                  public:
                    ...
                    virtual auth_data_t get_auth_data(const req_state *
                                                      s) const = 0;
                };
              ...
              protected:
                ...
                virtual result_t authenticate(const boost::
            ...
            class LDAPEngine:public AWSEngine {
              ...
              protected:
                ...
                auth_info_t get_creds_info(const rgw::
                                           RGWToken & token) const noexcept;
              ...
              public:
                 LDAPEngine(CephContext * const cct,
                            ...
                            const apl_factory)
                :AWSEngine(cct, ver_abstractor), store(store),
            ...
            class S3AuthFactory:public rgw::auth::RemoteApplier::Factory,
              ...
              public:
                ...
                :store(store), implicit_tenant_context(implicit_tenant_context) {
                    ...
                    return aplptr_t(new rgw::auth::
                                    RemoteApplier(cct, store,
                                                  std::move(acl_alg), info,
                    ...
                    return aplptr_t(new rgw::auth::
                                    LocalApplier(cct, user_info, subuser));
            }};
#endif
