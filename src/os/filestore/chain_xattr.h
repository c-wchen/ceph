...
static inline int sys_fgetxattr(int fd, const char *name, void *val,
                                size_t size)
{
...
static inline int sys_getxattr(const char *fn, const char *name, void *val,
                               size_t size)
{
...
static inline int sys_setxattr(const char *fn, const char *name,
...
static inline int sys_fsetxattr(int fd, const char *name, const void *val,
                                size_t size)
{
...
template < bool skip_chain_cleanup = false, bool ensure_single_attr = false >
    int chain_setxattr(const char *fn, const char *name, const void *val,
                       size_t size)
{
    int i = 0, pos = 0;
    ...
    static_assert(!skip_chain_cleanup || ensure_single_attr,
