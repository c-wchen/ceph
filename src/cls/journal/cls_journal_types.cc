...
} void ObjectPosition::generate_test_instances(std::list <
        ObjectPosition * > &o)
{
...
void ObjectSetPosition::generate_test_instances(std::list <
        ObjectSetPosition *
        > &o)
{
                         ...
                         const ObjectSetPosition &object_set_position)
{
    os << "[positions=[";
    std::string delim;
    for (auto &object_position : object_set_position.
         object_positions) {
