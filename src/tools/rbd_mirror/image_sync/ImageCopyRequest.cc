    ...
    namespace mirror {
        namespace image_sync {
            ...
            using librbd::util::unique_lock_name;
             ...
             template < typename I >
                ImageCopyRequest < I >::ImageCopyRequest(I * local_image_ctx,
                                                         I * remote_image_ctx,
                                                         SafeTimer * timer,
                                                         Mutex * timer_lock,
                                                         Journaler * journaler,
            ...
            :BaseRequest("rbd::mirror::image_sync::ImageCopyRequest",
                ...
                m_timer_lock(timer_lock), m_journaler(journaler),
            ...
            template < typename I >
                ...
                uint64_t max_objects = m_client_meta->sync_object_count;
                {
                  ...
                  for (auto snap_id:m_remote_image_ctx->
                         snaps) {
                        max_objects =
                            std::max(max_objects,
                                     m_remote_image_ctx->
                ...
                Context *ctx = create_context_callback <
                    ImageCopyRequest < I >,
                    &ImageCopyRequest < I >::handle_update_max_object_count >
                    (this);
                m_journaler->update_client(client_data_bl, ctx);
            }

            template < typename I >
                void ImageCopyRequest <
                I >::handle_update_max_object_count(int r) {
                dout(20) << ": r=" << r << dendl;
                ...
                m_client_meta->sync_object_count =
            ...
            template < typename I >
                ...
                bool complete;
                {
                    Mutex::Locker locker(m_lock);
                    for (int i = 0;
                         i < cct->_conf->get_val < int64_t >
                         ("rbd_concurrent_management_ops"); ++i) {
            ...
            template < typename I >
                ...
                Context *ctx = create_context_callback <
                    ImageCopyRequest < I >,
                    &ImageCopyRequest < I >::handle_object_copy > (this);
                ObjectCopyRequest < I > *req =
                    ObjectCopyRequest < I >::create(m_local_image_ctx,
                                                    m_remote_image_ctx,
                                                    &m_snap_map, ono, ctx);
                req->send();
            }
            ...
            template < typename I >
                ...
                bool complete;
                {
                    ...
                    if (r < 0) {
                        derr << ": object copy failed: " << cpp_strerror(r) <<
                            dendl;
                        if (m_ret_val == 0) {
                            m_ret_val = r;
                        }
                ...
                update_progress("COPY_OBJECT " + stringify(percent) + "%",
                                false);
            ...
            template < typename I >
                ...
                Context *ctx = create_context_callback <
                    ImageCopyRequest < I >,
                    &ImageCopyRequest < I >::handle_update_sync_point > (this);
                m_journaler->update_client(client_data_bl, ctx);
            }
            ...
            template < typename I >
                ...
                if (r < 0) {
                    *m_client_meta = m_client_meta_copy;
                    lderr(cct) << ": failed to update client data: " <<
                        cpp_strerror(r)
                        << dendl;
                }
                ...
                bool complete;
                {
                    ...
                    complete = m_current_ops == 0 || m_canceled
                        || m_ret_val < 0;
            ...
            template < typename I >
                ...
                Context *ctx = create_context_callback <
                    ImageCopyRequest < I >,
                    &ImageCopyRequest < I >::handle_flush_sync_point > (this);
                m_journaler->update_client(client_data_bl, ctx);
            }
            ...
            template < typename I >
                ...
                if (m_snap_map.empty()) {
                    derr << ": failed to map snapshots within boundary" <<
                        dendl;
                    return -EINVAL;
                }
            ...
            template < typename I >
                ...
                if (m_progress_ctx) {
                    m_progress_ctx->update_progress("IMAGE_COPY/" + description,
                                                    flush);
                }
            }
