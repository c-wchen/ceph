...
public:
    ...
    int init_index(const DoutPrefixProvider *dpp, RGWBucketInfo &bucket_info,
                   const rgw::
                   bucket_index_layout_generation &idx_layout) override;
    ...
    int open_bucket_index_shard(const DoutPrefixProvider *dpp,
                                ...
                                RGWSI_RADOS::Obj *bucket_obj, int *shard_id);
    ...
    int open_bucket_index(const DoutPrefixProvider *dpp,
                          ...
                          RGWSI_RADOS::Pool *index_pool, std::map < int,
                          std::string > *bucket_objs, std::map < int,
                          std::string > *bucket_instance_ids);
};
