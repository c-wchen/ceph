...
COMMAND("pg stat", "show placement group status.", "pg", "r", "cli,rest")
    ...
    COMMAND("pg dump_stuck "
        ...
        "show information about stuck pgs", "pg", "r", "cli,rest")
    COMMAND("pg debug "
    ...
    COMMAND("pg force-recovery name=pgid,type=CephPgid,n=N",
        "force recovery of <pgid> first", "pg", "rw", "cli,rest")
    COMMAND("pg force-backfill name=pgid,type=CephPgid,n=N",
        "force backfill of <pgid> first", "pg", "rw", "cli,rest")
    COMMAND("pg cancel-force-recovery name=pgid,type=CephPgid,n=N",
        "restore normal recovery priority of <pgid>", "pg", "rw", "cli,rest")
    COMMAND("pg cancel-force-backfill name=pgid,type=CephPgid,n=N",
        "restore normal backfill priority of <pgid>", "pg", "rw", "cli,rest")
// stuff in osd namespace
    COMMAND("osd perf",
        "print dump of OSD perf summary stats", "osd", "r", "cli,rest")
    COMMAND("osd df "
    ...
    COMMAND("service dump", "dump service map", "service", "r", "cli,rest")
    COMMAND("service status", "dump service state", "service", "r", "cli,rest")
