...
class RGWUserPermHandler
{
    ...
    struct Init: public RGWGenericAsyncCR::Action {
        ...
        } int operate() override
        {
            ...
            info->identity = rgw::auth::transform_old_authinfo(sync_env->cct, uid, RGW_PERM_FULL_CONTROL,
                                     ...
                                     bufferlist > &bucket_attrs)
{
    ...
    ps.emplace(sync_env->cct, info->env, info->identity.get(), bucket_info, info->identity->get_perm_mask(),
