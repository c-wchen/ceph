...
namespace librbd {
    ...
    namespace image {
        ...
        DetachChildRequest < MockTestImageCtx > *DetachChildRequest <
            MockTestImageCtx >::s_instance;

        template <> class PreRemoveRequest < MockTestImageCtx > {
          public:
            static PreRemoveRequest *s_instance;
            static PreRemoveRequest *create(MockTestImageCtx * image_ctx,
        ...
        PreRemoveRequest < MockTestImageCtx > *PreRemoveRequest <
    ...
    namespace journal {
    ...
    } // namespace journal namespace operation {

        template <> class TrimRequest < MockTestImageCtx > {
          public:
            static TrimRequest *s_instance;
            static TrimRequest *create(MockTestImageCtx & image_ctx,
                                       Context * on_finish,
        ...
        TrimRequest < MockTestImageCtx > *TrimRequest <
            MockTestImageCtx >::s_instance;
    ...
    namespace mirror {
        ...
        template <> class DisableRequest < MockTestImageCtx > {
          public:
            ...
            static DisableRequest *create(MockTestImageCtx * image_ctx,
        ...
        DisableRequest < MockTestImageCtx > *DisableRequest <
            MockTestImageCtx >::s_instance;
    ...
    namespace image {
        ...
        class TestMockImageRemoveRequest:public TestMockFixture {
          public:
            ...
            typedef DetachChildRequest < MockTestImageCtx >
                MockDetachChildRequest;
            typedef librbd::operation::TrimRequest < MockTestImageCtx >
                MockTrimRequest;
