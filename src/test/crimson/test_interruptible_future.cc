    ...
    :interrupt(interrupt) {
        ...
        if (interrupt) {
            return seastar::futurize <
                T >::make_exception_future(test_interruption());
        }
        else {
    ...
    run_async([] {
              ...
              interruptor::with_interruption([] {
                                             ...
                                             .then_interruptible([] {
                                                                 std::
                                                                 cout <<
                                                                 "test seastar future do_for_each"
                                                                 << std::endl;
                                                                 std::vector <
                                                                 int >vec = {
                                                                 1, 2};
                                                                 ...
                                                                 do_with(std::
                                                                  ...
                                                                  std::
                                                                  cout <<
                                                                  "test interruptible seastar future do_for_each"
                                                                  << std::endl;
                                                                  std::vector <
                                                                  int >vec = {
                                                                  1, 2};
                                                                  ...
                                                                  std::
                                                                  cout <<
                                                                  "test interruptible seastar future repeat"
                                                                  << std::endl;
                                                                  return
                                                                  interruptor::
                                                                  repeat([] {
                                                                  ...
                                                                  std::
                                                                  cout <<
                                                                  "test errorated future do_for_each"
                                                                  << std::endl;
                                                                  std::vector <
                                                                  int >vec;
