...
public:
    ...
    BinnedLRUHandle **FindPointer(const rocksdb::Slice &key,
                                  uint32_t hash);
...
{
public:
    BinnedLRUCacheShard(CephContext *c, size_t capacity,
    ...
    virtual DeleterFn GetDeleter(rocksdb::Cache::Handle *
                                 handle) const override;

    void TEST_GetLRUList(BinnedLRUHandle **lru,
