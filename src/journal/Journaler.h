    ...
    class Journaler {
      public:
        ...
        static std::string object_oid_prefix(int pool_id,
         ...
         Journaler(librados::IoCtx & header_ioctx,
                   const std::string & journal_id,
                   const std::string & client_id, const Settings & settings);
         Journaler(ContextWQ * work_queue, SafeTimer * timer,
        ...
        bool try_pop_front(ReplayEntry * replay_entry, uint64_t * tag_tid =
                           nullptr);
        void stop_replay();
      ...
      private:
        ...
        void set_up(ContextWQ * work_queue, SafeTimer * timer,
                    Mutex * timer_lock, librados::IoCtx & header_ioctx,
