...
class XMLObjIter {
  ...
  public:
     XMLObjIter();
    ~XMLObjIter();
    void set(const XMLObjIter::map_iter_t & _cur,
...
class RGWXMLDecoder {
  public:
    ...
    template < class T >
        static bool decode_xml(const char *name, T & val, XMLObj * obj,
                               bool mandatory = false);

    template < class C >
        static bool decode_xml(const char *name, C & container,
                               void (*cb) (C &, XMLObj * obj), XMLObj * obj,
                               bool mandatory = false);

    template < class T >
        static void decode_xml(const char *name, T & val, T & default_val,
                               XMLObj * obj);
};
