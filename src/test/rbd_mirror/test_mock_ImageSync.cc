...
namespace rbd {
    namespace mirror {
        ...
        template <> struct InstanceWatcher <librbd::MockTestImageCtx > {
            MOCK_METHOD2(notify_sync_request,
        ...
        namespace image_sync {
            ...
            template <> class ImageCopyRequest < librbd::MockTestImageCtx > {
              public:
                ...
                static ImageCopyRequest *create(librbd::MockTestImageCtx *
                                                local_image_ctx,
            ...
            template <> class MetadataCopyRequest < librbd::MockTestImageCtx > {
              public:
                ...
                static MetadataCopyRequest *create(librbd::MockTestImageCtx *
                                                   local_image_ctx,
                                                   librbd::MockTestImageCtx *
                                                   remote_image_ctx,
                                                   Context * on_finish) {
            ...
            template <> class SnapshotCopyRequest < librbd::MockTestImageCtx > {
              public:
                ...
                static SnapshotCopyRequest *create(librbd::MockTestImageCtx *
                                                   local_image_ctx,
                                                   librbd::MockTestImageCtx *
                                                   remote_image_ctx,
                                                   SnapshotCopyRequest <
                                                   librbd::ImageCtx >::SnapMap *
                                                   snap_map,
                                                   journal::MockJournaler *
                                                   journaler,
                                                   librbd::journal::
            ...
            template <>
              ...
              public:
                ...
                static SyncPointCreateRequest *create(librbd::MockTestImageCtx *
                                                      remote_image_ctx,
                                                      const std::
                                                      string & mirror_uuid,
                                                      journal::MockJournaler *
            ...
            template <> class SyncPointPruneRequest < librbd::MockTestImageCtx > {
              public:
                ...
                static SyncPointPruneRequest *create(librbd::MockTestImageCtx *
                                                     remote_image_ctx,
                                                     bool sync_complete,
                                                     journal::MockJournaler *
                                                     journaler,
            ...
            ImageCopyRequest < librbd::MockTestImageCtx > *ImageCopyRequest <
                librbd::MockTestImageCtx >::s_instance = nullptr;
            MetadataCopyRequest < librbd::MockTestImageCtx >
                *MetadataCopyRequest < librbd::MockTestImageCtx >::s_instance =
                nullptr;
            SnapshotCopyRequest < librbd::MockTestImageCtx >
                *SnapshotCopyRequest < librbd::MockTestImageCtx >::s_instance =
                nullptr;
        ...
        class TestMockImageSync:public TestMockFixture {
          public:
            ...
            typedef InstanceWatcher < librbd::MockTestImageCtx >
                MockInstanceWatcher;
            typedef image_sync::ImageCopyRequest < librbd::MockTestImageCtx >
                MockImageCopyRequest;
            typedef image_sync::MetadataCopyRequest < librbd::MockTestImageCtx >
                MockMetadataCopyRequest;
            typedef image_sync::SnapshotCopyRequest < librbd::MockTestImageCtx >
                MockSnapshotCopyRequest;
            typedef image_sync::SyncPointCreateRequest <
                librbd::MockTestImageCtx > MockSyncPointCreateRequest;
            typedef image_sync::SyncPointPruneRequest <
                librbd::MockTestImageCtx > MockSyncPointPruneRequest;
            ...
            void SetUp() override {
                ...
                ASSERT_EQ(0,
                          open_image(m_local_io_ctx, m_image_name,
                                     &m_local_image_ctx));
            } void expect_start_op(librbd::
                                   MockExclusiveLock & mock_exclusive_lock) {
                EXPECT_CALL(mock_exclusive_lock,
                            start_op(_)).WillOnce(ReturnNew < FunctionContext >
                                                  ([](int) {
                                                   }));
            }
            ...
            void expect_notify_sync_request(MockInstanceWatcher &
                ...
                EXPECT_CALL(mock_instance_watcher,
                            notify_sync_request(sync_id, _))
                    .
                    WillOnce(Invoke
                             ([this, r] (const std::string &,
                                         Context * on_sync_start) {
                              m_threads->work_queue->queue(on_sync_start,
                                                           r);}));
            }
            ...
            void expect_create_sync_point(librbd::
                                          MockTestImageCtx &
                ...
                EXPECT_CALL(mock_sync_point_create_request, send())
                    ...
                    WillOnce(Invoke
                             ([this, &mock_local_image_ctx,
                              ...
                              m_client_meta.sync_points.
                              emplace_back(cls::rbd::UserSnapshotNamespace(),
                                           "snap1", boost::none);}
                              m_threads->work_queue->
                              queue(mock_sync_point_create_request.on_finish,
                                    r);}
                             )) ;
            }

            void expect_copy_snapshots(MockSnapshotCopyRequest &
                                       mock_snapshot_copy_request, int r) {
                EXPECT_CALL(mock_snapshot_copy_request, send())
                    .WillOnce(Invoke([this, &mock_snapshot_copy_request, r] () {
                                     m_threads->work_queue->
                                     queue(mock_snapshot_copy_request.on_finish,
                                           r);}));
            }

            void expect_copy_image(MockImageCopyRequest &
                                   mock_image_copy_request, int r) {
                EXPECT_CALL(mock_image_copy_request, send())
                    .WillOnce(Invoke([this, &mock_image_copy_request, r] () {
                                     m_threads->work_queue->
                                     queue(mock_image_copy_request.on_finish,
                                           r);}));
            }

            void expect_copy_metadata(MockMetadataCopyRequest &
                                      mock_metadata_copy_request, int r) {
                EXPECT_CALL(mock_metadata_copy_request, send())
                    .WillOnce(Invoke([this, &mock_metadata_copy_request, r] () {
                                     m_threads->work_queue->
                                     queue(mock_metadata_copy_request.on_finish,
                                           r);}));
            }

            void expect_rollback_object_map(librbd::
            ...
            void expect_prune_sync_point(MockSyncPointPruneRequest &
                                         mock_sync_point_prune_request,
                                         bool sync_complete, int r) {
                EXPECT_CALL(mock_sync_point_prune_request, send())
                    .
                    WillOnce(Invoke
                             ([this, &mock_sync_point_prune_request,
                               sync_complete, r] () {
                              ASSERT_EQ(sync_complete,
                                        mock_sync_point_prune_request.
                                        sync_complete);
                              if (r == 0
                                  && !m_client_meta.sync_points.empty()) {
                              if (sync_complete) {
                              ...
                              m_threads->work_queue->
                              queue(mock_sync_point_prune_request.on_finish,
                                    r);}
                             )) ;
            }

            MockImageSync *create_request(librbd::
                                          MockTestImageCtx &
                                          ...
                                          mock_instance_watcher,
                                          Context * ctx) {
                return new MockImageSync(&mock_local_image_ctx,
                                         &mock_remote_image_ctx,
                                         m_threads->timer,
                                         &m_threads->timer_lock, "mirror-uuid",
        ...
        TEST_F(TestMockImageSync, SimpleSync) {
            ...
            expect_create_sync_point(mock_local_image_ctx,
                                     mock_sync_point_create_request, 0);
        ...
        TEST_F(TestMockImageSync, CancelNotifySyncRequest) {
            ...
            EXPECT_CALL(mock_instance_watcher,
                ...
                WillOnce(Invoke
                         ([this, &on_sync_start,
                           &notify_sync_ctx] (const std::string &,
                                              Context * ctx) {
                          on_sync_start = ctx; notify_sync_ctx.complete(0);}));
            EXPECT_CALL(mock_instance_watcher,
