...
namespace librbd {
            ...
            struct ReplayerListener;
             ...
             template < typename ImageCtxT > class StateBuilder {
              public:
                ...
                virtual cls::rbd::
                    MirrorImageMode get_mirror_image_mode() const = 0;

                virtual image_sync::SyncPointHandler *
                    create_sync_point_handler() = 0;
                ...
                virtual BaseRequest *create_local_image_request(Threads <
                                                                ImageCtxT >
                                                                *threads,
                                                                librados::
                                                                IoCtx &
                ...
                virtual BaseRequest *create_prepare_replay_request(const std::
                                                                   string &
                                                                   local_mirror_uuid,
                                                                   ProgressContext
                                                                   *
                ...
                virtual Replayer *create_replayer(Threads < ImageCtxT >
                                                  *threads,
    ...
    // namespace rbd
    extern template class rbd::mirror::image_replayer::StateBuilder <
    librbd::ImageCtx >;
