...
class SnapClient:public MDSTableClient {
  public:
    ...
    void prepare_create(inodeno_t dirino, boost::string_view name,
                        utime_t stamp, version_t * pstid, bufferlist * pbl,
    ...
    void prepare_destroy(inodeno_t ino, snapid_t snapid, version_t * pstid,
                         bufferlist * pbl, MDSInternalContextBase * onfinish) {
        bufferlist bl;
    ...
    void prepare_update(inodeno_t ino, snapid_t snapid, boost::string_view name,
                        utime_t stamp, version_t * pstid, bufferlist * pbl,
                        MDSInternalContextBase * onfinish) {
        bufferlist bl;
