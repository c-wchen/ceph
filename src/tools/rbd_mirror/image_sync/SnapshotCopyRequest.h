...
namespace journal {
    ...
    namespace mirror {
        namespace image_sync {
          ...
          template < typename ImageCtxT = librbd::ImageCtx > class SnapshotCopyRequest:public BaseRequest
            {
              public:
                ...
                static SnapshotCopyRequest *create(ImageCtxT * local_image_ctx,
                                                   ...
                                                   Context * on_finish) {
                    return new SnapshotCopyRequest(local_image_ctx,
                                                   remote_image_ctx, snap_map,
                                                   journaler, client_meta,
                                                   work_queue, on_finish);
                } SnapshotCopyRequest(ImageCtxT * local_image_ctx,
                                      ImageCtxT * remote_image_ctx,
   ...
   */
                ...
                typedef std::map < librados::snap_t,
                    librados::snap_t > SnapSeqs;
                ...
                int validate_parent(ImageCtxT * image_ctx,
    ...
    // namespace rbd
    extern template class rbd::mirror::image_sync::SnapshotCopyRequest <
    librbd::ImageCtx >;
