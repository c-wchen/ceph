...
namespace librbd {
    ...
    namespace migration {
        ...
        HttpClient < MockTestImageCtx > *HttpClient <
    ...
    namespace migration {
        ...
        class TestMockMigrationS3Stream:public TestMockFixture {
          public:
            ...
            void expect_get_size(MockHttpClient & mock_http_client,
                                 uint64_t size, int r) {
            ...
            void expect_read(MockHttpClient & mock_http_client,
                             io::Extents byte_extents, const bufferlist & bl,
                             int r) {
                uint64_t len = 0;
        ...
        TEST_F(TestMockMigrationS3Stream, ProcessRequest) {
            ...
            ASSERT_EQ(1U,
                      request.count(boost::beast::http::field::authorization));
            ASSERT_TRUE(boost::algorithm::
                        starts_with(request
