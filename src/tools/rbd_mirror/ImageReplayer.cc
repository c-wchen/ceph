...
namespace rbd {
    namespace mirror {
          ...
          template < typename I > class ImageReplayerAdminSocketHook:public AdminSocketHook
            {
              ...
              private:
                typedef std::map < std::string,
                    ImageReplayerAdminSocketCommand < I > *,
                    std::less <>> Commands;
        ...
        template < typename I >
            struct ImageReplayer <I >::ReplayerListener:public image_replayer::
            ReplayerListener {
        ...
        template < typename I >
            ImageReplayer < I >::ImageReplayer(librados::IoCtx & local_io_ctx,
                                               const std::
                                               ...
                                               *local_status_updater,
                                               ...
                                               PoolMetaCache *
                                               pool_meta_cache):m_local_io_ctx
            (local_io_ctx), m_local_mirror_uuid(local_mirror_uuid),
            ...
            m_lock(ceph::
                   make_mutex("rbd::mirror::ImageReplayer " +
            ...
            m_image_spec =
                image_replayer::util::compute_image_spec(local_io_ctx,
                                                         global_image_id);
        ...
        template < typename I > void ImageReplayer < I >::bootstrap() {
            ...
            auto request =
                image_replayer::BootstrapRequest < I >::create(m_threads,
                                                               m_local_io_ctx,
                                                               m_remote_image_peer.
                                                               io_ctx,
                                                               m_instance_watcher,
        ...
        template < typename I > void ImageReplayer < I >::start_replay() {
            ...
            m_replayer =
                m_state_builder->create_replayer(m_threads, m_instance_watcher,
                                                 m_local_mirror_uuid,
                                                 m_pool_meta_cache,
                                                 m_replayer_listener);
        ...
        template < typename I >
            ...
            Context *ctx = new LambdaContext([this, r, desc] (int _r){
                                             ...
                                             m_lock};
                                             return
                                             on_start_interrupted(m_lock);}

                                             template < typename I >
                                             bool ImageReplayer <
                                             I >::on_start_interrupted(ceph::
                                                                       mutex &
                                                                       lock) {
                                             ...
                                             I >::stop(Context * on_finish,
                                                       ...
                                                       bool restart) {
                                             dout(10) << "on_finish=" <<
                                             on_finish << ", manual=" << manual
                                             << ", restart=" << restart <<
                                             dendl;
                                             image_replayer::BootstrapRequest <
                                             I > *bootstrap_request = nullptr;
                                             bool shut_down_replay = false;
                                             bool is_stopped = false; {
                                             std::lock_guard locker {
                                             m_lock}; if (!is_running_()) {
                                             if (manual && !m_manual_stop) {
                                             dout(10) << "marking manual" <<
                                             dendl; m_manual_stop = true;}
                                             if (!restart
                                                 && m_restart_requested) {
                                             dout(10) << "canceling restart" <<
                                             dendl;
                                             m_restart_requested = false;}
                                             if (is_stopped_()) {
                                             dout(10) << "already stopped" <<
                                             dendl; is_stopped = true;}
                                             else {
                                             dout(10) <<
                                             "joining in-flight stop" << dendl;
                                             if (on_finish != nullptr) {
                                             m_on_stop_contexts.
                                             push_back(on_finish);}
                                             }
                                             ...
                                             dout(10) << "interrupting replay"
                                             << dendl; shut_down_replay = true;}

                                             ceph_assert(m_on_stop_contexts.
                                                         empty());
                                             if (on_finish != nullptr) {
                                             m_on_stop_contexts.
                                             push_back(on_finish);}
                                             ...
                                             template < typename I >
                                             void ImageReplayer <
                                             I >::on_stop_journal_replay(int r,
                                                                         const
                                                                         std::
                                                                         string
                                                                         & desc)
                                             ...
                                             template < typename I >
                                             void ImageReplayer <
                                             I >::restart(Context * on_finish) {
                                             {
                                             std::lock_guard locker {
                                             m_lock};
                                             m_restart_requested = true;}

                                             auto ctx = new LambdaContext([this,
                                                                           on_finish]
                                                                          (int
                                                                           r) {
                                                                          if (r
                                             ...
                                             ceph_assert(m_update_status_task ==
                                                         nullptr);
                                             ...
                                             void ImageReplayer <
                                             I >::
                                             set_mirror_image_status_update(bool
                                                                            force,
                                                                            const
                                                                            OptionalState
                                                                            &
                                             ...
                                             State state;
                                             std::string state_desc; int last_r;
...
break; default:
                                             ...
                                             *mirror_image_status_state;}
                                             ...
                                             if (m_delete_requested
                                                 ...
                                                 && !m_state_builder->
                                                 local_image_id.empty()) {
                                             ceph_assert(m_state_builder->
                                                         remote_image_id.
                                                         empty());
                                             dout(0) <<
                                             ...
                                             std::swap(delete_requested,
                                                       m_delete_requested);
                                             m_delete_in_progress = true;}

                                             std::swap(resync_requested,
                                                       m_resync_requested);
                                             if (!delete_requested
                                                 && !resync_requested
                                                 && m_last_r == -ENOENT
                                             ...
                                             dendl; unregister_asok_hook = true;
                                             m_finished = true;}
                                             }
                                             ...
                                             << dendl;
                                             auto ctx =
                                             new LambdaContext([this, r] (int) {
                                                               handle_shut_down
                                                               (r);});
                                             ImageDeleter <
                                             I >::trash_move(m_local_io_ctx,
                                                             m_global_image_id,
                                                             resync_requested,
                                                             m_threads->
                                                             work_queue, ctx);
                                             ...
                                             if (on_start != nullptr) {
                                             dout(10) <<
                                             "on start finish complete, r=" << r
                                             << dendl; on_start->complete(r);
                                             r = 0;}
          for (auto ctx:                    on_stop_contexts)
                                             {
                                             dout(10) << "on stop finish " <<
                                             ctx << " complete, r=" << r <<
                                             dendl; ctx->complete(r);}
                                             }
                                             ...
                                             if (m_replayer->
                                                 is_resync_requested()) {
                                             dout(10) << "resync requested" <<
                                             dendl; m_resync_requested = true;
                                             on_stop_journal_replay(0,
                                                                    "resync requested");
                                             return;}

                                             if (!m_replayer->is_replaying()) {
                                             auto error_code =
                                             m_replayer->get_error_code();
                                             ...
                                             dendl;
                                             on_stop_journal_replay(error_code,
                                                                    error_description);
                                             return;}
...
return "Stopped"; default:
                                             ...
                                             template < typename I >
                                             void ImageReplayer <
                                             I >::register_admin_socket_hook() {
                                             ImageReplayerAdminSocketHook < I >
                                             *asok_hook; {
                                             std::lock_guard locker {
                                             m_lock};
                                             ...
                                             auto image_spec =
                                             image_replayer::util::
                                             compute_image_spec(m_local_io_ctx,
                                                                m_local_image_name);
                                             if (m_asok_hook != nullptr
                                                 && m_image_spec ==
                                                 image_spec) {
                                             ...
                                             dout(15) << "old_image_spec=" <<
                                             m_image_spec << ", " <<
                                             "new_image_spec=" << image_spec <<
                                             dendl; m_image_spec = image_spec;
                                             ...
                                             auto ctx =
                                             new
                                             LambdaContext([this, force,
                                                            on_finish] (int) {
                                                           remove_image_status_remote
                                                           (force,
                                                            on_finish);});
                                             if (m_local_status_updater->
                                                 exists(m_global_image_id)) {
                                             dout(15) <<
                                             "removing local mirror image status"
                                             << dendl; if (force) {
                                             m_local_status_updater->
                                             ...
                                             void ImageReplayer <
                                             I >::
                                             remove_image_status_remote(bool
                                                                        force,
                                                                        Context
                                                                        *
                                                                        on_finish)
                                             ...
                                             if (m_remote_image_peer.
                                                 ...
                                                 exists(m_global_image_id)) {
                                             dout(15) <<
                                             "removing remote mirror image status"
                                             << dendl; if (force) {
                                             m_remote_image_peer.
                                             mirror_status_updater->
                                             remove_mirror_image_status
                                             (m_global_image_id, true,
                                              on_finish);}
                                             else {
                                             m_remote_image_peer.
                                             mirror_status_updater->
