...
namespace ceph {
    ...
    class Formatter {
      public:
        ...
        template < typename ... Params >
            static std::unique_ptr < Formatter > create_unique(Params
                                                               && ... params) {
        ...
        /* with attrs */
        virtual void open_array_section_with_attrs(std::string_view name,
                                                   const FormatterAttrs & attrs)
        {
            open_array_section(name);
        }
        virtual void open_object_section_with_attrs(std::string_view name,
    ...
    class JSONFormatter:public Formatter {
      ...
      private:
        ...
        void add_value(std::string_view name, std::string_view val,
                       bool quoted);
    ...
    class XMLFormatter:public Formatter {
      public:
        ...
        /* with attrs */
        void open_array_section_with_attrs(std::string_view name,
                                           const FormatterAttrs & attrs)
            override;
        void open_object_section_with_attrs(std::string_view name,
                                            const FormatterAttrs & attrs)
            override;
