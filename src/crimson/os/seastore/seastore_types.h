...
constexpr sea_time_point get_average_time(const sea_time_point& t1, std::size_t n1,
...
struct trans_writer_stats_t {
    ...
    trans_writer_stats_t &operator+=(const trans_writer_stats_t &o)
    {
