...
namespace librbd {
    ...
    template <> struct ManagedLock <MockTestImageCtx > {
        ...
        void release_lock(Context * on_released) {
            ceph_assert(MockManagedLock::get_instance().m_on_released ==
                        nullptr);
            ...
            Context *release_ctx = new LambdaContext([post_release_ctx] (int r){
                                                     ...
                                                     LambdaContext([this,
                                                                   ...
                                                                   (shutting_down,
                                                                    release_ctx);});
                                                     m_work_queue->
                                                     queue(pre_release_ctx, 0);}

                                                     void reacquire_lock(Context
                                                                         *
                                                                         on_finish)
                                                     {
                                                     MockManagedLock::
                                                     ...
                                                     virtual void post_acquire_lock_handler(int r, Context * on_finish) = 0; virtual void pre_release_lock_handler(bool shutting_down, Context * on_finish) = 0; virtual void post_release_lock_handler(bool shutting_down, int r, Context * on_finish) = 0;};} // namespace librbd

                                                     namespace rbd {
                                                     namespace mirror {

                                                     template <>
                                                     struct Threads <librbd::
                                                     MockTestImageCtx > {
          ...
          :                                         timer_lock(threads->
                                                     ...
                                                     MOCK_METHOD0(destroy, void ()); MOCK_METHOD1(init, void (Context *)); MOCK_METHOD1(shut_down, void (Context *)); MOCK_METHOD1(acked, void (const std::vector < std::string > &)); MOCK_METHOD0(unblock_listener, void ());}; Instances < librbd::MockTestImageCtx > *Instances < librbd::MockTestImageCtx >::s_instance = nullptr;}    // namespace mirror
                                                     }  // namespace rbd
...
#include "tools/rbd_mirror/LeaderWatcher.cc"
      ...
      MOCK_METHOD1(post_acquire_handler, void (Context *)); MOCK_METHOD1(pre_release_handler, void (Context *)); MOCK_METHOD1(update_leader_handler, void (const std::string &)); MOCK_METHOD1(handle_instances_added, void (const InstanceIds &)); MOCK_METHOD1(handle_instances_removed, void (const InstanceIds &));}; MockListener * MockListener::s_instance = nullptr; class TestMockLeaderWatcher:public TestMockFixture
                                                     {
          public:
                                                     typedef Instances <
                                                     librbd::MockTestImageCtx >
                                                     MockInstances;
                                                     typedef LeaderWatcher <
                                                     librbd::MockTestImageCtx >
                                                     MockLeaderWatcher;
                                                     typedef Threads <
                                                     librbd::MockTestImageCtx >
                                                     ...
                                                     WillOnce(CompleteContext
                                                              (r));
                                                     if (r == 0) {
                                                     expect_set_state_post_acquiring
                                                     (mock_managed_lock);}
                                                     }
                                                     ...
                                                     WillOnce(Invoke
                                                              ([on_finish,
                                                               ...
                                                               m_on_released =
                                                               new
                                                               LambdaContext([on_released, on_finish] (int r) {
                                                                             on_released->
                                                                             complete
                                                                             (r);
                                                                             on_finish->
                                                     ...
                                                     (MockInstances &
                                                      mock_instances) {
                                                     EXPECT_CALL(mock_instances,
                                                                 destroy());}

                                                     void
                                                     expect_init(MockInstances &
                                                                 mock_instances,
                                                                 int r) {
                                                     EXPECT_CALL(mock_instances,
                                                                 init(_))
                                                     ...
                                                     (MockManagedLock &
                                                      ...
                                                      mock_listener, int r) {
                                                     expect_is_leader
                                                     (mock_managed_lock, true,
                                                      false);
                                                     EXPECT_CALL(mock_listener,
                                                                 post_acquire_handler
                                                                 (_))
                                                     .
                                                     WillOnce(CompleteContext
                                                              (r));
