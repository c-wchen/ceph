...
{
public:
    static void file_to_extents(CephContext *cct, const file_layout_t *layout,
    ...
    class StripedReadResult
    {
        ...
        std::map < uint64_t, std::pair < ceph::buffer::list,
            uint64_t > >partial;
    ...
    public:
        ...
        void add_partial_result(CephContext *cct, ceph::buffer::list
                                && bl,
                                const striper::
        ...
        void add_partial_sparse_result(CephContext *cct,
                                       ...
                                       uint64_t > &bl_map, uint64_t bl_off,
                                       const std::vector < std::pair < uint64_t,
                                       uint64_t > > &buffer_extents);
        void add_partial_sparse_result(CephContext *cct, ceph::buffer::list
                                       && bl,
                                       const std::vector < std::pair < uint64_t,
                                       uint64_t >> &bl_map, uint64_t bl_off,
                                       const striper::
