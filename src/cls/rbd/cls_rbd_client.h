...
namespace librados {
    ...
    namespace cls_client {
        ...
        int get_immutable_metadata_finish(bufferlist::iterator * it,
                                          ...
                                          uint8_t * order);
        int get_immutable_metadata(librados::IoCtx * ioctx,
        ...
        int get_mutable_metadata_finish(bufferlist::iterator * it,
                                        ...
                                        *lockers, bool * exclusive_lock,
                                        std::string * lock_tag,::SnapContext *
                                        snapc, ParentInfo * parent);
        int get_mutable_metadata(librados::IoCtx * ioctx,
                                 const std::string & oid, bool read_only,
                                 uint64_t * size, uint64_t * features,
                                 uint64_t * incompatible_features,
                                 map < rados::cls::lock::locker_id_t,
                                 rados::cls::lock::locker_info_t > *lockers,
                                 bool * exclusive_lock,
                                 std::string * lock_tag,::SnapContext * snapc,
                                 ParentInfo * parent);
        ...
        int get_data_pool_finish(bufferlist::iterator * it,
                                 int64_t * data_pool_id);
        ...
        int snapshot_timestamp_list(librados::IoCtx * ioctx,
                                    const std::string & oid,
                                    const std::vector < snapid_t > &ids,
                                    std::vector < utime_t > *timestamps);
        ...
        int snapshot_namespace_list_finish(bufferlist::iterator * it,
                                           ...
                                           *namespaces);
        int snapshot_namespace_list(librados::IoCtx * ioctx,
                                    const std::string & oid,
                                    const std::vector < snapid_t > &ids,
        ...
        int dir_get_id_finish(bufferlist::iterator * iter,
                              std::string * image_id);
        ...
        void dir_list_start(librados::ObjectReadOperation * op,
                            const std::string & start, uint64_t max_return);
        int dir_list_finish(bufferlist::iterator * it, map < string,
                            string > *images);
        ...
        int trash_list(librados::IoCtx * ioctx, const std::string & start,
                       uint64_t max_return, map < string,
                       cls::rbd::TrashImageSpec > *entries);
