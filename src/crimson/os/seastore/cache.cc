...
namespace crimson::os::seastore {
    ...
    Cache::retire_extent_ret Cache::retire_extent_addr(Transaction & t,
                                                       paddr_t addr,
                                                       extent_len_t length) {
        ...
        if (result == Transaction::get_extent_ret::PRESENT) {
            ...
            ERRORT("retire {}~{} failed, already retired -- {}", t, addr,
                   length, *ext);
            ceph_abort();
        }
    ...
    void Cache::register_metrics() {
        ...
        std::map < extent_types_t, sm::label_instance > labels_by_ext {
            ...
            extent_types_t::LADDR_INTERNAL, sm::label_instance("ext",
                                                                   "LADDR_INTERNAL")},
            {
            extent_types_t::LADDR_LEAF, sm::label_instance("ext",
                                                               "LADDR_LEAF")}, {
            extent_types_t::DINK_LADDR_LEAF, sm::label_instance("ext",
                                                                    "DINK_LADDR_LEAF")},
            {
            extent_types_t::OMAP_INNER, sm::label_instance("ext",
                                                               "OMAP_INNER")}, {
            extent_types_t::OMAP_LEAF, sm::label_instance("ext", "OMAP_LEAF")},
            {
            extent_types_t::ONODE_BLOCK_STAGED, sm::label_instance("ext",
                                                                       "ONODE_BLOCK_STAGED")},
            {
            extent_types_t::COLL_BLOCK, sm::label_instance("ext",
                                                               "COLL_BLOCK")}, {
            extent_types_t::OBJECT_DATA_BLOCK, sm::label_instance("ext",
                                                                      "OBJECT_DATA_BLOCK")},
            {
            extent_types_t::RETIRED_PLACEHOLDER, sm::label_instance("ext",
                                                                        "RETIRED_PLACEHOLDER")},
            {
            extent_types_t::ALLOC_INFO, sm::label_instance("ext",
                                                               "ALLOC_INFO")}, {
            extent_types_t::JOURNAL_TAIL, sm::label_instance("ext",
                                                                 "JOURNAL_TAIL")},
            {
            extent_types_t::TEST_BLOCK, sm::label_instance("ext",
                                                               "TEST_BLOCK")}, {
            extent_types_t::TEST_BLOCK_PHYSICAL, sm::label_instance("ext",
                                                                        "TEST_BLOCK_PHYSICAL")},
            {
            extent_types_t::BACKREF_INTERNAL, sm::label_instance("ext",
                                                                     "BACKREF_INTERNAL")},
            {
            extent_types_t::BACKREF_LEAF, sm::label_instance("ext",
                                                                 "BACKREF_LEAF")}
        };
      ...
      for (auto &[src, src_label]:labels_by_src) {
            metrics.add_group("cache", {
                              sm::make_counter("trans_created",
                                               ...
                                               sm::
                                               description
                                               ("total number of transaction created"),
                                               {
                                               src_label}
                              ),}
            );
      ...
      for (auto &[src, src_label]:labels_by_src) {
...

        {
          ...
          for (auto &[src, src_label]:labels_by_src) {
                auto & efforts =
                    get_by_src(stats.invalidated_efforts_by_src, src);
              for (auto &[ext, ext_label]:labels_by_ext) {
                    auto & counter =
                        get_by_ext(efforts.num_trans_invalidated, ext);
                    metrics.add_group("cache", {
                                      sm::make_counter("trans_invalidated",
                                                       counter,
                                                       sm::
                                                       description
                                                       ("total number of transaction invalidated"),
                                                       {
                                                       src_label, ext_label}
                                      ),}
                    );
                ...
                if (src == src_t::READ) {
                    ...
                    metrics.add_group("cache", {
                                      sm::make_counter("invalidated_extents",
                                                       ...
                                                       sm::
                                                       description
                                                       ("extents of invalidated transactions"),
                                                       {
                                                       src_label,
                                                       read_effort_label}
                                      ),
                                      sm::
                                      make_counter("invalidated_extent_bytes",
                                                   efforts.read.bytes,
                                                   sm::
                                                   description
                                                   ("extent bytes of invalidated transactions"),
                                                   {
              ...
              for (auto & effort_name:invalidated_effort_names) {
                ...
                metrics.add_group("cache", {
                                  sm::make_counter("invalidated_delta_bytes",
                                                   ...
                                                   sm::
                                                   description
                                                   ("delta bytes of invalidated transactions"),
                                                   {
                                                   src_label}
                                  ),
                                  ...
                                  sm::
                                  make_counter("invalidated_ool_record_bytes",
          ...
          for (auto &[src, src_label]:labels_by_src) {
                ...
                auto & efforts =
                    get_by_src(stats.committed_efforts_by_src, src);
                metrics.add_group("cache", {
                                  ...
                                  ("committed_ool_record_metadata_bytes",
                                   ...
                                   sm::
                                   description
                                   ("bytes of ool-record metadata from committed transactions"),
                                   {
                                   src_label}
                                  ),
                                  sm::
                                  ...
                                  ("committed_inline_record_metadata_bytes",
                                   ...
                                   sm::
                                   description
                                   ("bytes of inline-record metadata from committed transactions"
                  ...
                  for (auto &[ext, ext_label]:labels_by_ext)
                    {
                        ...
                        metrics.add_group("cache", {
                                          sm::make_counter("committed_extents",
                                                           ...
                                                           sm::
                                                           description
                                                           ("extents of committed transactions"),
                                                           {
                                                           src_label,
                                                           effort_label
                                                           (effort_name),
                                          ...
                                          sm::
                                          make_counter("committed_extent_bytes",
                                                       effort.bytes,
                                                       sm::
                                                       description
                                                       ("extent bytes of committed transactions"),
                                                       {
                                                       src_label,
                                                       effort_label
                                                       (effort_name), ext_label}
                                          ),}
                        );
                    }           // ext
                }               // effort_name
              ...
              for (auto &[ext, ext_label]:labels_by_ext) {
                    ...
                    metrics.add_group("cache", {
                                      sm::make_counter("committed_delta_bytes",
                                                       ...
                                                       sm::
                                                       description
                                                       ("delta bytes of committed transactions"),
                                                       {
                                                       src_label, ext_label}
                                      ),}
                    );
            ...
            metrics.add_group("cache", {
                              sm::make_counter("trans_read_successful",
                                               ...
                                               sm::
                                               description
                                               ("total number of successful read transactions")
                              ), sm::make_counter("successful_read_extents",
                                                  stats.success_read_efforts.
                                                  read.num,
                                                  sm::
                                                  description
                                                  ("extents of successful read transactions")
                              ),
                              sm::make_counter("successful_read_extent_bytes",
                                               stats.success_read_efforts.read.
                                               bytes,
                                               sm::
                                               description
                                               ("extent bytes of successful read transactions")
                              ),}
            );
        }
   ...
   */
        metrics.add_group("cache", {
                          sm::make_counter("cached_extents",[this] {
                                           return extents.size();}
                                           ,
                                           sm::
                                           description
                                           ("total number of cached extents")
                          ), sm::make_counter("cached_extent_bytes",[this] {
                                              return extents.get_bytes();}
                                              ,
                                              sm::
                                              description
                                              ("total bytes of cached extents")
                          ), sm::make_counter("dirty_extents",[this] {
                                              return dirty.size();}
                                              ,
                                              sm::
                                              description
                                              ("total number of dirty extents")
                          ), sm::make_counter("dirty_extent_bytes",
                                              stats.dirty_bytes,
                                              sm::
                                              description
                                              ("total bytes of dirty extents")
                          ), sm::make_counter("cache_lru_size_bytes",[this] {
                                              return lru.
                                              get_current_contents_bytes();}
                                              ,
                                              sm::
                                              description
                                              ("total bytes pinned by the lru")
                          ), sm::make_counter("cache_lru_size_extents",[this] {
                                              return lru.
                                              get_current_contents_extents();}
                                              ,
                                              sm::
                                              description
                                              ("total extents pinned by the lru")
                          ),}
        );
   ...
   */
        ...
        auto register_tree_metrics =
            [&labels_by_src, &onode_label, &omap_label,
             this] (const sm::label_instance & tree_label,
                    uint64_t & tree_depth,
                    int64_t & tree_extents_num,
                    counter_by_src_t < tree_efforts_t > &committed_tree_efforts,
                    counter_by_src_t < tree_efforts_t >
                    &invalidated_tree_efforts){
            metrics.add_group("cache",
                              {
                               sm::make_counter("tree_depth",
                                                tree_depth,
                                                sm::
                                                description
                                                ("the depth of tree"),
                               ...
                               sm::make_counter("tree_extents_num",
                                                tree_extents_num,
                                                sm::
                                                description
                                                ("num of extents of the tree"),
                                                {tree_label}
                               )
                               }
            );
          for (auto &[src, src_label]:labels_by_src) {
                ...
                auto & committed_efforts =
                    get_by_src(committed_tree_efforts, src);
                auto & invalidated_efforts =
                    get_by_src(invalidated_tree_efforts, src);
                metrics.add_group("cache", {
   ...
   */
    ...
    void Cache::commit_replace_extent(Transaction & t,
    ...
    void Cache::mark_transaction_conflicted(Transaction & t,
      ...
      for (auto & i:t.read_set) {
        ...
        if (t.get_src() != Transaction::src_t::READ) {
          ...
          for (auto & i:t.pre_alloc_list) {
            ...
            auto ool_record_bytes =
                (ool_stats.md_bytes + ool_stats.get_data_bytes());
            ...
            SUBDEBUGT(seastore_t,
                      ...
                      fresh_stat,
                      delta_stat,
                      retire_stat, ool_stats.num_records, ool_record_bytes);
        }
        else {
            // read transaction won't have non-read efforts
    ...
    CachedExtentRef Cache::alloc_new_extent_by_type(Transaction & t,    ///< [in, out] current transaction
        ...
        SUBDEBUGT(seastore_cache, "allocate {} {}B, hint={}, gen={}",
                  t, type, length, hint, rewrite_gen_printer_t {
                  gen}
        );
        switch (type) {
        ...
        case extent_types_t::LADDR_INTERNAL:
            return alloc_new_extent < lba_manager::btree::LBAInternalNode > (t,
                                                                             length,
                                                                             hint,
                                                                             gen);
        case extent_types_t::LADDR_LEAF:
            return alloc_new_extent < lba_manager::btree::LBALeafNode > (t,
                                                                         length,
                                                                         hint,
                                                                         gen);
        ...
        case extent_types_t::COLL_BLOCK:
            return alloc_new_extent < collection_manager::CollectionNode > (t,
                                                                            length,
                                                                            hint,
                                                                            gen);
    ...
    CachedExtentRef Cache::duplicate_for_write(Transaction & t,
                                               CachedExtentRef i) {
    ...
    record_t Cache::prepare_record(Transaction & t,
      ...
      for (auto & i:t.read_set) {
            if (!i.ref->is_valid()) {
                SUBERRORT(seastore_t,
                          "read_set got invalid extent, aborting -- {}", t,
                          *i.ref);
                ceph_abort
                    ("no invalid extent allowed in transactions' read_set");
            }
      ...
      for (auto & i:t.mutated_block_list) {
            ...
            if (i->get_type() == extent_types_t::ROOT) {
                ...
                record.push_back(delta_info_t {
                                 ...
                                 MAX_SEG_SEQ,
                                 segment_type_t::NULL_SEG, std::move(delta_bl)
                                 }
                );
            }
            else {
                ...
                record.push_back(delta_info_t {
                                 i->get_type(), i->get_paddr(), (i->is_logical()
                                                                 ? i->cast <
                                                                 LogicalCachedExtent
                                                                 >
                                                                 ()->get_laddr()
                                 ...
                                 i->get_length(), i->get_version() - 1, sseq,
                                 stype, std::move(delta_bl)
                                 }
                );
                i->last_committed_crc = final_crc;
            }
      ...
      for (auto & i:t.retired_set) {
            ...
            if (is_backref_mapped_extent_node(i)
                ...
                rel_delta.alloc_blk_ranges.emplace_back(i->get_paddr(),
                                                        L_ADDR_NULL,
                                                        i->get_length(),
                                                        i->get_type());
            }
      ...
      for (auto & i:t.inline_block_list) {
            ...
            record.push_back(extent_t {
                             i->get_type(), i->is_logical()
                             ? i->cast < LogicalCachedExtent > ()->get_laddr()
                             : (is_lba_node(i->get_type())
                                ? i->cast < lba_manager::btree::LBANode >
                                ()->get_node_meta().begin : L_ADDR_NULL),
                             std::move(bl)
                             }
                             , modify_time);
            if (i->is_valid()
                && is_backref_mapped_extent_node(i)) {
                alloc_delta.alloc_blk_ranges.emplace_back(i->get_paddr(),
                                                          i->is_logical()
                                                          ? i->cast <
                                                          LogicalCachedExtent >
                                                          ()->get_laddr()
      ...
      for (auto b:alloc_deltas) {
        ...
        if (is_background_transaction(trans_src)) {
            ...
            if (!maybe_dirty_tail.has_value()) {
                ...
                SUBINFOT(seastore_t,
                         "dirty_tail all trimmed, set to head {}, src={}", t,
            ...
            if (!maybe_alloc_tail.has_value()) {
                ...
                SUBINFOT(seastore_t,
                         "alloc_tail all trimmed, set to head {}, src={}", t,
        ...
        SUBDEBUGT(seastore_t,
                  ...
                  record.size.dlength, sea_time_point_printer_t {
                  record.modify_time});
        if (is_background_transaction(trans_src)) {
            ...
            stats.onode_tree_extents_num +=
                t.onode_tree_stats.extents_num_delta;
            ceph_assert(stats.onode_tree_extents_num >= 0);
            get_by_src(stats.committed_onode_tree_efforts,
                       trans_src).increment(t.onode_tree_stats);
            stats.omap_tree_extents_num += t.omap_tree_stats.extents_num_delta;
            ceph_assert(stats.omap_tree_extents_num >= 0);
            get_by_src(stats.committed_omap_tree_efforts,
                       trans_src).increment(t.omap_tree_stats);
        }
        ...
        get_by_src(stats.committed_lba_tree_efforts,
                   trans_src).increment(t.lba_tree_stats);
        if (t.backref_tree_stats.depth) {
            stats.backref_tree_depth = t.backref_tree_stats.depth;
        }
        stats.backref_tree_extents_num +=
            t.backref_tree_stats.extents_num_delta;
        ceph_assert(stats.backref_tree_extents_num >= 0);
        get_by_src(stats.committed_backref_tree_efforts,
                   trans_src).increment(t.backref_tree_stats);
    ...
    void Cache::backref_batch_update(std::vector < backref_entry_ref > &&list,
    ...
    void Cache::complete_commit(Transaction & t,
        ...
        t.for_each_fresh_block([&](const CachedExtentRef & i) {
                               ...
                               bool is_inline = false; if (i->is_inline()) {
                               is_inline = true;
                               i->set_paddr(final_block_start.
                                            add_relative(i->get_paddr()));}
                               i->last_committed_crc = i->get_crc32c();
                               i->pending_for_transaction = TRANS_ID_NULL;
                               i->on_initial_write();
                               i->state = CachedExtent::extent_state_t::CLEAN;
                               DEBUGT("add extent as fresh, inline={} -- {}", t,
                                      is_inline, *i);
                               const auto t_src = t.get_src();
                               i->invalidate_hints(); add_extent(i, &t_src);
                               epm.commit_space_used(i->get_paddr(),
                                                     i->get_length());
                               if (is_backref_mapped_extent_node(i)) {
                               DEBUGT("backref_list new {} len {}", t,
                                      i->get_paddr(), i->get_length());
                               backref_list.emplace_back(std::make_unique <
                                                         backref_entry_t >
                                                         (i->get_paddr(),
                                                          i->is_logical()
                                                          ? i->cast <
                               ...
                               add_backref_extent(i->get_paddr(),
                                                  i->cast <
                                                  backref::BackrefNode >
                                                  ()->get_node_meta().begin,
                                                  i->get_type());}
                               else {
                               ERRORT("{}", t, *i); ceph_abort("not possible");}
                               }
        ) ;
      ...
      for (auto & i:t.retired_set) {
        ...
        DEBUGT("total existing blocks num: {}, exist clean num: {}, "
               ...
               existing_stats.clean_num, existing_stats.mutated_num);
      for (auto & i:t.existing_block_list) {
            if (i->is_valid()) {
                if (i->is_exist_clean()) {
                    i->state = CachedExtent::extent_state_t::CLEAN;
                ...
                backref_list.emplace_back(std::make_unique < backref_entry_t >
                                          (i->get_paddr(),
                                           i->cast < LogicalCachedExtent >
                                           ()->get_laddr(), i->get_length(),
                                           i->get_type(), start_seq));
                const auto t_src = t.get_src();
                add_extent(i, &t_src);
            }
        }
    ...
    Cache::close_ertr::future <> Cache::close() {
        ...
        INFO("close with {}({}B) dirty, dirty_from={}, alloc_from={}, "
             ...
             extents.size(), extents.get_bytes());
        root.reset();
    ...
    Cache::replay_delta_ret
        Cache::replay_delta(journal_seq_t journal_seq,
                            paddr_t record_base,
        ...
        if (delta.paddr != P_ADDR_NULL &&
            ...
            if (seg_info) {
                ...
                if (delta_paddr_segment_seq != delta.ext_seq ||
                    ...
                    return replay_delta_ertr::make_ready_future < bool >
                        (false);
                }
            }
        }
        ...
        if (delta.type == extent_types_t::ALLOC_INFO) {
          ...
          for (auto & alloc_blk:alloc_delta.alloc_blk_ranges) {
                ...
                DEBUG("replay alloc_blk {}~{} {}, journal_seq: {}",
                      ...
                      journal_seq);
                backref_list.emplace_back(std::make_unique < backref_entry_t >
                                          (alloc_blk.paddr, alloc_blk.laddr,
                                           alloc_blk.len, alloc_blk.type,
                                           journal_seq));
            }
            if (!backref_list.empty()) {
        ...
        if (delta.type == extent_types_t::ROOT) {
            ...
            auto extent_fut = (delta.pversion == 0 ?
                               // replay is not included by the cache hit metrics
                               _get_extent_by_type(delta.type,
                                                   delta.paddr,
                                                   delta.laddr,
                                                   delta.length,
                                                   nullptr,
            ...
            return extent_fut.safe_then([ =, this, &delta] (auto extent) {
                                        ...
                                        return replay_delta_ertr::
                                        make_ready_future < bool > (true);}

                                        DEBUG
                                        ("replay extent delta at {} {} ... -- {}, prv_extent={}",
                                         journal_seq, record_base, delta,
                                         *extent);
                                        assert(extent->last_committed_crc ==
                                               delta.prev_crc);
                                        assert(extent->version ==
                                               delta.pversion);
                                        extent->
                                        ...
                                        DEBUG
                                        ("replayed extent delta at {} {} -- {}, extent={}",
                                         journal_seq, record_base, delta,
                                         *extent);}
                                        mark_dirty(extent);
                                        return replay_delta_ertr::
    ...
    Cache::get_next_dirty_extents_ret Cache::
        get_next_dirty_extents(Transaction & t, journal_seq_t seq,
                               size_t max_bytes) {
        ...
        for (auto i = dirty.begin();
             i != dirty.end() && bytes_so_far < max_bytes; ++i) {
        ...
        return seastar::do_with(std::move(cand),
                                decltype(cand) (),
                                [FNAME, this, &t] (auto & cand, auto & ret) {
                                return trans_intr::do_for_each(cand,
                                                               [FNAME, this, &t,
                                                                &ret] (auto &
                                                                       ext) {
                                                               TRACET
                                                               ...
                                                               ([FNAME, this,
                                                                ...
                                                                assert(&*t.
                                                                       ...
                                                                       &*ext);
                                                                ceph_assert(0 ==
                                                                            "t.root would have to already be in the read set");}
                                                                else {
                                                                assert(&*ext ==
                                                                       &*root);
                                                                t.root = root;}
    ...
    Cache::get_root_ret Cache::get_root(Transaction & t) {
        ...
        if (t.root) {
            ...
            return t.root->wait_io().then([&t] {
                                          ...
                                          make_ready_future < RootBlockRef >
                                          (t.root);}
            );
        }
        else {
    ...
    Cache::get_extent_ertr::future < CachedExtentRef >
        Cache::_get_extent_by_type(extent_types_t type, paddr_t offset,
                                   laddr_t laddr, extent_len_t length,
                                   const Transaction::src_t * p_src,
                                   extent_init_func_t
                                   && extent_init_func, extent_init_func_t
                                   && on_cache) {
        return[ =, this, extent_init_func =
               std::move(extent_init_func)] ()mutable {
            ...
            case extent_types_t::BACKREF_INTERNAL:
                return get_extent < backref::BackrefInternalNode > (offset,
                                                                    length,
                                                                    p_metric_key,
                                                                    std::
                                                                    move
                                ...
                                return CachedExtentRef(extent.detach(),
                                                       false /* add_ref */ );
                                }
                );
            case extent_types_t::BACKREF_LEAF:
                return get_extent < backref::BackrefLeafNode > (offset, length,
                                                                p_metric_key,
                                                                std::
                                                                move
                                                                (extent_init_func),
            ...
            case extent_types_t::LADDR_LEAF:
                return get_extent < lba_manager::btree::LBALeafNode > (offset,
                                                                       length,
                                                                       p_metric_key,
                                                                       std::
                                                                       move
            ...
            case extent_types_t::OMAP_INNER:
                return get_extent < omap_manager::OMapInnerNode > (offset,
                                                                   length,
                                                                   p_metric_key,
                                                                   std::
                                                                   move
            ...
            case extent_types_t::OMAP_LEAF:
                return get_extent < omap_manager::OMapLeafNode > (offset,
                                                                  length,
                                                                  p_metric_key,
                                                                  std::
                                                                  move
            ...
            case extent_types_t::RETIRED_PLACEHOLDER:
                ...
                return get_extent_ertr::make_ready_future < CachedExtentRef >
                    ();
            case extent_types_t::TEST_BLOCK:
                return get_extent < TestBlock > (offset, length, p_metric_key,
