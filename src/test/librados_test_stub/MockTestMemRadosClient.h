...
namespace librados {
    ...
    class MockTestMemRadosClient:public TestMemRadosClient {
      public:
        MockTestMemRadosClient(CephContext * cct,
        ...
        MockTestMemIoCtxImpl *do_create_ioctx(int64_t pool_id,
            ...
            return new::testing::NiceMock < MockTestMemIoCtxImpl > (this, this,
                                                                    pool_id,
                                                                    pool_name,
                                                                    get_mem_cluster
                                                                    ()->
        ...
        int do_service_daemon_register(const std::string & service,
                                       ...
                                       std::string > &metadata) {
            return TestMemRadosClient::service_daemon_register(service, name,
                                                               metadata);
        }
        ...
        int do_service_daemon_update_status_r(const std::map < std::string,
                                              std::string > &status) {
            auto s = status;
            return TestMemRadosClient::service_daemon_update_status(std::
                                                                    move(s));
        }
        ...
        void default_to_dispatch() {
            ...
            ON_CALL(*this,
                    connect()).WillByDefault(Invoke(this,
                                                    &MockTestMemRadosClient::
                                                    do_connect));
            ON_CALL(*this,
                    create_ioctx(_, _)).WillByDefault(Invoke(this,
                                                             &MockTestMemRadosClient::
                                                             do_create_ioctx));
            ON_CALL(*this,
                    blocklist_add(_, _)).WillByDefault(Invoke(this,
                                                              &MockTestMemRadosClient::
                                                              do_blocklist_add));
            ON_CALL(*this,
                    get_min_compatible_osd(_)).WillByDefault(Invoke(this,
                                                                    &MockTestMemRadosClient::
                                                                    do_get_min_compatible_osd));
            ON_CALL(*this,
                    get_min_compatible_client(_, _)).WillByDefault(Invoke(this,
                                                                          &MockTestMemRadosClient::
                                                                          do_get_min_compatible_client));
            ON_CALL(*this,
                    service_daemon_register(_, _, _)).WillByDefault(Invoke(this,
                                                                           &MockTestMemRadosClient::
                                                                           do_service_daemon_register));
            ON_CALL(*this,
                    service_daemon_update_status_r(_)).
                WillByDefault(Invoke
                              (this,
                               &MockTestMemRadosClient::
                               do_service_daemon_update_status_r));
            ON_CALL(*this,
                    mon_command(_, _, _, _)).WillByDefault(Invoke(this,
                                                                  &MockTestMemRadosClient::
                                                                  do_mon_command));
            ON_CALL(*this,
                    wait_for_latest_osd_map()).WillByDefault(Invoke(this,
                                                                    &MockTestMemRadosClient::
