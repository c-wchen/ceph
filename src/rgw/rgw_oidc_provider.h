    ...
    namespace sal {
        ...
        class RGWOIDCProvider {
          ...
          protected:
            ...
            int get_tenant_url_from_arn(std::string & tenant,
                                        std::string & url);
          ...
          :    arn(std::move(arn)), tenant(std::move(tenant)) {
            }
          ...
          :    tenant(std::move(tenant)) {
            ...
            const std::string & get_provider_url() const {
                return provider_url;
            } const std::string & get_arn() const {
                return arn;
            } const std::string & get_create_date() const {
                return creation_date;
            } const std::vector < std::string > &get_client_ids() const {
                return client_ids;
            } const std::vector < std::string > &get_thumbprints() const {
                return thumbprints;
            } int create(const DoutPrefixProvider * dpp, bool exclusive,
                         optional_yield y);
