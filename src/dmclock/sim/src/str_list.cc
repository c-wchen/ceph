...
static bool get_next_token(const string & s, size_t & pos, const char *delims,
                           string & token)
{
...
void get_str_list(const string & str, const char *delims,
...
void get_str_vec(const string & str, const char *delims,
...
void get_str_set(const string & str, const char *delims,
                 set < string > &str_set)
{
    size_t pos = 0;
    string token;
