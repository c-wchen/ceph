    ...
    template <> struct ManagedLock <MockTestImageCtx > {
        ...
        bool is_lock_owner() const {
            ...
            if (MockManagedLock::get_instance().m_release_lock_on_shutdown) {
                on_shutdown = new FunctionContext([this, on_shutdown] (int r) {
                                                  MockManagedLock::
                                                  get_instance().
        ...
        void release_lock(Context * on_released) {
            Context *post_release_ctx = new FunctionContext([this,
                                                             on_released] (int
                                                                           r){
            ...
            Context *release_ctx = new FunctionContext([this, on_released,
                                                        post_release_ctx] (int
                                                                           r){
                                                       if (r < 0) {
                                                                   on_released->
                                                                   complete(r);}
          ...
          :                                           timer_lock(threads->
                                                       ...
                                                       *MirrorStatusWatcher <
                                                       ...
                                                       MOCK_METHOD0(destroy, void ()); MOCK_METHOD1(init, void (Context *)); MOCK_METHOD1(shut_down, void (Context *)); MOCK_METHOD1(notify, void (const std::string &));}; Instances < librbd::MockTestImageCtx > *Instances < librbd::MockTestImageCtx >::s_instance = nullptr;}  // namespace mirror
                                                       }    // namespace rbd
...
#include "tools/rbd_mirror/LeaderWatcher.cc"
      ...
      MOCK_METHOD1(post_acquire_handler, void (Context *)); MOCK_METHOD1(pre_release_handler, void (Context *)); MOCK_METHOD1(update_leader_handler, void (const std::string &));}; MockListener * MockListener::s_instance = nullptr; class TestMockLeaderWatcher:public TestMockFixture
                                                       {
          public:
                                                       typedef
                                                       MirrorStatusWatcher <
