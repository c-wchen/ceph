...
public:
    ...
    {
        return new ImageReplayer(local_io_ctx, local_mirror_uuid,
                                 global_image_id, threads,
                                 instance_watcher, local_status_updater,
                                 cache_manager_handler,
                                 pool_meta_cache);
    } void destroy()
    {
    ...
    } void start(Context *on_finish, bool manual =
                     false, bool restart = false);
    void stop(Context *on_finish, bool manual = false, bool restart =
                  false);
...
private:
    ...
    image_replayer::StateBuilder < ImageCtxT > *m_state_builder =
        nullptr;
    ...
    *m_bootstrap_request = nullptr;
    ...
    void update_mirror_image_status(bool force,
                                    const OptionalState &state);
    void set_mirror_image_status_update(bool force,
                                        const OptionalState &state);
