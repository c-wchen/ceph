...
} // namespace journal } // namespace rbd namespace rbd {
    namespace mirror {
...
} // namespace journal } // namespace image_replayer } // namespace mirror }    // namespace rbd
    ...
    namespace mirror {
        namespace image_replayer {
            namespace journal {
                ...
                class TestMockImageReplayerJournalPrepareReplayRequest:public
                    TestMockFixture {
                  public:
                    typedef PrepareReplayRequest < librbd::MockTestImageCtx >
                    ...
                    MockPrepareReplayRequest *create_request(MockStateBuilder &
                                                             mock_state_builder,
                                                             const std::
                                                             string &
                                                             local_mirror_uuid,
                                                             ...
                                                             Context *
                                                             on_finish) {
                        return new MockPrepareReplayRequest(local_mirror_uuid,
                                                            nullptr,
                                                            &mock_state_builder,
                                                            resync_requested,
                                                            syncing, on_finish);
                ...
                TEST_F(TestMockImageReplayerJournalPrepareReplayRequest,
                       Success) {
                    InSequence seq;
                    ...
                    expect_journaler_get_tags(mock_remote_journaler, 123, tags,
                                              0);

                    C_SaferCond ctx;
                    librbd::journal::
                        MirrorPeerClientMeta mirror_peer_client_meta;
                    ...
                    bool syncing;
                    auto request =
                        create_request(mock_state_builder, "local mirror uuid",
                ...
                TEST_F(TestMockImageReplayerJournalPrepareReplayRequest,
                    ...
                    ::journal::MockJournaler mock_remote_journaler;
                    expect_journaler_update_client(mock_remote_journaler,
                                                   client_data, 0);
                    ...
                    Tags tags = {
                        ...
                        ,
                        {3, 123,
                         encode_tag_data({librbd::Journal <>::
                                          ORPHAN_MIRROR_UUID,
                                          librbd::Journal <>::LOCAL_MIRROR_UUID,
                                          true, 2, 1}
                         )}
                ...
                TEST_F(TestMockImageReplayerJournalPrepareReplayRequest,
                    ...
                    Tags tags = {
                        {2, 123,
                         encode_tag_data({"local mirror uuid",
                                          "local mirror uuid",
                                          true, 344, 99}
                         )}
                        ,
