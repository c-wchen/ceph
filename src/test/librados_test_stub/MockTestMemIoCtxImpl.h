    ...
    class MockTestMemIoCtxImpl:public TestMemIoCtxImpl {
      public:
        ...
        MOCK_METHOD4(read, int (const std::string & oid,
                                size_t len, uint64_t off, bufferlist * bl));
        ...
        void default_to_parent() {
            ...
            ON_CALL(*this,
                    aio_unwatch(_, _)).WillByDefault(Invoke(this,
                                                            ...
                                                            do_aio_unwatch));
            ON_CALL(*this,
                    assert_exists(_)).WillByDefault(Invoke(this,
                                                           &MockTestMemIoCtxImpl::
                                                           do_assert_exists));
            ON_CALL(*this,
                    create(_, _)).WillByDefault(Invoke(this,
                                                       &MockTestMemIoCtxImpl::
                                                       do_create));
            ON_CALL(*this,
                    cmpext(_, _, _)).WillByDefault(Invoke(this,
                                                          &MockTestMemIoCtxImpl::
                                                          do_cmpext));
            ON_CALL(*this,
                    exec(_, _, _, _, _, _, _)).WillByDefault(Invoke(this,
                                                                    &MockTestMemIoCtxImpl::
                                                                    do_exec));
            ON_CALL(*this,
            ...
            ON_CALL(*this,
                    notify(_, _, _, _)).WillByDefault(Invoke(this,
                                                             ...
                                                             do_notify));
            ON_CALL(*this,
                    read(_, _, _, _)).WillByDefault(Invoke(this,
                                                           &MockTestMemIoCtxImpl::
                                                           do_read));
            ON_CALL(*this,
                    set_snap_read(_)).WillByDefault(Invoke(this,
                                                           ...
                                                           do_set_snap_read));
            ON_CALL(*this,
                    sparse_read(_, _, _, _, _)).WillByDefault(Invoke(this,
                                                                     &MockTestMemIoCtxImpl::
                                                                     do_sparse_read));
            ON_CALL(*this,
