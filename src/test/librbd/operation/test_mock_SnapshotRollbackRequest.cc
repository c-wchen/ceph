...
namespace librbd {
    ...
    namespace operation {
        ...
        template <> struct ResizeRequest <MockOperationImageCtx > {
            ...
            static ResizeRequest *create(MockOperationImageCtx & image_ctx,
                                         Context * on_finish, uint64_t new_size,
                                         bool allow_shrink,
        ...
        ResizeRequest < MockOperationImageCtx > *ResizeRequest <
    ...
    namespace operation {
        ...
        class TestMockOperationSnapshotRollbackRequest:public TestMockFixture {
          public:
            ...
            void expect_get_snap_object_map(MockOperationImageCtx &
                                            mock_image_ctx,
            ...
            void expect_get_current_size(MockOperationImageCtx & mock_image_ctx,
                                         uint64_t size) {
            ...
            void expect_create_object_map(MockOperationImageCtx &
                                          mock_image_ctx,
                                          MockObjectMap * mock_object_map) {
            ...
            void expect_refresh_object_map(MockOperationImageCtx &
                                           mock_image_ctx,
                                           MockObjectMap & mock_object_map) {
                if (mock_image_ctx.object_map != nullptr) {
            ...
            int when_snap_rollback(MockOperationImageCtx & mock_image_ctx,
                ...
                MockSnapshotRollbackRequest *req =
                    new MockSnapshotRollbackRequest(mock_image_ctx, &cond_ctx,
                                                    cls::rbd::
        ...
        TEST_F(TestMockOperationSnapshotRollbackRequest, Success) {
            ...
            expect_get_snap_object_map(mock_image_ctx, &mock_snap_object_map,
                                       123);
