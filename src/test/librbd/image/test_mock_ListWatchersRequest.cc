...
namespace librbd {
    ...
    namespace image {
        ...
        class TestMockListWatchersRequest:public TestMockFixture {
          public:
            typedef ListWatchersRequest < MockImageCtx >
                MockListWatchersRequest;

            obj_watch_t watcher(const std::string & address,
            ...
            }} void expect_list_image_watchers(MockTestImageCtx &
                                               mock_image_ctx,
                                               const std::list < obj_watch_t >
                                               &watchers, int r) {
            ...
            void expect_list_mirror_watchers(MockTestImageCtx & mock_image_ctx,
                                             const std::list < obj_watch_t >
                                             &watchers, int r) {
                expect_list_watchers(mock_image_ctx, RBD_MIRRORING, watchers,
                                     r);
            }
        ...
        TEST_F(TestMockListWatchersRequest, NoImageWatchers) {
            ...
            C_SaferCond ctx;
            auto req =
                MockListWatchersRequest::create(mock_image_ctx, 0, &watchers,
                                                &ctx);
            req->send();
        ...
        TEST_F(TestMockListWatchersRequest, FilterOutMyInstance) {
            ...
            C_SaferCond ctx;
            auto req =
                MockListWatchersRequest::create(mock_image_ctx,
        ...
        TEST_F(TestMockListWatchersRequest, FilterOutMirrorInstance) {
            ...
            expect_list_image_watchers(mock_image_ctx, {
                                       watcher("a", 123), watcher("b", 456)},
                                       0);
            expect_list_mirror_watchers(mock_image_ctx, {
                                        watcher("b", 789)}, 0);
            expect_get_watch_handle(*mock_image_ctx.image_watcher, 123);
