...
namespace crimson::os::seastore::segment_manager {
    ...
    using EphemeralSegmentManagerRef =
        std::unique_ptr < EphemeralSegmentManager >;
    ...
    class EphemeralSegmentManager final:public SegmentManager {
        ...
        device_type_t get_device_type() const final {
            ...
            return (seg_addr.get_segment_id().device_segment_id() *
                    config.segment_size) + seg_addr.get_segment_off();
      ...
      :    config(config) {
        ...
        magic_t get_magic() const final {
            ...
            crimson::ct_error::enospc, crimson::ct_error::invarg >;
...
template <> struct fmt::formatter <
    crimson::os::seastore::segment_manager::ephemeral_config_t >:fmt::
    ostream_formatter {
};
#endif
