...
namespace librbd {
    namespace object_map {
        ...
        template < typename I > struct MockInvalidateRequestBase {
            ...
            static InvalidateRequest < I > *create(I & image_ctx,
                ...
                s_requests.push_back(static_cast < InvalidateRequest < I >
                                     *>(this));
            } MOCK_METHOD0(send, void ());
        };

        template < typename I >
            std::list < InvalidateRequest < I > *>MockInvalidateRequestBase <
            I >::s_requests;
