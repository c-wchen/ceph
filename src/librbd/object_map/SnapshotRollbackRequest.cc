    ...
    namespace object_map {
        ...
        namespace {
            ...
            std::ostream & operator<<(std::ostream & os,
                                      const SnapshotRollbackRequest::
                                      State & state) {
                switch (state) {
                case SnapshotRollbackRequest::STATE_READ_MAP:
                    os << "READ_MAP";
                    break;
                    case SnapshotRollbackRequest::
                        STATE_INVALIDATE_MAP:os << "INVALIDATE_MAP";
                    break;
                    case SnapshotRollbackRequest::
        ...
        }} // anonymous namespace void SnapshotRollbackRequest::send() {
            send_read_map();
        }
        ...
        void SnapshotRollbackRequest::send_invalidate_map() {
            ...
            InvalidateRequest <> *req =
                new InvalidateRequest <> (m_image_ctx, m_snap_id, false,
