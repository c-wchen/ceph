...
public:
    ...
    const std::string &get_error_dentry()
    {
        return error_dentry;
    }
    ...
    MDiscoverReply(MDiscover *dis) : Message(MSG_MDS_DISCOVERREPLY, HEAD_VERSION),
    ...
    MDiscoverReply(dirfrag_t df) : Message(MSG_MDS_DISCOVERREPLY, HEAD_VERSION),
                                   base_ino(df.ino),
...
void
set_flag_error_dn(boost::string_view dn)
{
    flag_error_dn = true;
