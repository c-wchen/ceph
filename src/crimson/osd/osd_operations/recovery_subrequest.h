...
namespace crimson::osd {
    ...
    class RecoverySubRequest final:public PhasedOperationT <
        RecoverySubRequest > {
      public:
        static constexpr OperationTypeCode type =
            OperationTypeCode::background_recovery_sub;

        RecoverySubRequest(crimson::net::ConnectionRef conn,
...
template <> struct fmt::formatter <
    crimson::osd::RecoverySubRequest >:fmt::ostream_formatter {
};
#endif
