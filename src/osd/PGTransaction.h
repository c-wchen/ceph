...
class PGTransaction {
  public:
     ...
     * to account for truncates overriding previous writes */
        ...
        boost::optional < pair < set < snapid_t >,
            set < snapid_t > > >updated_snaps;
        ...
        struct SplitMerger {
            BufferUpdateType split(uint64_t offset,
                ...
                return match(bu,
                             ...
                             BufferUpdateType {
                             bufferlist bl; bl.substr_of(w.buffer, offset, len);
            ...
            BufferUpdateType merge(BufferUpdateType && left,
                ...
                return match(left,
                             ...
                             bufferlist bl = w.buffer; bl.append(r->buffer);
                             return BufferUpdate::Write {
                             bl, w.fadvise_flags};}
                             ,
                             ...
                             auto r =
                             boost::get < BufferUpdate::Zero > (&right);
                             assert(r); return BufferUpdate::Zero {
                             z.len + r->len};}
                             ,
                             [&](const BufferUpdate::CloneRange & c)->
                             BufferUpdateType {
  ...
  public:
    ...
    void rename(const hobject_t & target,   ///< [in] source (must be a temp object)
    ...
    void omap_setkeys(const hobject_t & hoid,   ///< [in] object to write
        ...
        op.omap_updates.
            emplace_back(make_pair
                         (ObjectOperation::OmapUpdateType::Insert, keys_bl));
    }
    void omap_setkeys(const hobject_t & hoid,   ///< [in] object to write
    ...
    void omap_rmkeys(const hobject_t & hoid,    ///< [in] object to write
        ...
        op.omap_updates.
            emplace_back(make_pair
                         (ObjectOperation::OmapUpdateType::Remove, keys_bl));
    }
    void omap_rmkeys(const hobject_t & hoid,    ///< [in] object to write
