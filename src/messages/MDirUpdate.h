...
public:
    ...
    MDirUpdate(mds_rank_t f, dirfrag_t dirfrag, int dir_rep, const std::set<int32_t> &dir_rep_by, filepath &path, bool discover = false) : Message(MSG_MDS_DIRUPDATE), from_mds(f), dirfrag(dirfrag),
