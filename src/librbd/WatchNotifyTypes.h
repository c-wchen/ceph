...
struct Payload {
    ...
    virtual void decode(__u8 version,
                        bufferlist::const_iterator &iter) = 0;
...
struct AcquiredLockPayload: public Payload {
    ...
    void decode(__u8 version,
                bufferlist::const_iterator &iter) override;
...
struct AsyncProgressPayload: public AsyncRequestPayloadBase {
    ...
    {
    } AsyncProgressPayload(const AsyncRequestId &id, uint64_t offset,
                           uint64_t total)
...
struct ResizePayload: public AsyncRequestPayloadBase {
    ...
    ResizePayload()
    {
    } ResizePayload(const AsyncRequestId &id, uint64_t size,
                    bool allow_shrink)
...
struct RenamePayload: public AsyncRequestPayloadBase {
    ...
    RenamePayload()
    {
    } RenamePayload(const AsyncRequestId &id,
...
struct UpdateFeaturesPayload: public AsyncRequestPayloadBase {
    ...
    {
    } UpdateFeaturesPayload(const AsyncRequestId &id,
...
struct MigratePayload: public AsyncRequestPayloadBase {
    MigratePayload()
    {
    } MigratePayload(const AsyncRequestId &
                     id): AsyncRequestPayloadBase(id)
    {
    }
...
struct QuiescePayload: public AsyncRequestPayloadBase {
    QuiescePayload()
    {
    } QuiescePayload(const AsyncRequestId &
                     id): AsyncRequestPayloadBase(id)
    {
    }
...
struct UnquiescePayload: public AsyncRequestPayloadBase {
    UnquiescePayload()
    {
    } UnquiescePayload(const AsyncRequestId &
                       id): AsyncRequestPayloadBase(id)
    {
    }
