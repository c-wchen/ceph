...
template <bool FORCE_MERGE>
eagain_ifuture<> Node::try_merge_adjacent(
...
eagain_ifuture<Node::search_result_t> InternalNode::lower_bound_tracked(
...
eagain_ifuture<Node::search_result_t> LeafNode::lower_bound_tracked(
    context_t c, const key_hobj_t &key, MatchHistory &history)
{
    key_view_t index_key;
