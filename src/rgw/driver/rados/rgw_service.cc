...
int RGWServices::do_init(CephContext *_cct, rgw::sal::RadosStore* driver, bool have_cache, bool raw, bool run_sync,
                         optional_yield y, const DoutPrefixProvider *dpp, const rgw::SiteConfig& _site)
{
    cct = _cct;
    site = &_site;
                    ...
                    librados::Rados& rados, const DoutPrefixProvider *dpp)
{
    ...
    RGWBucketInstanceMetadataHandlerBase *bi_meta_handler = static_cast < RGWBucketInstanceMetadataHandlerBase * >
        (meta.bucket_instance.get());
