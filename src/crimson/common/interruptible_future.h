        ...
        void set(InterruptCondRef < InterruptCond > &ic)
{
  ...
  template < typename InterruptCond, typename T > class[[nodiscard]] interruptible_future_detail < InterruptCond, seastar::future < T >>:private seastar::future < T >
    {
      public:
  ...
  template < typename InterruptCond, template < typename ... >typename ErroratedFuture, typename T > class[[nodiscard]] interruptible_future_detail < InterruptCond, ErroratedFuture <::crimson::errorated_future_marker < T >>>:private ErroratedFuture <::crimson::errorated_future_marker < T >>
    {
      public:
        using core_type =
      ...
      :    core_type(static_cast < seastar::future < T > &&>(fut)) {
        ...
        template < class ... A >[[gnu::always_inline]]
