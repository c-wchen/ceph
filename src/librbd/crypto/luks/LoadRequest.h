...
// default header size in LUKS2 2 X 16KB + 1 X 256KB keyslot
            const uint64_t DEFAULT_INITIAL_READ_SIZE = 288 * 1024;
             ...
             template < typename I > class LoadRequest {
              public:
                static LoadRequest *create(I * image_ctx,
                                           ...
                                           *result_crypto,
                                           ...
                                           Context * on_finish) {
                    return new LoadRequest(image_ctx, format, passphrase,
                                           result_crypto, detected_format_name,
                                           on_finish);
    ...
    // namespace librbd
    extern template class librbd::crypto::luks::LoadRequest <
    librbd::ImageCtx >;
