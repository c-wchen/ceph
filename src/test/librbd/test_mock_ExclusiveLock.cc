      ...
      public:
        ...
        void expect_block_writes(MockExclusiveLockImageCtx & mock_image_ctx) {
            ...
            if (mock_image_ctx.clone_copy_on_read
                ...
                expect_set_require_lock(mock_image_ctx, io::DIRECTION_BOTH,
                                        true);
            }
            else {
                expect_set_require_lock(mock_image_ctx, io::DIRECTION_WRITE,
                                        true);
            }
        }
        ...
        void expect_post_acquire_request(MockPostAcquireRequest &
        ...
        void expect_shut_down(MockManagedLock & managed_lock) {
            EXPECT_CALL(managed_lock, shut_down(_))
                .
                WillOnce(CompleteContext
                         (0, static_cast < ContextWQ * >(nullptr)));
        }
