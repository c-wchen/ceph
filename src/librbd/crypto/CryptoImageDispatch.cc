...
namespace librbd {
    namespace crypto {
        ...
        CryptoImageDispatch::
            CryptoImageDispatch(uint64_t data_offset):m_data_offset(data_offset)
        {
        } void CryptoImageDispatch::remap_to_physical(io::
        ...
        io::ImageArea CryptoImageDispatch::remap_to_logical(io::
                                                            Extents &
                                                            image_extents) {
            bool saw_data = false;
