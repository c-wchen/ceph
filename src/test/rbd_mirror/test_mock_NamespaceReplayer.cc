    ...
    namespace mirror {
        ...
        template <> struct ImageDeleter <librbd::MockTestImageCtx > {
            ...
            static ImageDeleter *create(librados::IoCtx & ioctx,
             ...
             MOCK_METHOD2(print_status,
                          void (Formatter *, std::stringstream *));

             ImageDeleter() {
                s_instance = this;
        }};

        ImageDeleter < librbd::MockTestImageCtx > *ImageDeleter <
        ...
        template <> struct ImageMap <librbd::MockTestImageCtx > {
            ...
            static ImageMap *create(librados::IoCtx & ioctx,
                                    Threads < librbd::MockTestImageCtx >
                                    *threads, const std::string & instance_id,
            ...
            MOCK_METHOD1(update_instances_added,
                         void (const std::vector < std::string > &));
            MOCK_METHOD1(update_instances_removed,
                         void (const std::vector < std::string > &));
        ...
        ImageMap < librbd::MockTestImageCtx > *ImageMap <
            librbd::MockTestImageCtx >::s_instance = nullptr;
        ...
        template <> struct InstanceReplayer <librbd::MockTestImageCtx > {
            ...
            MOCK_METHOD1(add_peer,
                         void (const Peer < librbd::MockTestImageCtx > &));
        ...
        InstanceReplayer < librbd::MockTestImageCtx > *InstanceReplayer <
            librbd::MockTestImageCtx >::s_instance = nullptr;
        ...
        template <> struct InstanceWatcher <librbd::MockTestImageCtx > {
            ...
            MOCK_METHOD2(print_sync_status,
                         void (Formatter *, std::stringstream *));
        ...
        InstanceWatcher < librbd::MockTestImageCtx > *InstanceWatcher <
            librbd::MockTestImageCtx >::s_instance = nullptr;
        ...
        template <> struct MirrorStatusUpdater <librbd::MockTestImageCtx > {
            ...
            :local_mirror_uuid(local_mirror_uuid) {
                s_instance[std::string {
                           local_mirror_uuid}] = this;
            }
            ~MirrorStatusUpdater() {
        ...
        template <> struct PoolWatcher <librbd::MockTestImageCtx > {
            ...
            static PoolWatcher *create(Threads < librbd::MockTestImageCtx >
        ...
        std::map < int64_t,
            PoolWatcher < librbd::MockTestImageCtx > *>PoolWatcher <
    ...
    namespace mirror {
        ...
        class TestMockNamespaceReplayer:public TestMockFixture {
          public:
            ...
            typedef InstanceReplayer < librbd::MockTestImageCtx >
                MockInstanceReplayer;
            typedef InstanceWatcher < librbd::MockTestImageCtx >
                MockInstanceWatcher;
            typedef MirrorStatusUpdater < librbd::MockTestImageCtx >
            ...
            void SetUp() override {
            ...
            } void expect_mirror_status_updater_init(MockMirrorStatusUpdater &
                ...
                expect_mirror_status_updater_shut_down(MockMirrorStatusUpdater &
                                                       mock_mirror_status_updater)
            {
            ...
            void expect_instance_replayer_init(MockInstanceReplayer &
                                               mock_instance_replayer, int r) {
                EXPECT_CALL(mock_instance_replayer, init(_))
                    .WillOnce(CompleteContext(m_mock_threads->work_queue, r));
            }

            void expect_instance_replayer_shut_down(MockInstanceReplayer &
                                                    mock_instance_replayer) {
                EXPECT_CALL(mock_instance_replayer, shut_down(_))
                    .WillOnce(CompleteContext(m_mock_threads->work_queue, 0));
            }

            void expect_instance_replayer_stop(MockInstanceReplayer &
                                               mock_instance_replayer) {
                EXPECT_CALL(mock_instance_replayer, stop(_))
                    .WillOnce(CompleteContext(m_mock_threads->work_queue, 0));
            }

            void expect_instance_replayer_add_peer(MockInstanceReplayer &
                                                   mock_instance_replayer) {
                EXPECT_CALL(mock_instance_replayer, add_peer(_));
            }

            void expect_instance_replayer_release_all(MockInstanceReplayer &
                                                      mock_instance_replayer) {
                EXPECT_CALL(mock_instance_replayer, release_all(_))
                    .WillOnce(CompleteContext(m_mock_threads->work_queue, 0));
            }

            void expect_instance_watcher_get_instance_id(MockInstanceWatcher &
            ...
            void expect_instance_watcher_init(MockInstanceWatcher &
                                              mock_instance_watcher, int r) {
                EXPECT_CALL(mock_instance_watcher, init(_))
                    .WillOnce(CompleteContext(m_mock_threads->work_queue, r));
            }

            void expect_instance_watcher_shut_down(MockInstanceWatcher &
                                                   mock_instance_watcher) {
            ...
            void expect_image_map_init(MockInstanceWatcher &
                                       mock_instance_watcher,
                                       MockImageMap & mock_image_map, int r) {
                expect_instance_watcher_get_instance_id(mock_instance_watcher,
                                                        "1234");
            ...
            void expect_pool_watcher_init(MockPoolWatcher & mock_pool_watcher,
                                          int r) {
                EXPECT_CALL(mock_pool_watcher, init(_))
                    .WillOnce(CompleteContext(m_mock_threads->work_queue, r));
            }

            void expect_pool_watcher_shut_down(MockPoolWatcher &
                                               mock_pool_watcher) {
                EXPECT_CALL(mock_pool_watcher, shut_down(_))
                    .WillOnce(CompleteContext(m_mock_threads->work_queue, 0));
            }

            void expect_image_deleter_init(MockImageDeleter &
                                           mock_image_deleter, int r) {
                EXPECT_CALL(mock_image_deleter, init(_))
                    .WillOnce(CompleteContext(m_mock_threads->work_queue, r));
            }

            void expect_image_deleter_shut_down(MockImageDeleter &
                                                mock_image_deleter) {
        ...
        TEST_F(TestMockNamespaceReplayer, Init_LocalMirrorStatusUpdaterError) {
            ...
            auto mock_local_mirror_status_updater =
                new MockMirrorStatusUpdater { "" };
            expect_mirror_status_updater_init(*mock_local_mirror_status_updater,
                                              -EINVAL);
        ...
        TEST_F(TestMockNamespaceReplayer, Init_RemoteMirrorStatusUpdaterError) {
            ...
            expect_mirror_status_updater_init
                (*mock_remote_mirror_status_updater, -EINVAL);

            expect_mirror_status_updater_shut_down
                (*mock_local_mirror_status_updater);
        ...
        TEST_F(TestMockNamespaceReplayer, AcquireLeader) {
            ...
            auto mock_local_pool_watcher =
                new MockPoolWatcher(m_local_io_ctx.get_id());
            expect_pool_watcher_init(*mock_local_pool_watcher, 0);

            auto mock_remote_pool_watcher =
                new MockPoolWatcher(m_remote_io_ctx.get_id());
