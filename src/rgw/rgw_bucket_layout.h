...
void encode_json_impl(const char *name, const BucketIndexType &t,
                      ceph::Formatter *f);
...
void encode_json_impl(const char *name, const BucketHashType &t,
                      ceph::Formatter *f);
...
struct bucket_index_normal_layout {
    ...
    {
        out << "num_shards=" << l.
            num_shards << ", hash_type=" << to_string(l.hash_type);
        return out;
    }
};
...
void encode(const bucket_index_normal_layout &l, bufferlist &bl,
            uint64_t f = 0);
void decode(bucket_index_normal_layout &l,
            bufferlist::const_iterator &bl);
void encode_json_impl(const char *name,
                      const bucket_index_normal_layout &l,
                      ceph::Formatter *f);
...
void encode_json_impl(const char *name, const bucket_index_layout &l,
                      ceph::Formatter *f);
...
void encode(const bucket_index_layout_generation &l, bufferlist &bl,
            uint64_t f = 0);
void decode(bucket_index_layout_generation &l,
            bufferlist::const_iterator &bl);
void encode_json_impl(const char *name,
...
void encode_json_impl(const char *name, const BucketLogType &t,
                      ceph::Formatter *f);
void decode_json_obj(BucketLogType &t, JSONObj *obj);

inline std::ostream &operator<<(std::ostream &out,
                                const BucketLogType &log_type)
{
    switch (log_type) {
...
void encode_json_impl(const char *name, const bucket_index_log_layout &l,
                      ceph::Formatter *f);
...
void encode_json_impl(const char *name, const bucket_log_layout &l,
                      ceph::Formatter *f);
...
struct bucket_log_layout_generation {
    ...
    friend std::ostream &operator<<(std::ostream &out,
                                    const bucket_log_layout_generation &g)
    {
...
void encode(const bucket_log_layout_generation &l, bufferlist &bl,
            uint64_t f = 0);
void decode(bucket_log_layout_generation &l,
            bufferlist::const_iterator &bl);
void encode_json_impl(const char *name,
...
inline bucket_log_layout_generation log_layout_from_index(uint64_t gen,
        const
...
{
    return[gen](const bucket_log_layout_generation & l) {
        return l.gen == gen;
    };
}

inline bucket_index_layout_generation log_to_index_layout(const
...
void encode_json_impl(const char *name, const BucketReshardState &s,
                      ceph::Formatter *f);
...
void encode_json_impl(const char *name, const BucketLayout &l,
                      ceph::Formatter *f);
...
inline bool is_layout_indexless(const bucket_index_layout_generation &
                                layout)
{
