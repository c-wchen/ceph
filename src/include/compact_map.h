...
protected:
    ...
    template < class It > class const_iterator_base
    {
        ...
        const_iterator_base(const compact_map_base *m, const It &i): map(m),
            it(i)
        {
        }
...
public:
    ...
    public:
        ...
        iterator(compact_map_base *m): iterator_base < typename Map::iterator >
            (m)
        {
        }
    ...
    public:
        const_iterator()
        {
        } const_iterator(const iterator_base < typename Map::const_iterator >
                         &o)
            : const_iterator_base < typename Map::const_iterator > (o)
        {
        }
        const_iterator(const compact_map_base *m): const_iterator_base <
    ...
    class reverse_iterator: public iterator_base <
        typename Map::reverse_iterator >
    {
    public:
        reverse_iterator()
        {
        } reverse_iterator(const iterator_base <
                           typename Map::reverse_iterator > &o)
            : iterator_base < typename Map::reverse_iterator > (o)
        {
        }
        reverse_iterator(compact_map_base *m): iterator_base < typename Map::reverse_iterator >
            (m)
        {
        }
    ...
    public:
        ...
        {
        } const_reverse_iterator(const iterator_base <
                                 typename Map::const_reverse_iterator > &o)
            : iterator_base < typename Map::const_reverse_iterator > (o)
        {
        }
        const_reverse_iterator(const compact_map_base *m): const_iterator_base <
            typename Map::const_reverse_iterator > (m)
        {
        }
    ...
    std::pair < iterator, bool > emplace(Args && ... args)
    {
        ...
        return std::pair < iterator, bool > (iterator(this, em.first),
                                             em.second);
    }
    iterator begin()
    {
...
inline void encode(const compact_map_base < Key, T, Map > &m,
                   ceph::buffer::list &bl)
{
    m.encode(bl);
}
...
template < class Key, class T, class Compare = std::less < Key >, class Alloc =
           std::allocator < std::pair < const Key,
                                        T > >> class compact_map: public compact_map_base < Key, T, std::map < Key,
    T, Compare, Alloc > >
{
public:
...
template < class Key, class T, class Compare = std::less < Key >, class Alloc =
           std::allocator < std::pair < const Key,
                                        T > >> inline std::ostream & operator<<(std::ostream &out,
                                                const compact_map < Key, T, Compare,
                                                Alloc > &m)
{
    out << "{";
    bool first = true;
...
template < class Key, class T, class Compare = std::less < Key >, class Alloc =
           std::allocator < std::pair < const Key,
                                        T > >> class compact_multimap: public compact_map_base < Key, T,
