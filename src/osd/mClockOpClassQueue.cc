...
namespace ceph {
    ...
    mClockOpClassQueue::mclock_op_tags_t::mclock_op_tags_t(CephContext *
                                                           cct):client_op(cct->
                                                                          _conf->
        ...
        dout(20) << "mClockOpClassQueue settings:: " << "client_op:" <<
            client_op << "; osd_subop:" << osd_subop << "; snaptrim:" <<
            snaptrim << "; recov:" << recov << "; scrub:" << scrub << dendl;
    } dmc::ClientInfo mClockOpClassQueue::
  ...
  mClockOpClassQueue::mClockOpClassQueue(CephContext * cct):
    ...
    mClockOpClassQueue::osd_op_type_t
        ...
        osd_op_type_t type =
            boost::apply_visitor(pg_queueable_visitor,
                                 request.second.get_variant());
