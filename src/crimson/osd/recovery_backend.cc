...
RecoveryBackend::interruptible_future<> RecoveryBackend::handle_backfill_progress(
    MOSDPGBackfill &m)
{
    logger().debug("{}", __func__);
    ceph_assert(!pg.is_primary());
...
RecoveryBackend::interruptible_future<> RecoveryBackend::handle_backfill_finish_ack(
    MOSDPGBackfill &m)
{
    logger().debug("{}", __func__);
    ceph_assert(pg.is_primary());
...
RecoveryBackend::interruptible_future<> RecoveryBackend::handle_backfill(
    MOSDPGBackfill &m,
    crimson::net::ConnectionRef conn)
{
    logger().debug("{}", __func__);
...
RecoveryBackend::interruptible_future<> RecoveryBackend::handle_backfill_remove(
...
RecoveryBackend::interruptible_future<> RecoveryBackend::handle_scan_get_digest(
    MOSDPGScan &m,
    crimson::net::ConnectionRef conn)
{
    logger().debug("{}", __func__);
...
RecoveryBackend::interruptible_future<> RecoveryBackend::handle_scan_digest(
    MOSDPGScan &m)
{
    logger().debug("{}", __func__);
...
RecoveryBackend::interruptible_future<> RecoveryBackend::handle_scan(
    MOSDPGScan &m,
    crimson::net::ConnectionRef conn)
{
    logger().debug("{}", __func__);
...
RecoveryBackend::interruptible_future<> RecoveryBackend::handle_recovery_op(
