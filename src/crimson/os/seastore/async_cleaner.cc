...
JournalTrimmerImpl::config_t JournalTrimmerImpl::config_t::get_test(std::size_t roll_size,
        journal_type_t type)
{
    assert(roll_size);
    std::size_t target_dirty_bytes = 0;
...
SegmentCleaner::do_reclaim_space_ret SegmentCleaner::do_reclaim_space(const std::vector < CachedExtentRef >
        &backref_extents,
    ...
    &runs] {
        ...
        t) {
            ...
            extents) {
                ...
                auto cached_backref_entries = backref_manager.get_cached_backref_entries_in_range(reclaim_state->start_pos,
                     ...
                     segment_id_t segment_id)
{
    ...
    SegmentManagerGroup::found_record_handler_t([this, segment_id, segment_header, FNAME](record_locator_t locator,
