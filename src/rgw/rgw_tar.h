...
static inline std::pair<class StatusIndicator,
           boost::optional<class HeaderView>> interpret_block(const StatusIndicator &status, ceph::bufferlist &bl);
...
static inline std::pair<StatusIndicator,
       boost::optional<HeaderView>> interpret_block(const StatusIndicator &status, ceph::bufferlist &bl)
{
