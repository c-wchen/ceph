          ...
          template < typename ImageCtxT = librbd::ImageCtx > class BootstrapRequest:public CancelableRequest
            {
              public:
                ...
                static BootstrapRequest *create(Threads < ImageCtxT > *threads,
                                                ...
                                                **state_builder,
                                                bool * do_resync,
                                                Context * on_finish) {
                    return new BootstrapRequest(threads, local_io_ctx,
                                                remote_io_ctx, instance_watcher,
                                                global_image_id,
                                                local_mirror_uuid,
                                                remote_pool_meta,
                                                cache_manager_handler,
                                                pool_meta_cache, progress_ctx,
                                                state_builder, do_resync,
                                                on_finish);
