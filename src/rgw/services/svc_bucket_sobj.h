...
class RGWSI_Bucket_SObj:public RGWSI_Bucket {
    ...
    using RGWChainedCacheImpl_bucket_info_cache_entry =
     ...
     std::unique_ptr < RGWChainedCacheImpl_bucket_info_cache_entry >
        binfo_cache;
  ...
  public:
    ...
    int read_bucket_entrypoint_info(RGWSI_Bucket_EP_Ctx & ctx,
                                    ...
                                    nullptr,
                                    boost::optional < obj_version >
                                    refresh_version = boost::none) override;
    ...
    int store_bucket_instance_info(RGWSI_Bucket_BI_Ctx & ctx, const std::string & key, RGWBucketInfo & info, std::optional < RGWBucketInfo * >orig_info,    /* nullopt: orig_info was not fetched,
