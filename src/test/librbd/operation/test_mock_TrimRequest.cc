    ...
    namespace io {
        ...
        template <>
            ...
            static ObjectRequest *create_discard(librbd::MockTestImageCtx *
                ...
                s_instance->construct(object_off, object_len,
                                      update_object_map);
                return s_instance;
            } ObjectRequest() {
                s_instance = this;
    ...
    namespace operation {
        ...
        class TestMockOperationTrimRequest:public TestMockFixture {
          public:
            ...
            typedef librbd::io::ObjectRequest < MockTestImageCtx >
                MockObjectRequest;
            ...
            void expect_object_discard(MockImageCtx & mock_image_ctx,
                ...
                EXPECT_CALL(mock_object_request, send())
                    .
                    WillOnce(Invoke
                             ([&mock_image_ctx, &mock_object_request,
                               ret_val] () {
                              mock_image_ctx.op_work_queue->
                              queue(mock_object_request.on_finish, ret_val);}));
            }
        };
