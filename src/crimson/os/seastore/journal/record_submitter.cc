...
RecordBatch::add_pending_ret RecordBatch::add_pending(
...
std::pair<ceph::bufferlist, record_group_size_t> RecordBatch::encode_batch(
...
std::pair<ceph::bufferlist, record_group_size_t> RecordBatch::submit_pending_fast(
    record_t&& record,
    extent_len_t block_size,
    const journal_seq_t &committed_to,
    segment_nonce_t segment_nonce)
...
RecordSubmitter::action_t RecordSubmitter::check_action(
...
RecordSubmitter::submit_ret RecordSubmitter::submit(
    record_t&& record,
