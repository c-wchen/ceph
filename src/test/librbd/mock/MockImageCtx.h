...
namespace librbd {
    ...
    namespace cache {
        ...
        :image_ctx(&image_ctx),
            ...
            journal_object_flush_interval(image_ctx.
            ...
            journal_max_concurrent_object_sets(image_ctx.
                                               journal_max_concurrent_object_sets),
            mirroring_resync_after_disconnect(image_ctx.
        ...
        MOCK_CONST_METHOD2(get_parent_overlap,
                           int (librados::snap_t in_snap_id,
                                uint64_t * overlap));
        MOCK_CONST_METHOD2(prune_parent_extents,
                           uint64_t(vector < pair < uint64_t, uint64_t > >&,
                                    uint64_t));
        ...
        MOCK_METHOD8(aio_read_from_cache,
                     void (object_t, uint64_t, bufferlist *, size_t, uint64_t,
                           Context *, int, ZTracer::Trace *));
        MOCK_METHOD8(write_to_cache,
                     void (object_t, const bufferlist &, size_t, uint64_t,
                           Context *, int, uint64_t, ZTracer::Trace *));
        ...
        std::map < std::pair < cls::rbd::SnapshotNamespace, std::string >,
            librados::snap_t > snap_ids;
