...
BtreeLBAManager::get_mappings_ret BtreeLBAManager::get_mappings(
    Transaction &t,
...
BtreeLBAManager::_get_mapping_ret BtreeLBAManager::_get_mapping(
    Transaction &t,
    laddr_t offset)
{
...
BtreeLBAManager::alloc_extents_ret BtreeLBAManager::_alloc_extents(
    Transaction &t,
    laddr_t hint,
...
BtreeLBAManager::base_iertr::template future < > _init_cached_extent(
    op_context_t < laddr_t > c,
...
BtreeLBAManager::check_child_trackers_ret BtreeLBAManager::check_child_trackers(
    Transaction &t)
{
    auto c = get_context(t);
    return with_btree < LBABtree > (
