...
PerfCounters *build_scrub_labeled_perf(CephContext *cct, std::string label)
{
    ...
    scrub_perf.add_time_avg(scrbcnt_resrv_successful_elapsed, "successful_reservations_elapsed",
    ...
    scrub_perf.add_u64_counter(scrbcnt_resrv_rejected, "reservation_process_failure",
                               "scrub reservation failed due to replica denial");
    scrub_perf.add_u64_counter(scrbcnt_resrv_skipped, "reservation_process_skipped",
                               "scrub reservation skipped for high priority scrub");
    scrub_perf.add_time_avg(scrbcnt_resrv_failed_elapsed, "failed_reservations_elapsed",
                            "time for scrub reservation to fail");
