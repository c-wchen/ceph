...
seastar::future<IOHandler::exit_dispatching_ret> IOHandler::wait_io_exit_dispatching(
    crosscore_t::seq_t cc_seq)
{
    assert(seastar::this_shard_id() == get_shard_id());
    if (!crosscore.proceed_or_wait(cc_seq)) {
...
seastar::future<> IOHandler::dispatch_accept(
    crosscore_t::seq_t cc_seq,
...
seastar::future<> IOHandler::dispatch_connect(
    crosscore_t::seq_t cc_seq,
    seastar::shard_id new_sid,
    ConnectionFRef conn_fref)
{
...
seastar::future<> IOHandler::to_new_sid(
    crosscore_t::seq_t cc_seq,
    seastar::shard_id new_sid,
    ConnectionFRef conn_fref,
...
seastar::future<> IOHandler::read_message(
    shard_states_t &ctx,
...
seastar::future<> IOHandler::close_io(
    crosscore_t::seq_t cc_seq,
...
void IOHandler::shard_states_t::notify_out_dispatching_stopped(
...
IOHandler::shard_states_ref_t IOHandler::shard_states_t::create_from_previous(
