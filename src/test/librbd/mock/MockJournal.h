...
namespace librados {
    ...
    namespace io {
        ...
        static MockJournal *get_instance() {
            ...
            static int is_tag_owner(ImageCtxT * image_ctx,
                                    bool * is_tag_owner) {
        ...
        MOCK_METHOD5(append_write_event, uint64_t(uint64_t, size_t,
                                                  ...
                                                  bool));
        MOCK_METHOD6(append_io_event_mock,
                     uint64_t(const journal::EventEntry &,
                              const ObjectRequests &, uint64_t, size_t, bool,
                              int));
        ...
        MOCK_METHOD3(append_op_event_mock,
