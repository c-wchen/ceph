...
#define dout_prefix *_dout << "librbd::migration::RawSnapshot::OpenRequest " \
        ...
        template < typename I > struct RawSnapshot <I >::OpenRequest {
            ...
            void handle_open_stream(int r) {
                ...
                if (r < 0) {
                    lderr(cct) << "failed to open stream: " << cpp_strerror(r)
                        << dendl;
                    finish(r);
                    return;
                }
            ...
            void get_image_size() {
                ...
                raw_snapshot->m_stream->get_size(&raw_snapshot->m_snap_info.
                                                 size, ctx);
            }
...
#define dout_prefix *_dout << "librbd::migration::RawSnapshot: " << this \
        ...
        template < typename I >
            ...
            int r =
                m_source_spec_builder->build_stream(m_json_object, &m_stream);
            if (r < 0) {
