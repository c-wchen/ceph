    ...
    namespace io {
        ...
        using util::get_image_ctx;
         ...
         namespace {
            ...
            template < typename ImageCtxT = ImageCtx > struct C_DiscardRequest {
                ...
                ObjectExtents object_extents;
                 ...
                 C_DiscardRequest(ImageCtxT & image_ctx,
                                  AioCompletion * aio_completion,
                ...
                :image_ctx(image_ctx), aio_completion(aio_completion),
                    ...
                    CephContext *cct = image_ctx.cct;
                     ldout(cct,
                           20) <<
                        "C_DiscardRequest: delaying cache discard until " <<
                    ...
                    // the discard request
                     ...
                     image_ctx.object_cacher->discard_writeback(image_ctx.
                                                                object_set,
                                                                object_extents,
                                                                ctx);
                    ...
                    {
                        Mutex::Locker cache_locker(image_ctx.cache_lock);
                        image_ctx.object_cacher->discard_set(image_ctx.
                                                             object_set,
                                                             object_extents);
                    }
            ...
            template < typename ImageCtxT = ImageCtx >
                ...
                C_DiscardJournalCommit(ImageCtxT & _image_ctx,
                                       ...
                                       *discard_request, uint64_t tid)
                :image_ctx(_image_ctx), discard_request(discard_request) {
                    CephContext *cct = image_ctx.cct;
                     ldout(cct,
                           20) << "delaying cache discard until journal tid " <<
                        tid << " " << "safe" << dendl;
            ...
            template < typename ImageCtxT = ImageCtx >
                ...
                AioCompletion *aio_comp;
                 ...
                 C_FlushJournalCommit(ImageCtxT & _image_ctx,
                                      AioCompletion * _aio_comp, uint64_t tid)
                :image_ctx(_image_ctx), aio_comp(_aio_comp) {
                    ...
                    CephContext *cct = image_ctx.cct;
                    ldout(cct,
                          20) << "C_FlushJournalCommit: journal committed" <<
                        dendl;
        ...
        template < typename I >
            ImageRequest < I > *ImageRequest <
            I >::create_read_request(I & image_ctx, AioCompletion * aio_comp,
                                     Extents && image_extents, ReadResult
        ...
        template < typename I >
            ImageRequest < I > *ImageRequest <
            I >::create_write_request(I & image_ctx, AioCompletion * aio_comp,
                                      Extents && image_extents, bufferlist
                                      && bl, int op_flags,
                                      const ZTracer::Trace & parent_trace) {
            return new ImageWriteRequest < I > (image_ctx, aio_comp,
                                                std::move(image_extents),
        ...
        template < typename I >
            ImageRequest < I > *ImageRequest <
            I >::create_discard_request(I & image_ctx, AioCompletion * aio_comp,
        ...
        template < typename I >
            ImageRequest < I > *ImageRequest <
            I >::create_flush_request(I & image_ctx, AioCompletion * aio_comp,
                                      const ZTracer::Trace & parent_trace) {
            return new ImageFlushRequest < I > (image_ctx, aio_comp,
                                                parent_trace);
        }

        template < typename I >
            ImageRequest < I > *ImageRequest <
            I >::create_writesame_request(I & image_ctx,
                                          AioCompletion * aio_comp,
                                          uint64_t off, uint64_t len, bufferlist
                                          && bl, int op_flags,
                                          const ZTracer::Trace & parent_trace) {
            return new ImageWriteSameRequest < I > (image_ctx, aio_comp, off,
                                                    len, std::move(bl),
        ...
        template < typename I >
            ImageRequest < I > *ImageRequest <
            I >::create_compare_and_write_request(I & image_ctx,
        ...
        template < typename I >
            void ImageRequest < I >::aio_writesame(I * ictx, AioCompletion * c,
                                                   ...
                                                   const ZTracer::
                                                   Trace & parent_trace) {
            ImageWriteSameRequest < I > req(*ictx, c, off, len, std::move(bl),
                                            op_flags, parent_trace);
            req.send();
        }
        ...
        template < typename I > int ImageRequest < I >::clip_request() {
            RWLock::RLocker snap_locker(m_image_ctx.snap_lock);
          for (auto & image_extent:m_image_extents) {
                auto clip_len = image_extent.second;
                int r =
                    clip_io(get_image_ctx(&m_image_ctx), image_extent.first,
                            &clip_len);
                if (r < 0) {
                    return r;
                }
        ...
        template < typename I > void ImageRequest < I >::start_op() {
            m_aio_comp->start_op();
        }

        template < typename I > void ImageRequest < I >::fail(int r) {
            AioCompletion *aio_comp = this->m_aio_comp;
            aio_comp->get();
            aio_comp->fail(r);
        }
        ...
        :ImageRequest < I > (image_ctx, aio_comp, std::move(image_extents),
                             "read", parent_trace), m_op_flags(op_flags) {
            aio_comp->read_result = std::move(read_result);
        }

        template < typename I > int ImageReadRequest < I >::clip_request() {
        ...
        template < typename I > void ImageReadRequest < I >::send_request() {
            ...
            uint64_t buffer_ofs = 0;
            {
              ...
              for (auto & extent:image_extents) {
                    ...
                    Striper::file_to_extents(cct, image_ctx.format_string,
                                             &image_ctx.layout, extent.first,
                                             extent.second, 0, object_extents,
                                             buffer_ofs);
          ...
          for (auto & object_extent:object_extents) {
              for (auto & extent:object_extent.second) {
                    ldout(cct,
                          20) << "oid " << extent.oid << " " << extent.
                        offset << "~" << extent.length << " from " << extent.
                        buffer_extents << dendl;

                    auto req_comp =
                        new io::ReadResult::C_SparseReadRequest < I > (aio_comp,
                                                                       std::
                                                                       move
                                                                       (extent.
                                                                        buffer_extents),
                                                                       true);
                    ObjectReadRequest < I > *req =
                        ObjectReadRequest < I >::create(&image_ctx,
                                                        extent.oid.name,
                                                        extent.objectno,
                                                        extent.offset,
                                                        extent.length, snap_id,
                                                        m_op_flags, false,
                                                        this->m_trace,
                                                        req_comp);
        ...
        template < typename I >
            ...
            auto *req_comp =
                new io::ReadResult::C_ImageReadRequest(aio_comp,
        ...
        template < typename I >
            ...
            I >::send_object_requests(const ObjectExtents & object_extents,
            ...
            for (ObjectExtents::const_iterator p = object_extents.begin();
                ...
                ldout(cct,
                      20) << "oid " << p->oid << " " << p->offset << "~" << p->
                    length << " from " << p->buffer_extents << dendl;
        ...
        template < typename I >
            ...
            I >::assemble_extent(const ObjectExtent & object_extent,
                                 bufferlist * bl) {
        ...
        template < typename I >
            ...
            I >::append_journal_event(const ObjectRequests & requests,
                                      bool synchronous) {
            I & image_ctx = this->m_image_ctx;
        ...
        template < typename I >
            void ImageWriteRequest <
            I >::
            send_object_cache_requests(const ObjectExtents & object_extents,
            ...
            for (auto p = object_extents.begin(); p != object_extents.end();
                ...
                AioCompletion *aio_comp = this->m_aio_comp;
                C_AioRequest *req_comp = new C_AioRequest(aio_comp);
                image_ctx.write_to_cache(object_extent.oid, bl,
                                         object_extent.length,
                                         object_extent.offset, req_comp,
                                         m_op_flags, journal_tid,
                                         (this->m_trace.valid()? &this->
                                          m_trace : nullptr));
            }
        }
        ...
        template < typename I >
            ...
            if (image_ctx.object_cacher == NULL) {
                AbstractImageWriteRequest <
                    I >::send_object_requests(object_extents, snapc,
                                              object_requests);
            }
        }

        template < typename I >
            ObjectRequestHandle * ImageWriteRequest <
            I >::create_object_request(const ObjectExtent & object_extent,
                                       const::SnapContext & snapc,
                                       Context * on_finish) {
            I & image_ctx = this->m_image_ctx;
            ...
            assemble_extent(object_extent, &bl);
            ObjectRequest < I > *req =
                ObjectRequest < I >::create_write(&image_ctx,
        ...
        template < typename I >
            ...
            I >::prune_object_extents(ObjectExtents & object_extents) {
            I & image_ctx = this->m_image_ctx;
            CephContext *cct = image_ctx.cct;
            ...
            for (auto p = object_extents.begin(); p != object_extents.end();) {
                if (p->offset + p->length < image_ctx.layout.object_size) {
                    ldout(cct,
                          20) << "oid " << p->oid << " " << p->
                        offset << "~" << p->length << " from " << p->
                        buffer_extents << ": skip partial discard" << dendl;
        ...
        template < typename I >
            ...
            I >::get_object_cache_request_count()const {
        ...
        template < typename I >
            ...
            auto req =
                new C_DiscardRequest < I > (image_ctx, aio_comp,
                                            object_extents);
            if (journal_tid == 0) {
                req->send();
            }
                ...
                assert(image_ctx.journal != NULL);
                image_ctx.journal->wait_event(journal_tid,
                                              new C_DiscardJournalCommit < I >
                                              (image_ctx, req, journal_tid));
            }
        }

        template < typename I >
            ObjectRequestHandle * ImageDiscardRequest <
            I >::create_object_request(const ObjectExtent & object_extent,
                                       const::SnapContext & snapc,
                                       Context * on_finish) {
            I & image_ctx = this->m_image_ctx;
            ...
            auto req =
                ObjectRequest < I >::create_discard(&image_ctx,
                                                    object_extent.oid.name,
                                                    object_extent.objectno,
                                                    object_extent.offset,
                                                    object_extent.length, snapc,
                                                    true, true,
                                                    this->m_trace, on_finish);
            return req;
        }
            ...
            if (journaling) {
                ...
                uint64_t journal_tid =
                    ...
                    append_io_event(journal::
                                    EventEntry(journal::AioFlushEvent()),
                                    ObjectRequests(), 0, 0, false, 0);

                aio_comp->set_request_count(1);
                aio_comp->associate_journal_event(journal_tid);

                FunctionContext *flush_ctx = new FunctionContext([aio_comp,
                                                                  &image_ctx,
                                                                  journal_tid]
                                                                 (int r){
                                                                 auto ctx =
                                                                 new
                                                                 C_FlushJournalCommit
                                                                 < I >
                                                                 (image_ctx,
                                                                  aio_comp,
                                                                  journal_tid);
        ...
        template < typename I >
            bool ImageWriteSameRequest <
            I >::assemble_writesame_extent(const ObjectExtent & object_extent,
            ...
            if (!force_write) {
                ...
                for (auto q = object_extent.buffer_extents.begin();
                     q != object_extent.buffer_extents.end(); ++q) {
                    if (!
                        (q->first % m_data_len == 0
                         && q->second % m_data_len == 0)) {
                        may_writesame = false;
                        break;
                    }
                }
        ...
        template < typename I >
          ...
          for (auto & extent:this->m_image_extents) {
                C_AioRequest *req_comp = new C_AioRequest(aio_comp);
                image_ctx.image_cache->aio_writesame(extent.first,
                                                     extent.second,
                                                     std::move(m_data_bl),
                                                     m_op_flags, req_comp);
            }
        ...
        template < typename I >
            ObjectRequestHandle * ImageWriteSameRequest <
            I >::create_object_request(const ObjectExtent & object_extent,
                                       const::SnapContext & snapc,
                                       Context * on_finish) {
            I & image_ctx = this->m_image_ctx;
            ...
            if (assemble_writesame_extent(object_extent, &bl, false)) {
                req =
                    ObjectRequest < I >::create_writesame(&image_ctx,
                                                          object_extent.oid.
                                                          name,
                                                          object_extent.
                                                          objectno,
        ...
        template < typename I >
            uint32_t ImageCompareAndWriteRequest <
            I >::get_object_cache_request_count()const {
            // extra completion request is required for tracking discard
            I & image_ctx = this->m_image_ctx;
            return (image_ctx.object_cacher != nullptr ? 1 : 0);
        ...
        template < typename I >
            ...
            aio_comp->set_request_count(1);
            C_AioRequest *req_comp = new C_AioRequest(aio_comp);
            image_ctx.image_cache->
                aio_compare_and_write(std::move(this->m_image_extents),
                                      std::move(m_cmp_bl), std::move(m_bl),
                                      m_mismatch_offset, m_op_flags, req_comp);
        }

        template < typename I >
            ObjectRequestHandle * ImageCompareAndWriteRequest <
            I >::create_object_request(const ObjectExtent & object_extent,
                                       const::SnapContext & snapc,
                                       Context * on_finish) {
            I & image_ctx = this->m_image_ctx;
            ...
            assemble_extent(object_extent, &bl);
            ObjectRequest < I > *req =
                ObjectRequest < I >::create_compare_and_write(&image_ctx,
                                                              object_extent.oid.
                                                              name,
                                                              object_extent.
                                                              objectno,
        ...
        template < typename I >
            ...
            if (object_extent.offset % sector_size + object_extent.length >
                sector_size || (su != 0
                                && (object_extent.offset % su +
                                    object_extent.length > su)))
                return -EINVAL;
