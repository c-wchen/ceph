...
public:
     ...
     */
    static bool translate_raw_obj_to_obj_in_ns(std::string &obj,
            std::string &instance,
            std::string &ns)
    {
        if (obj[0] != '_') {
     ...
     * false if it fails.
     */
    static bool strip_namespace_from_object(std::string &obj, std::string &ns,
                                            std::string &instance)
    {
        ns.clear();
        instance.clear();
...
struct test_rgw_env {
    ...
    test_rgw_env()
    {
        ...
        default_placement.data_pool =
            rgw_pool(zone_params.
                     placement_pools[zonegroup.default_placement.name].
