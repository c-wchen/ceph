    ...
    namespace image {
        ...
        template <> struct CreateRequest <librbd::MockTestImageCtx > {
            ...
            static CreateRequest *create(IoCtx & ioctx,
                                         ...
                                         const std::
                                         string & non_primary_global_image_id,
                                         const std::
        ...
        CreateRequest < librbd::MockTestImageCtx > *CreateRequest <
        ...
        CloneRequest < librbd::MockTestImageCtx > *CloneRequest <
            librbd::MockTestImageCtx >::s_instance = nullptr;
...
namespace rbd {
    namespace mirror {
        namespace image_replayer {
            ...
            } class TestMockImageReplayerCreateImageRequest:public
                TestMockFixture {
              public:
                typedef librbd::image::CreateRequest <
                    librbd::MockTestImageCtx > MockCreateRequest;
                typedef librbd::image::CloneRequest < librbd::MockTestImageCtx >
                    MockCloneRequest;
                ...
                void SetUp() override {
                                  ...
                                  const std::string & clone_name) {
                    {
                        librbd::ImageCtx * ictx =
                            new librbd::ImageCtx(parent_image_ctx->name, "", "",
                ...
                void expect_mirror_image_get_image_id(librados::IoCtx & io_ctx,
                    ...
                    EXPECT_CALL(get_mock_io_ctx(io_ctx),
                                exec(RBD_MIRRORING, _, StrEq("rbd"),
                                     StrEq("mirror_image_get_image_id"), _, _,
                                     _))
                        .
                        WillOnce(DoAll
                                 (WithArg < 5 >
                ...
                void expect_clone_image(MockCloneRequest & mock_clone_request,
                                        librbd::
                                        MockTestImageCtx & mock_parent_imctx,
                                        int r) {
                    EXPECT_CALL(mock_clone_request,
                                construct(&mock_parent_imctx));
                    EXPECT_CALL(mock_clone_request, send())
                        .WillOnce(Invoke([this, &mock_clone_request, r] () {
                                         m_threads->work_queue->
                                         queue(mock_clone_request.on_finish,
                                               r);}));
                }
                ...
                MockCreateImageRequest *create_request(const std::
                                                       ...
                                                       Context * on_finish) {
                    return new MockCreateImageRequest(m_local_io_ctx,
                                                      m_threads->work_queue,
                                                      global_image_id,
                                                      remote_mirror_uuid,
                                                      local_image_name,
            ...
            TEST_F(TestMockImageReplayerCreateImageRequest, Create) {
                ...
                C_SaferCond ctx;
                MockCreateImageRequest *request =
                    create_request("global uuid", "remote uuid",
            ...
            TEST_F(TestMockImageReplayerCreateImageRequest, CreateError) {
                ...
                InSequence seq;
                expect_create_image(mock_create_request, m_local_io_ctx,
                                    -EINVAL);
            ...
            TEST_F(TestMockImageReplayerCreateImageRequest, Clone) {
                ...
                ASSERT_EQ(0,
                          clone_image(m_remote_image_ctx, "snap",
                                      clone_image_name));
                ...
                librbd::
                    MockTestImageCtx
                    mock_local_parent_image_ctx(*local_image_ctx);
                librbd::
                    MockTestImageCtx
                ...
                expect_get_parent_global_image_id(m_remote_io_ctx,
                                                  "global uuid", 0);
                expect_mirror_image_get_image_id(m_local_io_ctx,
                                                 "local parent id", 0);
                ...
                expect_open_image(mock_open_image_request, m_local_io_ctx,
                                  "local parent id",
                                  mock_local_parent_image_ctx, 0);
                expect_snap_set(mock_local_parent_image_ctx, "snap", 0);
                expect_clone_image(mock_clone_request,
                                   mock_local_parent_image_ctx, 0);
            ...
            TEST_F(TestMockImageReplayerCreateImageRequest,
            ...
            TEST_F(TestMockImageReplayerCreateImageRequest,
                ...
                expect_open_image(mock_open_image_request, m_local_io_ctx,
                                  "local parent id",
                                  mock_local_parent_image_ctx, -ENOENT);
                expect_close_image(mock_close_image_request,
                                   mock_remote_parent_image_ctx, 0);
            ...
            TEST_F(TestMockImageReplayerCreateImageRequest, CloneError) {
                ...
                expect_snap_set(mock_local_parent_image_ctx, "snap", 0);
                expect_clone_image(mock_clone_request,
                                   mock_local_parent_image_ctx, -EINVAL);
                expect_close_image(mock_close_image_request,
                                   mock_local_parent_image_ctx, 0);
                expect_close_image(mock_close_image_request,
                                   mock_remote_parent_image_ctx, 0);
            ...
            TEST_F(TestMockImageReplayerCreateImageRequest,
                ...
                expect_close_image(mock_close_image_request,
                                   mock_local_parent_image_ctx, 0);
                expect_close_image(mock_close_image_request,
                                   mock_remote_parent_image_ctx, -EINVAL);
