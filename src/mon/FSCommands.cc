...
public:
    ...
    string const &get_prefix() const override
    {
        return alias_prefix;
    }
...
public:
    ...
    boost::optional < pair < string, string>> extract_remote_cluster_conf(const string &spec)
    {
        auto pos = spec.find("@");
...
list < std::shared_ptr < FileSystemCommandHandler> > FileSystemCommandHandler::load(Paxos *paxos)
{
