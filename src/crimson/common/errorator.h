...
// AllowedErrorsV and also avoid the burden of throwing.
    ...
    template < class ... AllowedErrors > struct errorator {
      ...
      template < class ValueT > class[[nodiscard]] _future <::crimson::errorated_future_marker < ValueT >>:private seastar::future < ValueT >
        {
     ...
     */
      ...
      public:
        ...
        template < typename Iterator, typename Func >
            ...
            parallel_for_each(Iterator first, Iterator last, Func
                              && func) noexcept {
