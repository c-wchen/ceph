...
public:
    ...
    uint64_t get_blob_limit() override
    {
...
public:
    SQLInsertUser(void **db, std::string db_name, CephContext *cct) : SQLiteDB((sqlite3 *)(*db), db_name, cct),
        sdb((sqlite3 * *)db) {}
    ~SQLInsertUser()
    {
        if (stmt) {
...
public:
    SQLRemoveUser(void **db, std::string db_name, CephContext *cct) : SQLiteDB((sqlite3 *)(*db), db_name, cct),
        sdb((sqlite3 * *)db) {}
    ~SQLRemoveUser()
    {
        if (stmt) {
...
public:
    SQLGetUser(void **db, std::string db_name, CephContext *cct) : SQLiteDB((sqlite3 *)(*db), db_name, cct),
        sdb((sqlite3 * *)db) {}
    ~SQLGetUser()
    {
        if (stmt) {
...
public:
    SQLInsertBucket(void **db, std::string db_name, CephContext *cct) : SQLiteDB((sqlite3 *)(*db), db_name, cct),
        sdb((sqlite3 * *)db) {}
    ~SQLInsertBucket()
    {
        if (stmt) {
...
public:
    SQLUpdateBucket(void **db, std::string db_name, CephContext *cct) : SQLiteDB((sqlite3 *)(*db), db_name, cct),
        sdb((sqlite3 * *)db) {}
    ~SQLUpdateBucket()
    {
        if (info_stmt) {
...
public:
    SQLRemoveBucket(void **db, std::string db_name, CephContext *cct) : SQLiteDB((sqlite3 *)(*db), db_name, cct),
        sdb((sqlite3 * *)db) {}
    ~SQLRemoveBucket()
    {
        if (stmt) {
...
public:
    SQLGetBucket(void **db, std::string db_name, CephContext *cct) : SQLiteDB((sqlite3 *)(*db), db_name, cct),
        sdb((sqlite3 * *)db) {}
    ~SQLGetBucket()
    {
        if (stmt) {
...
public:
    SQLListUserBuckets(void **db, std::string db_name, CephContext *cct) : SQLiteDB((sqlite3 *)(*db), db_name, cct),
        sdb((sqlite3 * *)db) {}
    ~SQLListUserBuckets()
    {
        if (stmt) {
...
public:
    SQLPutObject(void **db, std::string db_name, CephContext *cct) : SQLiteDB((sqlite3 *)(*db), db_name, cct),
        sdb((sqlite3 * *)db) {}
...
public:
    SQLDeleteObject(void **db, std::string db_name, CephContext *cct) : SQLiteDB((sqlite3 *)(*db), db_name, cct),
        sdb((sqlite3 * *)db) {}
...
public:
    SQLGetObject(void **db, std::string db_name, CephContext *cct) : SQLiteDB((sqlite3 *)(*db), db_name, cct),
        sdb((sqlite3 * *)db) {}
...
public:
    SQLUpdateObject(void **db, std::string db_name, CephContext *cct) : SQLiteDB((sqlite3 *)(*db), db_name, cct),
        sdb((sqlite3 * *)db) {}
...
public:
    SQLListBucketObjects(void **db, std::string db_name, CephContext *cct) : SQLiteDB((sqlite3 *)(*db), db_name, cct),
        sdb((sqlite3 * *)db) {}
    SQLListBucketObjects(sqlite3 **sdbi, std::string db_name, CephContext *cct) : SQLiteDB(*sdbi, db_name, cct),
        sdb(sdbi) {}
...
public:
    SQLListVersionedObjects(void **db, std::string db_name, CephContext *cct) : SQLiteDB((sqlite3 *)(*db), db_name, cct),
        sdb((sqlite3 * *)db) {}
    SQLListVersionedObjects(sqlite3 **sdbi, std::string db_name, CephContext *cct) : SQLiteDB(*sdbi, db_name, cct),
        sdb(sdbi) {}
...
public:
    SQLPutObjectData(void **db, std::string db_name, CephContext *cct) : SQLiteDB((sqlite3 *)(*db), db_name, cct),
        sdb((sqlite3 * *)db) {}
...
public:
    SQLUpdateObjectData(void **db, std::string db_name, CephContext *cct) : SQLiteDB((sqlite3 *)(*db), db_name, cct),
        sdb((sqlite3 * *)db) {}
...
public:
    SQLGetObjectData(void **db, std::string db_name, CephContext *cct) : SQLiteDB((sqlite3 *)(*db), db_name, cct),
        sdb((sqlite3 * *)db) {}
...
public:
    SQLDeleteObjectData(void **db, std::string db_name, CephContext *cct) : SQLiteDB((sqlite3 *)(*db), db_name, cct),
        sdb((sqlite3 * *)db) {}
...
public:
    SQLDeleteStaleObjectData(void **db, std::string db_name, CephContext *cct) : SQLiteDB((sqlite3 *)(*db), db_name, cct),
        sdb((sqlite3 * *)db) {}
    SQLDeleteStaleObjectData(sqlite3 **sdbi, std::string db_name, CephContext *cct) : SQLiteDB(*sdbi, db_name, cct),
        sdb(sdbi) {}
...
public:
    SQLInsertLCEntry(void **db, std::string db_name, CephContext *cct) : SQLiteDB((sqlite3 *)(*db), db_name, cct),
        sdb((sqlite3 * *)db) {}
    ~SQLInsertLCEntry()
    {
        if (stmt) {
...
public:
    SQLRemoveLCEntry(void **db, std::string db_name, CephContext *cct) : SQLiteDB((sqlite3 *)(*db), db_name, cct),
        sdb((sqlite3 * *)db) {}
    ~SQLRemoveLCEntry()
    {
        if (stmt) {
...
public:
    SQLGetLCEntry(void **db, std::string db_name, CephContext *cct) : SQLiteDB((sqlite3 *)(*db), db_name, cct),
        sdb((sqlite3 * *)db) {}
    ~SQLGetLCEntry()
    {
        if (stmt) {
...
public:
    SQLListLCEntries(void **db, std::string db_name, CephContext *cct) : SQLiteDB((sqlite3 *)(*db), db_name, cct),
        sdb((sqlite3 * *)db) {}
    ~SQLListLCEntries()
    {
        if (stmt) {
...
public:
    SQLInsertLCHead(void **db, std::string db_name, CephContext *cct) : SQLiteDB((sqlite3 *)(*db), db_name, cct),
        sdb((sqlite3 * *)db) {}
    ~SQLInsertLCHead()
    {
        if (stmt) {
...
public:
    SQLRemoveLCHead(void **db, std::string db_name, CephContext *cct) : SQLiteDB((sqlite3 *)(*db), db_name, cct),
        sdb((sqlite3 * *)db) {}
    ~SQLRemoveLCHead()
    {
        if (stmt) {
...
public:
    SQLGetLCHead(void **db, std::string db_name, CephContext *cct) : SQLiteDB((sqlite3 *)(*db), db_name, cct),
        sdb((sqlite3 * *)db) {}
    ~SQLGetLCHead()
    {
        if (stmt) {
