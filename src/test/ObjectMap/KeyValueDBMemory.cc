...
int KeyValueDBMemory::set(const string &prefix,
                          const string &key, const bufferlist &bl)
{
...
int KeyValueDBMemory::rm_range_keys(const string &prefix, const string &start,
                                    const string &end)
{
    map < std::pair < string, string >, bufferlist >::iterator i;
...
KeyValueDB::WholeSpaceIterator KeyValueDBMemory::
...
public:
    ...
    explicit WholeSpaceSnapshotMemIterator(KeyValueDBMemory *
                                           db): WholeSpaceMemIterator(db)
    {
