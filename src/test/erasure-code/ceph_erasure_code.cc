...
int ErasureCodeCommand::setup(int argc, char **argv)
{
    ...
    desc.add_options()
        ...
        ("all", "implies "
         ...
         "--get_coding_chunk_count " "--get_chunk_count ")
        ...
        ("parameter,P", po::value < vector < string > >(), "parameters")
...
int ErasureCodeCommand::display_information()
{
    ...
    if (vm.count("all") || vm.count("get_chunk_count"))
        cout << "get_chunk_count\t" << erasure_code->get_chunk_count() << endl;
    return 0;
}
