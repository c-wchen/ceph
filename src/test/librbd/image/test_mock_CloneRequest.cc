...
namespace librbd {
    ...
    namespace deep_copy {
        ...
        MetadataCopyRequest < MockTestImageCtx > *MetadataCopyRequest <
    ...
    namespace image {
        ...
        AttachChildRequest < MockTestImageCtx > *AttachChildRequest <
            MockTestImageCtx >::s_instance = nullptr;
        ...
        AttachParentRequest < MockTestImageCtx > *AttachParentRequest <
            MockTestImageCtx >::s_instance = nullptr;
        ...
        CreateRequest < MockTestImageCtx > *CreateRequest <
            MockTestImageCtx >::s_instance = nullptr;
        ...
        RemoveRequest < MockTestImageCtx > *RemoveRequest <
            MockTestImageCtx >::s_instance = nullptr;
    ...
    namespace mirror {
        ...
        EnableRequest < MockTestImageCtx > *EnableRequest <
            MockTestImageCtx >::s_instance = nullptr;
    ...
    namespace image {
        ...
        class TestMockImageCloneRequest:public TestMockFixture {
          public:
            ...
            typedef mirror::EnableRequest < MockTestImageCtx >
            ...
            void SetUp() override {
                ...
                if (is_feature_enabled(RBD_FEATURE_LAYERING)) {
                    ...
                    uint64_t snap_id = image_ctx->snap_ids[{ cls::rbd::
            ...
            void expect_get_min_compat_client(int8_t min_compat_client, int r) {
                ...
                EXPECT_CALL(*mock_rados_client, get_min_compatible_client(_, _))
                    .
                    WillOnce(Invoke
                             ([min_compat_client, r] (int8_t * min,
                                                      int8_t * required_min) {
                              *min = min_compat_client;
                              *required_min = min_compat_client; return r;}
                             ));
            }

            void expect_get_image_size(MockTestImageCtx & mock_image_ctx,
                                       uint64_t snap_id, uint64_t size) {
                EXPECT_CALL(mock_image_ctx, get_image_size(snap_id))
                    .WillOnce(Return(size));
            }

            void expect_is_snap_protected(MockImageCtx & mock_image_ctx,
                                          bool is_protected, int r) {
                EXPECT_CALL(mock_image_ctx, is_snap_protected(_, _))
                    .WillOnce(WithArg < 1 >
                              (Invoke([is_protected, r] (bool * is_prot) {
                                      *is_prot = is_protected; return r;}
                               )));
            }
            ...
            void expect_attach_parent(MockAttachParentRequest & mock_request,
                                      int r) {
            ...
            void expect_attach_child(MockAttachChildRequest & mock_request,
                ...
                EXPECT_CALL(mock_request, send())
                    .WillOnce(Invoke([this, &mock_request, clone_format, r] () {
                                     EXPECT_EQ(mock_request.clone_format,
                                               clone_format);
                                     image_ctx->op_work_queue->
                                     queue(mock_request.on_finish, r);}));
            }

            void expect_metadata_copy(MockMetadataCopyRequest & mock_request,
                                      int r) {
                EXPECT_CALL(mock_request, send())
                    .WillOnce(Invoke([this, &mock_request, r] () {
                                     image_ctx->op_work_queue->
            ...
            void expect_mirror_mode_get(MockTestImageCtx & mock_image_ctx,
                ...
                EXPECT_CALL(get_mock_io_ctx(mock_image_ctx.md_ctx),
                    ...
                    .WillOnce(WithArg < 5 >
                              (Invoke([out_bl, r] (bufferlist * out) {
                                      *out = out_bl; return r;}
                               )));
            }

            void expect_mirror_enable(MockMirrorEnableRequest &
                                      mock_mirror_enable_request, int r) {
                EXPECT_CALL(mock_mirror_enable_request, send())
                    .WillOnce(Invoke([this, &mock_mirror_enable_request, r] () {
                                     image_ctx->op_work_queue->
                                     queue(mock_mirror_enable_request.on_finish,
                                           r);}));
            }
            ...
            void expect_close(MockImageCtx & mock_image_ctx, int r) {
                EXPECT_CALL(*mock_image_ctx.state, close(_))
                    .WillOnce(Invoke([this, r] (Context * ctx) {
                                     image_ctx->op_work_queue->queue(ctx,
                                                                     r);}));
            }
            ...
            void expect_remove(MockRemoveRequest & mock_remove_request, int r) {
                EXPECT_CALL(mock_remove_request, send())
                    .WillOnce(Invoke([this, &mock_remove_request, r] () {
                                     image_ctx->op_work_queue->
                                     queue(mock_remove_request.on_finish,
                                           r);}));
            }
        ...
        TEST_F(TestMockImageCloneRequest, SuccessV1) {
            ...
            expect_get_image_size(mock_image_ctx, mock_image_ctx.snaps.front(),
                                  123);
            ...
            if (is_feature_enabled(RBD_FEATURE_JOURNALING)) {
                expect_test_features(mock_image_ctx, RBD_FEATURE_JOURNALING,
                                     true);
                expect_mirror_mode_get(mock_image_ctx,
                                       cls::rbd::MIRROR_MODE_POOL, 0);
            ...
            auto req =
                new MockCloneRequest(m_cct->_conf, m_ioctx, "parent id", "", { }
                                     , 123,
                                     m_ioctx, "clone name", "clone id",
                                     clone_opts,
        ...
        TEST_F(TestMockImageCloneRequest, GetMirrorModeError) {
            ...
            expect_mirror_mode_get(mock_image_ctx, cls::rbd::MIRROR_MODE_POOL,
                                   -EINVAL);
