...
TEST_F(StriperTest, SimpleWrite)
{
    ...
    ASSERT_EQ(0,
              rados_striper_aio_write(striper, "StriperTest", my_completion,
                                      buf, sizeof(buf), 0));
    TestAlarm alarm;
...
TEST_F(StriperTestPP, SimpleWritePP)
{
    ...
    ASSERT_EQ(0,
              striper.aio_write("SimpleWritePP", my_completion, bl1,
                                sizeof(buf), 0));
    TestAlarm alarm;
    sem_wait(test_data.m_sem);
    sem_wait(test_data.m_sem);
...
TEST_F(StriperTest, WaitForSafe)
{
    ...
    memset(buf, 0xcc, sizeof(buf));
    ASSERT_EQ(0,
              rados_striper_aio_write(striper, "WaitForSafe", my_completion,
                                      buf, sizeof(buf), 0));
    TestAlarm alarm;
...
TEST_F(StriperTestPP, WaitForSafePP)
{
    ...
    bl1.append(buf, sizeof(buf));
    ASSERT_EQ(0,
              striper.aio_write("WaitForSafePP", my_completion, bl1,
                                sizeof(buf), 0));
    TestAlarm alarm;
...
TEST_F(StriperTest, RoundTrip)
{
    ...
    memset(buf, 0xcc, sizeof(buf));
    ASSERT_EQ(0,
              rados_striper_aio_write(striper, "RoundTrip", my_completion, buf,
                                      sizeof(buf), 0));
    {
        TestAlarm alarm;
        sem_wait(test_data.m_sem);
...
TEST_F(StriperTest, RoundTrip2)
{
    ...
    memset(buf, 0xcc, sizeof(buf));
    ASSERT_EQ(0,
              rados_striper_aio_write(striper, "RoundTrip2", my_completion, buf,
                                      sizeof(buf), 0));
    {
        TestAlarm alarm;
        sem_wait(test_data.m_sem);
...
TEST_F(StriperTestPP, RoundTripPP)
{
    ...
    bl1.append(buf, sizeof(buf));
    ASSERT_EQ(0,
              striper.aio_write("RoundTripPP", my_completion, bl1, sizeof(buf),
                                0));
    {
        TestAlarm alarm;
        sem_wait(test_data.m_sem);
...
TEST_F(StriperTestPP, RoundTripPP2)
{
    ...
    bl1.append(buf, sizeof(buf));
    ASSERT_EQ(0,
              striper.aio_write("RoundTripPP2", my_completion, bl1, sizeof(buf),
                                0));
    {
        TestAlarm alarm;
        sem_wait(test_data.m_sem);
...
TEST_F(StriperTest, IsComplete)
{
    ...
    memset(buf, 0xcc, sizeof(buf));
    ASSERT_EQ(0,
              rados_striper_aio_write(striper, "IsComplete", my_completion, buf,
                                      sizeof(buf), 0));
    {
        TestAlarm alarm;
        sem_wait(test_data.m_sem);
...
TEST_F(StriperTestPP, IsCompletePP)
{
    ...
    bl1.append(buf, sizeof(buf));
    ASSERT_EQ(0,
              striper.aio_write("IsCompletePP", my_completion, bl1, sizeof(buf),
                                0));
    {
        TestAlarm alarm;
        sem_wait(test_data.m_sem);
...
TEST_F(StriperTest, IsSafe)
{
    ...
    memset(buf, 0xcc, sizeof(buf));
    ASSERT_EQ(0,
              rados_striper_aio_write(striper, "IsSafe", my_completion, buf,
                                      sizeof(buf), 0));
    {
        TestAlarm alarm;
        // Busy-wait until the AIO completes.
...
TEST_F(StriperTestPP, IsSafePP)
{
    ...
    bl1.append(buf, sizeof(buf));
    ASSERT_EQ(0,
              striper.aio_write("IsSafePP", my_completion, bl1, sizeof(buf),
                                0));
    {
        TestAlarm alarm;
        // Busy-wait until the AIO completes.
    ...
    AioCompletion *my_completion2 = librados::Rados::aio_create_completion
        ((void *)&test_data, set_completion_complete, set_completion_safe);
    ASSERT_EQ(0,
              striper.aio_read("IsSafePP", my_completion2, &bl2, sizeof(buf),
                               0));
    {
        TestAlarm alarm;
        my_completion2->wait_for_complete();
...
TEST_F(StriperTestPP, RoundTripAppendPP)
{
    ...
    bl1.append(buf, sizeof(buf));
    ASSERT_EQ(0,
              striper.aio_append("RoundTripAppendPP", my_completion, bl1,
                                 sizeof(buf)));
    {
        TestAlarm alarm;
    ...
    ASSERT_EQ(sizeof(buf) + sizeof(buf2),
              (unsigned)my_completion3->get_return_value());
...
TEST_F(StriperTest, Flush)
{
    ...
    ASSERT_EQ(0,
              rados_striper_aio_write(striper, "Flush", my_completion, buf,
                                      sizeof(buf), 0));
...
TEST_F(StriperTestPP, FlushPP)
{
    ...
    bl1.append(buf, sizeof(buf));
    ASSERT_EQ(0,
              striper.aio_write("FlushPP", my_completion, bl1, sizeof(buf), 0));
    striper.aio_flush();
    bufferlist bl2;
    AioCompletion *my_completion2 = librados::Rados::aio_create_completion
        ((void *)&test_data, set_completion_complete, set_completion_safe);
...
TEST_F(StriperTest, RoundTripWriteFull)
{
    ...
    memset(buf, 0xcc, sizeof(buf));
    ASSERT_EQ(0,
              rados_striper_aio_write(striper, "RoundTripWriteFull",
...
TEST_F(StriperTestPP, RoundTripWriteFullPP)
{
    ...
    bl1.append(buf, sizeof(buf));
    ASSERT_EQ(0,
              striper.aio_write("RoundTripWriteFullPP", my_completion, bl1,
                                sizeof(buf), 0));
    {
        TestAlarm alarm;
        my_completion->wait_for_complete();
