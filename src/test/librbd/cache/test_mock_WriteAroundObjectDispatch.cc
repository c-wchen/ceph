...
namespace librbd {
    namespace cache {
        ...
        TEST_F(TestMockCacheWriteAroundObjectDispatch, WriteThrough) {
            ...
            MockWriteAroundObjectDispatch object_dispatch(&mock_image_ctx, 0,
                                                          false);
        ...
        TEST_F(TestMockCacheWriteAroundObjectDispatch, WriteThroughUntilFlushed) {
            ...
            MockTestImageCtx mock_image_ctx(*ictx);
            MockWriteAroundObjectDispatch object_dispatch(&mock_image_ctx, 4096,
                                                          true);
            ...
            ASSERT_TRUE(object_dispatch.write(0, 0, std::move(data), {
                                              }, 0, 0, std::nullopt, {
                                              }, nullptr, nullptr,
        ...
        TEST_F(TestMockCacheWriteAroundObjectDispatch, BlockedIO) {
            ...
            MockTestImageCtx mock_image_ctx(*ictx);
            MockWriteAroundObjectDispatch object_dispatch(&mock_image_ctx,
                                                          16384, false);
            expect_op_work_queue(mock_image_ctx);
            ...
            ASSERT_TRUE(object_dispatch.write(0, 4096, std::move(data), {
                                              }, 0, 0, std::nullopt, {
                                              }, nullptr, nullptr,
                                              &dispatch_result,
                                              &finish_ctx_ptr2,
            ...
            ASSERT_TRUE(object_dispatch.write(0, 1024, std::move(data), {
                                              }, 0, 0, std::nullopt, {
                                              }, nullptr, nullptr,
                                              &dispatch_result,
                                              &finish_ctx_ptr3,
        ...
        TEST_F(TestMockCacheWriteAroundObjectDispatch, QueuedIO) {
            ...
            MockTestImageCtx mock_image_ctx(*ictx);
            MockWriteAroundObjectDispatch object_dispatch(&mock_image_ctx, 4095,
                                                          false);
            expect_op_work_queue(mock_image_ctx);
            ...
            ASSERT_TRUE(object_dispatch.write(0, 8192, std::move(data), {
                                              }, 0, 0, std::nullopt, {
                                              }, nullptr, nullptr,
                                              &dispatch_result,
                                              &finish_ctx_ptr2,
        ...
        TEST_F(TestMockCacheWriteAroundObjectDispatch, BlockedAndQueuedIO) {
            ...
            MockTestImageCtx mock_image_ctx(*ictx);
            MockWriteAroundObjectDispatch object_dispatch(&mock_image_ctx, 8196,
                                                          false);
            expect_op_work_queue(mock_image_ctx);
        ...
        TEST_F(TestMockCacheWriteAroundObjectDispatch, FlushQueuedOnQueuedIO) {
            ...
            MockContext dispatch_ctx3;
            Context *finish_ctx_ptr3 = &finish_ctx3;
            ASSERT_TRUE(object_dispatch.flush(io::FLUSH_SOURCE_USER, {
                                              }, nullptr,
                                              &dispatch_result,
                                              &finish_ctx_ptr3,
                                              &dispatch_ctx3));
        ...
        TEST_F(TestMockCacheWriteAroundObjectDispatch, WriteSameFUA) {
            ...
            MockContext dispatch_ctx;
            Context *finish_ctx_ptr = &finish_ctx;
            ASSERT_FALSE(object_dispatch.write_same(0, 0, 8192, { {
                                                    0, 8192}}, std::move(data), {
                                                    },
