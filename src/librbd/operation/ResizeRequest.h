...
{
public:
    static ResizeRequest *create(ImageCtxT &image_ctx,
    ...
    {
        return new ResizeRequest(image_ctx, on_finish, new_size,
                                 allow_shrink, prog_ctx, journal_op_tid,
                                 disable_journal);
    } ResizeRequest(ImageCtxT &image_ctx, Context *on_finish,
