...
void Capability::Export::encode(bufferlist & bl) const const
{
    ENCODE_START(2, 2, bl);
    ::encode(cap_id, bl);
    ::encode(wanted, bl);
...
void Capability::Export::dump(Formatter * f) const const
{
...
void Capability::Export::generate_test_instances(list <
...
void Capability::Import::encode(bufferlist & bl) const const
{
    ENCODE_START(1, 1, bl);
    ::encode(cap_id, bl);
    ::encode(issue_seq, bl);
...
void Capability::Import::dump(Formatter * f) const const
{
    f->dump_unsigned("cap_id", cap_id);
...
void Capability::revoke_info::encode(bufferlist & bl) const const
{
    ENCODE_START(2, 2, bl)
        ::encode(before, bl);
    ::encode(seq, bl);
...
void Capability::revoke_info::dump(Formatter * f) const const
{
...
void Capability::revoke_info::generate_test_instances(list <
                                                      Capability::revoke_info *
                                                      >&ls)
{
...
void Capability::encode(bufferlist & bl) const const
{
    ENCODE_START(2, 2, bl)
        ::encode(last_sent, bl);
    ::encode(last_issue_stamp, bl);
...
void Capability::dump(Formatter * f) const const
{
