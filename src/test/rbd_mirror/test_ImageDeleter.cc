...
class TestImageDeleter:public TestFixture {
  public:
    ...
    static void SetUpTestCase() {
        ...
        EXPECT_EQ(0,
                  librbd::create(m_local_io_ctx, m_image_name, m_local_image_id,
    ...
    void remove_image(bool force = false) {
        if (!force) {
            ...
            int r =
                cls_client::mirror_image_get(&m_local_io_ctx, m_local_image_id,
                                             &mirror_image);
    ...
    std::string create_clone() {
        ...
        EXPECT_EQ(0,
                  ictx->operations->
                  snap_create(cls::rbd::UserSnapshotNamespace(), "snap1"));
        EXPECT_EQ(0,
                  ictx->operations->
        ...
        cls::rbd::MirrorImage mirror_image(GLOBAL_CLONE_IMAGE_ID,
                                           ...
                                           MIRROR_IMAGE_STATE_ENABLED);
        EXPECT_EQ(0,
                  cls_client::mirror_image_set(&m_local_io_ctx, clone_id,
                                               mirror_image));
        EXPECT_EQ(0, ictx->state->close());
        return clone_id;
    }
...
TEST_F(TestImageDeleter, Delete_Image_With_Clone)
{
    ...
    C_SaferCond ctx2;
    m_deleter->wait_for_scheduled_deletion(m_local_pool_id,
                                           GLOBAL_CLONE_IMAGE_ID, &ctx2);
...
TEST_F(TestImageDeleter, Delete_NonExistent_Image)
{
    ...
    cls::rbd::MirrorImage mirror_image(GLOBAL_IMAGE_ID,
                                       ...
                                       MIRROR_IMAGE_STATE_ENABLED);
    EXPECT_EQ(0,
              cls_client::mirror_image_set(&m_local_io_ctx, m_local_image_id,
                                           mirror_image));
