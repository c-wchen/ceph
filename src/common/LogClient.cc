                             ...
                             uuid_d & fsid, string & host)
{
    ...
    if (r < 0) {
        lderr(cct) << __func__ << " error parsing 'clog_to_syslog_facility'" <<
            dendl;
        return r;
    }
    ...
    if (r < 0) {
        lderr(cct) << __func__ << " error parsing 'clog_to_syslog_level'" <<
            dendl;
        return r;
    }
    ...
    if (r < 0) {
        lderr(cct) << __func__ << " error parsing 'clog_to_graylog_host'" <<
            dendl;
        return r;
    }
    ...
    if (r < 0) {
        lderr(cct) << __func__ << " error parsing 'clog_to_graylog_port'" <<
            dendl;
        return r;
    }
