...
{
    {
        ...
        BlueStore::Cache * cache =
            BlueStore::Cache::create(g_ceph_context, "lru", NULL);
    ...
    BlueStore::Cache * cache =
        BlueStore::Cache::create(g_ceph_context, "lru", NULL);
    BlueStore::CollectionRef coll(new BlueStore::
                                  Collection(&store, cache, coll_t()));
...
TEST(Blob, legacy_decode)
{
    ...
    bufferlist bl, bl2;
    {
        ...
        uint64_t sbid, sbid2;
        Bres.decode(coll.get(), p, 1,   /*struct_v */
                    &sbid, true);
        Bres2.decode(coll.get(), p2, 2, /*struct_v */
                     &sbid2, true);
