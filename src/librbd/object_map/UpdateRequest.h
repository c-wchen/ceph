...
public:
    static UpdateRequest *create(ImageCtx &image_ctx,
                                 ...
                                 Context *on_finish)
    {
        return new UpdateRequest(image_ctx, object_map_lock, object_map,
                                 snap_id, start_object_no,
                                 end_object_no, new_state,
                                 current_state, parent_trace,
                                 ignore_enoent, on_finish);
    } UpdateRequest(ImageCtx &image_ctx,
                    ceph::shared_mutex *object_map_lock,
        ...
        : Request(image_ctx, snap_id, on_finish),
          ...
          m_trace(util::
                  create_trace(image_ctx, "update object map",
                               parent_trace)),
