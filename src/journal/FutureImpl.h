...
namespace journal {
    ...
    class FutureImpl:public RefCountedObject, boost::noncopyable {
      ...
      private:
        ...
        typedef std::map < FlushHandler::ref,
            ceph::ref_t < FutureImpl >> FlushHandlers;
        ...
        struct C_ConsistentAck:public Context {
            ...
            C_ConsistentAck(ceph::ref_t < FutureImpl >
                            _future):future(std::move(_future)) {
        ...
        mutable ceph::mutex m_lock =
            ceph::make_mutex("FutureImpl::m_lock", false);
        ...
        ceph::ref_t < FutureImpl >
            prepare_flush(FlushHandlers * flush_handlers);
