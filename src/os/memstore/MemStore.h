...
public:
    struct Object: public RefCountedObject {
        ceph::mutex xattr_mutex {
            ceph::make_mutex("MemStore::Object::xattr_mutex")};
        ceph::mutex omap_mutex {
            ceph::make_mutex("MemStore::Object::omap_mutex")};
        ...
        virtual int read(uint64_t offset, uint64_t len,
...
public:
    ...
    int collection_list(CollectionHandle &cid,
                        ...
                        int max, std::vector < ghobject_t > *ls,
