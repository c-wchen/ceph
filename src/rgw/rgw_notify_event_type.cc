...
namespace rgw::notify {
    ...
    std::string to_string(EventType t) {
        ...
        case ObjectCreated:
            ...
            case ObjectSyncedDeletionMarkerCreated:return
    ...
    void from_string_list(const std::string & string_list,
                          EventTypeList & event_list) {
        event_list.clear();
        ceph::for_each_substr(string_list, ",",[&event_list] (auto token) {
                              event_list.
                              push_back(rgw::notify::
                                        from_string(std::
                                                    string(token.begin(),
                                                           token.end())));});
    }
