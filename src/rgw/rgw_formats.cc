...
void RGWFormatter_Plain::open_array_section_in_ns(const char *name,
                                                  const char *ns)
{
    ostringstream oss;
    oss << name << " " << ns;
...
void RGWFormatter_Plain::dump_format_va(const char *name, const char *ns,
