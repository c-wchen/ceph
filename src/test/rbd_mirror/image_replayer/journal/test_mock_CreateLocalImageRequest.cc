    ...
    namespace mirror {
        ...
        namespace image_replayer {
            ...
            template <> struct CreateImageRequest <librbd::MockTestImageCtx > {
                ...
                static CreateImageRequest *create(Threads <
    ...
    namespace mirror {
        namespace image_replayer {
            namespace journal {
                ...
                class TestMockImageReplayerJournalCreateLocalImageRequest:public
                    TestMockFixture {
                  public:
                    ...
                    void expect_create_image(MockCreateImageRequest &
                                             ...
                                             int r) {
                        EXPECT_CALL(mock_create_image_request,
                                    construct(image_id));
                    ...
                    MockCreateLocalImageRequest *create_request(MockThreads &
                                                                mock_threads,
                                                                MockStateBuilder
                                                                &
                                                                mock_state_builder,
                ...
                TEST_F(TestMockImageReplayerJournalCreateLocalImageRequest,
                       Success) {
                    InSequence seq;
                    ...
                    expect_journaler_register_client(mock_journaler,
                                                     client_data, 0);
                    ...
                    auto request =
                        create_request(mock_threads, mock_state_builder,
                                       "global image id", &ctx);
                    request->send();
                    ASSERT_EQ(0, ctx.wait());

                    ASSERT_EQ("local image id",
                              mock_state_builder.local_image_id);
                    ASSERT_EQ("local image id",
                              mock_state_builder.remote_client_meta.image_id);
