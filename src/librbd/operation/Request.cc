...
namespace librbd {
    namespace operation {
        ...
        :AsyncRequest < I > (image_ctx, on_finish), m_op_tid(journal_op_tid) {
            ...
            return util::create_context_callback < Request < I >,
                &Request < I >::finish > (this);
        }
        ...
        template < typename I > bool Request < I >::append_op_event() {
            ...
            if (image_ctx.journal != nullptr &&
                ...
                append_op_event(util::create_context_callback <
                                Request < I >,
                                &Request < I >::handle_op_event_safe > (this));
                return true;
            }
            return false;
        }
        ...
        template < typename I >
            void Request < I >::handle_commit_op_event(int r,
            ...
            if (r < 0) {
                lderr(cct) << "failed to commit op event to journal: " <<
                    cpp_strerror(r)
                    << dendl;
            }
        ...
        template < typename I >
            ...
            image_ctx.journal->replay_op_ready(m_op_tid,
                                               util::
        ...
        template < typename I >
            ...
            image_ctx.journal->append_op_event(m_op_tid, journal::EventEntry {
                                               create_event(m_op_tid)},
                                               new C_AppendOpEvent(this,
                                                                   on_safe));
        }
