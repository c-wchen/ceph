...
template <typename I> ObjectRequest<I>::ObjectRequest(
...
template <typename I> ObjectReadRequest<I>::ObjectReadRequest(
...
template <typename I> AbstractObjectWriteRequest<I>::AbstractObjectWriteRequest(
...
template <typename I> ObjectListSnapsRequest<I>::ObjectListSnapsRequest(
