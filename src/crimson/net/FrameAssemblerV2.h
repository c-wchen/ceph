...
namespace crimson::net {
    ...
    class FrameAssemblerV2 {
      public:
        ...
        void create_session_stream_handlers(const AuthConnectionMeta &
                                            auth_meta, bool crossed);
      ...
      private:
        ...
        &session_stream_handlers, is_rev1,
                common::local_conf()->ms_crc_data, &session_comp_handlers};
