...
public:
    ...
    virtual int InitializeObjectOps(std::string db_name, const DoutPrefixProvider *dpp)
    {
        return 0;
    }
};
...
public:
    ...
    public:
        ...
        Object(DB *_store, const RGWBucketInfo &_bucket_info, const rgw_obj &_obj, const std::string &_obj_id) : store(_store),
