...
public:
    ...
    ESQueryNode_Bool(ESQueryCompiler *compiler, const string &_op, ESQueryNode *_first,
                     ESQueryNode *_second) : ESQueryNode(compiler), op(_op), first(_first), second(_second) {}
...
public:
    ESQueryNode_Op_Nested(ESQueryCompiler *compiler, const string &_name,
                          ESQueryNode *_next) : ESQueryNode_Op_Nested_Parent(compiler),
