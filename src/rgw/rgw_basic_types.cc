...
{
    struct visitor {
        std::string operator()(const rgw_account_id& a)
        {
            return a;
        }
        std::string operator()(const rgw_user& u)
        {
            return u.to_str();
        }
    };
...
std::ostream &operator<<(std::ostream& out, const rgw_owner& o)
{
    struct visitor {
        std::ostream &out;
        std::ostream &operator()(const rgw_account_id& a)
        {
            return out << a;
        }
        std::ostream &operator()(const rgw_user& u)
        {
            return out << u;
        }
    };
