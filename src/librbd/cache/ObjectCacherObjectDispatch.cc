...
template < typename I > void ObjectCacherObjectDispatch < I >::init()
{
    ...
    m_object_cacher = new ObjectCacher(cct, m_image_ctx->perfcounter->get_name(), *m_writeback_handler, m_cache_lock,
                                       nullptr, nullptr, cache_size, 10, /* reset this in init */
