...
namespace crimson::os::seastore {
    ...
    class RandomBlockManager {
      public:
        ...
        using close_ertr = crimson::errorator <
            crimson::ct_error::input_output_error, crimson::ct_error::invarg >;
        virtual close_ertr::future <> close() = 0;

        using allocate_ertr = crimson::errorator <
            crimson::ct_error::input_output_error,
            crimson::ct_error::invarg, crimson::ct_error::enospc >;
        ...
        virtual rbm_extent_state_t get_extent_state(paddr_t addr, size_t size) =
            0;
    ...
    inline paddr_t convert_abs_addr_to_paddr(rbm_abs_addr addr,
                                             device_id_t d_id) {
...
template <> struct fmt::formatter <
    crimson::os::seastore::rbm_metadata_header_t >:fmt::ostream_formatter {
};
#endif
