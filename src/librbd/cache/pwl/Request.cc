...
template <typename T> C_BlockIORequest<T>::C_BlockIORequest(T &pwl, const utime_t arrived, io::Extents &&extents,
...
template <typename T> C_FlushRequest<T>::C_FlushRequest(T &pwl, const utime_t arrived,
...
template <typename T> C_DiscardRequest<T>::C_DiscardRequest(T &pwl, const utime_t arrived, io::Extents &&image_extents,
