...
namespace ceph {
    ...
    void add_level_spec_options(boost::program_options::options_description *
                                options, bool allow_image = true);
    ...
    void add_schedule_options(boost::program_options::options_description *
                              positional, bool mandatory);
    int get_schedule_args(const boost::program_options::variables_map & vm,
                          bool mandatory, std::map < std::string,
                          std::string > *args);
