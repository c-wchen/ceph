...
public:
    struct config_t {
        ...
        } void populate_options(boost::program_options::
    ...
    virtual seastar::future < ceph::bufferlist > read(off_t offset,
            size_t size) = 0;
