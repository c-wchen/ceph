...
ObjectContextLoader::load_obc_iertr::future < > ObjectContextLoader::with_head_obc(const hobject_t &oid,
...
template < RWState::State State >
ObjectContextLoader::load_obc_iertr::future < > ObjectContextLoader::with_clone_obc(const hobject_t &oid,
        with_obc_func_t&& func,
        bool resolve_clone)
{
...
template < RWState::State State >
ObjectContextLoader::load_obc_iertr::future < > ObjectContextLoader::with_obc(hobject_t oid,
        with_obc_func_t&& func,
        bool resolve_clone)
{
    if (oid.is_head()) {
...
ObjectContextLoader::load_obc_iertr::future < > ObjectContextLoader::with_locked_obc(const hobject_t &oid,
        Func&& func)
{
...
ObjectContextLoader::load_obc_iertr::future < > ObjectContextLoader::load_obc(ObjectContextRef obc)
{
