...
public:
    ...
    boost::asio::any_completion_handler < void(boost::system::error_code) > OpContextVert(Context* c)
    {
        if (c) {
    ...
    template < typename T >
    boost::asio::any_completion_handler < void(boost::system::error_code, T) > OpContextVert(Context* c, T* p)
    {
    ...
    boost::asio::any_completion_handler < void(boost::system::error_code) > OpCompletionVert(
    ...
    boost::asio::any_completion_handler < void(boost::system::error_code,
            T) > OpCompletionVert(std::unique_ptr < ceph::async::Completion <
...
public:
    ...
    template < typename Callback, typename...Args > decltype(auto) with_osdmap(Callback&& cb, Args&&... args) const
    {
        std::shared_lock l(rwlock);
