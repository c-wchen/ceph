...
class RGWPolicyEnv {
  ...
  public:
    ...
    bool get_value(const std::string & s, std::string & val,
                   std::map < std::string, bool, ltstr_nocase > &checked_vars);
    bool match_policy_vars(std::map < std::string, bool,
                           ltstr_nocase > &policy_vars, std::string & err_msg);
};
...
class RGWPolicy {
  ...
  public:
    ...
    int add_condition(const std::string & op, const std::string & first,
                      const std::string & second, std::string & err_msg);
