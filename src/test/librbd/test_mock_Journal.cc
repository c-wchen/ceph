...
namespace librbd {
    ...
    class TestMockJournal:public TestMockFixture {
      public:
        ...
        uint64_t when_append_write_event(MockJournalImageCtx & mock_image_ctx,
            ...
            return mock_journal.append_write_event(0, length, bl, {
                                                   }
                                                   , false);
        }
        ...
        void open_journal(MockJournalImageCtx & mock_image_ctx,
                          MockJournal & mock_journal,::journal::
                          MockJournaler & mock_journaler,
                          MockJournalOpenRequest & mock_open_request,
                          bool primary = true) {
        ...
        void close_journal(MockJournal & mock_journal,::journal::
                           MockJournaler & mock_journaler) {
    ...
    TEST_F(TestMockJournal, EventAndIOCommitOrder) {
        ...
        ASSERT_EQ(1U,
                  when_append_io_event(mock_image_ctx, mock_journal, nullptr,
                                       0));
    ...
    TEST_F(TestMockJournal, EventCommitError) {
        ...
        auto object_request =
            new io::ObjectDiscardRequest <> (ictx, "oid", 0, 0,
                                             ictx->layout.object_size, { }
                                             , true, true, { }
                                             ,
                                             &object_request_ctx);
