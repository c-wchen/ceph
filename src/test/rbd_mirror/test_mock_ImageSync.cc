...
namespace librbd {
    ...
    DeepCopyRequest < librbd::MockTestImageCtx > *DeepCopyRequest <
    ...
    namespace mirror {
        ...
        class TestMockImageSync:public TestMockFixture {
          public:
            ...
            typedef librbd::DeepCopyRequest < librbd::MockTestImageCtx >
            ...
            void expect_flush_sync_point(MockSyncPointHandler &
                                         mock_sync_point_handler, int r) {
                EXPECT_CALL(mock_sync_point_handler,
                            update_sync_points(_, _, false, _))
            ...
            void expect_get_snap_seqs(MockSyncPointHandler &
            ...
            void expect_get_sync_points(MockSyncPointHandler &
                                        mock_sync_point_handler) {
        ...
        TEST_F(TestMockImageSync, SimpleSync) {
            ...
            C_SaferCond ctx;
            MockImageSync *request =
                create_request(mock_threads, mock_remote_image_ctx,
                               mock_local_image_ctx,
                               mock_sync_point_handler,
