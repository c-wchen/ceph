        ...
        template < typename ImageCtxT = librbd::ImageCtx > class ImageDeleter {
          public:
            static const int EISPRM = 1000;
             ...
             ImageDeleter(ContextWQ * work_queue, SafeTimer * timer,
                          Mutex * timer_lock,
          ...
          private:
             ...
             class ImageDeleterThread:public Thread {
              ...
              public:
                 ImageDeleterThread(ImageDeleter *
                                    image_deleter):m_image_deleter
                    (image_deleter) {
                } void *entry() override {
                    m_image_deleter->run();
                    return 0;
            ...
            struct DeleteInfo {
                ...
                } bool match(int64_t local_pool_id,
                             const std::string & global_image_id) {
            ...
            unique_ptr < DeleteInfo >
                const *find_delete_info(int64_t local_pool_id,
                                        const std::string & global_image_id);
