        ...
        namespace journal {
            ...
            static int do_show_journal_info(librados::Rados & rados,
                ...
                int64_t pool_id;
                 ...
                 cls::journal::client::get_immutable_metadata(io_ctx,
                                                              header_oid,
                                                              &order,
                                                              &splay_width,
                                                              &pool_id, &cond);
            ...
            int execute_info(const po::variables_map & vm) {
                ...
                int r =
                    utils::get_pool_journal_names(vm,
                                                  at::ARGUMENT_MODIFIER_NONE,
                                                  &arg_index, &pool_name,
                                                  &journal_name);
                if (r < 0) {
            ...
            int execute_export(const po::variables_map & vm) {
                ...
                std::string path;
                r = utils::get_path(vm, utils::get_positional_argument(vm, 1),
                                    &path);
                if (r < 0) {
                    return r;
                }
            ...
            int execute_import(const po::variables_map & vm) {
                std::string path;
                int r =
                    utils::get_path(vm, utils::get_positional_argument(vm, 0),
                                    &path);
                if (r < 0) {
                    return r;
                }
                ...
                std::string pool_name;
                std::string journal_name;
                r = utils::get_pool_journal_names(vm,
                                                  at::ARGUMENT_MODIFIER_DEST,
                                                  &arg_index, &pool_name,
                                                  &journal_name);
                if (r < 0) {
