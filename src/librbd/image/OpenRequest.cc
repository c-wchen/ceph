...
namespace librbd {
    namespace image {
        ...
        template < typename I >
            Context * OpenRequest <
            I >::handle_v2_get_immutable_metadata(int *result) {
            CephContext *cct = m_image_ctx->cct;
            ldout(cct, 10) << __func__ << ": r=" << *result << dendl;
            ...
            if (*result == 0) {
                bufferlist::iterator it = m_out_bl.begin();
                *result =
                    cls_client::get_immutable_metadata_finish(&it,
                                                              &m_image_ctx->
                                                              object_prefix,
                                                              &m_image_ctx->
                                                              order);
        ...
        template < typename I >
            ...
            if (data_pool_id != -1) {
                ...
                *result =
                    rados.ioctx_create2(data_pool_id, m_image_ctx->data_ctx);
                if (*result < 0) {
        ...
        template < typename I > void OpenRequest < I >::send_v2_apply_metadata() {
            CephContext *cct = m_image_ctx->cct;
            ...
            librados::AioCompletion * comp =
                create_rados_callback < klass,
                &klass::handle_v2_apply_metadata > (this);
            m_out_bl.clear();
            m_image_ctx->md_ctx.aio_operate(m_image_ctx->header_oid, comp, &op,
                                            &m_out_bl);
            comp->release();
        ...
        template < typename I > void OpenRequest < I >::send_register_watch() {
            m_image_ctx->init();
        ...
        template < typename I >
            ...
            SetSnapRequest < I > *req =
                SetSnapRequest < I >::create(*m_image_ctx,
