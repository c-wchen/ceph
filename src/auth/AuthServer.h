...
class AuthServer {
  public:
    ...
    virtual void get_supported_auth_methods(int peer_type,
    ...
    virtual int handle_auth_request(Connection * con, AuthConnectionMeta * auth_meta, bool more,    ///< true if this is not the first part of the handshake
                                    uint32_t auth_method,
