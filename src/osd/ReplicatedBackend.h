...
class ReplicatedBackend:public PGBackend {
    ...
    void dump_recovery_info(Formatter * f) const override {
        {
            ...
            for (map < pg_shard_t, set < hobject_t > >::const_iterator i =
                ...
                f->dump_stream("pull_from") << i->first;
                {
                    ...
                    for (set < hobject_t >::const_iterator j =
        ...
        }
        {
            ...
            for (map < hobject_t, map < pg_shard_t,
                ...
                f->dump_stream("pushing") << i->first;
                {
                    ...
                    for (map < pg_shard_t, PushInfo >::const_iterator j =
                         i->second.begin(); j != i->second.end(); ++j) {
  ...
  private:
    ...
    void clear_pull(map < hobject_t, PullInfo >::iterator piter,
                    bool clear_pull_from_peer = true);
    void clear_pull_from(map < hobject_t, PullInfo >::iterator piter);
    ...
    static void trim_pushed_data(const interval_set < uint64_t > &copy_subset,
                                 ...
                                 &intervals_received, bufferlist data_received,
    ...
    void send_pulls(int priority, map < pg_shard_t, vector < PullOp > >&pulls);
   ...
   */
    struct InProgressOp {
        ...
        OpRequestRef op;
        eversion_t v;
         InProgressOp(ceph_tid_t tid, Context * on_commit, Context * on_applied,
  ...
  private:
    ...
    void issue_op(const hobject_t & soid, const eversion_t & at_version,
                  ...
                  eversion_t pg_roll_forward_to, hobject_t new_temp_oid,
                  hobject_t discard_temp_oid,
                  const vector < pg_log_entry_t > &log_entries,
