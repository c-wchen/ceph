        ...
        namespace image_map {
            ...
            class Policy {
              public:
                ...
                // init -- called during initialization void init(
                                                                     const std::
                                                                     map <
                                                                     std::
                                                                     string,
              ...
              protected:
                ...
                virtual std::string do_map(const InstanceToImageMap & map,
                                           const std::
                                           string & global_image_id) = 0;

                // shuffle images when instances are added/removed
                virtual void do_shuffle_add_instances(const InstanceToImageMap &
                                                      map, size_t image_count,
                                                      std::set < std::string >
              ...
              private:
                struct ImageState {
                    ...
                    utime_t mapped_time;
                     ...
                     ImageState() {
                    } ImageState(const std::string & instance_id,
                    ...
                    // next scheduled state
                     boost::optional < StateTransition::State > next_state =
                        boost::none;
                };
                ...
                bool set_state(ImageState * image_state,
                               StateTransition::State state,
