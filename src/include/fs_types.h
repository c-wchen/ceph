...
struct inodeno_t {
    ...
    // cppcheck-suppress noExplicitConstructor inodeno_t(_inodeno_t v):val(v) {
    }
...
// file modes static inline bool file_mode_is_readonly(int mode)
{
...
WRITE_CLASS_ENCODER_FEATURES(file_layout_t)
    ...
    WRITE_EQ_OPERATORS_5(file_layout_t, stripe_unit, stripe_count, object_size,
                     pool_id, pool_ns);
