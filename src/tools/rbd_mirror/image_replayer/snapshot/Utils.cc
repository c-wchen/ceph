        ...
        namespace image_replayer {
            namespace snapshot {
                namespace util {
                    ...
                    uint64_t compute_remote_snap_id(const ceph::
                                                    shared_mutex &
                                                    local_image_lock,
                                                    const std::map <
                                                    librados::snap_t,
                                                    ...
                                                    string & remote_mirror_uuid)
                    {
                        ...
                        for (auto snap_it =
                             local_snap_infos.lower_bound(local_snap_id);
