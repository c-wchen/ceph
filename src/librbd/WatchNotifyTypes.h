    ...
    namespace watch_notify {
        ...
        struct AcquiredLockPayload {
            ...
            ClientId client_id;
             ...
             AcquiredLockPayload() {
            } AcquiredLockPayload(const ClientId &
                                  client_id_):client_id(client_id_) {
            }
        ...
        struct ReleasedLockPayload {
            ...
            ClientId client_id;
             ...
             ReleasedLockPayload() {
            } ReleasedLockPayload(const ClientId &
                                  client_id_):client_id(client_id_) {
            }
        ...
        struct AsyncRequestPayloadBase {
          ...
          protected:
            ...
            } AsyncRequestPayloadBase(const AsyncRequestId &
                                      id):async_request_id(id) {
            }
        };
        ...
        struct AsyncProgressPayload:public AsyncRequestPayloadBase {
            ...
            } AsyncProgressPayload(const AsyncRequestId & id, uint64_t offset_,
                                   uint64_t total_)
        ...
        struct FlattenPayload:public AsyncRequestPayloadBase {
            ...
            static const bool CHECK_FOR_REFRESH = true;
             ...
             FlattenPayload() {
            } FlattenPayload(const AsyncRequestId &
                             id):AsyncRequestPayloadBase(id) {
            }
        };
        ...
        struct ResizePayload:public AsyncRequestPayloadBase {
            ...
            } ResizePayload(uint64_t size_, bool allow_shrink_,
                            const AsyncRequestId & id)
            :AsyncRequestPayloadBase(id), size(size_),
                allow_shrink(allow_shrink_) {
            }
        ...
        struct SnapPayloadBase {
          ...
          protected:
             SnapPayloadBase() {
            } SnapPayloadBase(const cls::rbd::
                              SnapshotNamespace & _snap_namespace,
        ...
        struct SnapCreatePayload:public SnapPayloadBase {
            static const NotifyOp NOTIFY_OP = NOTIFY_OP_SNAP_CREATE;
             ...
             SnapCreatePayload() {
            } SnapCreatePayload(const cls::rbd::
                                SnapshotNamespace & _snap_namespace,
                                const std::string & name)
        ...
        struct SnapRemovePayload:public SnapPayloadBase {
            static const NotifyOp NOTIFY_OP = NOTIFY_OP_SNAP_REMOVE;
             ...
             SnapRemovePayload() {
            } SnapRemovePayload(const cls::rbd::
        ...
        struct SnapProtectPayload:public SnapPayloadBase {
            static const NotifyOp NOTIFY_OP = NOTIFY_OP_SNAP_PROTECT;
             ...
             SnapProtectPayload() {
            } SnapProtectPayload(const cls::rbd::
                                 SnapshotNamespace & snap_namespace,
                                 const std::string & name)
            :SnapPayloadBase(snap_namespace, name) {
            }
        ...
        struct SnapUnprotectPayload:public SnapPayloadBase {
            ...
            } SnapUnprotectPayload(const cls::rbd::
                                   SnapshotNamespace & snap_namespace,
                                   const std::string & name)
            :SnapPayloadBase(snap_namespace, name) {
            }
        ...
        struct RenamePayload {
            ...
            static const bool CHECK_FOR_REFRESH = true;
             ...
             RenamePayload() {
            } RenamePayload(const std::
                            string _image_name):image_name(_image_name) {
            }
        ...
        typedef boost::variant < AcquiredLockPayload,
            ...
            SnapUnprotectPayload,
            RebuildObjectMapPayload,
            RenamePayload, UpdateFeaturesPayload, UnknownPayload > Payload;
