...
public:
    ...
    static void assimilate_extents(map<object_t,
    ...
    public:
        void add_partial_result(CephContext *cct, bufferlist &bl,
         ...
         */
        void add_partial_sparse_result(CephContext *cct, bufferlist &bl,
                                       const map<uint64_t, uint64_t> &bl_map,
                                       uint64_t bl_off,
                                       const vector<pair<uint64_t,
                                                         uint64_t>> &buffer_extents);

        void assemble_result(CephContext *cct, bufferlist &bl,
                             bool zero_tail);
