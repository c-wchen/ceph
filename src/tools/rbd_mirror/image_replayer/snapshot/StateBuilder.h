...
} // namespace mirror } // namespace librbd namespace rbd {
namespace mirror
{
...
class StateBuilder: public image_replayer::StateBuilder <
    ImageCtxT >
{
public:
    static StateBuilder *create(const std::
    ...
    cls::rbd::
    MirrorImageMode get_mirror_image_mode() const override;
    ...
    {
        return true;
    } BaseRequest *create_local_image_request(Threads <
            ImageCtxT >
            *threads,
            librados::
            IoCtx &
    ...
    BaseRequest *create_prepare_replay_request(const std::
            string &
            local_mirror_uuid,
            ProgressContext *
            progress_ctx,
    ...
    image_replayer::Replayer *create_replayer(Threads <
            ImageCtxT >
            *threads,
            InstanceWatcher
            < ImageCtxT >
    ...
    SyncPointHandler < ImageCtxT > *sync_point_handler =
        nullptr;

    std::string remote_mirror_peer_uuid;

    librbd::mirror::snapshot::ImageMeta < ImageCtxT >
