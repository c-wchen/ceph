...
PGBackend::rep_op_fut_t PGBackend::mutate_object(
...
PGBackend::stat_ierrorator::future<> PGBackend::stat(
...
PGBackend::get_attr_ierrorator::future<ceph::bufferlist> PGBackend::getxattr(
...
PGBackend::rm_xattr_iertr::future<> PGBackend::rm_xattr(
    ObjectState &os,
    const OSDOp &osd_op,
    ceph::os::Transaction &txn)
{
...
crimson::os::FuturizedStore::Shard::omap_values_t > maybe_get_omap_vals_by_keys(
...
PGBackend::ll_read_ierrorator::future<> PGBackend::omap_get_header(
    const ObjectState &os,
    OSDOp &osd_op,
    object_stat_sum_t &delta_stats) const
{
...
PGBackend::ll_read_ierrorator::future<> PGBackend::omap_get_keys(
    const ObjectState &os,
    OSDOp &osd_op,
    object_stat_sum_t &delta_stats) const
{
...
PGBackend::omap_cmp_iertr::future<> PGBackend::omap_cmp(
    const ObjectState &os,
    OSDOp &osd_op,
    object_stat_sum_t &delta_stats) const
{
...
PGBackend::ll_read_ierrorator::future<> PGBackend::omap_get_vals(
    const ObjectState &os,
    OSDOp &osd_op,
    object_stat_sum_t &delta_stats) const
{
...
PGBackend::ll_read_ierrorator::future<> PGBackend::omap_get_vals_by_keys(
    const ObjectState &os,
    OSDOp &osd_op,
    object_stat_sum_t &delta_stats) const
{
...
PGBackend::interruptible_future<> PGBackend::omap_set_vals(
    ObjectState &os,
    const OSDOp &osd_op,
    ceph::os::Transaction &txn,
    osd_op_params_t &osd_op_params,
...
PGBackend::interruptible_future<> PGBackend::omap_set_header(
    ObjectState &os,
    const OSDOp &osd_op,
    ceph::os::Transaction &txn,
    osd_op_params_t &osd_op_params,
...
PGBackend::omap_clear_iertr::future<> PGBackend::omap_clear(
    ObjectState &os,
    OSDOp &osd_op,
    ceph::os::Transaction &txn,
    osd_op_params_t &osd_op_params,
...
PGBackend::interruptible_future<struct stat> PGBackend::stat(
    CollectionRef c,
    const ghobject_t &oid) const
{
...
PGBackend::read_errorator::future<std::map<uint64_t, uint64_t>> PGBackend::fiemap(
            CollectionRef c,
