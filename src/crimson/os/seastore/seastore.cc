...
seastar::future < > SeaStore::Shard::set_collection_opts(CollectionRef c,
...
SeaStore::Shard::read_errorator::future < ceph::bufferlist > SeaStore::Shard::read(
    CollectionRef ch,
...
SeaStore::Shard::base_errorator::future < bool > SeaStore::Shard::exists(
    CollectionRef c,
    const ghobject_t &oid)
{
...
SeaStore::Shard::read_errorator::future < ceph::bufferlist > SeaStore::Shard::readv(
    CollectionRef ch,
...
SeaStore::Shard::get_attr_errorator::future < ceph::bufferlist > SeaStore::Shard::get_attr(
    CollectionRef ch,
    const ghobject_t &oid,
...
SeaStore::Shard::get_attrs_ertr::future < SeaStore::Shard::attrs_t > SeaStore::Shard::get_attrs(
    CollectionRef ch,
    const ghobject_t &oid)
{
...
SeaStore::Shard::get_attr_errorator::future < ceph::bufferlist > SeaStore::Shard::omap_get_header(
    CollectionRef ch,
    const ghobject_t &oid)
{
...
SeaStore::Shard::_omap_get_value_ret SeaStore::Shard::_omap_get_value(
    Transaction &t,
    omap_root_t &&root,
...
SeaStore::Shard::_omap_get_values_ret SeaStore::Shard::_omap_get_values(
    Transaction &t,
...
SeaStore::Shard::omap_list_ret SeaStore::Shard::omap_list(
    Onode &onode,
...
SeaStore::Shard::omap_get_values_ret_t SeaStore::Shard::omap_get_values(
    CollectionRef ch,
    const ghobject_t &oid,
...
SeaStore::Shard::read_errorator::future < std::map < uint64_t, uint64_t>> SeaStore::Shard::fiemap(
    CollectionRef ch,
    const ghobject_t &oid,
    uint64_t off,
    uint64_t len)
...
SeaStore::Shard::tm_ret SeaStore::Shard::_do_transaction_step(
...
SeaStore::Shard::tm_ret SeaStore::Shard::_rename(
    internal_context_t &ctx,
    OnodeRef &onode,
    OnodeRef &d_onode)
{
...
SeaStore::Shard::tm_ret SeaStore::Shard::_remove_omaps(
    internal_context_t &ctx,
    OnodeRef &onode,
    omap_root_t &&omap_root)
{
...
SeaStore::Shard::tm_ret SeaStore::Shard::_remove(
    internal_context_t &ctx,
    OnodeRef &onode)
{
...
SeaStore::Shard::tm_ret SeaStore::Shard::_touch(
    internal_context_t &ctx,
    OnodeRef &onode)
{
...
SeaStore::Shard::tm_ret SeaStore::Shard::_write(
    internal_context_t &ctx,
    OnodeRef &onode,
...
SeaStore::Shard::tm_ret SeaStore::Shard::_clone_omaps(
    internal_context_t &ctx,
    OnodeRef &onode,
    OnodeRef &d_onode,
...
SeaStore::Shard::tm_ret SeaStore::Shard::_clone(
    internal_context_t &ctx,
    OnodeRef &onode,
    OnodeRef &d_onode)
{
...
SeaStore::Shard::tm_ret SeaStore::Shard::_zero(
    internal_context_t &ctx,
    OnodeRef &onode,
    objaddr_t offset,
    extent_len_t len)
...
SeaStore::Shard::omap_set_kvs_ret SeaStore::Shard::_omap_set_kvs(
...
SeaStore::Shard::tm_ret SeaStore::Shard::_omap_set_values(
    internal_context_t &ctx,
    OnodeRef &onode,
    std::map < std::string, ceph::bufferlist > &&aset)
{
...
SeaStore::Shard::tm_ret SeaStore::Shard::_omap_set_header(
    internal_context_t &ctx,
    OnodeRef &onode,
...
SeaStore::Shard::tm_ret SeaStore::Shard::_omap_clear(
    internal_context_t &ctx,
    OnodeRef &onode)
{
...
SeaStore::Shard::tm_ret SeaStore::Shard::_omap_rmkeys(
    internal_context_t &ctx,
    OnodeRef &onode,
    omap_keys_t &&keys)
{
...
SeaStore::Shard::tm_ret SeaStore::Shard::_omap_rmkeyrange(
    internal_context_t &ctx,
    OnodeRef &onode,
    std::string first,
    std::string last)
...
SeaStore::Shard::tm_ret SeaStore::Shard::_truncate(
    internal_context_t &ctx,
    OnodeRef &onode,
    uint64_t size)
{
...
SeaStore::Shard::tm_ret SeaStore::Shard::_setattrs(
    internal_context_t &ctx,
    OnodeRef &onode,
...
SeaStore::Shard::tm_ret SeaStore::Shard::_rmattr(
    internal_context_t &ctx,
    OnodeRef &onode,
    std::string name)
{
...
SeaStore::Shard::tm_ret SeaStore::Shard::_rmattrs(
    internal_context_t &ctx,
    OnodeRef &onode)
{
...
SeaStore::Shard::tm_ret SeaStore::Shard::_xattr_clear(
    internal_context_t &ctx,
    OnodeRef &onode)
{
...
SeaStore::Shard::tm_ret SeaStore::Shard::_create_collection(
    internal_context_t &ctx,
...
SeaStore::Shard::tm_ret SeaStore::Shard::_remove_collection(
    internal_context_t &ctx,
    const coll_t &cid)
{
    return transaction_manager->read_collection_root(
