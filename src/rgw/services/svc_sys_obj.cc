                                 ...
                                 optional_yield y)
{
    ...
    return svc->read(dpp, *state,
                     ...
                     obj, bl, ofs, end,
                     lastmod, obj_size,
                     attrs, raw_attrs, cache_info, refresh_version, y);
}
...
int RGWSI_SysObj::Obj::WOp::remove(const DoutPrefixProvider * dpp,
                                   optional_yield y)
{
    RGWSI_SysObj_Core *svc = source.core_svc;
    rgw_raw_obj & obj = source.get_obj();
...
int RGWSI_SysObj::Obj::WOp::write(const DoutPrefixProvider * dpp,
...
int RGWSI_SysObj::Obj::WOp::write_data(const DoutPrefixProvider * dpp,
                                       bufferlist & bl, optional_yield y)
{
    RGWSI_SysObj_Core *svc = source.core_svc;
    rgw_raw_obj & obj = source.get_obj();
...
int RGWSI_SysObj::Obj::WOp::write_attrs(const DoutPrefixProvider * dpp,
                                        optional_yield y)
{
    RGWSI_SysObj_Core *svc = source.core_svc;
    rgw_raw_obj & obj = source.get_obj();
...
int RGWSI_SysObj::Obj::WOp::write_attr(const DoutPrefixProvider * dpp,
...
int RGWSI_SysObj::Pool::list_prefixed_objs(const DoutPrefixProvider * dpp,
                                           const string & prefix,
                                           std::function <
                                           void (const string &) > cb)
{
    return core_svc->pool_list_prefixed_objs(dpp, pool, prefix, cb);
}

int RGWSI_SysObj::Pool::Op::init(const DoutPrefixProvider * dpp,
                                 const string & marker, const string & prefix)
{
    return source.core_svc->pool_list_objects_init(dpp, source.pool, marker,
                                                   prefix, &ctx);
}

int RGWSI_SysObj::Pool::Op::get_next(const DoutPrefixProvider * dpp, int max,
                                     vector < string > *oids,
                                     bool * is_truncated)
{
    return source.core_svc->pool_list_objects_next(dpp, ctx, max, oids,
                                                   is_truncated);
}
...
int RGWSI_SysObj::Obj::OmapOp::get_all(const DoutPrefixProvider * dpp,
...
int RGWSI_SysObj::Obj::OmapOp::set(const DoutPrefixProvider * dpp,
...
int RGWSI_SysObj::Obj::OmapOp::del(const DoutPrefixProvider * dpp,
...
int RGWSI_SysObj::Obj::WNOp::notify(const DoutPrefixProvider * dpp,
