...
} void ModeUpdatedPayload::decode(__u8 version,
...
} void ImageUpdatedPayload::decode(__u8 version,
                                   bufferlist::const_iterator &iter)
{
    using ceph::decode;
    ...
    mirror_image_state =
        static_cast < cls::rbd::MirrorImageState >
...
{
    o.push_back(new
                NotifyMessage(ModeUpdatedPayload
                              (cls::rbd::MIRROR_MODE_DISABLED)));
    o.push_back(new
                NotifyMessage(ImageUpdatedPayload
