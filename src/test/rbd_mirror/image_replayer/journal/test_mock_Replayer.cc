...
namespace librbd {
    ...
    namespace {
        ...
        struct MockTestJournal:public MockJournal {
            MOCK_METHOD2(start_external_replay,
                         void (journal::Replay < MockTestImageCtx > **,
                               Context * on_start));
    ...
    namespace journal {
        ...
        template <> struct Replay <MockTestImageCtx > {
            MOCK_METHOD2(decode,
                         int (bufferlist::const_iterator *, EventEntry *));
            MOCK_METHOD3(process,
                         void (const EventEntry &, Context *, Context *));
            MOCK_METHOD1(flush, void (Context *));
            MOCK_METHOD2(shut_down, void (bool, Context *));
        };

} // namespace journal } // namespace librbd namespace boost {
        ...
        namespace image_replayer {
            ...
            namespace journal {
                ...
                template <> struct EventPreprocessor <librbd::MockTestImageCtx > {
                    ...
                    static EventPreprocessor *create(librbd::
                                                     MockTestImageCtx &
                                                     local_image_ctx,::journal::
                                                     MockJournaler &
                                                     remote_journaler,
                                                     const std::
                    ...
                    MOCK_METHOD1(is_required,
                                 bool(const librbd::journal::EventEntry &));
                    MOCK_METHOD2(preprocess,
                ...
                template <>
                    ...
                    static ReplayStatusFormatter *create(::journal::
                                                         MockJournaler *
                                                         journaler,
                                                         const std::
                                                         string & mirror_uuid) {
                    ...
                    MOCK_METHOD2(get_or_send_update,
                ...
                template <> struct StateBuilder <librbd::MockTestImageCtx > {
                    StateBuilder(librbd::MockTestImageCtx & local_image_ctx,::
                                 ...
                                 const librbd::journal::
                                 MirrorPeerClientMeta & remote_client_meta)
    ...
    namespace mirror {
        namespace image_replayer {
            namespace journal {
                ...
                class TestMockImageReplayerJournalReplayer:public
                    TestMockFixture {
                  public:
                    typedef Replayer < librbd::MockTestImageCtx > MockReplayer;
                    typedef EventPreprocessor < librbd::MockTestImageCtx >
                    ...
                    typedef librbd::journal::Replay < librbd::MockTestImageCtx >
                        MockReplay;
                    ...
                    void SetUp() override {
                        ...
                        ASSERT_EQ(0,
                                  open_image(m_local_io_ctx, m_image_name,
                                             &m_local_image_ctx));
                    } bufferlist encode_tag_data(const librbd::journal::
                                                 TagData & tag_data) {
                        bufferlist bl;
                        encode(tag_data, bl);
                        return bl;
                    ...
                    void expect_init(::journal::MockJournaler & mock_journaler,
                                     int r) {
                    ...
                    void expect_stop_replay(::journal::
                    ...
                    void expect_shut_down(MockReplay & mock_replay,
                                          bool cancel_ops, int r) {
                        EXPECT_CALL(mock_replay, shut_down(cancel_ops, _))
                            .WillOnce(WithArg < 1 >
                                      (CompleteContext
                                       (m_threads->work_queue, r)));
                    }

                    void expect_get_cached_client(::journal::
                                                  MockJournaler &
                                                  mock_journaler,
                        ...
                        cls::journal::Client client_copy {
                        client};
                        encode(client_data, client_copy.data);

                        EXPECT_CALL(mock_journaler,
                                    get_cached_client(client_id, _))
                            .
                            WillOnce(DoAll
                                     (SetArgPointee < 1 > (client_copy),
                                      Return(r)));
                    }

                    void expect_start_external_replay(librbd::
                                                      MockTestJournal &
                                                      mock_journal,
                    ...
                    void expect_is_tag_owner(librbd::
                                             MockTestJournal & mock_journal,
                                             bool is_owner) {
                        EXPECT_CALL(mock_journal,
                                    is_tag_owner()).WillOnce(Return(is_owner));
                    }

                    void expect_is_resync_requested(librbd::
                                                    MockTestJournal &
                                                    mock_journal, int r,
                        ...
                        EXPECT_CALL(mock_journal,
                            ...
                            WillOnce(DoAll
                                     (SetArgPointee < 0 > (resync_requested),
                                      Return(r)));
                    }

                    void expect_get_commit_tid_in_debug(::journal::
                                                        MockReplayEntry &
                                                        mock_replay_entry) {
                    ...
                    void expect_get_tag_tid_in_debug(librbd::
                                                     MockTestJournal &
                                                     mock_journal) {
                        // It is used in debug messages and depends on debug level
                        EXPECT_CALL(mock_journal,
                    ...
                    void expect_committed(::journal::
                                          MockReplayEntry & mock_replay_entry,::
                                          journal::
                                          MockJournaler & mock_journaler,
                                          int times) {
                        ...
                        EXPECT_CALL(mock_journaler,
                                    committed(MatcherCast <
                                              const::journal::
                                              MockReplayEntryProxy & >(_)))
                        .Times(times);
                    }

                    void expect_try_pop_front(::journal::
                                              MockJournaler & mock_journaler,
                    ...
                    void expect_try_pop_front_return_no_entries(::journal::
                                                                MockJournaler &
                                                                mock_journaler,
                                                                Context *
                                                                on_finish) {
                        EXPECT_CALL(mock_journaler, try_pop_front(_, _))
                            ...
                            WillOnce(DoAll
                                     (Invoke
                                      ([on_finish]
                                       (::journal::MockReplayEntryProxy * e,
                                        uint64_t * t) {
                                       on_finish->complete(0);}),
                                      Return(false)));
                    }

                    void expect_get_tag(::journal::
                                        MockJournaler & mock_journaler,
                    ...
                    void expect_allocate_tag(librbd::
                                             MockTestJournal & mock_journal,
                                             int r) {
                    ...
                    void expect_process(MockReplay & mock_replay,
                        ...
                        EXPECT_CALL(mock_replay, process(_, _, _))
                            ...
                            WillOnce(DoAll
                                     (WithArg < 1 >
                                      (CompleteContext(on_ready_r)),
                                      WithArg < 2 >
                                      (CompleteContext(on_commit_r))));
                    }
                    ...
                    void expect_flush_commit_position(::journal::
                                                      MockJournaler &
                                                      mock_journal, int r) {
                    ...
                    void expect_get_tag_data(librbd::
                                             MockTestJournal &
                                             mock_local_journal,
                                             const librbd::journal::
                                             TagData & tag_data) {
                    ...
                    void expect_local_journal_add_listener(librbd::
                                                           MockTestJournal &
                                                           mock_local_journal,
                                                           librbd::journal::
                                                           Listener **
                                                           local_journal_listener)
                    {
                        ...
                        expect_is_resync_requested(mock_local_journal, 0,
                                                   false);
                    }
                    ...
                    int init_entry_replayer(MockReplayer & mock_replayer,
                                            ...
                                            librbd::
                                            MockTestJournal &
                                            mock_local_journal,::journal::
                                            MockJournaler &
                                            mock_remote_journaler,
                                            MockReplay &
                                            mock_local_journal_replay,
                                            librbd::journal::Listener **
                                            local_journal_listener,::journal::
                                            ReplayHandler **
                                            remote_replay_handler,::journal::
                                            JournalMetadataListener **
                        ...
                        expect_start_external_replay(mock_local_journal,
                                                     &mock_local_journal_replay,
                                                     0);
                        expect_local_journal_add_listener(mock_local_journal,
                                                          local_journal_listener);
                        EXPECT_CALL(mock_remote_journaler,
                                    start_live_replay(_, _))
                            .WillOnce(SaveArg < 0 > (remote_replay_handler));
                        expect_notification(mock_threads,
                                            mock_replayer_listener);
                    ...
                    ceph::mutex m_lock =
                        ceph::
                        make_mutex("TestMockImageReplayerJournalReplayer");
                ...
                TEST_F(TestMockImageReplayerJournalReplayer, InitShutDown) {
                    ...
                    *m_local_image_ctx, mock_local_journal};
                    ...
                    ::journal::JournalMetadataListener *
                        remote_journaler_listener = nullptr;
                    ASSERT_EQ(0,
                ...
                TEST_F(TestMockImageReplayerJournalReplayer,
                ...
                TEST_F(TestMockImageReplayerJournalReplayer,
                    ...
                    *m_local_image_ctx, mock_local_journal};
                    ...
                    expect_get_cached_client(mock_remote_journaler,
                                             ...
                                             , 0);
                    expect_start_external_replay(mock_local_journal, nullptr,
                                                 -EINVAL);
                    MockCloseImageRequest mock_close_image_request;
                    expect_send(mock_close_image_request, 0);
                    EXPECT_CALL(mock_remote_journaler, remove_listener(_));
                ...
                TEST_F(TestMockImageReplayerJournalReplayer,
                    ...
                    *m_local_image_ctx, mock_local_journal};
                    ...
                    EXPECT_CALL(mock_local_journal, add_listener(_));
                    expect_is_tag_owner(mock_local_journal, false);
                    expect_is_resync_requested(mock_local_journal, -EINVAL,
                                               false);
                    expect_notification(mock_threads, mock_replayer_listener);
                ...
                TEST_F(TestMockImageReplayerJournalReplayer, Replay) {
                    ...
                    *m_local_image_ctx, mock_local_journal};
                    ...
                    expect_committed(mock_replay_entry, mock_remote_journaler,
                                     2);
                    ...
                    // process
                    EXPECT_CALL(mock_local_journal_replay,
                                decode(_, _)).WillOnce(Return(0));
                    expect_preprocess(mock_event_preprocessor, false, 0);
                    expect_process(mock_local_journal_replay, 0, 0);
                    EXPECT_CALL(mock_replay_status_formatter,
                                handle_entry_processed(_));
                    ...
                    expect_try_pop_front_return_no_entries
                        (mock_remote_journaler, &replay_ctx);
                ...
                TEST_F(TestMockImageReplayerJournalReplayer, DelayedReplay) {
                    ...
                    *m_local_image_ctx, mock_local_journal};
                    ...
                    // process with delay
                    EXPECT_CALL(mock_replay_entry, get_data());
                    librbd::journal::EventEntry event_entry(librbd::journal::
                                                            AioDiscardEvent(123,
                                                                            345,
                                                                            0),
                                                            ceph_clock_now());
                    ...
                    EXPECT_CALL(*mock_threads.timer, add_event_after(_, _))
                        ...
                        WillOnce(DoAll
                                 (Invoke
                                  ([this, &delayed_task_ctx] (double seconds,
                                                              Context * ctx) {
                                   std::unique_lock locker {
                                   m_lock};
                                   delayed_task_ctx = ctx;
                                   m_cond.notify_all();}), ReturnArg < 1 > ()));
                    expect_preprocess(mock_event_preprocessor, false, 0);
                    expect_process(mock_local_journal_replay, 0, 0);
                    EXPECT_CALL(mock_replay_status_formatter,
                                handle_entry_processed(_));
                ...
                TEST_F(TestMockImageReplayerJournalReplayer,
                    ...
                    *m_local_image_ctx, mock_local_journal};
                    ...
                    expect_flush(mock_local_journal_replay, 0);
                    expect_flush_commit_position(mock_remote_journaler,
                                                 -EINVAL);
                ...
                TEST_F(TestMockImageReplayerJournalReplayer, ImageNameUpdated) {
                    ...
                    *m_local_image_ctx, mock_local_journal};
                    ...
                    auto image_spec =
                        util::compute_image_spec(m_local_io_ctx, "NEW NAME");
