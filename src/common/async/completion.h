    ...
    template < typename T, typename ... Args >
      ...
      public:
        ...
        template < typename Executor1, typename Handler, typename ... TArgs >
            ...
            create(const Executor1 & ex1, Handler && handler, TArgs
                   && ... args);
...
// the C++ Networking TS
        template < typename Executor1, typename Handler, typename T,
            ...
            template < typename ... TArgs >
                CompletionImpl(const Executor1 & ex1, Handler && handler, TArgs
                               && ... args)
...
/// any additional arguments are forwared to T's constructor
    template < typename Signature, typename T, typename Executor1,
        ...
        create_completion(const Executor1 & ex, Handler && handler, TArgs
                          && ... args) {
