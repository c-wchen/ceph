...
, backend(PGBackend::create(pgid.pgid,
                            ...
                            shard_services,
                            profile,
                            *this)), recovery_backend(std::make_unique < ReplicatedRecoveryBackend >
...
PG::interruptible_future <>> PG::submit_transaction(ObjectContextRef && obc,
...
PG::do_osd_ops_iertr::future < PG::pg_rep_op_fut_t < Ret >> PG::do_osd_ops_execute(seastar::lw_shared_ptr
        < OpsExecuter > ox,
...
PG::do_osd_ops_iertr::future < PG::pg_rep_op_fut_t <>> PG::do_osd_ops(ObjectContextRef obc,
        std::vector < OSDOp > &ops,
        const OpInfo &op_info,
...
PG::load_obc_iertr::future <> PG::with_locked_obc(const hobject_t &hobj,
