...
namespace rgw {
    namespace sal {
        ...
        class LCDBSerializer:public StoreLCSerializer {
          ...
          public:
            LCDBSerializer(DBStore * store, const std::string & oid,
        ...
        class DBNotification:public StoreNotification {
          protected:
          public:
            DBNotification(Object * _obj, Object * _src_obj,
        ...
        class DBUser:public StoreUser {
          ...
          public:
            ...
            } DBUser(DBStore * _st, const RGWUserInfo & _i):StoreUser(_i),
                store(_st) {
            }
        ...
        class DBPlacementTier:public StorePlacementTier {
          ...
          public:
             DBPlacementTier(DBStore * _store,
        ...
        class DBZoneGroup:public StoreZoneGroup {
            DBStore *store;
             ...
             std::string empty;
          public:
             DBZoneGroup(DBStore * _store,
                         std::unique_ptr < RGWZoneGroup > _group):store(_store),
        ...
        class DBZone:public StoreZone {
          ...
          public:
             DBZone(DBStore * _store):store(_store) {
                realm = new RGWRealm();
                zonegroup =
                    new DBZoneGroup(store,
                                    std::make_unique < RGWZoneGroup > ());
    ...
    /** List lua packages */
        ...
        class DBMultipartPart:public StoreMultipartPart {
          ...
          public:
            ...
            virtual RGWUploadPartInfo & get_info() {
                return info;
            } virtual void set_info(const RGWUploadPartInfo & _info) {
                info = _info;
            }
        ...
        class DBMultipartUpload:public StoreMultipartUpload {
          ...
          public:
             DBMultipartUpload(DBStore * _store, Bucket * _bucket,
                               const std::string & oid,
                               std::optional < std::string > upload_id,
                               ACLOwner _owner,
                               ceph::
        ...
        class MPDBSerializer:public StoreMPSerializer {
          ...
          public:
            MPDBSerializer(const DoutPrefixProvider * dpp, DBStore * store,
                           DBObject * obj, const std::string & lock_name) {
            } virtual int try_lock(const DoutPrefixProvider * dpp, utime_t dur,
                                   optional_yield y) override {
                return 0;
            }
        ...
        class DBStore:public StoreDriver {
          ...
          public:
            ...
            /* Unique to DBStore */
            void setDBStoreManager(DBStoreManager * stm) {
                dbsm = stm;
            }
            DBStoreManager *getDBStoreManager(void) {
                return dbsm;
            }
