...
{
public:
    typedef SnapshotProtectRequest < MockImageCtx >
    MockSnapshotProtectRequest;
...
TEST_F(TestMockOperationSnapshotProtectRequest, Success)
{
    ...
    MockSnapshotProtectRequest *req =
        new MockSnapshotProtectRequest(mock_image_ctx, &cond_ctx,
                                       cls::rbd::
