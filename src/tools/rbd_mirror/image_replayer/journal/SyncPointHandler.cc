...
template <typename I> SyncPointHandler<I>::SyncPointHandler(StateBuilder<I> *state_builder)
...
template <typename I>
typename SyncPointHandler<I>::SyncPoints SyncPointHandler<I>::get_sync_points() const
{
