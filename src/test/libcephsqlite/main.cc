...
protected:
    int db_open()
    {
        static const char SQL[] =
            ...
            "INSERT INTO perf (v)" "    VALUES (ceph_perf());";
...
TEST_F(CephSQLiteTest, InsertBulk4096)
{
    static const char SQL[] =
        ...
        "  )"
        "INSERT INTO foo (a)"
        "  SELECT RANDOM()" "  FROM c" "  LIMIT 1000000;" "PRAGMA page_size;";
...
TEST_F(CephSQLiteTest, InsertBulk)
{
    static const char SQL[] =
        ...
        "   FROM c"
        "  )"
        "INSERT INTO foo (a)" "  SELECT RANDOM()" "  FROM c" "  LIMIT 1000000;";
...
TEST_F(CephSQLiteTest, UpdateBulk)
{
    static const char SQL[] =
        ...
        "UPDATE foo" "  SET a = a+a;" "SELECT SUM(a) FROM foo;";
...
TEST_F(CephSQLiteTest, InsertRate)
{
    ...
    static const char SQL[] =
        "CREATE TABLE foo (a INT);" "INSERT INTO foo (a) VALUES (RANDOM());";
...
TEST_F(CephSQLiteTest, DatabaseShrink)
{
    static const char SQL[] =
        ...
        "  FROM c"
        "  LIMIT 1000000;"
        "DELETE FROM foo" "  WHERE RANDOM()%4 < 3;" "VACUUM;";
...
TEST_F(CephSQLiteTest, DeleteBulk)
{
    static const char SQL[] =
        ...
        "  SELECT x"
        "  FROM c"
        "  LIMIT 1000000;" "DELETE FROM foo" "  WHERE RANDOM()%2 == 0;";
...
TEST_F(CephSQLiteTest, InsertMassiveVerify)
{
    static const char SQL[] =
        ...
        "  LIMIT 1024;"
        "SELECT a FROM bar;"
        "INSERT INTO foo (a)" "  SELECT a FROM bar;" "SELECT a FROM foo;";
