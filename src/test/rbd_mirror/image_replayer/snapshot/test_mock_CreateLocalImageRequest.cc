...
} // namespace snapshot } // namespace image_replayer } // namespace mirror }   // namespace rbd
    ...
    namespace mirror {
        namespace image_replayer {
            namespace snapshot {
                ...
                class
                    TestMockImageReplayerSnapshotCreateLocalImageRequest:public
                    TestMockFixture {
                  public:
                    ...
                    void SetUp() override {
                        ...
                        return librbd::clone(m_remote_io_ctx,
                                             ...
                                             clone_name.c_str(),
                                             parent_image_ctx->features, &order,
                                             0, 0);
                        ...
                        .WillOnce(Return(r));
                    } void expect_mirror_image_remove(const std::
                                                      string & image_id,
                                                      int r) {
                        bufferlist bl;
                        encode(image_id, bl);
                ...
                TEST_F(TestMockImageReplayerSnapshotCreateLocalImageRequest,
                       Success) {
                    InSequence seq;
