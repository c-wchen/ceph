...
namespace ZTracer {
    ...
    class Trace {
      public:
        Trace() {
        } Trace(const char *name, const Endpoint * ep, const Trace * parent =
                NULL) {
        }
        ...
        bool valid() const {
            ...
            return false;
        } int init(const char *name, const Endpoint * ep, const Trace * parent =
                   NULL) {
            return 0;
        }
...
static inline void decode(blkin_trace_info & b,
