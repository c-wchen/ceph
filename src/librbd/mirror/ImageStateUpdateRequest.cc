    ...
    namespace mirror {
        ...
        using util::create_rados_callback;
         ...
         template < typename I >
            ...
            I >::ImageStateUpdateRequest(librados::IoCtx & io_ctx,
        ...
        :m_io_ctx(io_ctx), m_image_id(image_id),
            ...
            ceph_assert(m_mirror_image_state !=
            ...
            auto comp = create_rados_callback <
                ...
                &ImageStateUpdateRequest < I >::handle_get_mirror_image >
                (this);
        ...
        template < typename I >
            ...
            auto comp = create_rados_callback <
                ImageStateUpdateRequest < I >,
                &ImageStateUpdateRequest < I >::handle_set_mirror_image >
                (this);
        ...
        template < typename I >
            ...
            if (r < 0) {
                lderr(m_cct) << "failed to disable mirroring image: " <<
                    cpp_strerror(r)
                    << dendl;
                finish(r);
                return;
        ...
        template < typename I >
            ...
            auto ctx = util::create_context_callback <
                ImageStateUpdateRequest < I >,
                &ImageStateUpdateRequest <
                I >::handle_notify_mirroring_watcher > (this);
            MirroringWatcher < I >::notify_image_updated(m_io_ctx,
                                                         m_mirror_image_state,
                                                         m_image_id,
                                                         m_mirror_image.
                                                         global_image_id, ctx);
        }
