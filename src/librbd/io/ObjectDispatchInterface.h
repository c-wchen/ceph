...
struct ObjectDispatchInterface {
    ...
    virtual bool read(uint64_t object_no, ReadExtents *extents,
    ...
    virtual bool discard(uint64_t object_no, uint64_t object_off,
    ...
    virtual bool write(uint64_t object_no, uint64_t object_off,
                       ceph::bufferlist
    ...
    virtual bool write_same(uint64_t object_no, uint64_t object_off,
                            uint64_t object_len,
    ...
    virtual bool compare_and_write(uint64_t object_no,
    ...
    virtual bool flush(FlushSource flush_source,
                       const ZTracer::Trace &parent_trace,
                       uint64_t *journal_tid,
                       DispatchResult *dispatch_result,
                       Context **on_finish, Context *on_dispatched) =
    ...
    virtual bool list_snaps(uint64_t object_no, Extents
                            && extents, SnapIds
