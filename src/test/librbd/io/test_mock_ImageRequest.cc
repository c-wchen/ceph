...
namespace librbd {
    ...
    namespace util {
        ...
        template <>
            struct ObjectRequest <librbd::
            MockTestImageCtx >:public ObjectRequestHandle {
            ...
            static ObjectRequest *create_write(librbd::MockTestImageCtx * ictx,
                ...
                return s_instance;
            } static ObjectRequest *create_discard(librbd::MockTestImageCtx *
                                                   ictx,
                                                   const std::string & oid,
                                                   uint64_t object_no,
                                                   uint64_t object_off,
                ...
                s_instance->on_finish = completion;
                return s_instance;
            } static ObjectRequest *create_writesame(librbd::MockTestImageCtx *
                                                     ictx,
                                                     const std::string & oid,
                                                     uint64_t object_no,
                                                     uint64_t object_off,
            ...
            static ObjectRequest *create_compare_and_write(librbd::
                                                           MockTestImageCtx *
                                                           ictx,
                                                           const std::
                                                           string & oid,
        ...
        template <>
            struct ObjectReadRequest <librbd::
            MockTestImageCtx >:public ObjectRequest < librbd::MockTestImageCtx >
        {
        ...
        ObjectRequest < librbd::MockTestImageCtx > *ObjectRequest <
            librbd::MockTestImageCtx >::s_instance = nullptr;
        ObjectReadRequest < librbd::MockTestImageCtx > *ObjectReadRequest <
            librbd::MockTestImageCtx >::s_instance = nullptr;
...
namespace librbd {
    namespace io {
        ...
        struct TestMockIoImageRequest:public TestMockFixture {
            ...
            void expect_is_journal_appending(MockJournal & mock_journal,
                                             bool appending) {
                ...
                EXPECT_CALL(mock_image_ctx,
                            write_to_cache(object, _, length, offset, _, _,
                                           journal_tid, _))
                    .WillOnce(WithArg < 4 >
                              (CompleteContext
                               (r, mock_image_ctx.image_ctx->op_work_queue)));
                                              ...
                                              MockObjectRequest &
                                              mock_object_request, int r) {
                EXPECT_CALL(mock_object_request, send())
                    .
                    WillOnce(Invoke
                             ([&mock_image_ctx, &mock_object_request, r] () {
                              mock_image_ctx.image_ctx->op_work_queue->
                              queue(mock_object_request.on_finish, r);}));
            }
        ...
        TEST_F(TestMockIoImageRequest, AioWriteJournalAppendDisabled) {
            ...
            if (mock_image_ctx.image_ctx->cache) {
                ...
                expect_object_request_send(mock_image_ctx,
                                           mock_aio_object_request, 0);
            }
        ...
        TEST_F(TestMockIoImageRequest, AioCompareAndWriteJournalAppendDisabled) {
            ...
            InSequence seq;
            expect_is_journal_appending(mock_journal, false);
            expect_object_request_send(mock_image_ctx, mock_aio_object_request,
                                       0);
