...
namespace librbd {
    namespace deep_copy {
        ...
        using librbd::util::create_rados_callback;
         ...
         template < typename I >
            MetadataCopyRequest < I >::MetadataCopyRequest(I * src_image_ctx,
                                                           I * dst_image_ctx,
                                                           Context * on_finish)
        ...
        template < typename I >
            ...
            auto req =
                image::GetMetadataRequest < I >::create(m_src_image_ctx->md_ctx,
                                                        m_src_image_ctx->
                                                        header_oid, true, "",
                                                        m_last_metadata_key,
                                                        MAX_METADATA_ITEMS,
        ...
        template < typename I >
            ...
            if (r < 0) {
                lderr(m_cct) << "failed to retrieve metadata: " <<
        ...
        template < typename I >
            ...
            m_dst_image_ctx->md_ctx.aio_operate(m_dst_image_ctx->header_oid,
                                                aio_comp, &op);
            aio_comp->release();
        }
        ...
        template < typename I >
            ...
            if (r < 0) {
                lderr(m_cct) << "failed to set metadata: " << cpp_strerror(r) <<
                    dendl;
                finish(r);
                return;
            }
