...
future<> test_read_write(bool is_fixed_cpu)
{
    ...
    return SocketFactory::dispatch_sockets(
               is_fixed_cpu,
    [](auto cs) {
        return Connection::dispatch_rw_bounded(cs, 128);
    },
    [](auto ss) {
        return Connection::dispatch_rw_bounded(ss, 128);
    }
    ).then([] {
...
future<> test_unexpected_down(bool is_fixed_cpu)
{
    ...
    [](auto ss) {
        return Connection::dispatch_rw_unbounded(ss);
    }
    ).then([] {
...
future<> test_preemptive_down(bool is_fixed_cpu)
{
    ...
    return SocketFactory::dispatch_sockets(
               is_fixed_cpu,
    [](auto cs) {
        return Connection::dispatch_rw_unbounded(cs, true);
    },
    [](auto ss) {
        return Connection::dispatch_rw_unbounded(ss);
    }
