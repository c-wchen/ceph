...
namespace librbd {
    namespace cache {
        namespace pwl {
            ...
            using GenericLogOperationSharedPtr =
                std::shared_ptr < GenericLogOperation >;

            using GenericLogOperationsVector =
                std::vector < GenericLogOperationSharedPtr >;
            ...
            class GenericLogOperation {
              ...
              public:
                ...
                utime_t log_append_comp_time;   // When log append completes
                 GenericLogOperation(utime_t dispatch_time,
                                     PerfCounters * perfcounter);
                 virtual ~ GenericLogOperation() {
                };
                 GenericLogOperation(const GenericLogOperation &) = delete;
                 GenericLogOperation & operator=(const GenericLogOperation &) =
                    delete;
                virtual std::ostream & format(std::ostream & os) const;
                friend std::ostream & operator<<(std::ostream & os,
                                                 const GenericLogOperation &
                                                 op);
                virtual const std::shared_ptr < GenericLogEntry >
                    get_log_entry() = 0;
                ...
                virtual bool reserved_allocated() const {
                    ...
                    return false;
                } virtual void init_op(uint64_t current_sync_gen,
                                       bool persist_on_flush,
                                       uint64_t last_op_sequence_num,
                                       Context * write_persist,
                                       Context * write_append) {
                };
                virtual void copy_bl_to_cache_buffer(std::vector <
            ...
            class SyncPointLogOperation:public GenericLogOperation {
              ...
              public:
                ...
                ~SyncPointLogOperation() override;
                 ...
                 SyncPointLogOperation & operator=(const SyncPointLogOperation
                                                   &) = delete;
                 std::ostream & format(std::ostream & os) const;
                friend std::ostream & operator<<(std::ostream & os,
                                                 const SyncPointLogOperation &
                                                 op);
            ...
            class GenericWriteLogOperation:public GenericLogOperation {
              ...
              public:
                ...
                Context *on_write_persist = nullptr;    /* Completion for things waiting on this
                                                         * write to persist */
                 GenericWriteLogOperation(std::shared_ptr < SyncPoint >
                                          sync_point, utime_t dispatch_time,
                                          PerfCounters * perfcounter,
                                          CephContext * cct);
                ~GenericWriteLogOperation() override;
                 GenericWriteLogOperation(const GenericWriteLogOperation &) =
                    delete;
                 GenericWriteLogOperation & operator=(const
                                                      GenericWriteLogOperation
                                                      &) = delete;
                 std::ostream & format(std::ostream & os) const;
                friend std::ostream & operator<<(std::ostream & os,
                                                 const GenericWriteLogOperation
                                                 & op);
            ...
            class WriteLogOperation:public GenericWriteLogOperation {
              public:
                ...
                ~WriteLogOperation() override;
                 ...
                 WriteLogOperation & operator=(const WriteLogOperation &) =
                    delete;
                void init(bool has_data,
                          std::vector <
                          WriteBufferAllocation >::iterator allocation,
            ...
            class WriteLogOperationSet {
              ...
              public:
                ...
                PerfCounters *perfcounter = nullptr;
                 std::shared_ptr < SyncPoint > sync_point;
                 WriteLogOperationSet(utime_t dispatched,
                                      PerfCounters * perfcounter,
                                      std::shared_ptr < SyncPoint > sync_point,
                ...
                ~WriteLogOperationSet();
                 ...
                 WriteLogOperationSet & operator=(const WriteLogOperationSet &)
                    = delete;
                friend std::ostream & operator<<(std::ostream & os,
                                                 const WriteLogOperationSet &
                                                 s);
            };
            ...
            class DiscardLogOperation:public GenericWriteLogOperation {
              public:
                ...
                ~DiscardLogOperation() override;
                 ...
                 DiscardLogOperation & operator=(const DiscardLogOperation &) =
                    delete;
                const std::shared_ptr < GenericLogEntry >
                    get_log_entry() override {
                    return log_entry;
