...
class RGWInfo_ObjStore_SWIFT:public RGWInfo_ObjStore {
  protected:
    struct info {
        bool is_admin_info;
         function < void (Formatter &, const md_config_t &,
                          RGWRados &) > list_data;
    };
  ...
  public:
    ...
    static void list_swift_data(Formatter & formatter,
                                const md_config_t & config, RGWRados & store);
    ...
    static void list_tempurl_data(Formatter & formatter,
                                  const md_config_t & config, RGWRados & store);
    static void list_slo_data(Formatter & formatter, const md_config_t & config,
                              RGWRados & store);
...
class RGWSwiftWebsiteHandler {
  ...
  public:
    ...
    :store(store), s(s), handler(handler) {
    } int error_handler(const int err_no, std::string * const error_content);
...
class RGWHandler_REST_SWIFT:public RGWHandler_REST {
  ...
  public:
    ...
    int init(RGWRados * store, struct req_state *s,
...
class RGWHandler_REST_Bucket_SWIFT:public RGWHandler_REST_SWIFT {
  ...
  public:
    ...
    int init(RGWRados * const store,
        ...
        website_handler =
            boost::in_place < RGWSwiftWebsiteHandler > (store, s, this);
