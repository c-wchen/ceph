...
class C_IO_Wrapper:public MDSIOContext {
  protected:
    ...
    void finish(int r) override {
     ...
     C_IO_Wrapper(MDSRank * mds_,
                  MDSInternalContextBase * wrapped_):MDSIOContext(mds_),
...
class MDSGather:public C_GatherBase < MDSInternalContextBase,
    MDSInternalContextGather > {
  public:
    MDSGather(CephContext * cct,
              MDSInternalContextBase * onfinish):C_GatherBase <
        MDSInternalContextBase, MDSInternalContextGather > (cct, onfinish) {
  } protected:
     MDSRank * get_mds() override {
        return NULL;
    }
...
typedef C_GatherBuilderBase < MDSInternalContextBase,
    MDSGather > MDSGatherBuilder;
