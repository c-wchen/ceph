...
BtreeOMapManager::handle_root_split_ret BtreeOMapManager::handle_root_split(
    omap_context_t oc,
    omap_root_t &omap_root,
...
BtreeOMapManager::handle_root_merge_ret BtreeOMapManager::handle_root_merge(
    omap_context_t oc,
    omap_root_t &omap_root,
...
BtreeOMapManager::omap_get_value_ret BtreeOMapManager::omap_get_value(
...
BtreeOMapManager::omap_set_keys_ret BtreeOMapManager::omap_set_keys(
    omap_root_t &omap_root,
    Transaction &t,
...
BtreeOMapManager::omap_set_key_ret BtreeOMapManager::omap_set_key(
    omap_root_t &omap_root,
    Transaction &t,
    const std::string &key,
...
BtreeOMapManager::omap_rm_key_ret BtreeOMapManager::omap_rm_key(
    omap_root_t &omap_root,
    Transaction &t,
    const std::string &key)
{
...
BtreeOMapManager::omap_rm_key_range_ret BtreeOMapManager::omap_rm_key_range(
    omap_root_t &omap_root,
    Transaction &t,
...
BtreeOMapManager::omap_list_ret BtreeOMapManager::omap_list(
    const omap_root_t &omap_root,
    Transaction &t,
...
BtreeOMapManager::omap_clear_ret BtreeOMapManager::omap_clear(
    omap_root_t &omap_root,
    Transaction &t)
{
