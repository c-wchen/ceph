...
namespace librbd {
    namespace mirror {
        ...
        } template < typename I > GetInfoRequest <
            I >::GetInfoRequest(I & image_ctx,
        ...
        template < typename I >
            ...
            auto ctx = create_context_callback <
                GetInfoRequest < I >,
                &GetInfoRequest < I >::handle_get_journal_tag_owner > (this);
        ...
        template < typename I > void GetInfoRequest < I >::get_snapcontext() {
            ...
            librados::AioCompletion * comp = create_rados_callback <
                GetInfoRequest < I >,
                &GetInfoRequest < I >::handle_get_snapcontext > (this);
            m_out_bl.clear();
            int r =
                m_io_ctx.aio_operate(util::header_name(m_image_id), comp, &op,
                                     &m_out_bl);
            ceph_assert(r == 0);
            comp->release();
        }
        ...
        template < typename I > void GetInfoRequest < I >::get_snapshots() {
          ...
          for (auto snap_id:m_snapc.snaps) {
            ...
            librados::AioCompletion * comp = create_rados_callback <
                GetInfoRequest < I >,
                &GetInfoRequest < I >::handle_get_snapshots > (this);
            m_out_bl.clear();
            int r =
                m_io_ctx.aio_operate(util::header_name(m_image_id), comp, &op,
                                     &m_out_bl);
        ...
        template < typename I >
          ...
          for (auto snap_id:m_snapc.snaps) {
                ...
                snap_info.emplace(snap_id,
                                  SnapInfo(snap.name, snap.snapshot_namespace,
                                           0, {
                                           }
                                           , 0, 0, {
                                           }
        ...
        template < typename I >
            void GetInfoRequest < I >::calc_promotion_state(const std::map <
                                                            librados::snap_t,
                                                            SnapInfo >
                                                            &snap_info) {
            *m_promotion_state = PROMOTION_STATE_UNKNOWN;
