...
namespace crimson {
    namespace test_simple_scheduler {
        ...
        using SimpleQueue =
            ssched::SimpleQueue < ClientId, sim::TestRequest, Time >;

        using SimpleServer = sim::SimulatedServer < SimpleQueue,
            ssched::ReqParams, ssched::NullData, SimpleAccum >;
        using SimpleClient =
            sim::SimulatedClient < ssched::ServiceTracker < ServerId >,
            ssched::ReqParams, ssched::NullData, SimpleAccum >;
        ...
        using MySim =
            sim::Simulation < ServerId, ClientId, SimpleServer, SimpleClient >;
...
} // namespace test_simple }    // namespace crimson
