...
namespace crimson::os::seastore::omap_manager {
    ...
    :tm(tm) {
        ...
        return tm.alloc_extent < OMapLeafNode > (t, hint, OMAP_LEAF_BLOCK_SIZE)
            .si_then([hint, &t] (auto && root_extent) {
                     root_extent->set_size(0); omap_node_meta_t meta {
                     1};
    ...
    BtreeOMapManager::get_root_ret
        BtreeOMapManager::get_omap_root(omap_context_t oc,
    ...
    BtreeOMapManager::handle_root_split_ret
        BtreeOMapManager::handle_root_split(omap_context_t oc,
                                            omap_root_t & omap_root,
                                            const OMapNode::
    ...
    BtreeOMapManager::handle_root_merge_ret
        BtreeOMapManager::handle_root_merge(omap_context_t oc,
                                            omap_root_t & omap_root,
    ...
    BtreeOMapManager::omap_get_value_ret
        BtreeOMapManager::omap_get_value(const omap_root_t & omap_root,
                                         Transaction & t,
    ...
    BtreeOMapManager::omap_set_keys_ret
        BtreeOMapManager::omap_set_keys(omap_root_t & omap_root,
                                        Transaction & t,
                                        std::map < std::string,
    ...
    BtreeOMapManager::omap_set_key_ret
        BtreeOMapManager::omap_set_key(omap_root_t & omap_root,
                                       Transaction & t,
                                       const std::string & key,
    ...
    BtreeOMapManager::omap_rm_key_range_ret
        BtreeOMapManager::omap_rm_key_range(omap_root_t & omap_root,
                                            Transaction & t,
        ...
        return seastar::do_with(std::make_optional < std::string > (first),
          ...
          LOG_PREFIX(BtreeOMapManager::omap_rm_key_range); auto &[complete, kvs] = results; std::vector < std::string > keys; for (const auto &[k, _]:kvs)
                  {
                  keys.push_back(k);}
