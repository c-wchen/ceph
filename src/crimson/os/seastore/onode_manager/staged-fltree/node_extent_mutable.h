 ...
 */
    class NodeExtentMutable {
      public:
        ...
        } const void *copy_in_relative(extent_len_t dst_offset, const void *src,
                                       extent_len_t len) {
        ...
        template < typename T >
            const T *copy_in_relative(extent_len_t dst_offset, const T & src) {
        ...
        void shift_relative(extent_len_t src_offset, extent_len_t len,
                            int offset) {
        ...
        template < typename T > void validate_inplace_update(const T & updated) {
        ...
        node_offset_t get_node_offset() const {
            return node_offset;
        } NodeExtentMutable get_mutable_absolute(const void *dst,
                                                 node_offset_t len)const {
            ...
            return ret;
        } NodeExtentMutable get_mutable_relative(node_offset_t offset,
                                                 node_offset_t len) const {
