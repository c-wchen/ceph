        ...
        namespace list {
            ...
            int execute(const po::variables_map & vm) {
                ...
                r = do_list(pool_name, vm["long"].as < bool > (),
                            ...
                            ("rbd_concurrent_management_ops"), formatter.get());
                if (r < 0) {
