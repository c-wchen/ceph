...
namespace librbd {
    ...
    namespace mirror {
        ...
        namespace image_replayer {
            ...
            template < typename ImageCtxT = librbd::ImageCtx >
              ...
              public:
                static CreateImageRequest *create(Threads < ImageCtxT >
                                                  *threads,
                                                  librados::
                                                  IoCtx & local_io_ctx,
                                                  const std::
                                                  ...
                                                  mirror_image_mode,
                                                  Context * on_finish) {
                    return new CreateImageRequest(threads, local_io_ctx,
                                                  global_image_id,
                                                  remote_mirror_uuid,
                                                  local_image_name,
                                                  local_image_id,
                ...
                } CreateImageRequest(Threads < ImageCtxT > *threads,
   ...
   */
                ...
                void populate_image_options(librbd::ImageOptions *
                                            image_options);
