...
namespace librbd {
    namespace image {
        template <> struct TypeTraits <MockImageCtx > {
        ...
        template <> class TrimRequest < MockImageCtx > {
          public:
            ...
            static TrimRequest *create(MockImageCtx & image_ctx,
                                       Context * on_finish,
    ...
    namespace journal {
        template <> class RemoveRequest < MockImageCtx > {
          private:
        ...
        RemoveRequest < MockImageCtx > *RemoveRequest <
            MockImageCtx >::s_instance = nullptr;
    }                           // namespace journal

    namespace mirror {

        template <> class DisableRequest < MockImageCtx > {
          public:
        ...
        DisableRequest < MockImageCtx > *DisableRequest <
    ...
    namespace image {
        ...
        class TestMockImageRemoveRequest:public TestMockFixture {
          public:
            ...
            typedef librbd::operation::TrimRequest < MockImageCtx >
                MockTrimRequest;
            typedef librbd::journal::RemoveRequest < MockImageCtx >
                MockJournalRemoveRequest;
            typedef librbd::mirror::DisableRequest < MockImageCtx >
        ...
        TEST_F(TestMockImageRemoveRequest, SuccessV1) {
            ...
            MockRemoveRequest *req =
                MockRemoveRequest::create(m_ioctx, m_image_name, "",
                                          true, false, no_op, &op_work_queue,
                                          &ctx);
            req->send();
        ...
        TEST_F(TestMockImageRemoveRequest, SuccessV2) {
            ...
            expect_shut_down_exclusive_lock(*m_mock_imctx, *mock_exclusive_lock,
                                            0);
            ...
            expect_mirror_disable(*m_mock_imctx, mock_mirror_disable_request,
                                  0);
            expect_state_close(*m_mock_imctx);
            expect_wq_queue(op_work_queue, 0);
            expect_journal_remove(*m_mock_imctx, mock_journal_remove_request,
                                  0);
            expect_remove_mirror_image(m_ioctx, 0);
            expect_dir_remove_image(m_ioctx, 0);

            MockRemoveRequest *req =
                MockRemoveRequest::create(m_ioctx, m_image_name, "", true,
                                          false, no_op, &op_work_queue, &ctx);
            req->send();
