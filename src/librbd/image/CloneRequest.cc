    ...
    namespace image {
        ...
        :m_config(config), m_parent_io_ctx(parent_io_ctx),
            ...
            if (!default_format_set) {
                ...
                get_id() << ", " << "parent_image_id=" << parent_image_id <<
                ", " << "parent_snap=" << parent_snap_name << "/" <<
                parent_snap_id << " clone to " << "pool_id=" << m_ioctx.
                get_id() << ", " << "name=" << m_name << ", " << "opts=" <<
                m_opts << dendl;
        ...
        template < typename I > void CloneRequest < I >::validate_options() {
            ...
            if (m_clone_format == 1 &&
                ...
                ldout(m_cct,
                      1) << "clone v2 required for cross-namespace clones" <<
                    dendl;
                complete(-EXDEV);
                return;
            }
        ...
        template < typename I > void CloneRequest < I >::open_parent() {
            ldout(m_cct, 20) << dendl;
            ceph_assert(m_parent_snap_name.
                        empty() ^ (m_parent_snap_id == CEPH_NOSNAP));

            if (m_parent_snap_id != CEPH_NOSNAP) {
                m_parent_image_ctx =
                    I::create("", m_parent_image_id, m_parent_snap_id,
            ...
            Context *ctx = create_context_callback <
                CloneRequest < I >,
                &CloneRequest < I >::handle_open_parent > (this);
        ...
        template < typename I >
            ...
            if (r < 0) {
                ...
                lderr(m_cct) << "failed to open parent image: " <<
        ...
        template < typename I > void CloneRequest < I >::validate_parent() {
            ...
            m_size =
                m_parent_image_ctx->get_image_size(m_parent_image_ctx->snap_id);

            bool snap_protected;
            int r =
                m_parent_image_ctx->is_snap_protected(m_parent_image_ctx->
                                                      snap_id, &snap_protected);
        ...
        template < typename I > void CloneRequest < I >::create_child() {
            ...
            auto req =
                CreateRequest < I >::create(m_config, m_ioctx, m_name, m_id,
                                            m_size, m_opts,
                                            image::
        ...
        template < typename I > void CloneRequest < I >::attach_parent() {
            ...
            auto ctx = create_context_callback <
                CloneRequest < I >,
                &CloneRequest < I >::handle_attach_parent > (this);
            auto req =
                AttachParentRequest < I >::create(*m_imctx, m_pspec, m_size,
                                                  false, ctx);
            req->send();
        }
        ...
        template < typename I >
            ...
            if (r < 0) {
                lderr(m_cct) << "failed to attach parent: " << cpp_strerror(r)
                    << dendl;
                m_r_saved = r;
                close_child();
                return;
        ...
        template < typename I > void CloneRequest < I >::attach_child() {
            ...
            auto ctx = create_context_callback <
                CloneRequest < I >,
                &CloneRequest < I >::handle_attach_child > (this);
            auto req =
                AttachChildRequest < I >::create(m_imctx, m_parent_image_ctx,
                                                 m_parent_image_ctx->snap_id,
                                                 nullptr, 0,
                                                 m_clone_format, ctx);
            req->send();
        }
        ...
        template < typename I > void CloneRequest < I >::copy_metadata() {
            ...
            auto ctx = create_context_callback <
                CloneRequest < I >,
                &CloneRequest < I >::handle_copy_metadata > (this);
            auto req =
                deep_copy::MetadataCopyRequest < I >::create(m_parent_image_ctx,
                                                             m_imctx, ctx);
            req->send();
        }
        ...
        template < typename I >
            ...
            if (r < 0) {
                lderr(m_cct) << "failed to copy metadata: " << cpp_strerror(r)
                    << dendl;
                m_r_saved = r;
                close_child();
                return;
        ...
        template < typename I > void CloneRequest < I >::enable_mirror() {
            ...
            auto req =
                mirror::EnableRequest < I >::create(m_imctx,
                                                    m_mirror_image_mode,
                                                    m_non_primary_global_image_id,
                                                    true, ctx);
            req->send();
        ...
        template < typename I > void CloneRequest < I >::close_child() {
            ...
            auto ctx = create_context_callback <
                CloneRequest < I >,
                &CloneRequest < I >::handle_close_child > (this);
        ...
        template < typename I > void CloneRequest < I >::remove_child() {
            ...
            auto req =
                librbd::image::RemoveRequest < I >::create(m_ioctx, m_name,
                                                           m_id, false, false,
                                                           m_no_op,
                                                           m_op_work_queue,
                                                           ctx);
        ...
        template < typename I > void CloneRequest < I >::close_parent() {
            ...
            auto ctx = create_context_callback <
                CloneRequest < I >,
                &CloneRequest < I >::handle_close_parent > (this);
