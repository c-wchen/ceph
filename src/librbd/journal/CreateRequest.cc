...
namespace librbd {
    ...
    namespace journal {
        ...
        :m_ioctx(ioctx), m_image_id(imageid), m_order(order),
            ...
            m_tag_class(tag_class), m_tag_data(tag_data),
        ...
        template < typename I > void CreateRequest < I >::create_journal() {
            ...
            m_journaler =
                new Journaler(m_op_work_queue, m_timer, m_timer_lock, m_ioctx,
                              m_image_id, m_image_client_id, {
                              }, nullptr);

            using klass = CreateRequest < I >;
            Context *ctx =
                create_context_callback < klass,
                &klass::handle_create_journal > (this);
        ...
        template < typename I >
            ...
            if (*result < 0) {
                lderr(m_cct) << "failed to allocate tag: " <<
                    cpp_strerror(*result) << dendl;
                shut_down_journaler(*result);
                return nullptr;
            }
        ...
        template < typename I > void CreateRequest < I >::register_client() {
            ...
            encode(ClientData {
                   ImageClientMeta {
                   m_tag.tag_class}}, m_bl);

            using klass = CreateRequest < I >;
            Context *ctx =
                create_context_callback < klass,
                &klass::handle_register_client > (this);
        ...
        template < typename I >
            ...
            if (*result < 0) {
                lderr(m_cct) << "failed to register client: " <<
                    cpp_strerror(*result) << dendl;
            }
        ...
        template < typename I >
            ...
            Context *ctx =
                create_context_callback < klass,
                &klass::handle_journaler_shutdown > (this);
        ...
        template < typename I >
            ...
            I >::handle_journaler_shutdown(int *result) {
            ldout(m_cct, 20) << __func__ << ": r=" << *result << dendl;

            if (*result < 0) {
                lderr(m_cct) << "failed to shut down journaler: " <<
                    cpp_strerror(*result) << dendl;
            }
        ...
        template < typename I > void CreateRequest < I >::remove_journal() {
            ...
            Context *ctx =
                create_context_callback < klass,
                &klass::handle_remove_journal > (this);

            RemoveRequest < I > *req =
                RemoveRequest < I >::create(m_ioctx, m_image_id,
                                            m_image_client_id, m_op_work_queue,
                                            ctx);
            req->send();
        }
