...
namespace rgw {
    namespace IAM {
        ...
        static constexpr std::uint64_t s3ListBucketMultipartUploads =
            1ULL << 19;
        static constexpr std::uint64_t s3GetAccelerateConfiguration =
            1ULL << 20;
        static constexpr std::uint64_t s3PutAccelerateConfiguration =
            1ULL << 21;
        ...
        static constexpr std::uint64_t s3PutReplicationConfiguration =
            1ULL << 45;
        static constexpr std::uint64_t s3GetReplicationConfiguration =
            1ULL << 46;
        static constexpr std::uint64_t s3DeleteReplicationConfiguration =
            1ULL << 47;
        ...
        static constexpr std::uint64_t s3DeleteObjectVersionTagging =
            1ULL << 53;
...
// modify this function.
            inline int op_to_perm(std::uint64_t op) {
                ...
                case s3ListMultipartUploadParts:
                    ...
                    case s3AbortMultipartUpload:case s3CreateBucket:case
                        s3DeleteBucket:case s3DeleteObject:case
                        s3DeleteObjectVersion:case s3PutObject:case
                        s3PutObjectTagging:case s3PutObjectVersionTagging:case
                        s3DeleteObjectTagging:case
                        s3DeleteObjectVersionTagging:case s3RestoreObject:return
                        RGW_PERM_WRITE;

                    case s3GetAccelerateConfiguration:case s3GetBucketAcl:case
                        s3GetBucketCORS:case s3GetBucketLocation:case
                        s3GetBucketLogging:case s3GetBucketNotification:case
                        s3GetBucketPolicy:case s3GetBucketRequestPayment:case
                        s3GetBucketTagging:case s3GetBucketVersioning:case
                        s3GetBucketWebsite:case s3GetLifecycleConfiguration:case
                        s3GetObjectAcl:case s3GetObjectVersionAcl:case
                        s3GetReplicationConfiguration:return RGW_PERM_READ_ACP;

                    case s3DeleteBucketPolicy:case s3DeleteBucketWebsite:case
                        s3DeleteReplicationConfiguration:case
                        s3PutAccelerateConfiguration:case s3PutBucketAcl:case
                        s3PutBucketCORS:case s3PutBucketLogging:case
                        s3PutBucketNotification:case s3PutBucketPolicy:case
                        s3PutBucketRequestPayment:case s3PutBucketTagging:case
                        s3PutBucketVersioning:case s3PutBucketWebsite:case
                        s3PutLifecycleConfiguration:case s3PutObjectAcl:case
                        s3PutObjectVersionAcl:case
                        s3PutReplicationConfiguration:return RGW_PERM_WRITE_ACP;
        ...
        enum struct Service {
            ...
            ds, dynamodb, ec2, ecr, ecs, ssm, elasticbeanstalk,
                elasticfilesystem,
            elasticloadbalancing, elasticmapreduce, elastictranscoder,
                elasticache,
        ...
        struct Condition {
            ...
            // context and a date in another.
             ...
             Condition() = default;
             Condition(TokenID op, const char *s, std::size_t len,
                       bool ifexists)
            ...
            static boost::optional < ceph::real_time >
                ...
                try {
                    double d = std::stod(s, &p);
                    if (p == s.length()) {
                        return ceph::real_time(std::chrono::
            ...
            static boost::optional < ceph::bufferlist >
                ...
                base64.push_back(buffer::create_static(s.length(), const_cast < char *>(s.data())));    // Yuck
            ...
            static boost::optional < MaskedIP >
                as_network(const std::string & s);
...
namespace std {
    template <> struct hash <::rgw::IAM::Service > {
