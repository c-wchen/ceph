    ...
    namespace mirror {
        ...
        template < typename I >
            ...
            auto ctx = new LambdaContext([this] (int r){
                                         ...
                                         std::lock_guard locker {
                                         m_lock};
                                         ceph_assert(m_on_shut_down_finish !=
                                                     nullptr);
        ...
        template < typename I >
            bool LeaderWatcher <
            I >::is_releasing_leader(ceph::mutex & lock) const {
            ceph_assert(ceph_mutex_is_locked(m_lock));
        ...
        template < typename I >
            ...
            m_timer_task = new LambdaContext([this, leader,
            ...
            dout(10) << "scheduling " << name << " after " << after <<
        ...
        template < typename I >
            ...
            if (r < 0 && r != -ENOENT) {
                derr << "error breaking leader lock: " << cpp_strerror(r) <<
                    dendl;
        ...
        template < typename I > void LeaderWatcher < I >::init_instances() {
            ...
            m_instances =
                Instances < I >::create(m_threads, m_ioctx, m_instance_id,
