...
TEST(ClsNumOps, Add)
{
    ...
    ASSERT_EQ(0,
              rados::cls::numops::add(&ioctx, "myobject", key, new_value_in));
...
TEST(ClsNumOps, Sub)
{
    ...
    ASSERT_EQ(0,
              rados::cls::numops::sub(&ioctx, "myobject", key, new_value_in));
...
TEST(ClsNumOps, Mul)
{
    ...
    ASSERT_EQ(0,
              rados::cls::numops::mul(&ioctx, "myobject", key, new_value_in));
...
TEST(ClsNumOps, Div)
{
    ...
    ASSERT_EQ(0,
              rados::cls::numops::div(&ioctx, "myobject", key, new_value_in));
