...
public:
    ...
    RadosTestContext(const std::string &pool_name, int max_in_flight, uint64_t max_size, uint64_t min_stride_size,
                     uint64_t max_stride_size, bool no_omap, bool no_sparse, bool pool_snaps, bool write_fadvise_dontneed,
...
public:
    ...
    } void _begin() override
    {
        ...
        context->io_ctx.aio_operate(context->prefix + oid, rcompletion, &read_op,
