...
const char **CompressorRegistry::get_tracked_conf_keys() const const
{
...
{
    auto c_mode =
        Compressor::get_comp_mode_type(cct->_conf.get_val < std::string >
                                       ("ms_osd_compress_mode"));
    ...
    ms_osd_compression_methods =
        _parse_method_list(cct->_conf.get_val < std::string >
                           ("ms_osd_compression_algorithm"));
    ms_osd_compress_min_size =
