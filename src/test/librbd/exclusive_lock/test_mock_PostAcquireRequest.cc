...
namespace librbd {
    ...
    namespace image {
        ...
        RefreshRequest < librbd::MockTestImageCtx > *RefreshRequest <
...
namespace librbd {
    namespace exclusive_lock {
        ...
        class TestMockExclusiveLockPostAcquireRequest:public TestMockFixture {
          public:
            typedef PostAcquireRequest < MockTestImageCtx >
                MockPostAcquireRequest;
            typedef librbd::image::RefreshRequest < MockTestImageCtx >
                MockRefreshRequest;
            ...
            void expect_acquired_exclusive_lock(MockTestImageCtx &
                                                mock_image_ctx, int r) {
                EXPECT_CALL(*mock_image_ctx.plugin_registry,
                            acquired_exclusive_lock(_))
                    .
                    WillOnce(CompleteContext
                             (r, mock_image_ctx.image_ctx->op_work_queue));
            }
        ...
        TEST_F(TestMockExclusiveLockPostAcquireRequest, Success) {
            ...
            MockPostAcquireRequest *req =
                MockPostAcquireRequest::create(mock_image_ctx,
                                               &acquire_ctx,
                                               &ctx);
            req->send();
        ...
        TEST_F(TestMockExclusiveLockPostAcquireRequest,
        ...
        TEST_F(TestMockExclusiveLockPostAcquireRequest, AllocateJournalTagError) {
            ...
            expect_open_journal(mock_image_ctx, mock_journal, 0);
            expect_get_journal_policy(mock_image_ctx, mock_journal_policy);
            expect_allocate_journal_tag(mock_image_ctx, mock_journal_policy,
                                        -EPERM);
            expect_close_journal(mock_image_ctx, mock_journal);
            expect_close_object_map(mock_image_ctx, mock_object_map);
