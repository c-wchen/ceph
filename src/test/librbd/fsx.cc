...
ssize_t librbd_writesame(struct rbd_ctx *ctx, uint64_t off, size_t len,
                         const char *buf, size_t data_len)
{
    ssize_t n;
    int ret;
...
ssize_t librbd_compare_and_write(struct rbd_ctx *ctx, uint64_t off, size_t len,
                                 const char *cmp_buf, const char *buf)
{
    ssize_t n;
    int ret;
...
int __librbd_deep_copy(struct rbd_ctx *ctx, const char *src_snapname,
...
int __librbd_clone(struct rbd_ctx *ctx, const char *src_snapname,
                   const char *dst_imagename, int *order, int stripe_unit,
                   int stripe_count)
{
    int ret;
...
int librbd_clone(struct rbd_ctx *ctx, const char *src_snapname,
                 const char *dst_imagename, int *order, int stripe_unit,
                 int stripe_count)
{
...
ssize_t generic_pread(struct rbd_ctx *ctx, uint64_t off, size_t len, char *buf)
{
    ssize_t n;
...
ssize_t generic_pwrite(struct rbd_ctx *ctx, uint64_t off, size_t len, const char *buf)
{
    ssize_t n;
...
int krbd_clone(struct rbd_ctx *ctx, const char *src_snapname,
               const char *dst_imagename, int *order, int stripe_unit,
               int stripe_count)
{
    int ret;
...
int nbd_clone(struct rbd_ctx *ctx, const char *src_snapname,
              const char *dst_imagename, int *order, int stripe_unit,
              int stripe_count)
{
    int ret;
...
#ifdef _WIN32
int wnbd_set_writable(struct rbd_ctx *ctx)
{
...
int wnbd_open(const char *name, struct rbd_ctx *ctx)
{
    int r;
    int fd;
...
int wnbd_close(struct rbd_ctx *ctx)
{
    int r;
...
int wnbd_flush(struct rbd_ctx *ctx)
{
    return _commit(ctx->krbd_fd);
}

int wnbd_discard(struct rbd_ctx *ctx, uint64_t off, uint64_t len)
{
...
int wnbd_get_size(struct rbd_ctx *ctx, uint64_t *size)
{
    DWORD bytesReturned = 0;
...
int wnbd_resize(struct rbd_ctx *ctx, uint64_t size)
{
    int ret;
...
int wnbd_clone(struct rbd_ctx *ctx, const char *src_snapname,
               const char *dst_imagename, int *order, int stripe_unit,
               int stripe_count)
{
    int ret;
...
int wnbd_flatten(struct rbd_ctx *ctx)
{
    int ret;
...
int ggate_clone(struct rbd_ctx *ctx, const char *src_snapname,
                const char *dst_imagename, int *order, int stripe_unit,
                int stripe_count)
{
    int ret;
