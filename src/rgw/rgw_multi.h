...
extern int list_multipart_parts(RGWRados * store, struct req_state *s,
                                ...
                                int marker, map < uint32_t,
                                RGWUploadPartInfo > &parts, int *next_marker,
                                bool * truncated, bool assume_unsorted = false);
...
extern int list_bucket_multiparts(RGWRados * store, RGWBucketInfo & bucket_info,
                                  ...
                                  string & delim, int &max_uploads,
                                  vector < rgw_bucket_dir_entry > *objs,
                                  map < string, bool > *common_prefixes,
                                  bool * is_truncated);

extern int abort_bucket_multiparts(RGWRados * store, CephContext * cct,
