...
namespace rbd {
    namespace mirror {
        namespace image_replayer {
            ...
            class TestMockImageReplayerPrepareLocalImageRequest:public
                TestMockFixture {
              public:
                typedef ImageDeleter < librbd::MockTestImageCtx >
                    MockImageDeleter;
                ...
                void expect_get_mirror_image_id(MockGetMirrorImageIdRequest &
                    ...
                    bufferlist bl;
                     ...
                     EXPECT_CALL(get_mock_io_ctx(io_ctx),
                                 exec(RBD_DIRECTORY, _, StrEq("rbd"),
                                      StrEq("dir_get_name"), _, _, _, _))
                    .
                        WillOnce(DoAll
                                 (WithArg < 5 >
            ...
            TEST_F(TestMockImageReplayerPrepareLocalImageRequest,
                   SuccessJournal) {
                InSequence seq;
            ...
            TEST_F(TestMockImageReplayerPrepareLocalImageRequest, ImageCreating) {
                ...
                expect_trash_move(mock_image_deleter, "global image id", false,
                                  0);
