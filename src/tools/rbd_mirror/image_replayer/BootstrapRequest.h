...
namespace journal {
    ...
    namespace mirror {
        ...
        namespace image_replayer {
          ...
          template < typename ImageCtxT = librbd::ImageCtx > class BootstrapRequest:public BaseRequest
            {
              public:
                ...
                static BootstrapRequest *create(librados::IoCtx & local_io_ctx,
                    ...
                    return new BootstrapRequest(local_io_ctx, remote_io_ctx,
                                                instance_watcher,
                                                local_image_ctx, local_image_id,
                                                remote_image_id,
                                                global_image_id, work_queue,
                                                timer, timer_lock,
                                                local_mirror_uuid,
                                                remote_mirror_uuid, journaler,
