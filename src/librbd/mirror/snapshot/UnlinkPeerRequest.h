    ...
    namespace mirror {
        namespace snapshot {
            ...
            template < typename ImageCtxT = librbd::ImageCtx >
              ...
              public:
                static UnlinkPeerRequest *create(ImageCtxT * image_ctx,
                                                 uint64_t snap_id,
                                                 const std::
                                                 string & mirror_peer_uuid,
                                                 bool allow_remove,
                                                 Context * on_finish) {
                    return new UnlinkPeerRequest(image_ctx, snap_id,
                                                 mirror_peer_uuid, allow_remove,
                                                 on_finish);
                ...
                :m_image_ctx(image_ctx), m_snap_id(snap_id),
                    ...
                    m_allow_remove(allow_remove), m_on_finish(on_finish) {
                } void send();
              ...
              private:
                ...
                void remove_snapshot(const cls::rbd::
