...
namespace cephfs {
    namespace mirror {
        ...
        MirrorWatcher::MirrorWatcher(librados::IoCtx & ioctx,
                                     FSMirror * fs_mirror,
                                     ContextWQ * work_queue)
        :Watcher(ioctx, CEPHFS_MIRROR_OBJECT, work_queue), m_ioctx(ioctx),
            m_fs_mirror(fs_mirror), m_work_queue(work_queue),
        ...
        void MirrorWatcher::unregister_watcher() {
            ...
            Context *on_finish = new C_CallbackAdapter <
                MirrorWatcher,
                &MirrorWatcher::handle_unregister_watcher > (this);
