...
ObjectStoreImitator::CollectionRef ObjectStoreImitator::_get_collection(const coll_t &cid)
{
...
ObjectStore::CollectionHandle ObjectStoreImitator::open_collection(const coll_t &cid)
{
    std::shared_lock l(coll_lock);
    ceph::unordered_map<coll_t, CollectionRef>::iterator cp = coll_map.find(cid);
    if (cp == coll_map.end()) {
...
ObjectStore::CollectionHandle ObjectStoreImitator::create_new_collection(const coll_t &cid)
{
