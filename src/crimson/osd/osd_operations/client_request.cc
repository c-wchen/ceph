...
ClientRequest::interruptible_future < > ClientRequest::reply_op_error(const Ref < PG > & pg, int err)
{
...
ClientRequest::interruptible_future < > ClientRequest::process_pg_op(
    Ref < PG > pg)
{
...
ClientRequest::interruptible_future < > ClientRequest::process_op(
...
ClientRequest::do_process_iertr::future < > ClientRequest::do_process(
    instance_handle_t &ihref,
