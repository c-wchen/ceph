...
public:
    static ImageCopyRequest *create(ImageCtxT *src_image_ctx,
                                    ...
                                    Context *on_finish)
    {
        return new ImageCopyRequest(src_image_ctx, dst_image_ctx,
                                    src_snap_id_start, src_snap_id_end,
                                    dst_snap_id_start, flatten,
                                    object_number, snap_seqs, handler,
                                    on_finish);
    } ImageCopyRequest(ImageCtxT *src_image_ctx,
                       ImageCtxT *dst_image_ctx,
                       librados::snap_t src_snap_id_start,
                       librados::snap_t src_snap_id_end,
...
private:
    ...
    uint64_t, std::vector < uint64_t >,
              std::greater < uint64_t >> m_copied_objects;
    ...
    void map_src_objects(uint64_t dst_object,
