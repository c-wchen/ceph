...
struct C_aio_watch_flush_Complete:public Context {
    ...
    C_aio_watch_flush_Complete(librados::RadosClient * _client,
                                          ...
                                          map < string,::pool_stat_t > &result)
{
    ...
    objecter->get_pool_stats(pools, &result,
...
int librados::RadosClient::service_daemon_update_status(const std::map <
                                                        std::string,
                                                        std::string > &status)
{
    if (state != CONNECTED) {
