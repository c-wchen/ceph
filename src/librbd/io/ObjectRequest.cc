    ...
    namespace io {
        ...
        namespace {
         ...
         ObjectRequest < I > *ObjectRequest < I >::create_write(I * ictx,
                                                                ...
                                                                Context *
                                                                completion) {
            return new ObjectWriteRequest < I > (ictx, oid, object_no,
                                                 object_off, data, snapc,
        ...
        template < typename I >
            ObjectRequest < I > *ObjectRequest < I >::create_discard(I * ictx,
                                                                     ...
                                                                     completion)
        {
            return new ObjectDiscardRequest < I > (ictx, oid, object_no,
                                                   object_off, object_len,
                                                   snapc, disable_clone_remove,
                                                   update_object_map,
                                                   parent_trace, completion);
        }

        template < typename I >
            ObjectRequest < I > *ObjectRequest < I >::create_writesame(I * ictx,
                                                                       const
                                                                       std::
                                                                       string &
                                                                       oid,
                                                                       ...
                                                                       completion)
        {
            return new ObjectWriteSameRequest < I > (ictx, oid, object_no,
                                                     object_off, object_len,
                                                     data, snapc, op_flags,
                                                     parent_trace, completion);
        }
        ...
        template < typename I >
            ...
            I >::create_compare_and_write(I * ictx, const std::string & oid,
                                          uint64_t object_no,
                                          uint64_t object_off,
                                          ...
                                          Context * completion) {
            return new ObjectCompareAndWriteRequest < I > (ictx, oid, object_no,
                                                           object_off, cmp_data,
                                                           write_data, snapc,
                                                           mismatch_offset,
                                                           op_flags,
        ...
        template < typename I >
            ObjectRequest < I >::ObjectRequest(I * ictx,
      ...
      :    m_ictx(ictx), m_oid(oid), m_object_no(objectno), m_object_off(off),
        ...
        template < typename I >
            ...
            uint64_t object_overlap =
                m_ictx->prune_parent_extents(*parent_extents,
                                             parent_overlap);
            if (object_overlap > 0) {
...
/** read **/
        ...
        :ObjectRequest < I > (ictx, oid, objectno, offset, len, snap_id, "read",
                              parent_trace, completion), m_op_flags(op_flags),
        ...
        template < typename I > void ObjectReadRequest < I >::read_cache() {
            I *image_ctx = this->m_ictx;
            ldout(image_ctx->cct, 20) << dendl;
            ...
            auto cache_ctx =
                util::create_async_context_callback(*image_ctx,
                                                    ...
                                                    I >::handle_read_cache >
                                                    (this));
            image_ctx->aio_read_from_cache(this->m_oid, this->m_object_no,
                                           &m_read_data, this->m_object_len,
                                           this->m_object_off, cache_ctx,
                                           m_op_flags,
        ...
        template < typename I > void ObjectReadRequest < I >::read_object() {
            ...
            if (this->m_object_len >= image_ctx->sparse_read_threshold_bytes) {
                op.sparse_read(this->m_object_off, this->m_object_len,
                               &m_ext_map, &m_read_data, nullptr);
            }
            else {
                op.read(this->m_object_off, this->m_object_len, &m_read_data,
                        nullptr);
            }
            op.set_op_flags2(m_op_flags);

            librados::AioCompletion * rados_completion =
                util::create_rados_callback < ObjectReadRequest < I >,
                &ObjectReadRequest < I >::handle_read_object > (this);
            int flags = image_ctx->get_read_flags(this->m_snap_id);
            int r =
                image_ctx->data_ctx.aio_operate(this->m_oid, rados_completion,
                                                &op, flags, nullptr,
                                                (this->m_trace.valid()? this->
                                                 m_trace.get_info() : nullptr));
            assert(r == 0);
        ...
        template < typename I > void ObjectReadRequest < I >::read_parent() {
            ...
            Extents parent_extents;
            {
                ...
                int r =
                    image_ctx->get_parent_overlap(this->m_snap_id,
                                                  &parent_overlap);
                if (r == 0) {
                    object_overlap =
            ...
            ImageRequest < I >::aio_read(image_ctx->parent, parent_completion,
                                         std::move(parent_extents), ReadResult {
                                         &m_read_data}
                                         , 0, this->m_trace);
        }
        ...
        template < typename I > void ObjectReadRequest < I >::copyup() {
            ...
            if (it == image_ctx->copyup_list.end()) {
                ...
                auto new_req =
                    CopyupRequest < I >::create(image_ctx, this->m_oid,
                                                this->m_object_no,
...
/** write **/
        ...
        template < typename I >
            ...
            I >::AbstractObjectWriteRequest(I * ictx, const std::string & oid,
                                            uint64_t object_no,
                                            ...
                                            const ZTracer::Trace & parent_trace,
                                            Context * completion)
        :ObjectRequest < I > (ictx, oid, object_no, object_off, len,
                              CEPH_NOSNAP, trace_name, parent_trace,
                              completion), m_snap_seq(snapc.seq.val) {
            m_snaps.insert(m_snaps.end(), snapc.snaps.begin(),
                           snapc.snaps.end());
        ...
        template < typename I >
            ...
            I >::add_write_hint(librados::ObjectWriteOperation * wr) {
            I *image_ctx = this->m_ictx;
            RWLock::RLocker snap_locker(image_ctx->snap_lock);
        ...
        template < typename I > void AbstractObjectWriteRequest < I >::send() {
            I *image_ctx = this->m_ictx;
            ldout(image_ctx->cct,
                  20) << this->get_op_type() << " " << this->
                m_oid << " " << this->m_object_off << "~" << this->
                m_object_len << dendl;
            {
        ...
        template < typename I >
            ...
            ldout(image_ctx->cct,
                  20) << this->m_oid << " " << this->
                m_object_off << "~" << this->m_object_len << dendl;
        ...
        template < typename I >
            ...
            librados::AioCompletion * rados_completion =
                util::create_rados_callback < AbstractObjectWriteRequest < I >,
        ...
        template < typename I >
            ...
            I >::add_write_ops(librados::ObjectWriteOperation * wr) {
