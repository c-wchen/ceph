    ...
    namespace mirror {
        namespace image_replayer {
            ...
            template < typename I >
                ...
                if (r < 0) {
                    if (r != -ENOENT) {
                        derr << "failed to retrieve image name: " <<
            ...
            template < typename I >
                ...
                librados::AioCompletion * aio_comp = create_rados_callback <
                    PrepareLocalImageRequest < I >,
                    &PrepareLocalImageRequest < I >::handle_get_mirror_state >
                    (this);
                int r =
            ...
            template < typename I >
                void PrepareLocalImageRequest <
                I >::handle_get_mirror_state(int r) {
                dout(20) << ": r=" << r << dendl;
            ...
            template < typename I >
                ...
                Context *ctx = create_context_callback <
                    PrepareLocalImageRequest < I >,
                    &PrepareLocalImageRequest < I >::handle_get_tag_owner >
                    (this);
            ...
            template < typename I >
                void PrepareLocalImageRequest <
                I >::handle_get_tag_owner(int r) {
                dout(20) << "r=" << r << ", " << "tag_owner=" << *m_tag_owner <<
                    dendl;

                if (r < 0) {
                    derr << "failed to retrieve journal tag owner: " <<
                        cpp_strerror(r)
                        << dendl;
                    finish(r);
                    return;
