...
namespace librbd {
    ...
    namespace plugin {
      ...
      template < typename ImageCtxT = ImageCtx > class ParentCacheObjectDispatch:public io::
            ObjectDispatchInterface
        {
          ...
          private:
            ...
            int read_object(std::string file_path, ceph::bufferlist * read_data,
                            ...
                            Context * on_finish);
            void handle_read_cache(ceph::immutable_obj_cache::
                                   ObjectCacheRequest * ack, uint64_t object_no,
...
extern template class librbd::cache::ParentCacheObjectDispatch <
    librbd::ImageCtx >;
