...
namespace rbd {
        ...
        namespace image_replayer {
            ...
            template < typename ImageCtxT = librbd::ImageCtx >
              ...
              public:
                ...
                static PrepareRemoteImageRequest *create(Threads < ImageCtxT >
                                                         *threads,
                                                         librados::
                                                         IoCtx & local_io_ctx,
                                                         librados::
                                                         ...
                                                         **state_builder,
                                                         Context * on_finish) {
                    return new PrepareRemoteImageRequest(threads, local_io_ctx,
                                                         remote_io_ctx,
                                                         global_image_id,
                                                         local_mirror_uuid,
                                                         remote_pool_meta,
                ...
                :m_threads(threads), m_local_io_ctx(local_io_ctx),
                    ...
                    m_state_builder(state_builder), m_on_finish(on_finish) {
                } void send();
   ...
   */
                ...
                void finalize_journal_state_builder(cls::journal::
