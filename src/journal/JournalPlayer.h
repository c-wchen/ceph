    ...
    class JournalPlayer {
      public:
        ...
        typedef cls::journal::ObjectSetPosition ObjectSetPosition;
         ...
         JournalPlayer(librados::IoCtx & ioctx,
      ...
      private:
        ...
        typedef std::map < uint8_t,
            ceph::ref_t < ObjectPlayer >> SplayedObjectPlayers;
        ...
        ceph::ref_t < ObjectPlayer >
            get_object_player(uint64_t object_number) const;
        bool remove_empty_object_player(const ceph::ref_t < ObjectPlayer >
                                        &object_player);
