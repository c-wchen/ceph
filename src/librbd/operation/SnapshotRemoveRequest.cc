...
namespace librbd {
    namespace operation {
        ...
        namespace {
            ...
            template < typename I >
                std::ostream & operator<<(std::ostream & os,
                                          const typename SnapshotRemoveRequest <
                                          I >::State & state) {
                switch (state) {
                case SnapshotRemoveRequest < I >::STATE_REMOVE_OBJECT_MAP:
                    os << "REMOVE_OBJECT_MAP";
                    break;
                    case SnapshotRemoveRequest <
                        I >::STATE_REMOVE_CHILD:os << "REMOVE_CHILD";
                    break;
                    case SnapshotRemoveRequest <
                        I >::STATE_REMOVE_SNAP:os << "REMOVE_SNAP";
                    break;
                    case SnapshotRemoveRequest <
                        I >::STATE_RELEASE_SNAP_ID:os << "RELEASE_SNAP_ID";
                    break;
                    case SnapshotRemoveRequest <
                        I >::STATE_ERROR:os << "STATE_ERROR";
                    break;
        ...
        template < typename I >
...

            {
                ...
                if (image_ctx.object_map != nullptr) {
                    ...
                    image_ctx.object_map->snapshot_remove(m_snap_id,
                                                          this->
        ...
        template < typename I >
            ...
            CephContext *cct = image_ctx.cct;
            {
                ...
                if (image_ctx.parent_md.spec != our_pspec &&
                    ...
                    r = image_ctx.md_ctx.aio_operate(RBD_CHILDREN,
                                                     rados_completion, &op);
                    assert(r == 0);
        ...
        template < typename I >
            ...
            I >::scan_for_parents(ParentSpec & pspec) {
            I & image_ctx = this->m_image_ctx;
