...
public:
    static Replayer *create(Threads < ImageCtxT > *threads,
                            ...
                            *state_builder,
                            ...
                            replayer_listener)
    {
        return new Replayer(threads, instance_watcher,
                            local_mirror_uuid, pool_meta_cache,
    ...
    rolling_mean >> m_bytes_per_snapshot {
    ...
    void scan_local_mirror_snapshots(std::unique_lock <
                                     ceph::mutex > *locker);
    void scan_remote_mirror_snapshots(std::unique_lock <
                                      ceph::mutex > *locker);
    ...
    void handle_update_non_primary_snapshot(bool complete,
                                            int r);
    ...
    void handle_replay_complete(int r,
                                const std::
                                string &description);
    void handle_replay_complete(std::unique_lock < ceph::mutex >
                                *locker, int r,
                                const std::
                                string &description);
    ...
    bool is_replay_interrupted(std::unique_lock < ceph::mutex >
                               *lock);
