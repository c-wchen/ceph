...
int main(int argc, char **argv)
{
    ...
    for (unsigned i = 0; i < vm["num-images"].as < unsigned >(); ++i) {
        stringstream name;
    ...
    librbd::RBD rbd;
    {
        ...
        if (vm["sequential"].as < bool > ()) {
            ...
            gen = new SequentialLoad(image_names,
                                     image_size,
            ...
            gen =
                ...
                Bencher::OpType > (new RandomDist < string > (rng, image_names),
                                   new Align(new
                                             UniformRandom(rng, 0,
                                                           image_size -
                                                           vm["io-size"].as <
