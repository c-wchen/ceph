...
// TODO
    template < typename T > class always_aligned_t {
        ...
        template < class ... Args > always_aligned_t(Args && ... args)
...
namespace ceph::crypto::onwire {
    ...
    struct TxHandler {
        ...
        void reset_tx_handler(std::initializer_list < uint32_t >
                              update_size_sequence) {
        ...
        virtual void authenticated_encrypt_update(const ceph::
                                                  bufferlist & plaintext) = 0;
    ...
    class RxHandler {
      public:
        ...
        virtual void authenticated_decrypt_update_final(ceph::bufferlist & bl) =
            0;
    };
    ...
    struct rxtx_t {
        ...
        static rxtx_t create_handler_pair(CephContext * ctx,
                                          const class AuthConnectionMeta &
                                          auth_meta, bool new_nonce_format,
                                          bool crossed);
    };
