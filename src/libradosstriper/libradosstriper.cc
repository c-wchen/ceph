...
void libradosstriper::MultiAioCompletion::MultiAioCompletion::
...
void libradosstriper::RadosStriper::to_rados_striper_t(RadosStriper &striper,
        rados_striper_t *s)
{
...
libradosstriper::RadosStriper &libradosstriper::RadosStriper::
operator=(const RadosStriper &rs)
{
    if (rados_striper_impl) {
...
int libradosstriper::RadosStriper::getxattr(const std::string &oid,
        const char *name, bufferlist &bl)
{
    return rados_striper_impl->getxattr(oid, name, bl);
}

int libradosstriper::RadosStriper::setxattr(const std::string &oid,
        const char *name, bufferlist &bl)
{
    return rados_striper_impl->setxattr(oid, name, bl);
}

int libradosstriper::RadosStriper::rmxattr(const std::string &oid,
        const char *name)
{
...
int libradosstriper::RadosStriper::stat(const std::string &soid,
...
int libradosstriper::RadosStriper::stat2(const std::string &soid,
...
int libradosstriper::RadosStriper::trunc(const std::string &soid,
        uint64_t size)
{
...
libradosstriper::MultiAioCompletion *libradosstriper::RadosStriper::multi_aio_create_completion(void *cb_arg,
        librados::
        callback_t
        cb_complete,
        librados::
        ...
        cb_safe)
{
    ...
    int r =
        rados_striper_multi_aio_create_completion(cb_arg, cb_complete, cb_safe,
            (void **)&c);
    ceph_assert(r == 0);
    return new MultiAioCompletion(c);
}
...
extern "C" int rados_striper_set_object_layout_stripe_unit(rados_striper_t
        striper,
        unsigned int
        stripe_unit)
{
...
extern "C" int rados_striper_set_object_layout_stripe_count(rados_striper_t
        striper,
        unsigned int
        stripe_count)
{
...
extern "C" int rados_striper_set_object_layout_object_size(rados_striper_t
        striper,
        unsigned int
        object_size)
{
...
extern "C" int rados_striper_trunc(rados_striper_t striper, const char *soid,
                                   uint64_t size)
{
    libradosstriper::RadosStriperImpl *impl =
        (libradosstriper::RadosStriperImpl *) striper;
...
extern "C" int rados_striper_multi_aio_is_safe(rados_striper_multi_completion_t
        c)
{
...
{
    return ((libradosstriper::MultiAioCompletionImpl *) c)->
           is_complete_and_cb();
}
...
extern "C" void rados_striper_multi_aio_release(rados_striper_multi_completion_t
        c)
{
                                       ...
                                       size_t len, uint64_t off)
{
    ...
    bufferlist bl;
    bl.append(buf, len);
    return impl->aio_write(soid, (librados::AioCompletionImpl *) completion, bl,
                           len, off);
}
                                        ...
                                        const char *buf, size_t len)
{
    ...
    bufferlist bl;
    bl.append(buf, len);
    return impl->aio_append(soid, (librados::AioCompletionImpl *) completion,
                            bl, len);
}
        ...
        const char *buf, size_t len)
{
    ...
    bufferlist bl;
    bl.append(buf, len);
    return impl->aio_write_full(soid,
                                      ...
                                      char *buf, size_t len, uint64_t off)
{
    libradosstriper::RadosStriperImpl *impl =
        (libradosstriper::RadosStriperImpl *) striper;
    return impl->aio_read(soid, (librados::AioCompletionImpl *) completion, buf,
                          len, off);
}
                                      ...
                                      uint64_t *psize, time_t *pmtime)
{
    libradosstriper::RadosStriperImpl *impl =
        (libradosstriper::RadosStriperImpl *) striper;
    return impl->aio_stat(soid, (librados::AioCompletionImpl *) completion,
                          psize, pmtime);
}
                                       ...
                                       struct timespec *pmtime)
{
    libradosstriper::RadosStriperImpl *impl =
        (libradosstriper::RadosStriperImpl *) striper;
    return impl->aio_stat2(soid, (librados::AioCompletionImpl *) completion,
                           psize, pmtime);
}
