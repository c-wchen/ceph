...
public:
    ...
    template < typename... Args > ScrubRequested(bool deep, Args&&... base_args)
...
public:
    ...
    template < typename... Args > ScrubMessage(MessageRef m, Args&&... base_args)
...
public:
    ...
    template < typename... Args > ScrubFindRange(const hobject_t &begin, Args&&... args)
...
public:
    ...
    template < typename... Args > ScrubReserveRange(const hobject_t &begin, const hobject_t &end, Args&&... args)
