...
TEST(OSDCap, AllowAll)
{
    ...
    ASSERT_TRUE(cap.is_capable("foo", "", 0, "asdf", true, true, { {
                               "cls", true, true, true}}));
    ASSERT_TRUE(cap.is_capable("foo", "anamespace", 0, "asdf", true, true, { {
                               "cls", true, true, true}}));
    ASSERT_TRUE(cap.is_capable("bar", "", 0, "asdf", true, true, { {
                               "cls", true, true, true}}));
    ASSERT_TRUE(cap.is_capable("bar", "anamespace", 0, "asdf", true, true, { {
                               "cls", true, true, true}}));
...
TEST(OSDCap, AllowPool)
{
    ...
    ASSERT_TRUE(cap.is_capable("foo", "", 0, "", true, true, { {
                               "cls", true, true, true}}));
    ASSERT_TRUE(cap.is_capable("foo", "ns", 0, "", true, true, { {
                               "cls", true, true, true}}));
    // true->false for classes not on whitelist
    ASSERT_FALSE(cap.is_capable("foo", "", 0, "", true, true, { {
                                "cls", true, true, false}}));
    ASSERT_FALSE(cap.is_capable("foo", "ns", 0, "", true, true, { {
                                "cls", true, true, false}}));

    ASSERT_FALSE(cap.is_capable("bar", "", 0, "", true, true, { {
                                "cls", true, true, true}}));
    ASSERT_FALSE(cap.is_capable("bar", "ns", 0, "", true, true, { {
                                "cls", true, true, true}}));
}
...
TEST(OSDCap, ObjectPrefix)
{
    ...
    ASSERT_TRUE(cap.is_capable("bar", "", 0, "foo", true, true, { {
                               "cls", true, true, true}}));
    ASSERT_TRUE(cap.is_capable("bar", "", 0, "food", true, true, { {
                               "cls", true, true, true}}));
    ASSERT_TRUE(cap.is_capable("bar", "", 0, "foo_bar", true, true, { {
                               "cls", true, true, true}}));
    // true-false for classes not on whitelist
    ASSERT_FALSE(cap.is_capable("bar", "", 0, "foo", true, true, { {
                                "cls", true, true, false}}));
    ASSERT_FALSE(cap.is_capable("bar", "", 0, "food", true, true, { {
                                "cls", true, true, false}}));
    ASSERT_FALSE(cap.is_capable("bar", "", 0, "foo_bar", true, true, { {
                                "cls", true, true, false}}));

    ASSERT_FALSE(cap.is_capable("bar", "", 0, "_foo", true, true, { {
                                "cls", true, true, true}}));
    ASSERT_FALSE(cap.is_capable("bar", "", 0, " foo ", true, true, { {
                                "cls", true, true, true}}));
    ASSERT_FALSE(cap.is_capable("bar", "", 0, "fo", true, true, { {
                                "cls", true, true, true}}));
}
...
TEST(OSDCap, ObjectPoolAndPrefix)
{
    ...
    ASSERT_FALSE(cap.is_capable("baz", "", 0, "foo", true, true, { {
                                "cls", true, true, true}}));
    ASSERT_FALSE(cap.is_capable("baz", "", 0, "food", true, true, { {
                                "cls", true, true, true}}));
    ASSERT_FALSE(cap.is_capable("baz", "", 0, "fo", true, true, { {
                                "cls", true, true, true}}));
}
...
TEST(OSDCap, BasicX)
{
    ...
    ASSERT_FALSE(cap.is_capable("bar", "", 0, "foo", false, false, { {
                                "cls", false, true, false}}));
    ASSERT_FALSE(cap.is_capable("bar", "", 0, "foo", false, false, { {
...
TEST(OSDCap, BasicRClassR)
{
    ...
    ASSERT_TRUE(cap.is_capable("bar", "any", 0, "foo", false, false, { {
                               "cls", true, false, true}}));
    ...
    // true->false when class not whitelisted
    ASSERT_FALSE(cap.is_capable("bar", "any", 0, "foo", false, false, { {
                                "cls", true, false, false}}));
    ASSERT_FALSE(cap.is_capable("bar", "any", 0, "foo", true, false, { {
                                "cls", true, false, false}}));
...
TEST(OSDCap, PoolClassR)
{
    OSDCap cap;
    ASSERT_TRUE(cap.
                parse("allow pool bar r class-read, allow pool foo rwx", NULL));
    ...
    ASSERT_TRUE(cap.is_capable("bar", "ns", 0, "foo", false, false, { {
                               "cls", true, false, true}}));
    ...
    // true->false when class not whitelisted
    ASSERT_FALSE(cap.is_capable("bar", "ns", 0, "foo", false, false, { {
                                "cls", true, false, false}}));
    ...
    ASSERT_TRUE(cap.is_capable("foo", "", 0, "foo", false, false, { {
                               "cls", true, true, true}}));
    ASSERT_TRUE(cap.is_capable("foo", "", 0, "foo", true, true, { {
                               "cls", true, true, true}}));
    ASSERT_TRUE(cap.is_capable("foo", "", 0, "foo", false, true, { {
                               "cls", true, true, true}}));
    ...
    ASSERT_TRUE(cap.is_capable("foo", "ns", 0, "foo", false, false, { {
                               "cls", true, true, true}}));
    ASSERT_TRUE(cap.is_capable("foo", "ns", 0, "foo", true, true, { {
                               "cls", true, true, true}}));
    ASSERT_TRUE(cap.is_capable("foo", "ns", 0, "foo", false, true, { {
                               "cls", true, true, true}}));
    ...
    ASSERT_TRUE(cap.is_capable("foo", "ns", 0, "foo", true, true, { {
                               "cls", true, false, true}}));
    // true->false when class not whitelisted
    ASSERT_FALSE(cap.is_capable("foo", "ns", 0, "foo", false, false, { {
                                "cls", true, true, false}}));
    ASSERT_FALSE(cap.is_capable("foo", "ns", 0, "foo", true, true, { {
                                "cls", true, true, false}}));
    ASSERT_FALSE(cap.is_capable("foo", "ns", 0, "foo", false, true, { {
                                "cls", true, true, false}}));
    ASSERT_FALSE(cap.is_capable("foo", "ns", 0, "foo", true, false, { {
                                "cls", false, true, false}}));
    ASSERT_FALSE(cap.is_capable("foo", "ns", 0, "foo", true, true, { {
                                "cls", false, true, false}}));
    ASSERT_FALSE(cap.is_capable("foo", "ns", 0, "foo", true, true, { {
    ...
    ASSERT_FALSE(cap.is_capable("baz", "", 0, "foo", true, true, { {
                                "cls", true, true, true}}));
    ASSERT_FALSE(cap.is_capable("baz", "", 0, "foo", false, true, { {
                                "cls", true, true, true}}));
...
TEST(OSDCap, PoolClassRNS)
{
    ...
    ASSERT_TRUE(cap.
                parse
                ("allow pool bar namespace='' r class-read, allow pool foo namespace=ns rwx",
                 NULL));
...
TEST(OSDCap, NSClassR)
{
    ...
    ASSERT_FALSE(cap.is_capable("bar", "test", 0, "foo", false, true, { {
                                "cls", false, true, true}}));
    ASSERT_FALSE(cap.is_capable("bar", "test", 0, "foo", true, false, { {
                                "cls", true, false, true}}));
    ...
    ASSERT_FALSE(cap.is_capable("foo", "test", 0, "foo", false, true, { {
                                "cls", false, true, true}}));
    ASSERT_FALSE(cap.is_capable("foo", "test", 0, "foo", true, false, { {
                                "cls", true, false, true}}));
    ...
    ASSERT_FALSE(cap.is_capable("foo", "bad", 0, "foo", false, false, { {
                                "cls", true, false, true}}));
    ASSERT_FALSE(cap.is_capable("foo", "bad", 0, "foo", false, false, { {
                                "cls", false, true, true}}));
}
...
TEST(OSDCap, AllowClassMulti)
{
    ...
    ASSERT_TRUE(cap2.is_capable("bar", "", 0, "foo", false, false, { {
                                "foo", true, true, true}
                                , {
                                "bar", true, true, true}
                                }
...
TEST(OSDCap, AllowProfile)
{
    OSDCap cap;
    ASSERT_TRUE(cap.
                parse("profile read-only, profile read-write pool abc", NULL));
    ASSERT_FALSE(cap.allow_all());
