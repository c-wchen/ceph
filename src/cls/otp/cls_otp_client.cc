...
namespace rados {
    namespace cls {
        namespace otp {
            ...
            } int OTP::check(CephContext * cct, librados::IoCtx & ioctx,
                             const string & oid, const string & id,
                             const string & val, otp_check_t * result) {
...
#define TOKEN_LEN 16
            ...
            int OTP::get(librados::ObjectReadOperation * rop,
                         ...
                         const list < string > *ids, bool get_all,
            ...
            int OTP::get_all(librados::ObjectReadOperation * op,
                             librados::IoCtx & ioctx, const string & oid,
                             list < otp_info_t > *result) {
                return get(op, ioctx, oid, nullptr, true, result);
            }

            int OTP::get_current_time(librados::IoCtx & ioctx,
                                      const string & oid,
