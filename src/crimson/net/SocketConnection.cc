...
SocketConnection::SocketConnection(SocketMessenger &messenger,
    ...
    : core(messenger.shard_id()), messenger(messenger)
{
...
void SocketConnection::start_accept(SocketRef && sock,
...
{
    assert(seastar::this_shard_id() == shard_id());
    return make_local_shared_foreign(seastar::
                                     make_foreign(shared_from_this()));
}
