    ...
    namespace action {
        namespace create {
            ...
            struct thick_provision_writer {
                ...
                // Constructor
                explicit thick_provision_writer(librbd::Image * i,
                                                librbd::ImageOptions & o)
                :image(i) {
                    ...
                    if (order == 0) {
                        order =
                            g_conf().get_val < uint64_t > ("rbd_default_order");
                    } auto stripe_count =
                        std::max < uint64_t > (1U, image->get_stripe_count());
                    ...
                    c = new librbd::RBD::AioCompletion(this,
                                                       thick_provision_writer_completion);
                    int r;
            ...
            void thick_provision_writer_completion(rbd_completion_t rc,
                                                   void *pc) {
                librbd::RBD::AioCompletion * ac =
                    (librbd::RBD::AioCompletion *) rc;
                thick_provision_writer *tc =
                    static_cast < thick_provision_writer * >(pc);
            ...
            int thick_write(const std::string & image_name,
            ...
            int execute(const po::variables_map & vm,
                ...
                if (vm.count(at::IMAGE_THICK_PROVISION)
                    ...
                    r = thick_write(image_name, io_ctx, opts,
