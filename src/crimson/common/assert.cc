                                       ...
                                       const char *func)
{
    ...
    logger.error("{}:{} : In function '{}', ceph_assert(%s)\n"
                 "{}",
                 file, line, func, assertion, seastar::current_backtrace());
    std::cout << std::flush;
    abort();
}
                                ...
                                const char *func, const std::string &msg)
{
    ...
    logger.error("{}:{} : In function '{}', abort(%s)\n"
                 "{}", file, line, func, msg, seastar::current_backtrace());
    std::cout << std::flush;
    abort();
}
                                 ...
                                 const char *func, const char *fmt, ...)
{
    ...
    logger.error("{}:{} : In function '{}', abort()\n"
                 "{}\n{}\n",
                 file, line, func, buf, seastar::current_backtrace());
    std::cout << std::flush;
    abort();
}
}
