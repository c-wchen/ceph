          ...
          private:
            ...
            struct C_Dispatcher:public Context {
                ...
                Context *on_finish;
                 ...
                 C_Dispatcher(ObjectDispatchSpec * object_dispatch_spec,
                              Context * on_finish)
          ...
          public:
            ...
            struct ReadRequest:public RequestBase {
                ...
                uint64_t *version;
                 ...
                 ReadRequest(uint64_t object_no, ReadExtents * extents,
                             int read_flags, uint64_t * version)
                :RequestBase(object_no), extents(extents),
                    read_flags(read_flags), version(version) {
            }};
            ...
            struct DiscardRequest:public WriteRequestBase {
                ...
                int discard_flags;
                 ...
                 DiscardRequest(uint64_t object_no, uint64_t object_off,
                                uint64_t object_len, int discard_flags,
                                uint64_t journal_tid)
            ...
            typedef boost::variant < ReadRequest,
                ...
                FlushRequest, ListSnapsRequest > Request;
            ...
            template < typename ImageCtxT >
                static ObjectDispatchSpec *create_read(ImageCtxT * image_ctx,
                                                       ObjectDispatchLayer
            ...
            template < typename ImageCtxT >
                static ObjectDispatchSpec *create_discard(ImageCtxT * image_ctx,
                                                          ObjectDispatchLayer
                                                          object_dispatch_layer,
                                                          uint64_t object_no,
                                                          uint64_t object_off,
                ...
                return new ObjectDispatchSpec(image_ctx->io_object_dispatcher,
                                              ...
                                              discard_flags, journal_tid}
                                              , io_context, 0, parent_trace,
                                              on_finish);
            }

            template < typename ImageCtxT >
                static ObjectDispatchSpec *create_write(ImageCtxT * image_ctx,
                                                        ObjectDispatchLayer
                                                        object_dispatch_layer,
                                                        uint64_t object_no,
                                                        uint64_t object_off,
            ...
            template < typename ImageCtxT >
                static ObjectDispatchSpec *create_write_same(ImageCtxT *
                                                             image_ctx,
                                                             ObjectDispatchLayer
                                                             object_dispatch_layer,
                                                             uint64_t object_no,
            ...
            template < typename ImageCtxT >
                static ObjectDispatchSpec *create_compare_and_write(ImageCtxT *
                                                                    image_ctx,
                                                                    ObjectDispatchLayer
                                                                    object_dispatch_layer,
                                                                    uint64_t
            ...
            template < typename ImageCtxT >
                static ObjectDispatchSpec *create_flush(ImageCtxT * image_ctx,
                                                        ObjectDispatchLayer
                                                        object_dispatch_layer,
                                                        FlushSource
                                                        flush_source,
            ...
            template < typename ImageCtxT >
                static ObjectDispatchSpec *create_list_snaps(ImageCtxT *
                                                             image_ctx,
                                                             ObjectDispatchLayer
                                                             object_dispatch_layer,
                                                             uint64_t object_no,
