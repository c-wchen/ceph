    ...
    namespace mirror {
            ...
            class PoolReplayerAdminSocketHook:public AdminSocketHook {
              ...
              private:
                typedef std::map < std::string,
                    PoolReplayerAdminSocketCommand * >Commands;
        ...
        PoolReplayer::PoolReplayer(Threads < librbd::ImageCtx > *threads,
                                   ...
                                   *service_daemon,
                                   ...
                                   const std::vector <
                                   const char *>&args):m_threads(threads),
            m_service_daemon(service_daemon), m_image_deleter(image_deleter),
            m_local_pool_id(local_pool_id), m_peer(peer), m_args(args),
        ...
        bool PoolReplayer::is_blacklisted() const {
            ...
            m_instance_replayer.
                reset(InstanceReplayer <>::
                      create(m_threads, m_service_daemon, m_image_deleter,
                             m_local_rados, local_mirror_uuid,
                             m_local_pool_id));
            ...
            m_instance_watcher.
                reset(InstanceWatcher <>::
                      create(m_local_io_ctx, m_threads->work_queue,
            ...
            m_leader_watcher.
                reset(new LeaderWatcher <>
                      (m_threads, m_local_io_ctx, &m_leader_listener));
        ...
        void PoolReplayer::print_status(Formatter * f, stringstream * ss) {
            ...
            f->dump_string("local_cluster_admin_socket",
                           reinterpret_cast <
                           CephContext *
                           >(m_local_io_ctx.cct())->_conf->get_val <
                           std::string > ("admin_socket"));
            f->dump_string("remote_cluster_admin_socket",
                           reinterpret_cast <
                           CephContext *
                           >(m_remote_io_ctx.cct())->_conf->get_val <
                           std::string > ("admin_socket"));
        ...
        void PoolReplayer::handle_init_local_pool_watcher(int r,
                                                          Context * on_finish) {
            dout(20) << "r=" << r << dendl;
            if (r < 0) {
        ...
        void PoolReplayer::handle_shut_down_pool_watchers(int r,
                                                          Context * on_finish) {
            dout(20) << "r=" << r << dendl;
        ...
        void PoolReplayer::handle_wait_for_update_ops(int r,
                                                      Context * on_finish) {
            dout(20) << "r=" << r << dendl;
        ...
        void PoolReplayer::handle_update_leader(const std::
