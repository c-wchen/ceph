...
public:
    ...
    MClientSession(int o, version_t s = 0) : Message(CEPH_MSG_CLIENT_SESSION, HEAD_VERSION, COMPAT_VERSION)
    {
        memset(&head, 0, sizeof(head));
        head.op = o;
        head.seq = s;
    }
    MClientSession(int o, utime_t st) : Message(CEPH_MSG_CLIENT_SESSION,
