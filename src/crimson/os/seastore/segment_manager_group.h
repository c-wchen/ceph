...
public:
    ...
    scan_valid_records_ret scan_valid_records(scan_valid_records_cursor
            &cursor,    ///< [in, out] cursor, updated during call
...
private:
    ...
    read_validate_data_ret read_validate_data(paddr_t record_base,
