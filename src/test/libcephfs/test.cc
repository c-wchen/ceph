...
TEST(LibCephFS, SnapdirAttrsOnSnapCreate)
{
    ...
    ASSERT_EQ(ceph_statx(cmount, snap_dir_path, &stx_snap_dir, CEPH_STATX_MTIME | CEPH_STATX_CTIME | CEPH_STATX_VERSION, 0),
              0);
    ASSERT_EQ(ceph_statx(cmount, "/.snap", &stx_root_snap_dir, CEPH_STATX_MTIME | CEPH_STATX_CTIME | CEPH_STATX_VERSION, 0),
              0);
    ASSERT_EQ(utime_t(stx_root_snap_dir.stx_mtime), utime_t(stx_snap_dir.stx_mtime));
    ASSERT_EQ(utime_t(stx_root_snap_dir.stx_ctime), utime_t(stx_snap_dir.stx_ctime));
    ASSERT_EQ(stx_root_snap_dir.stx_version, stx_snap_dir.stx_version);
    ...
    ASSERT_EQ(ceph_statx(cmount, snap_dir_path, &stx_snap_dir_1, CEPH_STATX_MTIME | CEPH_STATX_CTIME | CEPH_STATX_VERSION,
                         0), 0);
...
TEST(LibCephFS, SnapdirAttrsOnSnapDelete)
{
    ...
    ASSERT_EQ(ceph_statx(cmount, snap_dir_path, &stx_snap_dir_2, CEPH_STATX_MTIME | CEPH_STATX_CTIME | CEPH_STATX_VERSION,
                         0), 0);
