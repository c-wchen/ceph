...
static TracepointProvider::Traits tracepoint_traits("librados_tp.so",
                                                    "rados_tracing");
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_create) (rados_t * pcluster,
                                                       const char *const id) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_create2) (rados_t * pcluster,
                                                        const char *const
                                                        clustername,
 ...
 * their cluster.
 */
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_create_with_context) (rados_t *
                                                                    pcluster,
                                                                    rados_config_t
                                                                    cct_) {
...
extern "C" uint64_t LIBRADOS_C_API_DEFAULT_F(rados_get_instance_id) (rados_t
                                                                     cluster) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_get_min_compatible_osd) (rados_t
                                                                       cluster,
                                                                       int8_t *
                                                                       require_osd_release)
{
...
extern "C" int
LIBRADOS_C_API_DEFAULT_F(rados_get_min_compatible_client) (rados_t cluster,
                                                           int8_t *
                                                           min_compat_client,
                                                           int8_t *
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_version) (int *major, int *minor,
                                                         int *extra) {
    ...
    tracepoint(librados, rados_version_exit, LIBRADOS_VER_MAJOR,
...
// -- config --
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_conf_read_file) (rados_t cluster,
                                                               const char
                                                               *path_list) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_conf_parse_argv) (rados_t cluster,
                                                                int argc,
                                                                const char
                                                                **argv) {
...
extern "C" int
LIBRADOS_C_API_DEFAULT_F(rados_conf_parse_argv_remainder) (rados_t cluster,
                                                           int argc,
                                                           const char **argv,
                                                           const char **remargv)
{
    ...
    for (i = 0; i < (unsigned int)argc; ++i) {
        ...
        tracepoint(librados, rados_conf_parse_argv_remainder_remarg,
                   remargv[i]);
    }
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_conf_parse_env) (rados_t cluster,
                                                               const char *env)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_conf_set) (rados_t cluster,
                                                         const char *option,
                                                         const char *value) {
...
/* cluster info */
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_cluster_stat) (rados_t cluster,
    ...
    tracepoint(librados, rados_cluster_stat_exit, r, result->kb,
               result->kb_used, result->kb_avail, result->num_objects);
    return r;
}

LIBRADOS_C_API_BASE_DEFAULT(rados_cluster_stat);

extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_conf_get) (rados_t cluster,
                                                         const char *option,
                                                         char *buf, size_t len)
{
...
extern "C" int64_t LIBRADOS_C_API_DEFAULT_F(rados_pool_lookup) (rados_t cluster,
                                                                const char
                                                                *name) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_pool_reverse_lookup) (rados_t
                                                                    cluster,
                                                                    int64_t id,
                                                                    char *buf,
                                                                    size_t
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_cluster_fsid) (rados_t cluster,
                                                             char *buf,
                                                             size_t maxlen) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_wait_for_latest_osdmap) (rados_t
                                                                       cluster)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_blocklist_add) (rados_t cluster,
                                                              char
                                                              *client_address,
                                                              uint32_t
                                                              expire_seconds) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_blacklist_add) (rados_t cluster,
                                                              char
                                                              *client_address,
                                                              uint32_t
                                                              expire_seconds) {
    return LIBRADOS_C_API_DEFAULT_F(rados_blocklist_add) (cluster,
                                                          client_address,
                                                          expire_seconds);
}
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_getaddrs) (rados_t cluster,
                                                         char **addrs) {
    librados::RadosClient * radosp = (librados::RadosClient *) cluster;
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_set_pool_full_try) (rados_ioctx_t
                                                                   io) {
    librados::IoCtxImpl * ctx = (librados::IoCtxImpl *) io;
    ctx->extra_op_flags |= CEPH_OSD_FLAG_FULL_TRY;
}
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_application_enable) (rados_ioctx_t
                                                                   io,
                                                                   const char
                                                                   *app_name,
                                                                   int force) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_application_list) (rados_ioctx_t
                                                                 io,
                                                                 char *values,
                                                                 size_t *
                                                                 values_len) {
...
extern "C" int
LIBRADOS_C_API_DEFAULT_F(rados_application_metadata_get) (rados_ioctx_t io,
                                                          const char *app_name,
                                                          const char *key,
                                                          char *value,
                                                          size_t * value_len) {
...
extern "C" int
LIBRADOS_C_API_DEFAULT_F(rados_application_metadata_set) (rados_ioctx_t io,
                                                          const char *app_name,
                                                          const char *key,
                                                          const char *value) {
    librados::IoCtxImpl * ctx = (librados::IoCtxImpl *) io;
...
extern "C" int
LIBRADOS_C_API_DEFAULT_F(rados_application_metadata_remove) (rados_ioctx_t io,
                                                             const char
                                                             *app_name,
                                                             const char *key) {
    librados::IoCtxImpl * ctx = (librados::IoCtxImpl *) io;
...
extern "C" int
LIBRADOS_C_API_DEFAULT_F(rados_application_metadata_list) (rados_ioctx_t io,
                                                           const char *app_name,
                                                           char *keys,
                                                           size_t * keys_len,
                                                           char *values,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_pool_list) (rados_t cluster,
                                                          char *buf,
                                                          size_t len) {
    ...
    int needed = 0;
    std::list < std::pair < int64_t, std::string > >::const_iterator i =
        pools.begin();
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_inconsistent_pg_list) (rados_t
                                                                     cluster,
                                                                     int64_t
                                                                     pool_id,
                                                                     char *buf,
                                                                     size_t len)
{
    tracepoint(librados, rados_inconsistent_pg_list_enter, cluster, pool_id,
               len);
    librados::RadosClient * client = (librados::RadosClient *) cluster;
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_service_register) (rados_t
                                                                 cluster,
                                                                 const char
                                                                 *service,
                                                                 const char
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_service_update_status) (rados_t
                                                                      cluster,
                                                                      const char
                                                                      *status_dict)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_ping_monitor) (rados_t cluster,
                                                             const char *mon_id,
                                                             char **outstr,
                                                             size_t * outstrlen)
{
    ...
    tracepoint(librados, rados_ping_monitor_exit, ret, ret < 0 ? NULL : outstr,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_mon_command) (rados_t cluster,
                                                            const char **cmd,
                                                            size_t cmdlen,
                                                            const char *inbuf,
                                                            size_t inbuflen,
                                                            ...
                                                            char **outs,
                                                            size_t * outslen) {
    tracepoint(librados, rados_mon_command_enter, cluster, cmdlen, inbuf,
               inbuflen);
    librados::RadosClient * client = (librados::RadosClient *) cluster;
    bufferlist inbl;
    bufferlist outbl;
    ...
    tracepoint(librados, rados_mon_command_exit, ret, outbuf, outbuflen, outs,
               outslen);
    return ret;
}
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_mon_command_target) (rados_t
                                                                   cluster,
                                                                   const char
                                                                   *name,
                                                                   const char
                                                                   ...
                                                                   **outbuf,
                                                                   ...
                                                                   size_t *
                                                                   outslen) {
    tracepoint(librados, rados_mon_command_target_enter, cluster, name, cmdlen,
               inbuf, inbuflen);
    librados::RadosClient * client = (librados::RadosClient *) cluster;
    bufferlist inbl;
    bufferlist outbl;
    ...
    if ((errno == ERANGE && (rank == LONG_MAX || rank == LONG_MIN)) || (errno != 0 && rank == 0) || endptr == name ||   // no digits
    ...
    do_out_buffer(outbl, outbuf, outbuflen);
    do_out_buffer(outstring, outs, outslen);
    tracepoint(librados, rados_mon_command_target_exit, ret, outbuf, outbuflen,
               outs, outslen);
    return ret;
}
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_osd_command) (rados_t cluster,
                                                            int osdid,
                                                            const char **cmd,
                                                            size_t cmdlen,
                                                            const char *inbuf,
                                                            ...
                                                            char **outs,
                                                            size_t * outslen) {
    tracepoint(librados, rados_osd_command_enter, cluster, osdid, cmdlen, inbuf,
               inbuflen);
    librados::RadosClient * client = (librados::RadosClient *) cluster;
    bufferlist inbl;
    bufferlist outbl;
    ...
    do_out_buffer(outbl, outbuf, outbuflen);
    do_out_buffer(outstring, outs, outslen);
    tracepoint(librados, rados_osd_command_exit, ret, outbuf, outbuflen, outs,
               outslen);
    return ret;
}
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_mgr_command) (rados_t cluster,
                                                            const char **cmd,
                                                            size_t cmdlen,
                                                            const char *inbuf,
                                                            size_t inbuflen,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_mgr_command_target) (rados_t
                                                                   cluster,
                                                                   const char
                                                                   *name,
                                                                   const char
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_pg_command) (rados_t cluster,
                                                           const char *pgstr,
                                                           const char **cmd,
                                                           size_t cmdlen,
                                                           const char *inbuf,
                                                           ...
                                                           char **outs,
                                                           size_t * outslen) {
    tracepoint(librados, rados_pg_command_enter, cluster, pgstr, cmdlen, inbuf,
               inbuflen);
    librados::RadosClient * client = (librados::RadosClient *) cluster;
    bufferlist inbl;
    bufferlist outbl;
    ...
    do_out_buffer(outbl, outbuf, outbuflen);
    do_out_buffer(outstring, outs, outslen);
    tracepoint(librados, rados_pg_command_exit, ret, outbuf, outbuflen, outs,
               outslen);
    return ret;
}
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_monitor_log) (rados_t cluster,
                                                            const char *level,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_monitor_log2) (rados_t cluster,
                                                             const char *level,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_ioctx_create) (rados_t cluster,
                                                             const char *name,
                                                             rados_ioctx_t * io)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_ioctx_create2) (rados_t cluster,
                                                              int64_t pool_id,
                                                              rados_ioctx_t *
                                                              io) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_ioctx_pool_stat) (rados_ioctx_t
                                                                io,
                                                                struct
                                                                rados_pool_stat_t
                                                                * stats) {
    ...
    stats->num_objects_degraded = r.stats.sum.num_objects_degraded + r.stats.sum.num_objects_misplaced; // FIXME: this is imprecise
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_ioctx_snap_set_read) (rados_ioctx_t io,
                                                     rados_snap_t seq) {
...
(rados_ioctx_t io, rados_snap_t seq, rados_snap_t * snaps, int num_snaps) {
    tracepoint(librados, rados_ioctx_selfmanaged_snap_set_write_ctx_enter, io,
               seq, snaps, num_snaps);
    librados::IoCtxImpl * ctx = (librados::IoCtxImpl *) io;
    vector < snapid_t > snv;
    ...
    tracepoint(librados, rados_ioctx_selfmanaged_snap_set_write_ctx_exit,
               retval);
    return retval;
}
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_write) (rados_ioctx_t io,
                                                      const char *o,
                                                      const char *buf,
                                                      size_t len,
                                                      uint64_t off) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_append) (rados_ioctx_t io,
                                                       const char *o,
                                                       const char *buf,
                                                       size_t len) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_write_full) (rados_ioctx_t io,
                                                           const char *o,
                                                           const char *buf,
                                                           size_t len) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_writesame) (rados_ioctx_t io,
                                                          const char *o,
                                                          const char *buf,
                                                          size_t data_len,
                                                          size_t write_len,
                                                          uint64_t off) {
    tracepoint(librados, rados_writesame_enter, io, o, buf, data_len, write_len,
               off);
    librados::IoCtxImpl * ctx = (librados::IoCtxImpl *) io;
    object_t oid(o);
    bufferlist bl;
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_trunc) (rados_ioctx_t io,
                                                      const char *o,
                                                      uint64_t size) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_remove) (rados_ioctx_t io,
                                                       const char *o) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_read) (rados_ioctx_t io,
                                                     const char *o,
                                                     char *buf,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_checksum) (rados_ioctx_t io,
                                                         const char *o,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_pool_create) (rados_t cluster,
                                                            const char *name) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_pool_create_with_auid) (rados_t
                                                                      cluster,
                                                                      const char
                                                                      *name,
                                                                      uint64_t
                                                                      auid) {
    tracepoint(librados, rados_pool_create_with_auid_enter, cluster, name,
               auid);
    librados::RadosClient * radosp = (librados::RadosClient *) cluster;
    string sname(name);
    int retval = 0;
...
extern "C" int
LIBRADOS_C_API_DEFAULT_F(rados_pool_create_with_crush_rule) (rados_t cluster,
                                                             const char *name,
                                                             __u8
                                                             crush_rule_num) {
    tracepoint(librados, rados_pool_create_with_crush_rule_enter, cluster, name,
               crush_rule_num);
    librados::RadosClient * radosp = (librados::RadosClient *) cluster;
    string sname(name);
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_pool_create_with_all) (rados_t
                                                                     cluster,
                                                                     const char
                                                                     *name,
                                                                     uint64_t
                                                                     ...
                                                                     crush_rule_num)
{
    tracepoint(librados, rados_pool_create_with_all_enter, cluster, name, auid,
               crush_rule_num);
    librados::RadosClient * radosp = (librados::RadosClient *) cluster;
    string sname(name);
    int retval = 0;
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_pool_get_base_tier) (rados_t
                                                                   cluster,
                                                                   int64_t
                                                                   pool_id,
                                                                   int64_t *
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_pool_delete) (rados_t cluster,
                                                            const char
                                                            *pool_name) {
...
extern "C" int
LIBRADOS_C_API_DEFAULT_F(rados_ioctx_pool_set_auid) (rados_ioctx_t io,
                                                     uint64_t auid) {
...
extern "C" int
LIBRADOS_C_API_DEFAULT_F(rados_ioctx_pool_get_auid) (rados_ioctx_t io,
                                                     uint64_t * auid) {
...
extern "C" int
LIBRADOS_C_API_DEFAULT_F(rados_ioctx_pool_requires_alignment2) (rados_ioctx_t
                                                                io, int *req) {
...
extern "C" int
LIBRADOS_C_API_DEFAULT_F(rados_ioctx_pool_required_alignment2) (rados_ioctx_t
                                                                io,
                                                                uint64_t *
                                                                alignment) {
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_ioctx_locator_set_key) (rados_ioctx_t io,
                                                       const char *key) {
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_ioctx_set_namespace) (rados_ioctx_t io,
                                                     const char *nspace) {
...
extern "C" int
LIBRADOS_C_API_DEFAULT_F(rados_ioctx_get_namespace) (rados_ioctx_t io, char *s,
                                                     unsigned maxlen) {
...
extern "C" int64_t LIBRADOS_C_API_DEFAULT_F(rados_ioctx_get_id) (rados_ioctx_t
                                                                 io) {
...
extern "C" int
LIBRADOS_C_API_DEFAULT_F(rados_ioctx_get_pool_name) (rados_ioctx_t io, char *s,
                                                     unsigned maxlen) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_ioctx_snap_create) (rados_ioctx_t
                                                                  io,
                                                                  const char
                                                                  *snapname) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_ioctx_snap_remove) (rados_ioctx_t
                                                                  io,
                                                                  const char
                                                                  *snapname) {
...
extern "C" int
LIBRADOS_C_API_DEFAULT_F(rados_ioctx_snap_rollback) (rados_ioctx_t io,
                                                     const char *oid,
                                                     const char *snapname) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_rollback) (rados_ioctx_t io,
                                                         const char *oid,
                                                         const char *snapname) {
    return LIBRADOS_C_API_DEFAULT_F(rados_ioctx_snap_rollback) (io, oid,
                                                                snapname);
}
...
extern "C" int
LIBRADOS_C_API_DEFAULT_F(rados_ioctx_selfmanaged_snap_create) (rados_ioctx_t io,
                                                               uint64_t *
                                                               snapid) {
    tracepoint(librados, rados_ioctx_selfmanaged_snap_create_enter, io);
    librados::IoCtxImpl * ctx = (librados::IoCtxImpl *) io;
    int retval = ctx->selfmanaged_snap_create(snapid);
    tracepoint(librados, rados_ioctx_selfmanaged_snap_create_exit, retval,
               *snapid);
    return retval;
}
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_aio_ioctx_selfmanaged_snap_create) (rados_ioctx_t
                                                                   io,
                                                                   rados_snap_t
                                                                   * snapid,
                                                                   rados_completion_t
...
extern "C" int
LIBRADOS_C_API_DEFAULT_F(rados_ioctx_selfmanaged_snap_remove) (rados_ioctx_t io,
                                                               uint64_t snapid)
{
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_aio_ioctx_selfmanaged_snap_remove) (rados_ioctx_t
                                                                   io,
                                                                   rados_snap_t
                                                                   snapid,
                                                                   rados_completion_t
...
extern "C" int
LIBRADOS_C_API_DEFAULT_F(rados_ioctx_selfmanaged_snap_rollback) (rados_ioctx_t
                                                                 io,
                                                                 const char
                                                                 *oid,
                                                                 uint64_t
                                                                 snapid) {
    tracepoint(librados, rados_ioctx_selfmanaged_snap_rollback_enter, io, oid,
               snapid);
    librados::IoCtxImpl * ctx = (librados::IoCtxImpl *) io;
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_ioctx_snap_list) (rados_ioctx_t
                                                                io,
                                                                rados_snap_t *
                                                                snaps,
                                                                int maxlen) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_ioctx_snap_lookup) (rados_ioctx_t
                                                                  io,
                                                                  const char
                                                                  *name,
                                                                  rados_snap_t *
...
extern "C" int
LIBRADOS_C_API_DEFAULT_F(rados_ioctx_snap_get_name) (rados_ioctx_t io,
                                                     rados_snap_t id,
...
extern "C" int
LIBRADOS_C_API_DEFAULT_F(rados_ioctx_snap_get_stamp) (rados_ioctx_t io,
                                                      rados_snap_t id,
                                                      time_t * t) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_cmpext) (rados_ioctx_t io,
                                                       const char *o,
                                                       const char *cmp_buf,
                                                       size_t cmp_len,
                                                       uint64_t off) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_getxattr) (rados_ioctx_t io,
                                                         const char *o,
                                                         const char *name,
                                                         char *buf,
                                                         size_t len) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_getxattrs) (rados_ioctx_t io,
                                                          const char *oid,
                                                          rados_xattrs_iter_t *
                                                          iter) {
...
extern "C" int
LIBRADOS_C_API_DEFAULT_F(rados_getxattrs_next) (rados_xattrs_iter_t iter,
                                                const char **name,
                                                const char **val,
                                                size_t * len) {
    tracepoint(librados, rados_getxattrs_next_enter, iter);
    librados::RadosXattrsIter * it =
        static_cast < librados::RadosXattrsIter * >(iter);
    if (it->val) {
        free(it->val);
        it->val = NULL;
    }
    ...
    *name = s.c_str();
    ...
    if (!bl_len) {
        ...
        *val = (char *)NULL;
        ...
        if (!it->val) {
            tracepoint(librados, rados_getxattrs_next_exit, -ENOMEM, *name,
                       NULL, 0);
            return -ENOMEM;
        }
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_setxattr) (rados_ioctx_t io,
                                                         const char *o,
                                                         const char *name,
                                                         const char *buf,
                                                         size_t len) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_rmxattr) (rados_ioctx_t io,
                                                        const char *o,
                                                        const char *name) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_stat) (rados_ioctx_t io,
                                                     const char *o,
                                                     uint64_t * psize,
                                                     time_t * pmtime) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_stat2) (rados_ioctx_t io,
                                                      const char *o,
                                                      uint64_t * psize,
...
extern "C" int LIBRADOS_C_API_BASE_F(rados_tmap_update) (rados_ioctx_t io,
                                                         const char *o,
                                                         const char *cmdbuf,
                                                         size_t cmdbuflen) {
    librados::IoCtxImpl * ctx = (librados::IoCtxImpl *) io;
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_tmap_update) (rados_ioctx_t io,
                                                            const char *o,
                                                            const char *cmdbuf,
                                                            size_t cmdbuflen) {
    return -ENOTSUP;
...
extern "C" int LIBRADOS_C_API_BASE_F(rados_tmap_put) (rados_ioctx_t io,
                                                      const char *o,
                                                      const char *buf,
                                                      size_t buflen) {
    bufferlist bl;
    ...
    return LIBRADOS_C_API_DEFAULT_F(rados_write_full) (io, o, out_bl.c_str(),
                                                       out_bl.length());
}

LIBRADOS_C_API_BASE(rados_tmap_put);

extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_tmap_put) (rados_ioctx_t io,
                                                         const char *o,
                                                         const char *buf,
                                                         size_t buflen) {
    return -EOPNOTSUPP;
...
extern "C" int LIBRADOS_C_API_BASE_F(rados_tmap_get) (rados_ioctx_t io,
                                                      const char *o,
                                                      char *buf,
                                                      size_t buflen) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_tmap_get) (rados_ioctx_t io,
                                                         const char *o,
                                                         char *buf,
                                                         size_t buflen) {
    return -EOPNOTSUPP;
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_exec) (rados_ioctx_t io,
                                                     const char *o,
                                                     const char *cls,
                                                     const char *method,
                                                     const char *inbuf,
                                                     ...
                                                     char *buf,
                                                     size_t out_len) {
    tracepoint(librados, rados_exec_enter, io, o, cls, method, inbuf, in_len,
               out_len);
    librados::IoCtxImpl * ctx = (librados::IoCtxImpl *) io;
    object_t oid(o);
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_object_list_is_end) (rados_ioctx_t
                                                                   io,
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_object_list_cursor_free) (rados_ioctx_t io,
                                                         rados_object_list_cursor
                                                         cur) {
    hobject_t *hobj = (hobject_t *) cur;
    delete hobj;
...
extern "C" int
LIBRADOS_C_API_DEFAULT_F(rados_object_list_cursor_cmp) (rados_ioctx_t io,
                                                        rados_object_list_cursor
                                                        lhs_cur,
                                                        rados_object_list_cursor
                                                        rhs_cur) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_object_list) (rados_ioctx_t io,
    ...
    ceph::async::waiter < boost::system::error_code,
        std::vector < librados::ListObjectImpl >, hobject_t > w;
    ctx->objecter->enumerate_objects < librados::ListObjectImpl > (ctx->poolid,
                                                                   ctx->oloc.
                                                                   nspace,
                                                                   *((hobject_t
                                                                      *) start),
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_object_list_free) (const size_t
                                                                  result_size,
                                                                  rados_object_list_item
                                                                  * results) {
    ceph_assert(results);
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_nobjects_list_open) (rados_ioctx_t
                                                                   io,
                                                                   rados_list_ctx_t
                                                                   * listh) {
    librados::IoCtxImpl * ctx = (librados::IoCtxImpl *) io;
...
extern "C" uint32_t
LIBRADOS_C_API_DEFAULT_F(rados_nobjects_list_seek) (rados_list_ctx_t listctx,
                                                    uint32_t pos) {
...
extern "C" uint32_t
LIBRADOS_C_API_DEFAULT_F(rados_nobjects_list_seek_cursor) (rados_list_ctx_t
                                                           listctx,
                                                           rados_object_list_cursor
                                                           cursor) {
    librados::ObjListCtx * lh = (librados::ObjListCtx *) listctx;
...
extern "C" int
LIBRADOS_C_API_DEFAULT_F(rados_nobjects_list_get_cursor) (rados_list_ctx_t
                                                          listctx,
                                                          rados_object_list_cursor
                                                          * cursor) {
    librados::ObjListCtx * lh = (librados::ObjListCtx *) listctx;
...
(rados_list_ctx_t listctx) {
    librados::ObjListCtx * lh = (librados::ObjListCtx *) listctx;
    tracepoint(librados, rados_nobjects_list_get_pg_hash_position_enter,
               listctx);
...
extern "C" int
LIBRADOS_C_API_DEFAULT_F(rados_nobjects_list_next) (rados_list_ctx_t listctx,
                                                    const char **entry,
                                                    const char **key,
                                                    const char **nspace) {
    tracepoint(librados, rados_nobjects_list_next_enter, listctx);
    uint32_t retval =
        rados_nobjects_list_next2(listctx, entry, key, nspace, NULL, NULL,
                                  NULL);
...
extern "C" int
LIBRADOS_C_API_DEFAULT_F(rados_nobjects_list_next2) (rados_list_ctx_t listctx,
                                                     const char **entry,
                                                     const char **key,
                                                     const char **nspace,
                                                     size_t * entry_size,
    ...
    if (h->list.empty()) {
        ...
        if (ret < 0) {
            tracepoint(librados, rados_nobjects_list_next2_exit, ret, NULL,
                       NULL, NULL, NULL, NULL, NULL);
            return ret;
        }
        if (h->list.empty()) {
            tracepoint(librados, rados_nobjects_list_next2_exit, -ENOENT, NULL,
                       NULL, NULL, NULL, NULL, NULL);
            return -ENOENT;
        }
    }
 ...
 */
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_objects_list_open) (rados_ioctx_t
                                                                  io,
                                                                  rados_list_ctx_t
                                                                  * ctx) {
    return -ENOTSUP;
...
extern "C" uint32_t
LIBRADOS_C_API_DEFAULT_F(rados_objects_list_seek) (rados_list_ctx_t ctx,
                                                   uint32_t pos) {
    return 0;
}
...
extern "C" int
LIBRADOS_C_API_DEFAULT_F(rados_objects_list_next) (rados_list_ctx_t ctx,
                                                   const char **entry,
                                                   const char **key) {
    return -ENOTSUP;
}
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_create_completion) (void
                                                                      *cb_arg,
                                                                      rados_callback_t
                                                                      cb_complete,
                                                                      rados_callback_t
                                                                      ...
                                                                      rados_completion_t
                                                                      * pc) {
    tracepoint(librados, rados_aio_create_completion_enter, cb_arg, cb_complete,
               cb_safe);
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_create_completion2) (void
                                                                       *cb_arg,
                                                                       rados_callback_t
                                                                       cb_complete,
                                                                       rados_completion_t
                                                                       * pc) {
    tracepoint(librados, rados_aio_create_completion2_enter, cb_arg,
               cb_complete);
    librados::AioCompletionImpl * c = new librados::AioCompletionImpl;
    if (cb_complete)
        c->set_complete_callback(cb_arg, cb_complete);
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_is_safe) (rados_completion_t
                                                            c) {
...
extern "C" int
LIBRADOS_C_API_DEFAULT_F(rados_aio_wait_for_complete_and_cb) (rados_completion_t
                                                              c) {
    tracepoint(librados, rados_aio_wait_for_complete_and_cb_enter, c);
    int retval =
        ((librados::AioCompletionImpl *) c)->wait_for_complete_and_cb();
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_aio_release) (rados_completion_t
                                                             c) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_read) (rados_ioctx_t io,
                                                         const char *o,
                                                         rados_completion_t
                                                         completion, char *buf,
                                                         size_t len,
...
#ifdef WITH_BLKIN
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_read_traced) (rados_ioctx_t
                                                                io,
                                                                const char *o,
                                                                rados_completion_t
                                                                completion,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_write) (rados_ioctx_t io,
                                                          const char *o,
                                                          rados_completion_t
                                                          completion,
                                                          const char *buf,
                                                          size_t len,
                                                          uint64_t off) {
    tracepoint(librados, rados_aio_write_enter, io, o, completion, buf, len,
               off);
    if (len > UINT_MAX / 2)
        return -E2BIG;
    librados::IoCtxImpl * ctx = (librados::IoCtxImpl *) io;
...
#ifdef WITH_BLKIN
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_write_traced) (rados_ioctx_t
                                                                 io,
                                                                 const char *o,
                                                                 rados_completion_t
                                                                 completion,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_append) (rados_ioctx_t io,
                                                           const char *o,
                                                           rados_completion_t
                                                           completion,
                                                           const char *buf,
    ...
    bl.append(buf, len);
    int retval =
        ctx->aio_append(oid, (librados::AioCompletionImpl *) completion,
                        bl, len);
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_write_full) (rados_ioctx_t io,
                                                               const char *o,
                                                               rados_completion_t
                                                               completion,
                                                               const char *buf,
                                                               size_t len) {
    tracepoint(librados, rados_aio_write_full_enter, io, o, completion, buf,
               len);
    if (len > UINT_MAX / 2)
        return -E2BIG;
    librados::IoCtxImpl * ctx = (librados::IoCtxImpl *) io;
    ...
    bl.append(buf, len);
    int retval =
        ctx->aio_write_full(oid, (librados::AioCompletionImpl *) completion,
                            bl);
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_writesame) (rados_ioctx_t io,
                                                              const char *o,
                                                              rados_completion_t
                                                              completion,
                                                              const char *buf,
    ...
    bl.append(buf, data_len);
    int retval =
        ctx->aio_writesame(o, (librados::AioCompletionImpl *) completion,
                           bl, write_len, off);
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_remove) (rados_ioctx_t io,
                                                           const char *o,
                                                           rados_completion_t
                                                           completion) {
    ...
    object_t oid(o);
    int retval =
        ctx->aio_remove(oid, (librados::AioCompletionImpl *) completion);
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_flush_async) (rados_ioctx_t
                                                                io,
                                                                rados_completion_t
                                                                completion) {
...
struct AioGetxattrData {
    AioGetxattrData(char *buf, rados_completion_t c, size_t l):user_buf(buf),
        len(l), user_completion((librados::AioCompletionImpl *) c) {
    } bufferlist bl;
    char *user_buf;
    size_t len;
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_getxattr) (rados_ioctx_t io,
                                                             const char *o,
                                                             rados_completion_t
                                                             completion,
                                                             const char *name,
                                                             char *buf,
                                                             size_t len) {
    tracepoint(librados, rados_aio_getxattr_enter, io, o, completion, name,
               len);
...
namespace {
    struct AioGetxattrsData {
        AioGetxattrsData(rados_completion_t c,
                         rados_xattrs_iter_t * _iter):iter(_iter),
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_getxattrs) (rados_ioctx_t io,
                                                              const char *oid,
                                                              rados_completion_t
                                                              completion,
                                                              rados_xattrs_iter_t
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_setxattr) (rados_ioctx_t io,
                                                             const char *o,
                                                             rados_completion_t
                                                             completion,
                                                             const char *name,
                                                             const char *buf,
                                                             size_t len) {
    tracepoint(librados, rados_aio_setxattr_enter, io, o, completion, name, buf,
               len);
    librados::IoCtxImpl * ctx = (librados::IoCtxImpl *) io;
    object_t oid(o);
    bufferlist bl;
    bl.append(buf, len);
    int retval =
        ctx->aio_setxattr(oid, (librados::AioCompletionImpl *) completion, name,
                          bl);
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_rmxattr) (rados_ioctx_t io,
                                                            const char *o,
                                                            rados_completion_t
                                                            completion,
                                                            const char *name) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_stat) (rados_ioctx_t io,
                                                         const char *o,
                                                         rados_completion_t
                                                         completion,
                                                         uint64_t * psize,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_stat2) (rados_ioctx_t io,
                                                          const char *o,
                                                          rados_completion_t
                                                          completion,
                                                          uint64_t * psize,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_cmpext) (rados_ioctx_t io,
                                                           const char *o,
                                                           rados_completion_t
                                                           completion,
                                                           const char *cmp_buf,
    ...
    object_t oid(o);
    int retval =
        ctx->aio_cmpext(oid, (librados::AioCompletionImpl *) completion,
                        cmp_buf, cmp_len, off);
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_cancel) (rados_ioctx_t io,
                                                           rados_completion_t
                                                           completion) {
    librados::IoCtxImpl * ctx = (librados::IoCtxImpl *) io;
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_exec) (rados_ioctx_t io,
                                                         const char *o,
                                                         rados_completion_t
                                                         completion,
                                                         const char *cls,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_watch) (rados_ioctx_t io,
                                                      const char *o,
                                                      uint64_t ver,
                                                      uint64_t * handle,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_watch3) (rados_ioctx_t io,
                                                       const char *o,
                                                       uint64_t * handle,
                                                       ...
                                                       uint32_t timeout,
                                                       void *arg) {
    tracepoint(librados, rados_watch3_enter, io, o, handle, watchcb, timeout,
               arg);
    int ret;
    if (!watchcb || !o || !handle) {
        ret = -EINVAL;
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_watch2) (rados_ioctx_t io,
                                                       const char *o,
                                                       uint64_t * handle,
                                                       rados_watchcb2_t watchcb,
                                                       rados_watcherrcb_t
                                                       watcherrcb, void *arg) {
    return LIBRADOS_C_API_DEFAULT_F(rados_watch3) (io, o, handle, watchcb,
                                                   watcherrcb, 0, arg);
}

LIBRADOS_C_API_BASE_DEFAULT(rados_watch2);

extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_watch2) (rados_ioctx_t io,
                                                           const char *o,
                                                           rados_completion_t
                                                           completion,
                                                           uint64_t * handle,
                                                           ...
                                                           uint32_t timeout,
                                                           void *arg) {
    tracepoint(librados, rados_aio_watch2_enter, io, o, completion, handle,
               watchcb, timeout, arg);
    int ret;
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_watch) (rados_ioctx_t io,
                                                          const char *o,
                                                          rados_completion_t
                                                          completion,
                                                          uint64_t * handle,
                                                          ...
                                                          watcherrcb,
                                                          void *arg) {
    return LIBRADOS_C_API_DEFAULT_F(rados_aio_watch2) (io, o, completion,
                                                       handle, watchcb,
                                                       watcherrcb, 0, arg);
}
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_unwatch) (rados_ioctx_t io,
                                                        const char *o,
                                                        uint64_t handle) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_unwatch2) (rados_ioctx_t io,
                                                         uint64_t handle) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_unwatch) (rados_ioctx_t io,
                                                            uint64_t handle,
                                                            rados_completion_t
                                                            completion) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_watch_check) (rados_ioctx_t io,
                                                            uint64_t handle) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_notify) (rados_ioctx_t io,
                                                       const char *o,
                                                       uint64_t ver,
                                                       const char *buf,
                                                       int buf_len) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_notify2) (rados_ioctx_t io,
                                                        const char *o,
                                                        const char *buf,
                                                        int buf_len,
                                                        uint64_t timeout_ms,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_decode_notify_response) (char
                                                                       *reply_buffer,
                                                                       size_t
                                                                       reply_buffer_len,
                                                                       struct
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_free_notify_response) (struct
                                                                      notify_ack_t
                                                                      * acks,
                                                                      size_t
                                                                      nr_acks,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_notify) (rados_ioctx_t io,
                                                           const char *o,
                                                           rados_completion_t
                                                           completion,
                                                           const char *buf,
                                                           ...
                                                           size_t *
                                                           reply_buffer_len) {
    tracepoint(librados, rados_aio_notify_enter, io, o, completion, buf,
               buf_len, timeout_ms);
    librados::IoCtxImpl * ctx = (librados::IoCtxImpl *) io;
    object_t oid(o);
    bufferlist bl;
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_notify_ack) (rados_ioctx_t io,
                                                           const char *o,
                                                           uint64_t notify_id,
                                                           uint64_t handle,
                                                           const char *buf,
                                                           int buf_len) {
    tracepoint(librados, rados_notify_ack_enter, io, o, notify_id, handle, buf,
               buf_len);
    librados::IoCtxImpl * ctx = (librados::IoCtxImpl *) io;
    object_t oid(o);
    bufferlist bl;
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_watch_flush) (rados_t cluster,
                                                                rados_completion_t
                                                                completion) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_set_alloc_hint) (rados_ioctx_t io,
                                                               const char *o,
                                                               uint64_t
                                                               ...
                                                               expected_write_size)
{
    tracepoint(librados, rados_set_alloc_hint_enter, io, o,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_set_alloc_hint2) (rados_ioctx_t
                                                                io,
                                                                const char *o,
                                                                uint64_t
                                                                expected_object_size,
                                                                ...
                                                                uint32_t flags)
{
    tracepoint(librados, rados_set_alloc_hint2_enter, io, o,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_lock_exclusive) (rados_ioctx_t io,
                                                               const char *o,
                                                               const char *name,
                                                               const char
                                                               *cookie,
                                                               ...
                                                               duration,
                                                               uint8_t flags) {
    tracepoint(librados, rados_lock_exclusive_enter, io, o, name, cookie, desc,
               duration, flags);
    librados::IoCtx ctx;
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_lock_shared) (rados_ioctx_t io,
                                                            const char *o,
                                                            const char *name,
                                                            const char *cookie,
                                                            const char *tag,
                                                            ...
                                                            duration,
                                                            uint8_t flags) {
    tracepoint(librados, rados_lock_shared_enter, io, o, name, cookie, tag,
               desc, duration, flags);
    librados::IoCtx ctx;
    librados::IoCtx::from_rados_ioctx_t(io, ctx);
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_unlock) (rados_ioctx_t io,
                                                       const char *o,
                                                       const char *name,
                                                       const char *cookie) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_unlock) (rados_ioctx_t io,
                                                           const char *o,
                                                           const char *name,
                                                           const char *cookie,
                                                           rados_completion_t
                                                           completion) {
    tracepoint(librados, rados_aio_unlock_enter, io, o, name, cookie,
               completion);
    librados::IoCtx ctx;
    librados::IoCtx::from_rados_ioctx_t(io, ctx);
    librados::AioCompletionImpl * comp =
        (librados::AioCompletionImpl *) completion;
    comp->get();
...
extern "C" ssize_t LIBRADOS_C_API_DEFAULT_F(rados_list_lockers) (rados_ioctx_t
                                                                 io,
                                                                 const char *o,
                                                                 const char
                                                                 *name,
                                                                 ...
                                                                 size_t *
                                                                 addrs_len) {
    tracepoint(librados, rados_list_lockers_enter, io, o, name, *tag_len,
    ...
    if (r < 0) {
        tracepoint(librados, rados_list_lockers_exit, r, *exclusive, "",
                   *tag_len, *clients_len, *cookies_len, *addrs_len);
        return r;
    }
    ...
    *tag_len = tag_str.length() + 1;
    if (too_short) {
        tracepoint(librados, rados_list_lockers_exit, -ERANGE, *exclusive, "",
                   *tag_len, *clients_len, *cookies_len, *addrs_len);
        return -ERANGE;
    }
    ...
    for (it = lockers.begin(); it != lockers.end(); ++it) {
        ...
        tracepoint(librados, rados_list_lockers_locker, clients_p, cookies_p,
                   addrs_p);
    ...
    tracepoint(librados, rados_list_lockers_exit, retval, *exclusive, tag,
               *tag_len, *clients_len, *cookies_len, *addrs_len);
    return retval;
}
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_break_lock) (rados_ioctx_t io,
                                                           const char *o,
                                                           const char *name,
                                                           const char *client,
                                                           const char *cookie) {
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_write_op_set_flags) (rados_write_op_t write_op,
                                                    int flags) {
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_write_op_assert_version) (rados_write_op_t
                                                         write_op,
                                                         uint64_t ver) {
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_write_op_assert_exists) (rados_write_op_t
                                                        write_op) {
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_write_op_cmpext) (rados_write_op_t write_op,
                                                 const char *cmp_buf,
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_write_op_cmpxattr) (rados_write_op_t write_op,
                                                   const char *name,
                                                   uint8_t comparison_operator,
                                                   const char *value,
                                                   size_t value_len) {
    tracepoint(librados, rados_write_op_cmpxattr_enter, write_op, name,
               comparison_operator, value, value_len);
    bufferlist bl;
    bl.append(value, value_len);
    to_object_operation(write_op)->cmpxattr(name,
                                            comparison_operator,
                                            CEPH_OSD_CMPXATTR_MODE_STRING, bl);
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_write_op_omap_cmp) (rados_write_op_t write_op,
                                                   const char *key,
                                                   uint8_t comparison_operator,
                                                   const char *val,
                                                   size_t val_len, int *prval) {
    tracepoint(librados, rados_write_op_omap_cmp_enter, write_op, key,
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_write_op_omap_cmp2) (rados_write_op_t write_op,
                                                    const char *key,
                                                    uint8_t comparison_operator,
                                                    const char *val,
                                                    size_t key_len,
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_write_op_setxattr) (rados_write_op_t write_op,
                                                   const char *name,
                                                   const char *value,
                                                   size_t value_len) {
    tracepoint(librados, rados_write_op_setxattr_enter, write_op, name, value,
               value_len);
    bufferlist bl;
    bl.append(value, value_len);
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_write_op_rmxattr) (rados_write_op_t write_op,
                                                  const char *name) {
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_write_op_create) (rados_write_op_t write_op, int exclusive, const char *category)    // unused
{
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_write_op_write) (rados_write_op_t
                                                                write_op,
                                                                const char
                                                                *buffer,
                                                                size_t len,
                                                                uint64_t offset)
{
    tracepoint(librados, rados_write_op_write_enter, write_op, buffer, len,
               offset);
    bufferlist bl;
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_write_op_write_full) (rados_write_op_t write_op,
                                                     const char *buffer,
                                                     size_t len) {
    tracepoint(librados, rados_write_op_write_full_enter, write_op, buffer,
               len);
    bufferlist bl;
    bl.append(buffer, len);
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_write_op_writesame) (rados_write_op_t write_op,
                                                    const char *buffer,
                                                    size_t data_len,
                                                    size_t write_len,
                                                    uint64_t offset) {
    tracepoint(librados, rados_write_op_writesame_enter, write_op, buffer,
               data_len, write_len, offset);
    bufferlist bl;
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_write_op_append) (rados_write_op_t write_op,
                                                 const char *buffer,
                                                 size_t len) {
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_write_op_truncate) (rados_write_op_t write_op,
                                                   uint64_t offset) {
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_write_op_zero) (rados_write_op_t
                                                               write_op,
                                                               uint64_t offset,
                                                               uint64_t len) {
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_write_op_exec) (rados_write_op_t
                                                               write_op,
                                                               const char *cls,
                                                               const char
                                                               *method,
                                                               ...
                                                               *in_buf,
                                                               size_t in_len,
                                                               int *prval) {
    tracepoint(librados, rados_write_op_exec_enter, write_op, cls, method,
               in_buf, in_len, prval);
    bufferlist inbl;
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_write_op_omap_set) (rados_write_op_t write_op,
    ...
    for (size_t i = 0; i < num; ++i) {
        tracepoint(librados, rados_write_op_omap_set_entry, keys[i], vals[i],
                   lens[i]);
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_write_op_omap_set2) (rados_write_op_t write_op,
                                                    char const *const *keys,
                                                    char const *const *vals,
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_write_op_omap_rm_keys) (rados_write_op_t
                                                       write_op,
                                                       char const *const *keys,
                                                       size_t keys_len) {
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_write_op_omap_rm_keys2) (rados_write_op_t
                                                        write_op,
                                                        char const *const *keys,
                                                        const size_t * key_lens,
                                                        size_t keys_len) {
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_write_op_omap_rm_range2) (rados_write_op_t
                                                         write_op,
                                                         const char *key_begin,
                                                         size_t key_begin_len,
                                                         const char *key_end,
                                                         size_t key_end_len) {
    tracepoint(librados, rados_write_op_omap_rm_range_enter, write_op,
               key_begin, key_end);
    to_object_operation(write_op)->omap_rm_range( {
                                                 key_begin, key_begin_len}, {
                                                 key_end, key_end_len});
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_write_op_set_alloc_hint) (rados_write_op_t
                                                         write_op,
                                                         uint64_t
                                                         expected_object_size,
                                                         uint64_t
                                                         expected_write_size) {
    tracepoint(librados, rados_write_op_set_alloc_hint_enter, write_op,
               expected_object_size, expected_write_size);
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_write_op_set_alloc_hint2) (rados_write_op_t
                                                          write_op,
                                                          uint64_t
                                                          expected_object_size,
                                                          uint64_t
                                                          expected_write_size,
                                                          uint32_t flags) {
    tracepoint(librados, rados_write_op_set_alloc_hint2_enter, write_op,
               expected_object_size, expected_write_size, flags);
    to_object_operation(write_op)->set_alloc_hint(expected_object_size,
                                                  expected_write_size, flags);
...
extern "C" int
LIBRADOS_C_API_DEFAULT_F(rados_write_op_operate) (rados_write_op_t write_op,
                                                  rados_ioctx_t io,
                                                  const char *oid,
                                                  time_t * mtime, int flags) {
    tracepoint(librados, rados_write_op_operate_enter, write_op, io, oid, mtime,
               flags);
    object_t obj(oid);
    ...
    int retval =
        ctx->operate(obj, &oimpl->o, oimpl->prt, translate_flags(flags));
...
extern "C" int
LIBRADOS_C_API_DEFAULT_F(rados_write_op_operate2) (rados_write_op_t write_op,
                                                   rados_ioctx_t io,
                                                   const char *oid,
                                                   struct timespec * ts,
                                                   int flags) {
    tracepoint(librados, rados_write_op_operate2_enter, write_op, io, oid, ts,
               flags);
    object_t obj(oid);
    auto oimpl = static_cast < librados::ObjectOperationImpl * >(write_op);
    librados::IoCtxImpl * ctx = (librados::IoCtxImpl *) io;
...
extern "C" int
LIBRADOS_C_API_DEFAULT_F(rados_aio_write_op_operate) (rados_write_op_t write_op,
                                                      rados_ioctx_t io,
                                                      rados_completion_t
                                                      completion,
                                                      const char *oid,
                                                      time_t * mtime,
                                                      int flags) {
    tracepoint(librados, rados_aio_write_op_operate_enter, write_op, io,
               completion, oid, mtime, flags);
    object_t obj(oid);
    auto oimpl = static_cast < librados::ObjectOperationImpl * >(write_op);
    librados::IoCtxImpl * ctx = (librados::IoCtxImpl *) io;
    librados::AioCompletionImpl * c =
    ...
    int retval =
        ctx->aio_operate(obj, &oimpl->o, c, ctx->snapc, oimpl->prt,
...
extern "C" int
LIBRADOS_C_API_DEFAULT_F(rados_aio_write_op_operate2) (rados_write_op_t
                                                       write_op,
                                                       rados_ioctx_t io,
                                                       rados_completion_t
                                                       completion,
                                                       ...
                                                       int flags) {
    tracepoint(librados, rados_aio_write_op_operate2_enter, write_op, io,
               completion, oid, mtime, flags);
    object_t obj(oid);
    auto oimpl = static_cast < librados::ObjectOperationImpl * >(write_op);
    librados::IoCtxImpl * ctx = (librados::IoCtxImpl *) io;
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_release_read_op) (rados_read_op_t
                                                                 read_op) {
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_read_op_set_flags) (rados_read_op_t read_op,
                                                   int flags) {
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_read_op_assert_version) (rados_read_op_t read_op,
                                                        uint64_t ver) {
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_read_op_cmpext) (rados_read_op_t
                                                                read_op,
                                                                const char
                                                                *cmp_buf,
                                                                size_t cmp_len,
                                                                uint64_t off,
                                                                int *prval) {
    tracepoint(librados, rados_read_op_cmpext_enter, read_op, cmp_buf, cmp_len,
               off, prval);
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_read_op_cmpxattr) (rados_read_op_t read_op,
                                                  const char *name,
                                                  uint8_t comparison_operator,
                                                  const char *value,
                                                  size_t value_len) {
    tracepoint(librados, rados_read_op_cmpxattr_enter, read_op, name,
               comparison_operator, value, value_len);
    bufferlist bl;
    bl.append(value, value_len);
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_read_op_omap_cmp) (rados_read_op_t read_op,
                                                  const char *key,
                                                  uint8_t comparison_operator,
                                                  const char *val,
                                                  size_t val_len, int *prval) {
    tracepoint(librados, rados_read_op_omap_cmp_enter, read_op, key,
               comparison_operator, val, val_len, prval);
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_read_op_omap_cmp2) (rados_read_op_t read_op,
                                                   const char *key,
                                                   uint8_t comparison_operator,
                                                   const char *val,
                                                   size_t key_len,
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_read_op_stat) (rados_read_op_t
                                                              read_op,
                                                              uint64_t * psize,
                                                              time_t * pmtime,
                                                              int *prval) {
    tracepoint(librados, rados_read_op_stat_enter, read_op, psize, pmtime,
               prval);
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_read_op_stat2) (rados_read_op_t
                                                               read_op,
                                                               uint64_t * psize,
                                                               struct timespec *
                                                               pmtime,
                                                               int *prval) {
    tracepoint(librados, rados_read_op_stat2_enter, read_op, psize, pmtime,
               prval);
    ((::ObjectOperation *) read_op)->stat(psize, pmtime, prval);
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_read_op_read) (rados_read_op_t
                                                              read_op,
                                                              uint64_t offset,
                                                              size_t len,
                                                              char *buf,
                                                              ...
                                                              bytes_read,
                                                              int *prval) {
    tracepoint(librados, rados_read_op_read_enter, read_op, offset, len, buf,
               bytes_read, prval);
    C_bl_to_buf *ctx = new C_bl_to_buf(buf, len, bytes_read, prval);
    ctx->out_bl.push_back(buffer::create_static(len, buf));
    ((::ObjectOperation *) read_op)->read(offset, len, &ctx->out_bl, prval,
                                          ctx);
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_read_op_checksum) (rados_read_op_t read_op,
                                                  ...
                                                  size_t checksum_len,
                                                  int *prval) {
    tracepoint(librados, rados_read_op_checksum_enter, read_op, type,
               init_value, init_value_len, offset, len, chunk_size);
    bufferlist init_value_bl;
    init_value_bl.append(init_value, init_value_len);
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_read_op_exec) (rados_read_op_t
                                                              read_op,
                                                              const char *cls,
                                                              const char
                                                              *method,
                                                              ...
                                                              *in_buf,
                                                              ...
                                                              size_t * out_len,
                                                              int *prval) {
    tracepoint(librados, rados_read_op_exec_enter, read_op, cls, method, in_buf,
               in_len, out_buf, out_len, prval);
    bufferlist inbl;
    inbl.append(in_buf, in_len);
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_read_op_exec_user_buf) (rados_read_op_t read_op,
                                                       const char *cls,
                                                       const char *method,
                                                       const char *in_buf,
                                                       size_t in_len,
                                                       ...
                                                       size_t * used_len,
                                                       int *prval) {
    tracepoint(librados, rados_read_op_exec_user_buf_enter, read_op, cls,
               method, in_buf, in_len, out_buf, out_len, used_len, prval);
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_read_op_getxattrs) (rados_read_op_t read_op,
                                                   rados_xattrs_iter_t * iter,
                                                   int *prval) {
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_read_op_omap_get_vals) (rados_read_op_t read_op,
                                                       ...
                                                       *filter_prefix,
                                                       ...
                                                       int *prval) {
    tracepoint(librados, rados_read_op_omap_get_vals_enter, read_op,
               start_after, filter_prefix, max_return, prval);
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_read_op_omap_get_vals2) (rados_read_op_t read_op,
                                                        const char *start_after,
                                                        const char
                                                        *filter_prefix,
                                                        uint64_t max_return,
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_read_op_omap_get_keys) (rados_read_op_t read_op,
                                                       const char *start_after,
                                                       uint64_t max_return,
                                                       rados_omap_iter_t * iter,
                                                       int *prval) {
    tracepoint(librados, rados_read_op_omap_get_keys_enter, read_op,
               start_after, max_return, prval);
    RadosOmapIter *omap_iter = new RadosOmapIter;
    C_OmapKeysIter *ctx = new C_OmapKeysIter(omap_iter);
    ((::ObjectOperation *) read_op)->
        omap_get_keys(start_after ? start_after : "", max_return, &ctx->keys,
                      nullptr, prval);
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_read_op_omap_get_keys2) (rados_read_op_t read_op,
                                                        const char *start_after,
                                                        uint64_t max_return,
                                                        rados_omap_iter_t *
                                                        iter,
...
static void internal_rados_read_op_omap_get_vals_by_keys(rados_read_op_t
                                                         read_op,
                                                         set < string > &to_get,
                                                         rados_omap_iter_t *
                                                         iter, int *prval)
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_read_op_omap_get_vals_by_keys) (rados_read_op_t
                                                               read_op,
                                                               char const *const
                                                               *keys,
                                                               size_t keys_len,
                                                               ...
                                                               * iter,
                                                               int *prval) {
    tracepoint(librados, rados_read_op_omap_get_vals_by_keys_enter, read_op,
               keys, keys_len, iter, prval);
...
extern "C" void
LIBRADOS_C_API_DEFAULT_F(rados_read_op_omap_get_vals_by_keys2) (rados_read_op_t
                                                                read_op,
                                                                char const
                                                                *const *keys,
                                                                size_t num_keys,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_omap_get_next2) (rados_omap_iter_t
                                                               iter, char **key,
                                                               char **val,
                                                               size_t * key_len,
                                                               size_t *
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_omap_get_next) (rados_omap_iter_t
                                                              iter, char **key,
                                                              char **val,
                                                              size_t * len) {
    return LIBRADOS_C_API_DEFAULT_F(rados_omap_get_next2) (iter, key, val,
                                                           nullptr, len);
}
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_omap_get_end) (rados_omap_iter_t
                                                              iter) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_read_op_operate) (rados_read_op_t
                                                                read_op,
                                                                rados_ioctx_t
                                                                io,
                                                                const char *oid,
...
extern "C" int
LIBRADOS_C_API_DEFAULT_F(rados_aio_read_op_operate) (rados_read_op_t read_op,
                                                     rados_ioctx_t io,
                                                     rados_completion_t
                                                     completion,
                                                     const char *oid,
                                                     int flags) {
    tracepoint(librados, rados_aio_read_op_operate_enter, read_op, io,
               completion, oid, flags);
    object_t obj(oid);
    librados::IoCtxImpl * ctx = (librados::IoCtxImpl *) io;
    librados::AioCompletionImpl * c =
        (librados::AioCompletionImpl *) completion;
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_cache_pin) (rados_ioctx_t io,
                                                          const char *o) {
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_cache_unpin) (rados_ioctx_t io,
                                                            const char *o) {
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_object_list_slice) (rados_ioctx_t
                                                                   io,
                                                                   const
                                                                   rados_object_list_cursor
                                                                   start,
                                                                   ...
                                                                   split_finish)
{
    ...
    ctx->object_list_slice(*start_hobj,
                           *finish_hobj,
                           n, m, split_start_hobj, split_finish_hobj);
}
