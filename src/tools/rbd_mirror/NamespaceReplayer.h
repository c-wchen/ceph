   ...
   */
            ...
            struct PoolWatcherListener:public pool_watcher::Listener {
                ...
                bool local;
                 ...
                 PoolWatcherListener(NamespaceReplayer * namespace_replayer,
                                     bool local)
                :namespace_replayer(namespace_replayer), local(local) {
                    ...
                    namespace_replayer->
                        handle_update((local ? "" : mirror_uuid),
            ...
            struct ImageMapListener:public image_map::Listener {
                ...
                :namespace_replayer(namespace_replayer) {
                    ...
                    namespace_replayer->handle_acquire_image(global_image_id,
                                                             instance_id,
                                                             on_finish);
                }
                ...
                void release_image(const std::string & global_image_id,
                                   const std::string & instance_id,
                                   Context * on_finish) override {
                    namespace_replayer->handle_release_image(global_image_id,
                                                             instance_id,
                                                             on_finish);
                }
                ...
                void remove_image(const std::string & mirror_uuid,
                                  ...
                                  const std::string & instance_id,
                                  Context * on_finish) override {
                    namespace_replayer->handle_remove_image(mirror_uuid,
                                                            global_image_id,
                                                            instance_id,
                                                            on_finish);
                }
            ...
            std::unique_ptr < MirrorStatusUpdater <
                ImageCtxT >> m_local_status_updater;
            std::unique_ptr < MirrorStatusUpdater <
                ImageCtxT >> m_remote_status_updater;
            ...
            std::unique_ptr < InstanceReplayer <
                ImageCtxT >> m_instance_replayer;
