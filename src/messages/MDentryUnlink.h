...
protected:
    MDentryUnlink(): MMDSOp(MSG_MDS_DENTRYUNLINK, HEAD_VERSION, COMPAT_VERSION)
    {
...
public:
    ...
    MDentryUnlinkAck(): MMDSOp(MSG_MDS_DENTRYUNLINK_ACK, HEAD_VERSION,
                                   COMPAT_VERSION)
    {
    } MDentryUnlinkAck(dirfrag_t df,
                       std::string_view n): MMDSOp(MSG_MDS_DENTRYUNLINK_ACK,
