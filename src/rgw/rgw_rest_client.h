...
public:
    RGWRESTStreamReadRequest(CephContext *_cct, const std::string &_url, ReceiveCB *_cb, param_vec_t *_headers,
                             ...
                             HostStyle _host_style = PathStyle): RGWRESTStreamRWRequest(_cct, "GET", _url, _cb, _headers, _params, _api_name,
                                     _host_style)
    {
    }
};
...
public:
    RGWRESTStreamSendRequest(CephContext *_cct, const std::string &method, const std::string &_url, ReceiveCB *_cb,
                             ...
                             HostStyle _host_style = PathStyle): RGWRESTStreamRWRequest(_cct, method, _url, _cb, _headers, _params,
                                     _api_name,
                                     _host_style)
    {
    }
