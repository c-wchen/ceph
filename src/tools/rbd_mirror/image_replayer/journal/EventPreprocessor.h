        ...
        namespace image_replayer {
            namespace journal {
                ...
                template < typename ImageCtxT = librbd::ImageCtx >
                  ...
                  public:
                    using Journaler =
                        typename librbd::journal::TypeTraits <
                        ImageCtxT >::Journaler;
                    using EventEntry = librbd::journal::EventEntry;
                    using MirrorPeerClientMeta =
                        librbd::journal::MirrorPeerClientMeta;

                    static EventPreprocessor *create(ImageCtxT &
                                                     local_image_ctx,
                                                     Journaler &
                                                     remote_journaler,
                                                     const std::
                                                     ...
                                                     work_queue) {
                        return new EventPreprocessor(local_image_ctx,
                                                     remote_journaler,
                                                     local_mirror_uuid,
                                                     client_meta, work_queue);
                    } static void destroy(EventPreprocessor * processor) {
                        delete processor;
                    } EventPreprocessor(ImageCtxT & local_image_ctx,
                    ...
                    void preprocess(EventEntry * event_entry,
                                    Context * on_finish);
   ...
   */
                    ...
                    class PreprocessEventVisitor:public boost::static_visitor < int > {
                      public:
                        ...
                        PreprocessEventVisitor(EventPreprocessor *
                                               event_preprocessor)
                        :event_preprocessor(event_preprocessor) {
                        } template < typename T > inline int operator() (T &) const {
                            return 0;
                        } inline int operator() (librbd::journal::
                                                 SnapRenameEvent & event) const
                        {
                    ...
                    int preprocess_snap_rename(librbd::journal::
