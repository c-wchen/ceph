...
class MemDB:public KeyValueDB {
  ...
  public:
    MemDB(CephContext * c, const string & path, void *p):m_using_btree(false),
    ...
    static
    int _test_init(const string & dir) {
        return 0;
    };
    ...
    class MDBTransactionImpl:public KeyValueDB::TransactionImpl {
      ...
      public:
        const std::vector < std::pair < op_type, ms_op_t >> & get_ops() {
            return ops;
        };
  ...
  public:
    ...
    KeyValueDB::Transaction get_transaction()override {
        return std::shared_ptr < MDBTransactionImpl >
    ...
    class MDBWholeSpaceIteratorImpl:public KeyValueDB::WholeSpaceIteratorImpl {
      ...
      public:
        MDBWholeSpaceIteratorImpl(mdb_map_t * btree_p,
  ...
  protected:
    ...
    WholeSpaceIterator _get_iterator()override {
        return std::shared_ptr < KeyValueDB::WholeSpaceIteratorImpl >
            (new
             MDBWholeSpaceIteratorImpl(&m_map, &m_lock, &iterator_seq_no,
                                       m_using_btree));
    }
};
