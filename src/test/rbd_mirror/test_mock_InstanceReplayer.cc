...
namespace rbd {
    namespace mirror {
        ...
        template <> struct ImageReplayer <librbd::MockTestImageCtx > {
            ...
            static ImageReplayer *create(Threads < librbd::MockTestImageCtx >
                                         *threads,
                                         ImageDeleter <
            ...
            MOCK_METHOD2(add_peer,
                         void (const std::string &, librados::IoCtx &));
...
namespace rbd {
    namespace mirror {
        ...
        TEST_F(TestMockInstanceReplayer, AcquireReleaseImage) {
            ...
            MockInstanceReplayer instance_replayer(&mock_threads,
                                                   &mock_service_daemon,
                                                   &mock_image_deleter,
                                                   rbd::mirror::
                                                   RadosRef(new librados::
                                                            Rados
                                                            (m_local_io_ctx)),
                                                   "local_mirror_uuid",
        ...
        TEST_F(TestMockInstanceReplayer, RemoveFinishedImage) {
            ...
            EXPECT_CALL(mock_service_daemon,
                        add_or_update_attribute(_, _, _)).Times(3);
