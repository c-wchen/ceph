...
protected:
    ...
    int serve_errordoc(const DoutPrefixProvider *dpp, int http_ret,
                       const std::string &errordoc_key, optional_yield y);
public:
...
public:
    ...
    {
    } explicit RGWGetObj_ObjStore_S3Website(bool
                                            is_errordoc_request): is_errordoc_request
        (false)
    {
