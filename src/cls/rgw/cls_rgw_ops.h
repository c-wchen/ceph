...
struct rgw_cls_link_olh_op {
    ...
    rgw_cls_link_olh_op(): delete_marker(false), olh_epoch(0), log_op(false),
        bilog_flags(0), high_precision_time(false)
    {
    } void encode(ceph::buffer::list &bl) const
    {
        ENCODE_START(5, 1, bl);
...
struct rgw_cls_list_ret {
    ...
    rgw_cls_list_ret(): is_truncated(false), cls_filtered(true)
    {
    } void encode(ceph::buffer::list &bl) const
    {
        ENCODE_START(4, 2, bl);
...
struct rgw_cls_bucket_update_stats_op {
    ...
    void dump(ceph::Formatter *f) const;
    static void generate_test_instances(std::list <
                                        rgw_cls_bucket_update_stats_op * > &o);
};
...
struct cls_rgw_set_bucket_resharding_op {
    ...
    static void generate_test_instances(std::list <
                                        cls_rgw_set_bucket_resharding_op * > &o);
    void dump(ceph::Formatter *f) const;
};
...
struct cls_rgw_clear_bucket_resharding_op {
    ...
    static void generate_test_instances(std::list <
                                        cls_rgw_clear_bucket_resharding_op * > &o);
    void dump(ceph::Formatter *f) const;
};
...
struct cls_rgw_guard_bucket_resharding_op {
    ...
    static void generate_test_instances(std::list <
                                        cls_rgw_guard_bucket_resharding_op * > &o);
    void dump(ceph::Formatter *f) const;
};
...
struct cls_rgw_get_bucket_resharding_op {
    ...
    static void generate_test_instances(std::list <
                                        cls_rgw_get_bucket_resharding_op * > &o);
    void dump(ceph::Formatter *f) const;
};
...
struct cls_rgw_get_bucket_resharding_ret {
    ...
    static void generate_test_instances(std::list <
                                        cls_rgw_get_bucket_resharding_ret * > &o);
    void dump(ceph::Formatter *f) const;
};
