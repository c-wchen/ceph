...
namespace crimson {
    ...
    template < typename T, typename C > class Heap {
      ...
      public:
        ...
        class iterator {
            ...
            int index;
             ...
             iterator(Heap < T, C > &_heap, int _index):heap(_heap),
                index(_index) {
                // empty
          } public:
      ...
      protected:
        ...
        static inline int lhs(int i) {
            return 2 * i + 1;
        }

        static inline int rhs(int i) {
            return 2 * i + 2;
        }
      ...
      Heap():
        ...
        template < typename T1, typename T2 >
            friend std::ostream & operator<<(std::ostream &, const Heap < T1,
                                             T2 > &);
    };                          // class Heap

    template < typename T1, typename T2 >
        std::ostream & operator<<(std::ostream & out, const Heap < T1,
                                  T2 > &h) {
        out << "[ ";
        if (h.count) {
            out << h.data[0];
