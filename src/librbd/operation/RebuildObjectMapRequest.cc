    ...
    namespace operation {
        ...
        using util::create_context_callback;
         ...
         template < typename I > void RebuildObjectMapRequest < I >::send() {
            ...
            if (r == -ERESTART) {
                ...
                lderr(cct) << "rebuild object map encountered an error: " <<
                    cpp_strerror(r)
                    << dendl;
                return true;
            }
        ...
        template < typename I >
            ...
            uint64_t num_objects =
                Striper::get_num_objects(m_image_ctx.layout, size);
        ...
        template < typename I >
            bool update_object_map(I & image_ctx, uint64_t object_no,
            ...
            if (current_state == OBJECT_EXISTS
                && new_state == OBJECT_NONEXISTENT && snap_id == CEPH_NOSNAP) {
            ...
            if (new_state != current_state) {
                ...
                image_ctx.object_map->set_state(object_no, new_state,
                                                current_state);
            }
            return false;
        }
        ...
        template < typename I >
            ...
            uint64_t flags =
                RBD_FLAG_OBJECT_MAP_INVALID | RBD_FLAG_FAST_DIFF_INVALID;
