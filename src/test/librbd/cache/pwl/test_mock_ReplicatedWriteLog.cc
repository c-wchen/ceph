    ...
    namespace cache {
        namespace pwl {
            ...
            struct TestMockCacheReplicatedWriteLog:public TestMockFixture {
                typedef librbd::cache::pwl::rwl::WriteLog <
                    librbd::MockImageCtx > MockReplicatedWriteLog;
                typedef librbd::cache::pwl::ImageCacheState <
                    librbd::MockImageCtx > MockImageCacheStateRWL;
                ...
                } void expect_context_complete(MockContextRWL & mock_context,
                                               int r) {
            ...
            TEST_F(TestMockCacheReplicatedWriteLog, init_state_write) {
                ...
                ceph::mutex lock =
                    ceph::make_mutex("MockImageCacheStateRWL lock");
            ...
            TEST_F(TestMockCacheReplicatedWriteLog, init_shutdown) {
                ...
                MockApi mock_api;
                MockReplicatedWriteLog rwl(mock_image_ctx,
            ...
            TEST_F(TestMockCacheReplicatedWriteLog, read_hit_rwl_cache) {
                ...
                0, 4096}};
                bufferlist read_bl;
                rwl.read(std::move(image_extents_read), &read_bl, fadvise_flags,
                         &finish_ctx_read);
            ...
            TEST_F(TestMockCacheReplicatedWriteLog, writesame) {
                ...
                int fadvise_flags = 0;
                rwl.writesame(0, 4096, std::move(bl), fadvise_flags,
                              &finish_ctx2);
                ASSERT_EQ(0, finish_ctx2.wait());
            ...
            TEST_F(TestMockCacheReplicatedWriteLog,
                ...
                int fadvise_flags = 0;
                rwl.write(std::move(image_extents), std::move(bl1),
                          fadvise_flags, &finish_ctx2);
                ASSERT_EQ(0, finish_ctx2.wait());
