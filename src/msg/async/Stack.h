...
public:
    ...
    /// get listen/bind addr unsigned get_addr_slot() {
...
public:
        ...
        : cct(c), perf_logger(NULL), id(worker_id), references(0), center(c)
    {
        ...
        plb.add_u64_counter(l_msgr_recv_bytes, "msgr_recv_bytes",
                            "Network received bytes", NULL, 0,
                            unit_t(UNIT_BYTES));
        plb.add_u64_counter(l_msgr_send_bytes, "msgr_send_bytes",
                            "Network sent bytes", NULL, 0, unit_t(UNIT_BYTES));
