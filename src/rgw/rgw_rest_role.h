...
class RGWModifyRoleTrustPolicy:public RGWRoleWrite {
    bufferlist bl_post_body;
  public:
     RGWModifyRoleTrustPolicy(const bufferlist &
                              bl_post_body):bl_post_body(bl_post_body) {
    };
    void execute(optional_yield y) override;
    int get_params();
    const char *name() const override {
    ...
    uint64_t get_op() override {
        return rgw::IAM::iamModifyRoleTrustPolicy;
    }
};
...
class RGWPutRolePolicy:public RGWRoleWrite {
    bufferlist bl_post_body;
  public:
     RGWPutRolePolicy(const bufferlist &
                      bl_post_body):bl_post_body(bl_post_body) {
    };
    void execute(optional_yield y) override;
    int get_params();
    ...
    uint64_t get_op() override {
        return rgw::IAM::iamPutRolePolicy;
    }
};
...
class RGWGetRolePolicy:public RGWRoleRead {
  public:
    ...
    const char *name() const override {
        ...
        return rgw::IAM::iamGetRolePolicy;
    }
};
...
class RGWListRolePolicies:public RGWRoleRead {
  public:
    ...
    const char *name() const override {
        ...
        return rgw::IAM::iamListRolePolicies;
    }
};
...
class RGWDeleteRolePolicy:public RGWRoleWrite {
    bufferlist bl_post_body;
  public:
     RGWDeleteRolePolicy(const bufferlist &
                         bl_post_body):bl_post_body(bl_post_body) {
    };
    void execute(optional_yield y) override;
    int get_params();
    ...
    uint64_t get_op() override {
        return rgw::IAM::iamDeleteRolePolicy;
    }
};
...
class RGWListRoleTags:public RGWRoleRead {
  public:
    ...
    const char *name() const override {
        ...
        return rgw::IAM::iamListRoleTags;
    }
};
