    ...
    namespace operation {
        ...
        template < typename I >
            ...
            image_ctx.state->
                prepare_lock(create_async_context_callback
                             (image_ctx,
                              create_context_callback < EnableFeaturesRequest <
                              I >,
        ...
        template < typename I >
            ...
            image_ctx.io_image_dispatcher->
                block_writes(create_context_callback < EnableFeaturesRequest <
                             I >,
                             &EnableFeaturesRequest < I >::handle_block_writes >
                             (this));
        }
        ...
        template < typename I >
            ...
            do {
                ...
                if ((m_features & RBD_FEATURE_OBJECT_MAP) != 0) {
                    ...
                    m_features_mask |=
                        (RBD_FEATURE_EXCLUSIVE_LOCK | RBD_FEATURE_FAST_DIFF);
                }
        ...
        template < typename I >
            Context * EnableFeaturesRequest <
            I >::handle_create_journal(int *result) {
            I & image_ctx = this->m_image_ctx;
            CephContext *cct = image_ctx.cct;
            ldout(cct,
                  20) << this << " " << __func__ << ": r=" << *result << dendl;
        ...
        template < typename I >
            Context * EnableFeaturesRequest <
            I >::handle_create_object_map(int *result) {
            I & image_ctx = this->m_image_ctx;
            CephContext *cct = image_ctx.cct;
            ldout(cct,
                  20) << this << " " << __func__ << ": r=" << *result << dendl;
            ...
            if (*result < 0) {
                lderr(cct) << "failed to create object map: " <<
                    cpp_strerror(*result)
                    << dendl;
                return handle_finish(*result);
            }
        ...
        template < typename I >
            ...
            Context *ctx = create_context_callback <
                EnableFeaturesRequest < I >,
                &EnableFeaturesRequest < I >::handle_enable_mirror_image >
                (this);
        ...
        template < typename I >
            Context * EnableFeaturesRequest <
            I >::handle_enable_mirror_image(int *result) {
            I & image_ctx = this->m_image_ctx;
            CephContext *cct = image_ctx.cct;
            ldout(cct,
                  20) << this << " " << __func__ << ": r=" << *result << dendl;
