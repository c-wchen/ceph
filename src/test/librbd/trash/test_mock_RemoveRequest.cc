...
namespace librbd {
    namespace trash {
        ...
        struct TestMockTrashRemoveRequest:public TestMockFixture {
            typedef RemoveRequest < librbd::MockTestImageCtx >
                MockRemoveRequest;
            typedef image::RemoveRequest < librbd::MockTestImageCtx >
            ...
            void expect_set_state(MockTestImageCtx & mock_image_ctx,
                ...
                .WillOnce(Return(r));
            } void expect_set_deleting_state(MockTestImageCtx & mock_image_ctx,
                                             int r) {
                expect_set_state(mock_image_ctx,
                                 cls::rbd::TRASH_IMAGE_STATE_REMOVING,
                                 cls::rbd::TRASH_IMAGE_STATE_NORMAL, r);
            } void expect_restore_normal_state(MockTestImageCtx &
            ...
            void expect_remove_image(MockImageRemoveRequest &
                                     mock_image_remove_request, int r) {
                EXPECT_CALL(mock_image_remove_request, send())
                    .WillOnce(Invoke([&mock_image_remove_request, r] () {
                                     mock_image_remove_request.on_finish->
                                     complete(r);}));
            }
            ...
            void expect_remove_trash_entry(MockTestImageCtx & mock_image_ctx,
                ...
                EXPECT_CALL(get_mock_io_ctx(mock_image_ctx.md_ctx),
                            exec(StrEq("rbd_trash"), _, StrEq("rbd"),
                                 StrEq("trash_remove"), ContentsEqual(in_bl), _,
                                 _, _))
                    .WillOnce(Return(r));
            }
        };
        ...
        TEST_F(TestMockTrashRemoveRequest, Success) {
            ...
            C_SaferCond ctx;
            auto req =
                MockRemoveRequest::create(mock_image_ctx.md_ctx,
                                          &mock_image_ctx,
