...
public:
    ...
    typedef boost::variant < Read,
            Discard,
            Write, WriteSame, CompareAndWrite, Flush, ListSnaps > Request;
    ...
    static ImageDispatchSpec * create_read(ImageCtxT &image_ctx,
                                           ImageDispatchLayer
                                           ...
                                           Trace &parent_trace)
    {
        ...
        Read {
            std::move(read_result), read_flags}
        ,
        io_context, op_flags,
        parent_trace);
    }
    ...
    template < typename ImageCtxT = ImageCtx >
    static ImageDispatchSpec * create_discard(ImageCtxT &image_ctx,
            ImageDispatchLayer
            image_dispatch_layer,
            AioCompletion *
            aio_comp, Extents
    ...
    template < typename ImageCtxT = ImageCtx >
    static ImageDispatchSpec * create_write(ImageCtxT &image_ctx,
                                            ImageDispatchLayer
                                            image_dispatch_layer,
                                            AioCompletion *aio_comp,
                                            Extents
    ...
    template < typename ImageCtxT = ImageCtx >
    static ImageDispatchSpec * create_write_same(ImageCtxT &
            image_ctx,
            ImageDispatchLayer
            image_dispatch_layer,
            AioCompletion *
    ...
    template < typename ImageCtxT = ImageCtx >
    static ImageDispatchSpec * create_compare_and_write(ImageCtxT &
            image_ctx,
            ImageDispatchLayer
            image_dispatch_layer,
            AioCompletion
    ...
    template < typename ImageCtxT = ImageCtx >
    static ImageDispatchSpec * create_flush(ImageCtxT &image_ctx,
                                            ImageDispatchLayer
                                            image_dispatch_layer,
                                            AioCompletion *aio_comp,
                                            FlushSource flush_source,
    ...
    template < typename ImageCtxT = ImageCtx >
    static ImageDispatchSpec * create_list_snaps(ImageCtxT &
            image_ctx,
            ImageDispatchLayer
            image_dispatch_layer,
            AioCompletion *
...
private:
    ...
    ImageDispatchSpec(ImageDispatcherInterface *image_dispatcher,
                      ...
                      && image_extents, ImageArea area, Request
