...
class PipelineHandle
{
    ...
    std::optional < seastar::future < >> do_enter_maybe_sync(
        T &stage,
    ...
    template < typename OpT, typename T >
    std::optional < seastar::future < >> enter_maybe_sync(T &stage, typename T::BlockingEvent::template Trigger < OpT > &&
            t)
    {
...
public:
     ...
     */
    template < typename OpT, typename T >
    void enter_sync(T &stage, typename T::BlockingEvent::template Trigger < OpT > && t)
    {
