...
namespace librbd {
    ...
    } // namespace image namespace trash {
    ...
    namespace image {
        ...
        class TestMockImageDetachChildRequest:public TestMockFixture {
          public:
            ...
            typedef trash::RemoveRequest < MockTestImageCtx >
            ...
            } void expect_test_op_features(MockTestImageCtx & mock_image_ctx,
                                           bool enabled) {
                    ...
                    WillOnce(DoAll
                             (GetReference(*io_ctx_impl),
                              Return(*io_ctx_impl)));
                                       ...
                                       librados::
                                       MockTestMemIoCtxImpl & mock_io_ctx_impl,
                                       int r) {
            ...
            void expect_snap_remove(MockImageCtx & mock_image_ctx,
                ...
                EXPECT_CALL(*mock_image_ctx.operations, snap_remove( {
                                                                    cls::rbd::
            ...
            void expect_trash_remove(MockTrashRemoveRequest &
                                     mock_trash_remove_request, int r) {
                EXPECT_CALL(mock_trash_remove_request, send())
                    .WillOnce(Invoke([&mock_trash_remove_request, r] () {
                                     mock_trash_remove_request.on_finish->
                                     complete(r);}));
            }
        ...
        TEST_F(TestMockImageDetachChildRequest, TrashedSnapshotSuccess) {
            ...
            const cls::rbd::TrashImageSpec trash_spec;
            expect_trash_get(mock_image_ctx, *mock_io_ctx_impl, trash_spec,
                             -ENOENT);
