...
namespace librbd {
    ...
    class ImageUpdateWatchers {
      public:
        ...
        ImageUpdateWatchers(CephContext * cct):m_cct(cct),
            m_lock(util::
                   unique_lock_name("librbd::ImageUpdateWatchers::m_lock",
                                    this)) {
        } ~ImageUpdateWatchers() {
            ...
            int r = 0;
            {
                ...
                if (it == m_watchers.end()) {
                    ...
                    if (m_in_flight.find(handle) != m_in_flight.end()) {
                        assert(m_pending_unregister.find(handle) ==
        ...
        void send_notify(uint64_t handle, UpdateWatchCtx * watcher) {
            ...
            Context *ctx = new FunctionContext([this, handle, watcher] (int r){
  ...
  :    
    ...
    template < typename I > int ImageState < I >::open(bool skip_open_parent) {
        C_SaferCond ctx;
    ...
    template < typename I >
        void ImageState < I >::open(bool skip_open_parent,
                                    Context * on_finish) {
    ...
    template < typename I >
        void ImageState <
        I >::snap_set(const cls::rbd::SnapshotNamespace & snap_namespace,
    ...
    template < typename I > void ImageState < I >::send_open_unlock() {
        ...
        Context *ctx =
            create_async_context_callback(*m_image_ctx,
                                          ...
                                          I >,
                                          &ImageState < I >::handle_open >
                                          (this));
        image::OpenRequest < I > *req =
            image::OpenRequest < I >::create(m_image_ctx,
                                             m_skip_open_parent_image, ctx);
    ...
    template < typename I > void ImageState < I >::send_set_snap_unlock() {
        ...
        image::SetSnapRequest < I > *req =
            image::SetSnapRequest < I >::create(*m_image_ctx,
                                                action_contexts.first.
                                                snap_namespace,
                                                action_contexts.first.snap_name,
                                                ctx);
