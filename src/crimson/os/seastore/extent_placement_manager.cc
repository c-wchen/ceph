...
SegmentedOolWriter::alloc_write_iertr::future < > SegmentedOolWriter::do_write(
    Transaction& t,
...
device_stats_t ExtentPlacementManager::get_device_stats(
...
seastar::future < > ExtentPlacementManager::BackgroundProcess::reserve_projected_usage(
    io_usage_t usage)
{
    if (!is_ready()) {
        return seastar::now();
...
void ExtentPlacementManager::BackgroundProcess::maybe_wake_blocked_io()
{
    if (!is_ready()) {
        return;
    }
...
reserve_cleaner_result_t ExtentPlacementManager::BackgroundProcess::try_reserve_cleaner(
...
reserve_io_result_t ExtentPlacementManager::BackgroundProcess::try_reserve_io(
