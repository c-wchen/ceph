...
namespace rbd {
    namespace mirror {
        namespace image_sync {
            ...
            template < typename ImageCtxT = librbd::ImageCtx >
              ...
              public:
                static SnapshotCreateRequest *create(ImageCtxT *
                                                     local_image_ctx,
                                                     const std::
                                                     string & snap_name,
                                                     const cls::rbd::
                                                     ...
                                                     Context * on_finish) {
                    return new SnapshotCreateRequest(local_image_ctx, snap_name,
                                                     snap_namespace, size,
                                                     parent_spec,
   ...
   */
    ...
    // namespace rbd
    extern template class rbd::mirror::image_sync::SnapshotCreateRequest <
    librbd::ImageCtx >;
