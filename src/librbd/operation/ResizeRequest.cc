...
namespace librbd {
    namespace operation {
        ...
        template < typename I > void ResizeRequest < I >::send_flush_cache() {
            ...
            RWLock::RLocker owner_locker(image_ctx.owner_lock);
            image_ctx.
                flush_cache(create_async_context_callback
                            (image_ctx,
                             create_context_callback < ResizeRequest < I >,
                             &ResizeRequest < I >::handle_flush_cache >
                             (this)));
        }
        ...
        template < typename I >
            ...
            RWLock::RLocker owner_locker(image_ctx.owner_lock);
            image_ctx.invalidate_cache(false,
        ...
        template < typename I > void ResizeRequest < I >::send_update_header() {
            ...
            if (image_ctx.old_format) {
                ...
                bufferlist bl;
                bl.append(reinterpret_cast < const char *>(&m_new_size),
                          sizeof(m_new_size));
        ...
        template < typename I >
            ...
            if (image_ctx.parent == NULL) {
                ...
                m_new_parent_overlap =
                    MIN(m_new_size, image_ctx.parent_md.overlap);
            }
        }
