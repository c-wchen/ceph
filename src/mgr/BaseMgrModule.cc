...
static PyObject *ceph_set_health_checks(BaseMgrModule *self,
                                        PyObject *args)
{
...
static PyObject *ceph_state_get(BaseMgrModule *self,
                                PyObject *args)
{
    char *what = NULL;
    if (!PyArg_ParseTuple
...
static PyObject *ceph_get_server(BaseMgrModule *self,
                                 PyObject *args)
{
    char *hostname = NULL;
    if (!PyArg_ParseTuple
...
static PyObject *ceph_get_mgr_id(BaseMgrModule *self,
                                 PyObject *args)
{
...
static PyObject *ceph_option_get(BaseMgrModule *self,
                                 PyObject *args)
{
    char *what = nullptr;
    if (!PyArg_ParseTuple
...
static PyObject *ceph_foreign_option_get(BaseMgrModule *self,
        PyObject *args)
{
    char *who = nullptr;
    char *what = nullptr;
...
static PyObject *ceph_get_module_option(BaseMgrModule *self,
                                        PyObject *args)
{
    char *module = nullptr;
    char *key = nullptr;
...
static PyObject *ceph_store_get_prefix(BaseMgrModule *self,
                                       PyObject *args)
{
    char *prefix = nullptr;
    if (!PyArg_ParseTuple
...
static PyObject *ceph_set_module_option(BaseMgrModule *self,
                                        PyObject *args)
{
    char *module = nullptr;
    char *key = nullptr;
...
static PyObject *ceph_store_get(BaseMgrModule *self,
                                PyObject *args)
{
    char *what = nullptr;
    if (!PyArg_ParseTuple
...
static PyObject *ceph_store_set(BaseMgrModule *self,
                                PyObject *args)
{
    char *key = nullptr;
    char *value = nullptr;
...
static PyObject *get_metadata(BaseMgrModule *self,
                              PyObject *args)
{
    char *svc_name = NULL;
    char *svc_id = NULL;
...
static PyObject *get_daemon_status(BaseMgrModule *self,
                                   PyObject *args)
{
    char *svc_name = NULL;
    char *svc_id = NULL;
...
static PyObject *ceph_log(BaseMgrModule *self,
                          PyObject *args)
{
    char *record = nullptr;
    if (!PyArg_ParseTuple
...
static PyObject *ceph_cluster_log(BaseMgrModule *self,
                                  PyObject *args)
{
    int prio = 0;
...
static PyObject *ceph_get_version(BaseMgrModule *self,
                                  PyObject *args)
{
    return
...
static PyObject *ceph_get_ceph_conf_path(BaseMgrModule *self,
        PyObject *args)
{
...
static PyObject *ceph_get_release_name(BaseMgrModule *self,
                                       PyObject *args)
{
    return
...
static PyObject *ceph_lookup_release_name(BaseMgrModule *
        self,
        PyObject *args)
{
    int major = 0;
...
static PyObject *get_counter(BaseMgrModule *self,
                             PyObject *args)
{
...
static PyObject *get_latest_counter(BaseMgrModule *self,
                                    PyObject *args)
{
    char *svc_name = nullptr;
    char *svc_id = nullptr;
...
static PyObject *get_perf_schema(BaseMgrModule *self,
                                 PyObject *args)
{
...
static PyObject *ceph_get_rocksdb_version(BaseMgrModule *
        self)
{
    return self->py_modules->
           get_rocksdb_version();
...
static PyObject *ceph_get_osdmap(BaseMgrModule *self,
                                 PyObject *args)
{
    return self->py_modules->get_osdmap();
}

static PyObject *ceph_set_uri(BaseMgrModule *self,
                              PyObject *args)
{
...
static PyObject *ceph_set_wear_level(BaseMgrModule *self,
                                     PyObject *args)
{
    char *devid = nullptr;
    float wear_level;
...
static PyObject *ceph_have_mon_connection(BaseMgrModule *
        self,
        PyObject *args)
{
...
static PyObject *ceph_update_progress_event(BaseMgrModule *
        self,
        PyObject *args)
{
    char *evid = nullptr;
...
static PyObject *ceph_complete_progress_event(BaseMgrModule *
        self,
        PyObject *
        args)
{
...
static PyObject *ceph_clear_all_progress_events(BaseMgrModule
        * self,
        PyObject *
        args)
{
...
static PyObject *ceph_dispatch_remote(BaseMgrModule *self,
                                      PyObject *args)
{
...
static PyObject *ceph_add_osd_perf_query(BaseMgrModule *self,
        PyObject *args)
{
    static const std::
...
static PyObject *ceph_remove_osd_perf_query(BaseMgrModule *
        self,
        PyObject *args)
{
...
static PyObject *ceph_get_osd_perf_counters(BaseMgrModule *
        self,
        PyObject *args)
{
    MetricQueryID query_id;
...
static PyObject *ceph_add_mds_perf_query(BaseMgrModule *self,
        PyObject *args)
{
    static const std::
    string NAME_KEY_DESCRIPTOR =
...
static PyObject *ceph_remove_mds_perf_query(BaseMgrModule *
        self,
        PyObject *args)
{
    MetricQueryID query_id;
...
static PyObject *ceph_get_mds_perf_counters(BaseMgrModule *
        self,
        PyObject *args)
{
    MetricQueryID query_id;
...
static PyObject *ceph_is_authorized(BaseMgrModule *self,
                                    PyObject *args)
{
...
static PyObject *ceph_register_client(BaseMgrModule *self,
                                      PyObject *args)
{
    char *addrs = nullptr;
    if (!PyArg_ParseTuple
...
static PyObject *ceph_unregister_client(BaseMgrModule *self,
                                        PyObject *args)
{
    char *addrs = nullptr;
    if (!PyArg_ParseTuple
...
static PyObject *ceph_get_daemon_health_metrics(BaseMgrModule
        * self,
        PyObject *
        args)
{
...
static PyObject *BaseMgrModule_new(PyTypeObject *type,
                                   PyObject *args,
                                   PyObject *kwds)
{
    BaseMgrModule *self;
...
static int BaseMgrModule_init(BaseMgrModule *self,
                              PyObject *args,
                              PyObject *kwds)
{
