...
namespace librbd {
    ...
    namespace managed_lock {
        ...
        :m_ioctx(ioctx), m_watcher(watcher),
            ...
            m_on_finish(new C_AsyncCallback < ContextWQ >
        ...
        template < typename I > void AcquireRequest < I >::send_lock() {
            ...
            rados::cls::lock::lock(&op, RBD_LOCK_NAME,
                                   ...
                                   m_cookie, util::get_watcher_lock_tag(), "",
                                   utime_t(), 0);
        ...
        template < typename I > void AcquireRequest < I >::send_break_lock() {
            ...
            auto req =
                BreakRequest < I >::create(m_ioctx, m_work_queue, m_oid,
                                           m_locker, m_exclusive,
                                           m_blacklist_on_break_lock,
                                           m_blacklist_expire_seconds, false,
                                           ctx);
            req->send();
        }
