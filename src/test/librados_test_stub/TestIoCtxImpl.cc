...
namespace librados {
    ...
    :m_client(rhs.m_client),
        ...
        m_pool_name(rhs.m_pool_name), m_snap_seq(rhs.m_snap_seq) {
        m_client->get();
        get();
    }
    ...
    void TestIoCtxImpl::aio_notify(const std::string & oid,
        ...
        m_client->get_watch_notify()->aio_notify(m_client, oid, bl, timeout_ms,
                                                 pbl, ctx);
    }
    ...
    int TestIoCtxImpl::aio_operate(const std::string & oid,
        ...
        m_client->add_aio_operation(oid, true,
                                    boost::bind(&TestIoCtxImpl::
                                                execute_aio_operations, this,
                                                oid, &ops,
                                                reinterpret_cast <
                                                bufferlist * >(0),
                                                snap_context !=
    ...
    int TestIoCtxImpl::aio_watch(const std::string & o, AioCompletionImpl * c,
        ...
        if (m_client->is_blacklisted()) {
            ...
            m_client->get_watch_notify()->aio_watch(m_client, o,
    ...
    int TestIoCtxImpl::exec(const std::string & oid, TestClassHandler * handler,
        ...
        return (*call) (reinterpret_cast < cls_method_context_t >
                        (handler->get_method_context(this, oid, snapc).get()),
                        &inbl, outbl);
    }
    ...
    int TestIoCtxImpl::notify(const std::string & o, bufferlist & bl,
        ...
        return m_client->get_watch_notify()->notify(m_client, o, bl, timeout_ms,
                                                    pbl);
    }
    ...
    int TestIoCtxImpl::watch(const std::string & o, uint64_t * handle,
        ...
        return m_client->get_watch_notify()->watch(m_client, o,
                                                   get_instance_id(), handle,
                                                   ctx, ctx2);
    }
