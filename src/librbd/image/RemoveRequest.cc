...
namespace librbd {
    namespace image {
        ...
        using util::create_rados_callback;
         ...
         template < typename I >
            RemoveRequest < I >::RemoveRequest(IoCtx & ioctx,
        ...
        :m_ioctx(ioctx), m_image_name(image_name), m_image_id(image_id),
            ...
            m_image_ctx =
                I::create((m_image_id.empty()? m_image_name : std::string()),
        ...
        template < typename I >
            ...
            if (r < 0) {
                ...
                if (r != -ENOENT) {
                    lderr(m_cct) << "error opening image: " << cpp_strerror(r)
                        << dendl;
                    finish(r);
                    return;
                }
        ...
        template < typename I > void RemoveRequest < I >::check_exclusive_lock() {
            ldout(m_cct, 20) << dendl;
        ...
        template < typename I >
            ...
            if (r < 0 || !m_image_ctx->exclusive_lock->is_lock_owner()) {
                lderr(m_cct) << "cannot obtain exclusive lock - not removing" <<
                    dendl;
        ...
        template < typename I > void RemoveRequest < I >::check_image_snaps() {
            ldout(m_cct, 20) << dendl;
        ...
        template < typename I > void RemoveRequest < I >::list_image_watchers() {
            ldout(m_cct, 20) << dendl;
            ...
            librados::AioCompletion * rados_completion =
                ...
                &klass::handle_list_image_watchers > (this);

            int r =
                m_image_ctx->md_ctx.aio_operate(m_header_oid, rados_completion,
                                                &op, &m_out_bl);
            assert(r == 0);
        ...
        template < typename I >
            ...
            if (r < 0) {
                lderr(m_cct) << "error listing image watchers: " <<
                    cpp_strerror(r)
                    << dendl;
                send_close_image(r);
                return;
        ...
        template < typename I > void RemoveRequest < I >::get_mirror_image() {
            ldout(m_cct, 20) << dendl;
            if ((m_watchers.empty()) ||
        ...
        template < typename I > void RemoveRequest < I >::list_mirror_watchers() {
            ldout(m_cct, 20) << dendl;
            ...
            librados::AioCompletion * rados_completion =
                create_rados_callback < klass,
                &klass::handle_list_mirror_watchers > (this);
            m_out_bl.clear();
            int r =
                m_image_ctx->md_ctx.aio_operate(RBD_MIRRORING, rados_completion,
                                                &op, &m_out_bl);
            assert(r == 0);
            rados_completion->release();
        }
        ...
        template < typename I > void RemoveRequest < I >::check_image_watchers() {
        ...
        template < typename I > void RemoveRequest < I >::check_group() {
            ldout(m_cct, 20) << dendl;
        ...
        template < typename I > void RemoveRequest < I >::trim_image() {
            ...
            auto req =
                librbd::operation::TrimRequest < I >::create(*m_image_ctx, ctx,
                                                             m_image_ctx->size,
                                                             0, m_prog_ctx);
            req->send();
        }
        ...
        template < typename I > void RemoveRequest < I >::remove_child() {
            ldout(m_cct, 20) << dendl;
            ...
            int r =
                m_image_ctx->md_ctx.aio_operate(RBD_CHILDREN, rados_completion,
                                                &op);
            assert(r == 0);
            rados_completion->release();
        }
        ...
        template < typename I > void RemoveRequest < I >::send_disable_mirror() {
            ...
            mirror::DisableRequest < I > *req =
                mirror::DisableRequest < I >::create(m_image_ctx, m_force,
                                                     !m_force, ctx);
            req->send();
        }
        ...
        template < typename I > void RemoveRequest < I >::remove_header() {
            ...
            librados::AioCompletion * rados_completion =
                create_rados_callback < klass,
                &klass::handle_remove_header > (this);
        ...
        template < typename I >
            ...
            if (r < 0 && r != -ENOENT) {
                lderr(m_cct) << "error removing header: " << cpp_strerror(r) <<
                    dendl;
                m_ret_val = r;
            }
        ...
        template < typename I > void RemoveRequest < I >::remove_header_v2() {
            ...
            librados::AioCompletion * rados_completion =
                create_rados_callback < klass,
                &klass::handle_remove_header_v2 > (this);
            int r = m_ioctx.aio_remove(m_header_oid, rados_completion);
            assert(r == 0);
            rados_completion->release();
        }
        ...
        template < typename I > void RemoveRequest < I >::send_journal_remove() {
            ...
            journal::RemoveRequest < I > *req =
                journal::RemoveRequest < I >::create(m_ioctx, m_image_id,
                                                     Journal <>::
                                                     IMAGE_CLIENT_ID,
                                                     m_op_work_queue, ctx);
            req->send();
        ...
        template < typename I >
            ...
            if (r < 0 && r != -ENOENT) {
                lderr(m_cct) << "failed to remove image journal: " <<
                    cpp_strerror(r)
                    << dendl;
                finish(r);
                return;
        ...
        template < typename I >
            ...
            librados::AioCompletion * rados_completion =
                create_rados_callback < klass,
                &klass::handle_object_map_remove > (this);
        ...
        template < typename I > void RemoveRequest < I >::mirror_image_remove() {
            ...
            librados::AioCompletion * rados_completion =
                create_rados_callback < klass,
                &klass::handle_mirror_image_remove > (this);
        ...
        template < typename I > void RemoveRequest < I >::dir_get_image_id() {
            ...
            librados::AioCompletion * rados_completion =
                create_rados_callback < klass,
                &klass::handle_dir_get_image_id > (this);
            m_out_bl.clear();
            int r =
                m_ioctx.aio_operate(RBD_DIRECTORY, rados_completion, &op,
                                    &m_out_bl);
            assert(r == 0);
            rados_completion->release();
        }
        ...
        template < typename I > void RemoveRequest < I >::dir_get_image_name() {
            ...
            librados::AioCompletion * rados_completion =
                create_rados_callback < klass,
                &klass::handle_dir_get_image_name > (this);
            m_out_bl.clear();
            int r =
                m_ioctx.aio_operate(RBD_DIRECTORY, rados_completion, &op,
                                    &m_out_bl);
        ...
        template < typename I >
            ...
            if (r == 0) {
                bufferlist::iterator iter = m_out_bl.begin();
                r = librbd::cls_client::dir_get_name_finish(&iter,
                                                            &m_image_name);
                if (r < 0) {
                    finish(r);
                    return;
        ...
        template < typename I > void RemoveRequest < I >::remove_id_object() {
            ...
            int r =
                m_ioctx.aio_remove(util::id_obj_name(m_image_name),
                                   rados_completion);
            assert(r == 0);
            rados_completion->release();
        }
        ...
        template < typename I > void RemoveRequest < I >::dir_remove_image() {
            ...
            librados::AioCompletion * rados_completion =
                create_rados_callback < klass,
                &klass::handle_dir_remove_image > (this);
