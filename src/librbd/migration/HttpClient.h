...
public:
    ...
    static HttpClient *create(ImageCtxT *image_ctx,
               ...
               Completion && completion)
    {
        struct WorkImpl: Work {
            ...
            void operator()(boost::beast::ssl_stream <
...
private:
    ...
    struct Work: public std::enable_shared_from_this < Work > {
        ...
        virtual void operator()(boost::beast::ssl_stream <
    ...
    void handle_read(int r, Response && response, uint64_t byte_offset,
                     uint64_t byte_length, bufferlist *data,
                     Context *on_finish);
