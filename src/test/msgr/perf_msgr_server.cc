  ...
  public:
    ServerDispatcher(int threads, uint64_t delay):Dispatcher(g_ceph_context),
        think_time(delay), op_tp(g_ceph_context, "ServerDispatcher::op_tp",
                                 ...
                                 "serverdispatcher_op_threads"), op_wq(30, 30,
                                                                       &op_tp) {
        op_tp.start();
    }
...
class MessengerServer {
  ...
  public:
     MessengerServer(string t, string addr, int threads, int delay):msgr(NULL),
        type(t), bindaddr(addr), dispatcher(threads, delay) {
        msgr =
