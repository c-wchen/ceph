...
namespace librbd {
    ...
    template < typename I >
        ...
        AcquireRequest < I > *req =
            AcquireRequest < I >::create(m_ioctx, m_watcher, m_work_queue,
