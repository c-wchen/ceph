    ...
    namespace api {
        ...
        template < typename ImageCtxT = librbd::ImageCtx > struct Mirror {
            typedef std::map < std::string,
                mirror_image_status_t > IdToMirrorImageStatus;
            ...
            static int peer_remove(librados::IoCtx & io_ctx,
                                   const std::string & uuid);
            static int peer_list(librados::IoCtx & io_ctx,
                                 std::vector < mirror_peer_t > *peers);
            static int peer_set_client(librados::IoCtx & io_ctx,
                                       const std::string & uuid,
                                       const std::string & client_name);
            static int peer_set_cluster(librados::IoCtx & io_ctx,
                                        const std::string & uuid,
                                        const std::string & cluster_name);
            ...
            static int image_get_status(ImageCtxT * ictx,
                                        mirror_image_status_t * status,
                                        size_t status_size);
            static void image_get_status(ImageCtxT * ictx,
                                         mirror_image_status_t * status,
                                         size_t status_size,
                                         Context * on_finish);
