...
class tri_mutex:private read_lock,
    write_lock,
    excl_lock, excl_lock_from_read, excl_lock_from_write, excl_lock_from_excl {
  public:
    tri_mutex() = default;
    ~tri_mutex();
    ...
    // for shared writers seastar::future <> lock_for_write(bool greedy);
    ...
    // for exclusive users seastar::future <> lock_for_excl();
