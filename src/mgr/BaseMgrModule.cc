...
static PyObject *ceph_send_command(BaseMgrModule * self, PyObject * args)
{
    ...
    if (std::string(type) == "mon") {
        ...
        ceph_tid_t tid;
        self->py_modules->get_objecter().osd_command(osd_id, {
                                                     cmd_json}
                                                     , {
                                                     }
                                                     ,
        ...
        int r = self->py_modules->get_client().mds_command(name,
                                                           { cmd_json },
                                                           { },
                                                           &c->outbl,
                                                           &c->outs,
        ...
        ceph_tid_t tid;
        self->py_modules->get_objecter().pg_command(pgid, {
                                                    cmd_json}
                                                    , {
                                                    }
                                                    ,
...
static PyObject *ceph_config_get(BaseMgrModule * self, PyObject * args)
{
    char *what = nullptr;
    ...
    if (found) {
        dout(10) << "ceph_config_get " << what << " found: " << value.
            c_str() << dendl;
...
static PyObject *ceph_config_get_prefix(BaseMgrModule * self, PyObject * args)
{
    char *prefix = nullptr;
...
static PyObject *ceph_config_set(BaseMgrModule * self, PyObject * args)
{
    char *key = nullptr;
    char *value = nullptr;
...
static PyObject *ceph_get_context(BaseMgrModule * self, PyObject * args)
{
...
PyMethodDef BaseMgrModule_methods[] = {
    ...
    {"_ceph_get_config_prefix", (PyCFunction) ceph_config_get_prefix,
     METH_VARARGS,
...
static PyObject *BaseMgrModule_new(PyTypeObject * type, PyObject * args,
                                   PyObject * kwds)
{
    BaseMgrModule *self;
...
BaseMgrModule_init(BaseMgrModule * self, PyObject * args, PyObject * kwds)
{
    ...
    self->py_modules =
        (ActivePyModules *) PyCapsule_GetPointer(py_modules_capsule, nullptr);
    assert(self->py_modules);
    self->this_module =
        (ActivePyModule *) PyCapsule_GetPointer(this_module_capsule, nullptr);
    assert(self->this_module);
