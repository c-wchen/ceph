...
namespace journal {
    ...
    namespace mirror {
      ...
      } template < typename ImageCtxT = librbd::ImageCtx > class ImageSync:public BaseRequest
        {
          public:
            ...
            static ImageSync *create(ImageCtxT * local_image_ctx,
                ...
                return new ImageSync(local_image_ctx, remote_image_ctx, timer,
                                     timer_lock, mirror_uuid, journaler,
                                     client_meta, work_queue, instance_watcher,
                                     on_finish, progress_ctx);
            } ImageSync(ImageCtxT * local_image_ctx,
   ...
   */
            ...
            bool m_canceled = false;
             ...
             image_sync::SnapshotCopyRequest < ImageCtxT >
