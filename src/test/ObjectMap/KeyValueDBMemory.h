...
class KeyValueDBMemory:public KeyValueDB {
  public:
    ...
    int get_keys(const std::string & prefix,
                 const std::set < std::string > &key,
                 std::set < std::string > *out);

    int set(const std::string & prefix,
            const std::string & key, const bufferlist & bl);

    int rmkey(const std::string & prefix, const std::string & key);

    int rmkeys_by_prefix(const std::string & prefix);

    int rm_range_keys(const std::string & prefix,
    ...
    class TransactionImpl_:public TransactionImpl {
      public:
        ...
        struct RmRangeKeys:public Context {
            ...
            RmRangeKeys(KeyValueDBMemory * db, const std::string & prefix,
