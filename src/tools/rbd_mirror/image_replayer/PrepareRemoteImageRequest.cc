    ...
    namespace mirror {
        namespace image_replayer {
            ...
            using librbd::util::create_rados_callback;
             ...
             template < typename I >
                ...
                librados::AioCompletion * aio_comp = create_rados_callback <
                    ...
                    I >::handle_get_remote_mirror_uuid > (this);
                int r =
                ...
                I >::handle_get_remote_mirror_uuid(int r) {
                if (r >= 0) {
                ...
                if (r < 0) {
                    if (r == -ENOENT) {
                        ...
                        derr << "failed to retrieve remote mirror uuid: " <<
                            cpp_strerror(r)
                            << dendl;
                    }
                    finish(r);
            ...
            template < typename I >
                ...
                *m_remote_journaler =
                    new Journaler(m_threads->work_queue, m_threads->timer,
                ...
                Context *ctx =
                    create_async_context_callback(m_threads->work_queue,
                                                  ...
                                                  I >::handle_get_client >
                                                  (this));
                (*m_remote_journaler)->get_client(m_local_mirror_uuid,
                                                  &m_client, ctx);
            }
            ...
            template < typename I >
                ...
                try {
                    ...
                    derr << "failed to decode client meta data: " << err.
                        what() << dendl;
                    return false;
                }
                ...
                *m_client_meta = *client_meta;
                dout(20) << "client found: client_meta=" << *m_client_meta <<
                    dendl;
                return true;
            }
