...
public:
    ...
    void copy_bl_to_buffer(WriteRequestResources *resources,
                           std::unique_ptr <
...
protected:
    ...
    void schedule_flush_and_append(pwl::
    ...
    void write_data_to_buffer(std::shared_ptr <
...
// namespace librbd
extern template class librbd::cache::pwl::rwl::WriteLog <
    librbd::ImageCtx >;
