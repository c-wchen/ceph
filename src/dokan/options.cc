...
void print_usage()
{
    const char *usage_str = R "(
                        ...
                        --win - vol - name arg          The Windows volume name. Default:
                            Ceph - <fs_name>.
                        --win - vol - serial arg        The Windows volume serial number. Default:
                            <fs_id>.
        ...
        if (ceph_argparse_flag(args, i, "-h", "--help", (char *)NULL)) {
            ...
            *command = Command::Version;
            ...
            cfg->removable = true;
                   ...
                   (args, i, "--win-mount-mgr", "-o", (char *)NULL)) {
            ...
            cfg->file_mode = mode;
                   ...
                   (args, i, &dir_mode, "--dir-mode", (char *)NULL)) {
            ...
            cfg->dir_mode = mode;
                   ...
                   (args, i, "--current-session-only", (char *)NULL)) {
