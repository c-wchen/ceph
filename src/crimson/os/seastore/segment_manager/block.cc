...
write_ertr::future <> SegmentStateTracker::write_out(device_id_t device_id,
        seastar::file &device,
        uint64_t offset)
{
...
write_ertr::future <> SegmentStateTracker::read_in(device_id_t device_id,
...
static
BlockSegmentManager::access_ertr::future <> write_superblock(device_id_t device_id,
...
static
BlockSegmentManager::access_ertr::future < block_sm_superblock_t > read_superblock(seastar::file &device,
