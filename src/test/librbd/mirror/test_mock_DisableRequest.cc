...
namespace librbd {
    ...
    namespace journal {
        ...
        PromoteRequest < librbd::MockTestImageCtx > *PromoteRequest <
    ...
    namespace mirror {
        ...
        ImageStateUpdateRequest < librbd::MockTestImageCtx >
            *ImageStateUpdateRequest < librbd::MockTestImageCtx >::s_instance =
            nullptr;
    ...
    namespace mirror {
        ...
        class TestMockMirrorDisableRequest:public TestMockFixture {
          public:
            ...
            typedef journal::PromoteRequest < MockTestImageCtx >
                MockJournalPromoteRequest;
            typedef mirror::GetInfoRequest < MockTestImageCtx >
                MockGetInfoRequest;
            typedef mirror::ImageRemoveRequest < MockTestImageCtx >
                ...
                EXPECT_CALL(mock_get_info_request, send())
                    ...
                    WillOnce(Invoke
                             ([&mock_image_ctx, &mock_get_info_request,
                               mirror_image, promotion_state, r] () {
                              if (r == 0) {
                              *mock_get_info_request.mirror_image =
                              mirror_image;
                              *mock_get_info_request.promotion_state =
                              promotion_state;} mock_image_ctx.op_work_queue->
                              queue(mock_get_info_request.on_finish, r);}
                             )) ;
            } void expect_mirror_image_state_update(MockTestImageCtx &
                                                    mock_image_ctx,
                                                    MockImageStateUpdateRequest
                                                    & mock_request, int r) {
            ...
            void expect_mirror_image_remove(MockTestImageCtx & mock_image_ctx,
                                            MockImageRemoveRequest &
                                            mock_request, int r) {
                EXPECT_CALL(mock_request, send())
                    .WillOnce(Invoke([&mock_image_ctx, &mock_request, r] () {
            ...
            void expect_journal_client_list(MockTestImageCtx & mock_image_ctx,
                ...
                EXPECT_CALL(get_mock_io_ctx(mock_image_ctx.md_ctx),
                            exec(::journal::Journaler::
                                 header_oid(mock_image_ctx.id), _,
                                 StrEq("journal"), StrEq("client_list"), _, _,
                                 _, _))
                    .
                    WillOnce(DoAll
                             (WithArg < 5 > (CopyInBufferlist(bl)), Return(r)));
            }

            void expect_journal_client_unregister(MockTestImageCtx &
                                                  mock_image_ctx,
            ...
            void expect_journal_promote(MockTestImageCtx & mock_image_ctx,
                                        MockJournalPromoteRequest &
                                        mock_promote_request, int r) {
                EXPECT_CALL(mock_promote_request, send())
                    .
                    WillOnce(FinishRequest
                             (&mock_promote_request, r, &mock_image_ctx));
            }
            ...
            void expect_snap_remove(MockTestImageCtx & mock_image_ctx,
                ...
                EXPECT_CALL(*mock_image_ctx.operations,
                            snap_remove(_, StrEq(snap_name), _))
                    .WillOnce(WithArg < 2 >
                              (CompleteContext
                               (r, mock_image_ctx.image_ctx->op_work_queue)));
            }
        ...
        TEST_F(TestMockMirrorDisableRequest, Success) {
            ...
            expect_journal_client_list(mock_image_ctx, {
                                       ...
                                       , {
                                       "peer 2", encode(journal::ClientData {
                                                        journal::
                                                        MirrorPeerClientMeta {
                                                        "remote image id", { {
                                                        cls::rbd::
            ...
            expect_mirror_image_remove(mock_image_ctx,
                                       mock_image_remove_request, 0);

            C_SaferCond ctx;
            auto req =
                new MockDisableRequest(&mock_image_ctx, false, true, &ctx);
            req->send();
        ...
        TEST_F(TestMockMirrorDisableRequest, SuccessNoRemove) {
            ...
            C_SaferCond ctx;
            auto req =
                new MockDisableRequest(&mock_image_ctx, false, false, &ctx);
            req->send();
            ASSERT_EQ(0, ctx.wait());
        }
        ...
        TEST_F(TestMockMirrorDisableRequest, SuccessNonPrimary) {
            ...
            C_SaferCond ctx;
            auto req =
                new MockDisableRequest(&mock_image_ctx, true, true, &ctx);
            req->send();
            ASSERT_EQ(0, ctx.wait());
        }
        ...
        TEST_F(TestMockMirrorDisableRequest, JournalPromoteError) {
            ...
            expect_mirror_image_state_update(mock_image_ctx,
                                             mock_image_state_update_request,
                                             0);
            expect_journal_promote(mock_image_ctx, mock_promote_request,
                                   -EPERM);
        ...
        TEST_F(TestMockMirrorDisableRequest, SnapshotPromoteError) {
            ...
            expect_mirror_image_state_update(mock_image_ctx,
                                             mock_image_state_update_request,
                                             0);
            expect_snapshot_promote(mock_image_ctx, mock_promote_request,
                                    -EPERM);
        ...
        TEST_F(TestMockMirrorDisableRequest, MirrorImageRemoveError) {
            ...
            MockImageRemoveRequest mock_image_remove_request;
            expect_mirror_image_remove(mock_image_ctx,
                                       mock_image_remove_request, -EINVAL);
