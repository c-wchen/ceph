...
SegmentedJournal::prep_replay_segments_fut SegmentedJournal::prep_replay_segments(std::vector < std::pair <
        segment_id_t,
...
SegmentedJournal::scan_last_segment_ertr::future <> SegmentedJournal::scan_last_segment(const segment_id_t &segment_id,
        ...
        segment_header)
{
    ...
    return seastar::do_with(scan_valid_records_cursor(seq),
                            SegmentManagerGroup::found_record_handler_t([FNAME, this](record_locator_t locator,
...
SegmentedJournal::replay_ertr::future <> SegmentedJournal::replay_segment(journal_seq_t seq,
...
SegmentedJournal::submit_record_ret SegmentedJournal::do_submit_record(record_t && record,
...
SegmentedJournal::submit_record_ret SegmentedJournal::submit_record(record_t && record,
        OrderingHandle &handle)
{
