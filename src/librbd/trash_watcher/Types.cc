...
} // anonymous namespace void ImageAddedPayload::encode(bufferlist & bl) const {
using ceph::encode;
encode(image_id, bl);
encode(trash_image_spec, bl);
} void ImageAddedPayload::decode(__u8 version,
...
} void ImageRemovedPayload::encode(bufferlist &bl) const
{
    using ceph::encode;
    encode(image_id, bl);
} void ImageRemovedPayload::decode(__u8 version,
                                   bufferlist::const_iterator &iter)
{
    using ceph::decode;
    decode(image_id, iter);
        ...
        NotifyMessage * > &o)
{
    o.push_back(new NotifyMessage {
        ImageAddedPayload {
            "id", {
                cls::rbd::TRASH_IMAGE_SOURCE_USER, "name", {
                }, {
                }
            }}});
    o.push_back(new NotifyMessage {
