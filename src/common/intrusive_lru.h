...
template < typename Config > class intrusive_lru
{
    ...
    using lru_set_option_t = boost::intrusive::member_hook <
                             base_t, boost::intrusive::set_member_hook <>, &base_t::set_hook >;
    ...
    using lru_set_t = boost::intrusive::set <
                      base_t,
                      lru_set_option_t, boost::intrusive::key_of_value < VToKWrapped > >;
    lru_set_t lru_set;
    ...
    using lru_list_t = boost::intrusive::list <
                       ...
                       base_t,
                       boost::intrusive::list_member_hook <>, &base_t::list_hook >>;
    ...
    void evict()
    {
        while (!unreferenced_list.empty() &&
            ...
            lru_set.erase_and_dispose(lru_set.iterator_to(b), [](auto * p) {
                delete p;
            }
                                     );
        }
