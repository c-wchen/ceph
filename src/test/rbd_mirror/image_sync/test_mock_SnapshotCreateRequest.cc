...
template class rbd::mirror::image_sync::SnapshotCreateRequest <
        ...
        namespace image_sync {
            ...
            class TestMockImageSyncSnapshotCreateRequest:public TestMockFixture {
              public:
                ...
                } void expect_set_size(librbd::
                                       MockTestImageCtx & mock_image_ctx,
                                       int r) {
                    EXPECT_CALL(get_mock_io_ctx(mock_image_ctx.md_ctx),
                                exec(mock_image_ctx.header_oid, _, StrEq("rbd"),
                                     StrEq("set_size"), _, _, _))
                        .WillOnce(Return(r));
                }

                void expect_remove_parent(librbd::
                                          MockTestImageCtx & mock_image_ctx,
                                          int r) {
                    EXPECT_CALL(get_mock_io_ctx(mock_image_ctx.md_ctx),
                                exec(mock_image_ctx.header_oid, _, StrEq("rbd"),
            ...
            TEST_F(TestMockImageSyncSnapshotCreateRequest, Resize) {
                ...
                MockSnapshotCreateRequest *request =
                    create_request(mock_local_image_ctx,
                                   "snap1",
                                   cls::rbd::UserSnapshotNamespace(),
                                   123, { }
                                   , 0,
