...
using RGWBucketCreateLocalCR =
    RGWSimpleWriteOnlyAsyncCR < rgw_bucket_create_local_params >;
...
using RGWBucketGetSyncPolicyHandlerCR =
    RGWSimpleAsyncCR < rgw_bucket_get_sync_policy_params,
