...
public:
    ...
    virtual std::unique_ptr < Notification > get_notification(rgw::sal::Object *obj,
            ...
            const std::string *object_name =
                nullptr) override;
    virtual std::unique_ptr < Notification > get_notification(const DoutPrefixProvider *dpp,
            rgw::sal::Object *obj,
            rgw::sal::Object *src_obj,
            rgw::notify::EventType event_type,
...
public:
    ...
    virtual std::unique_ptr < Writer > get_writer(const DoutPrefixProvider *dpp, optional_yield y,
