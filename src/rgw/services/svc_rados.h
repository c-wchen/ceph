...
struct RGWAccessListFilterPrefix: public RGWAccessListFilter {
    ...
    explicit RGWAccessListFilterPrefix(const std::
                                       string &_prefix): prefix(_prefix)
    {
...
private:
    ...
    librados::IoCtx &io_ctx, const OpenParams &params = {
    });
...
public:
    ...
    public:
        ...
        int create(const DoutPrefixProvider *dpp,
                   const std::vector < rgw_pool > &pools,
