        ...
        namespace {
            ...
            std::string get_mon_host(CephContext * cct) {
                ...
                if (auto mon_addrs = cct->get_mon_addrs();
                    ...
                    for (auto it = mon_addrs->begin(); it != mon_addrs->end();
                         ++it) {
                    ...
                    ldout(cct,
                          20) << "falling back to mon_host in conf" << dendl;
            ...
            int create_bootstrap_user(CephContext * cct,
                ...
                int r =
                    get_config_key(rados, RBD_MIRROR_PEER_CLIENT_ID_CONFIG_KEY,
                                   peer_client_id);
                if (r == -EACCES) {
                    ldout(cct,
                          5) <<
                        "insufficient permissions to get peer-client-id " <<
                        "config-key" << dendl;
                    return r;
                }
                else if (r < 0 && r != -ENOENT) {
                    ...
                    ldout(cct,
                          20) << "creating new peer-client-id config-key" <<
                        dendl;

                    *peer_client_id = "rbd-mirror-peer";
                    r = set_config_key(rados,
                                       RBD_MIRROR_PEER_CLIENT_ID_CONFIG_KEY,
                                       *peer_client_id);
                    if (r == -EACCES) {
                        ldout(cct,
                              5) <<
                            "insufficient permissions to update peer-client-id "
                            << "config-key" << dendl;
                        return r;
                    }
                    else if (r < 0) {
                ...
                std::string cmd =
                    ...
                    R "(  " entity ": " client.)" + *peer_client_id + R"(",)"
                                                                         ...
                                                                         (cct,
                                                                          5) <<
                                                                         "caps mismatch for existing user"
                                                                         <<
                                                                         dendl;
                                                                         return
                                                                         -EEXIST;}
                                                                         ...
                                                                         *cephx_key
                                                                         ...
                                                                         (cct)
                                                                         <<
                                                                         "invalid auth keyring JSON received"
                                                                         <<
                                                                         dendl;
                                                                         return
                                                                         -EBADMSG;}
                                                                         ...
                                                                         (cct)
                                                                         <<
                                                                         "multiple peers are not currently supported"
                                                                         <<
                                                                         dendl;
                                                                         return
                                                                         -EINVAL;}
                                                                         ...
                                                                         (cct)
                                                                         <<
                                                                         "failed to update peer site name"
                                                                         <<
                                                                         dendl;}
                                                                         }
                                                                         }
              ...
              struct C_ImageGetInfo:                                    public
                                                                         ...
                                                                         *
                                                                          ...
                                                                          *
                                                                          on_finish)
                  :                                                     mirror_image_info(mirror_image_info), mirror_image_mode(mirror_image_mode), on_finish(on_finish) {
                                                                         }
                                                                         ...
                                                                         *mirror_image_mode
                                                                         ...
                                                                         complete
                                                                         (0);}
              }; struct C_ImageGetGlobalStatus:                         public
                                                                         C_ImageGetInfo
                                                                         {
                                                                         std::
                                                                         string
                      ...
                      mirror_image_global_status->name = image_name; mirror_image_global_status->site_statuses.clear(); mirror_image_global_status->site_statuses.reserve(mirror_image_status_internal.mirror_image_site_statuses.size()); for (auto & site_status:
mirror_image_status_internal.mirror_image_site_statuses) {
                                                                         ...
                                                                         finish
                                                                         (0);}
              }; template < typename I > struct C_ImageSnapshotCreate:  public
                                                                         Context
                                                                         {
                                                                         I *
                                                                         ictx;
                  ...
                  :                                                     ictx
                                                                         ...
                                                                         (ictx->
                                                                          cct)
                                                                         <<
                                                                         "snapshot based mirroring is not enabled"
                                                                         <<
                                                                         dendl;
                                                                         on_finish->
                                                                         complete
                                                                         ...
                                                                         * cct =
                                                                         ...
                                                                         (cct)
                                                                         <<
                                                                         "cannot enable mirroring: mirroring is not enabled on a "
                                                                         <<
                                                                         pool_or_namespace
                                                                         (ictx)
                                                                         <<
                                                                         ...
                                                                         (cct)
                                                                         <<
                                                                         "cannot enable mirroring: "
                                                                         <<
                                                                         pool_or_namespace
                                                                         (ictx)
                                                                         <<
                                                                         " is not in image mirror mode"
                                                                         <<
                                                                         dendl;
                                                                         return
                                                                         -EINVAL;}
                                                                         ...
                                                                         *
                                                                         ...
                                                                         (cct)
                                                                         <<
                                                                         "mirroring is not enabled for the parent"
                                                                         <<
                                                                         dendl;
                                                                         return
                                                                         -EINVAL;}
                                                                         ...
                                                                         * cct =
                                                                         ...
                                                                         (cct,
                                                                          20) <<
                                                                         "ignoring disable command: mirroring is not enabled for "
                                                                         <<
                                                                         "this image"
                                                                         <<
                                                                         dendl;
                                                                         ...
                                                                         (cct,
                                                                          5) <<
                                                                         "mirroring not supported by OSD"
                                                                         <<
                                                                         dendl;
                                                                         return
                                                                         r;}
                                                                         ...
                                                                         * cct =
                                                                         ...
                                                                         image_locker
                                                                         {
          ictx->image_lock}; std::map < librados::snap_t, SnapInfo > snap_info = ictx->snap_info; for (auto & info:snap_info) {
                                                                         cls::
                                                                         rbd::
                                                                         ParentImageSpec
                                                                         parent_spec
              ...
              librados::IoCtx child_io_ctx; int64_t child_pool_id = -1; for (auto & child_image:child_images) {
                                                                         std::
                                                                         string
                                                                         pool =
                                                                         child_image.
                                                                         ...
                                                                         (cct)
                                                                         <<
                                                                         "cannot remove snapshot image-meta key: "
                                                                         <<
                                                                         cpp_strerror
                                                                         (r)
                                                                         <<
                                                                         ...
                                                                         * cct =
                                                                         ...
                                                                         (cct)
                                                                         <<
                                                                         "image is primary, cannot resync to itself"
                                                                         <<
                                                                         dendl;
                                                                         return
                                                                         -EINVAL;}
                                                                         ...
                                                                         (cct)
                                                                         <<
                                                                         "failed to load mirror image-meta: "
                                                                         <<
                                                                         cpp_strerror
                                                                         (r)
                                                                         <<
                                                                         ...
                                                                         * cct =
                                                                         ...
                                                                         (cct)
                                                                         <<
                                                                         "mirroring is not currently enabled"
                                                                         <<
                                                                         dendl;
                                                                         return
                                                                         -EINVAL;}
                                                                         ...
                                                                         (cct)
                                                                         <<
                                                                         "failed to get mirror image instance: "
                                                                         <<
                                                                         cpp_strerror
                                                                         (r)
                                                                         <<
                                                                         ...
                                                                         *
                                                                         ...
                                                                         (cct)
                                                                         <<
                                                                         "failed to retrieve cluster fsid: "
                                                                         <<
                                                                         cpp_strerror
                                                                         (r)
                                                                         <<
                                                                         ...
                                                                         *
                                                                         ...
                                                                         (cct)
                                                                         <<
                                                                         "failed to retrieve mirror mode: "
                                                                         <<
                                                                         cpp_strerror
                                                                         (r)
                                                                         <<
...
*mirror_mode = static_cast < rbd_mirror_mode_t > (mirror_mode_internal); break; default:
                                                                         lderr
                                                                         (cct)
                                                                         <<
                                                                         "unknown mirror mode ("
...
next_mirror_mode = static_cast < cls::rbd::MirrorMode > (mirror_mode); break; default:
                                                                         lderr
                                                                         (cct)
                                                                         <<
                                                                         "unknown mirror mode ("
                                                                         ...
                                                                         (cct)
                                                                         <<
                                                                         "failed to allocate mirroring uuid: "
                                                                         <<
                                                                         cpp_strerror
                                                                         (r)
                                                                         <<
                  ...
                  for (const auto & img_pair:                           images)
                                                                         ...
                                                                         (cct)
                                                                         <<
                                                                         "error getting features for image "
                                                                         <<
                                                                         img_pair.
                                                                         first
                                                                         << ": "
                  ...
                  for (const auto & img_id:                             image_ids) {
                                                                         ...
                                                                         (cct)
                                                                         <<
                                                                         "error disabling mirroring for image id "
                                                                         <<
                                                                         img_id
                                                                         <<
                                                                         cpp_strerror
                                                                         ...
                                                                         *
                                                                         ...
                                                                         (cct)
                                                                         <<
                                                                         "failed to retrieve mirroring uuid: "
                                                                         <<
                                                                         cpp_strerror
                                                                         (r)
                                                                         <<
                                                                         ...
                                                                         *
                                                                         ...
                                                                         (cct)
                                                                         <<
                                                                         "failed to retrieve mirroring mode: "
                                                                         <<
                                                                         cpp_strerror
                                                                         (r)
                                                                         <<
                                                                         ...
                                                                         bufferlist token_bl; token_bl.append(R "({)" R "(" fsid ":") " + fsid + R"(",)" + R "(" client_id ":") " + peer_client_id + R"(",)" + R "(" key ":") " + cephx_key + R"(",)" + R "(" mon_host ":") " + \
        boost::replace_all_copy(mon_host, " \ "", "\\\"")
                  +R "(") " + \
    R"(}) ");
...
int Mirror<I>::peer_bootstrap_import(librados::IoCtx& io_ctx,
  ...
  if (r < 0) {
    ...
    lderr(cct) << " cannot import token for local
                      cluster " << dendl;
    return -EINVAL;
  ...
  if (r < 0) {
    ...
    lderr(cct) << " cannot import token for duplicate
site name " << dendl;
    return -EINVAL;
  }
...
int Mirror<I>::peer_site_remove(librados::IoCtx& io_ctx,
  ...
  for (auto &name : names) {
    ...
    for (const auto& image_id : image_ids) {
      ...
      if (r < 0) {
        lderr(cct) << " error getting mirror info for image
                              " << image_id
                   << ": " << cpp_strerror(r) << dendl;
        return r;
      }
      ...
      if (r < 0) {
        lderr(cct) << " error unlinking peer for image
                                  " << image_id << ": "
                   << cpp_strerror(r) << dendl;
        return r;
      } else if (close_r < 0) {
...
int Mirror<I>::peer_site_set_attributes(librados::IoCtx& io_ctx,
  ...
  for (auto& pair : attributes) {
    ss << " \\\ "" << pair.first << "\\\": " << "\\\"" << pair.second << "\\\"";
                    ...
                    librados::Rados rados(io_ctx);
                    r = set_config_key(rados,
                                       get_peer_config_key_name(io_ctx.get_id(),
                                                                uuid),
                                       ss.str());
                    if (r < 0 && r != -ENOENT) {
                        lderr(cct) << "failed to update peer attributes: " <<
                            cpp_strerror(r)
                            << dendl;
                        return r;
                    }
                ...
                template < typename I >
                    int Mirror <
                    I >::image_global_status_list(librados::IoCtx & io_ctx,
                    ...
                    std::map < std::string,
                        cls::rbd::MirrorImageStatus > statuses_;

                    r = librbd::cls_client::mirror_image_status_list(&io_ctx,
                                                                     start_id,
                                                                     max,
                                                                     &images_,
                                                                     &statuses_);
                    ...
                    for (auto it = images_.begin(); it != images_.end(); ++it) {
                        ...
                        if (image_name.empty()) {
                            lderr(cct) << "failed to find image name for image "
                                << image_id << ", " << "using image id as name"
                                << dendl;
                            image_name = image_id;
                        }

                        mirror_image_global_status_t & global_status =
                            (*images)[image_id];
                        global_status.name = image_name;
                        global_status.info = mirror_image_info_t {
                        info.global_image_id, static_cast < mirror_image_state_t > (info.state), false};    // XXX: To set "primary" right would require an additional call.
                        ...
                        if (s_it != statuses_.end()) {
                            ...
                            global_status.site_statuses.reserve(status.
                                                                mirror_image_site_statuses.
                                                                size());
                          for (auto & site_status:status.
                                 mirror_image_site_statuses)
                            {
                ...
                template < typename I >
                    int Mirror <
                    I >::image_status_summary(librados::IoCtx & io_ctx,
                                              MirrorImageStatusStates *
                                              states) {
                    CephContext *cct =
                        reinterpret_cast < CephContext * >(io_ctx.cct());
                    ...
                    std::vector < cls::rbd::MirrorPeer > mirror_peers;
                    int r =
                        cls_client::mirror_peer_list(&io_ctx, &mirror_peers);
                    if (r < 0 && r != -ENOENT) {
                        lderr(cct) << "failed to list mirror peers: " <<
                            cpp_strerror(r) << dendl;
                        return r;
                    }
                    ...
                    std::map < cls::rbd::MirrorImageStatusState,
                        int32_t > states_;
                    r = cls_client::mirror_image_status_get_summary(&io_ctx,
                                                                    mirror_peers,
                                                                    &states_);
                    if (r < 0 && r != -ENOENT) {
                  ...
                  for (auto & s:states_) {
                        (*states)[static_cast < mirror_image_status_state_t >
                                  (s.first)] = s.second;
                    }
                    return 0;
                }
                ...
                template < typename I >
                    int Mirror <
                    I >::image_instance_id_list(librados::IoCtx & io_ctx,
                                                const std::
                    ...
                    int r =
                        librbd::cls_client::mirror_image_instance_list(&io_ctx,
                                                                       start_image_id,
                                                                       max,
                                                                       &instances);
                    if (r < 0 && r != -ENOENT) {
                        lderr(cct) << "failed to list mirror image instances: "
                            << cpp_strerror(r)
                            << dendl;
                        return r;
                    }
                  ...
                  for (auto it:instances) {
                        (*instance_ids)[it.first] =
                            stringify(it.second.name.num());
                    }
                ...
                template < typename I >
                    int Mirror < I >::image_info_list(librados::IoCtx & io_ctx,
                                                      mirror_image_mode_t *
                                                      mode_filter,
                                                      const std::
                                                      string & start_id,
                    ...
                    ldout(cct,
                          20) << "pool=" << io_ctx.
                        get_pool_name() << ", mode_filter=" << (mode_filter ?
                                                                stringify
                                                                (*mode_filter) :
                                                                "null")
                        << ", start_id=" << start_id << ", max=" << max <<
                        dendl;
                    ...
                    while (entries->size() < max) {
                        ...
                        std::map < std::string,
                            cls::rbd::MirrorImageStatus > statuses;

                        int r =
                            librbd::cls_client::
                            mirror_image_status_list(&io_ctx, last_read, max,
                                                     &images, &statuses);
                        if (r < 0 && r != -ENOENT) {
                            lderr(cct) <<
                ...
                template < typename I >
                    int Mirror < I >::image_snapshot_create(I * ictx,
                                                            uint32_t flags,
                                                            uint64_t *
                                                            snap_id) {
                    C_SaferCond ctx;
                    Mirror < I >::image_snapshot_create(ictx, flags, snap_id,
                                                        &ctx);
                ...
                template < typename I >
                    void Mirror < I >::image_snapshot_create(I * ictx,
                                                             uint32_t flags,
                                                             uint64_t * snap_id,
                                                             Context *
                                                             on_finish) {
                    ...
                    auto on_refresh = new LambdaContext([ictx,
                                                         snap_create_flags,
                                                         snap_id,
                                                         on_finish] (int r) {
                                                        if (r < 0) {
