...
namespace librbd {
    ...
    namespace util {
        ...
        ImageRequest < librbd::MockTestImageCtx > *ImageRequest <
            librbd::MockTestImageCtx >::s_instance = nullptr;
    ...
    namespace io {
        ...
        struct TestMockIoObjectRequest:public TestMockFixture {
            ...
            void expect_cache_read(MockTestImageCtx & mock_image_ctx,
                ...
                EXPECT_CALL(mock_image_ctx, aio_read_from_cache( {
                                                                oid}, object_no,
                                                                _, len, off, _,
                                                                _, _))
                    .WillOnce(WithArgs < 2,
                              5 >
                              (Invoke
                               ([bl, r] (bufferlist * out_bl,
                                         Context * on_finish) {
                                out_bl->append(bl); on_finish->complete(r);})));
            }
            ...
            void expect_aio_read(MockImageRequest & mock_image_request,
                ...
                EXPECT_CALL(mock_image_request, aio_read(_, extents))
                    .WillOnce(WithArg < 0 >
                              (Invoke([r] (AioCompletion * aio_comp) {
        ...
        TEST_F(TestMockIoObjectRequest, Read) {
            ...
            C_SaferCond ctx;
            auto req =
                MockObjectReadRequest::create(&mock_image_ctx,
                                              ictx->get_object_name(0), 0, 0,
                                              4096, CEPH_NOSNAP, 0,
                                              false, { }
                                              , &ctx);
            req->send();
        ...
        TEST_F(TestMockIoObjectRequest, CacheRead) {
            ...
            InSequence seq;
            expect_cache_read(mock_image_ctx, ictx->get_object_name(0), 0, 0,
                              4096, std::string(4096, '1'), 0);
        ...
        TEST_F(TestMockIoObjectRequest, ParentRead) {
            ...
            expect_prune_parent_extents(mock_image_ctx, { {
                                        ...
                                        , 4096, 4096);
            expect_aio_read(mock_image_request, { {
                            0, 4096}
                            }
                            , 0);
        ...
        TEST_F(TestMockIoObjectRequest, Write) {
            ...
            C_SaferCond ctx;
            auto req =
                MockObjectWriteRequest::create_write(&mock_image_ctx,
        ...
        TEST_F(TestMockIoObjectRequest, DiscardRemove) {
            ...
            C_SaferCond ctx;
            auto req =
                MockObjectDiscardRequest::create_discard(&mock_image_ctx,
                                                         ictx->
                                                         get_object_name(0), 0,
                                                         0,
                                                         mock_image_ctx.
        ...
        TEST_F(TestMockIoObjectRequest, WriteSame) {
            ...
            C_SaferCond ctx;
            auto req =
                MockObjectWriteSameRequest::create_writesame(&mock_image_ctx,
                                                             ictx->
                                                             get_object_name(0),
                                                             0, 0, 4096, bl,
                                                             mock_image_ctx.
        ...
        TEST_F(TestMockIoObjectRequest, CompareAndWrite) {
            ...
            auto req =
                MockObjectWriteSameRequest::
                create_compare_and_write(&mock_image_ctx,
                                         ictx->get_object_name(0), 0, 0, cmp_bl,
                                         bl,
                                         mock_image_ctx.snapc, &mismatch_offset,
                                         0, { }
                                         , &ctx);
            req->send();
            ASSERT_EQ(0, ctx.wait());
