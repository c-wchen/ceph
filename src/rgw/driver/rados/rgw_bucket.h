...
public:
    ...
    RGWBucketEntryMetadataObject(RGWBucketEntryPoint& _ep, const obj_version& v, real_time m, std::map < std::string,
                                 bufferlist > && _attrs) :
...
struct RGWBucketAdminOpState {
    ...
    void set_hide_progress(bool value)
    {
        hide_progress = value;
    }
    void set_dump_keys(bool value)
    {
        dump_keys = value;
    }
    ...
    void set_min_age(ceph::timespan value)
    {
        min_age = value;
    }
...
public:
    ...
    int set_quota(RGWBucketAdminOpState& op_state, const DoutPrefixProvider *dpp, optional_yield y,
                  std::string *err_msg = NULL);

    int remove_object(const DoutPrefixProvider *dpp, RGWBucketAdminOpState& op_state, optional_yield y,
                      std::string *err_msg = NULL);
...
public:
    ...
    static int unlink(rgw::sal::Driver* driver, RGWBucketAdminOpState& op_state, const DoutPrefixProvider *dpp,
                      optional_yield y, std::string *err_msg = nullptr);
