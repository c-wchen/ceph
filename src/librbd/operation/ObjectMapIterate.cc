    ...
    namespace operation {
        ...
        namespace {
          ...
          template < typename I > class C_VerifyObjectCallback:public C_AsyncObjectThrottle < I >
            {
              public:
                C_VerifyObjectCallback(AsyncObjectThrottle < I > &throttle,
              ...
              :    C_AsyncObjectThrottle < I > (throttle, *image_ctx),
                    ...
                    if (should_complete(r)) {
                        ldout(image_ctx.cct,
                              20) << m_oid <<
                            " C_VerifyObjectCallback completed " << dendl;
                        m_io_ctx.close();
              ...
              private:
                ...
                bool should_complete(int r) {
                    ...
                    if (r < 0 && r != -ENOENT) {
                        lderr(cct) << m_oid <<
                            ...
                            "encountered an error: " << cpp_strerror(r) <<
                            dendl;
                        return true;
                    }
                    ...
                    ldout(cct,
                          20) << m_oid <<
                        " C_VerifyObjectCallback::should_complete: " << " r=" <<
                        r << dendl;
                ...
                void send_list_snaps() {
                    ...
                    ldout(image_ctx.cct, 5) << m_oid
                        << " C_VerifyObjectCallback::send_list_snaps" << dendl;
                ...
                uint8_t get_object_state() {
                    ...
                    for (std::vector <
                         librados::clone_info_t >::const_iterator r =
                        ...
                        if (r->cloneid == librados::SNAP_HEAD) {
                            from_snap_id =
                                next_valid_snap_id(m_snap_set.seq + 1);
                ...
                bool object_map_action(uint8_t new_state) {
                    ...
                    if (state != new_state) {
                        ...
                        r = m_handle_mismatch(image_ctx, m_object_no, state,
                                              new_state);
                        if (r) {
                            lderr(cct) << "object map error: object "
                                << image_ctx.get_object_name(m_object_no)
                                << " marked as " << (int)state <<
                                ", but should be " << (int)new_state << dendl;
        ...
        template < typename I >
            ...
            ldout(cct,
                  5) << this << " should_complete: " << " r=" << r << dendl;
        ...
        template < typename I >
            ...
            AsyncObjectThrottle < I > *throttle =
                new AsyncObjectThrottle < I > (this, m_image_ctx,
                                               context_factory,
        ...
        template < typename I >
            ...
            object_map::InvalidateRequest < I > *req =
                object_map::InvalidateRequest < I >::create(m_image_ctx,
                                                            m_image_ctx.snap_id,
                                                            true,
                                                            this->
