...
void cls_statelog_add_prepare_entry(cls_statelog_entry & entry,
                                    ...
                                    const utime_t & timestamp, uint32_t state,
                                    bufferlist & bl)
{
...
void cls_statelog_add(librados::ObjectWriteOperation & op,
                      ...
                      const string & object, const utime_t & timestamp,
...
void cls_statelog_list(librados::ObjectReadOperation & op, const string & client_id, const string & op_id, const string & object,   /* op_id may be empty, also one of client_id, object */
                       ...
                       string * out_marker, bool * truncated)
{
    ...
    op.exec("statelog", "list", inbl,
            new StateLogListCtx(&entries, out_marker, truncated));
}
