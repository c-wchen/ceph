        ...
        struct MockObjectDispatch:public ObjectDispatchInterface {
          public:
            ceph::shared_mutex lock =
                ceph::make_shared_mutex("MockObjectDispatch::lock");
            ...
            MockObjectDispatch() {
             ...
             MOCK_METHOD6(execute_read,
                          bool(uint64_t, ReadExtents *, IOContext io_context,
                               uint64_t *, DispatchResult *, Context *));
            bool read(uint64_t object_no, ReadExtents * extents,
            ...
            bool discard(uint64_t object_no, uint64_t object_off,
                ...
                return execute_discard(object_no, object_off, object_len,
                                       io_context, discard_flags,
                                       dispatch_flags, journal_tid,
                                       dispatch_result, on_dispatched);
            } MOCK_METHOD10(execute_write,
                            bool(uint64_t, uint64_t, const ceph::bufferlist &,
                                 IOContext, int, std::optional < uint64_t >,
                                 int *, uint64_t *, DispatchResult *,
                                 Context *));
            bool write(uint64_t object_no, uint64_t object_off, ceph::bufferlist
                ...
                return execute_write(object_no, object_off, data, io_context,
            ...
            bool write_same(uint64_t object_no, uint64_t object_off,
                            uint64_t object_len, LightweightBufferExtents
                ...
                return execute_write_same(object_no, object_off, object_len,
                                          buffer_extents, data, io_context,
                                          dispatch_flags, journal_tid,
                                          dispatch_result, on_dispatched);
            }
            ...
            MOCK_METHOD9(execute_compare_and_write,
                         bool(uint64_t, uint64_t, const ceph::bufferlist &,
                              const ceph::bufferlist &, uint64_t *, int *,
                              uint64_t *, DispatchResult *, Context *));
            bool compare_and_write(uint64_t object_no, uint64_t object_off,
                                   ...
                                   Context ** on_finish,
                                   Context * on_dispatched) override {
                return execute_compare_and_write(object_no, object_off,
                                                 cmp_data, write_data,
                                                 mismatch_offset,
                                                 dispatch_flags, journal_tid,
                                                 dispatch_result,
            ...
            MOCK_METHOD4(execute_flush,
                         bool(FlushSource, uint64_t *, DispatchResult *,
                              Context *));
            bool flush(FlushSource flush_source,
                       const ZTracer::Trace & parent_trace,
                       uint64_t * journal_tid, DispatchResult * dispatch_result,
                       Context ** on_finish, Context * on_dispatched) {
            ...
            bool list_snaps(uint64_t object_no, io::Extents && extents, SnapIds
                            ...
                            Context ** on_finish,
                            Context * on_dispatched) override {
                return execute_list_snaps(object_no, extents, snap_ids,
            ...
            MOCK_METHOD5(extent_overwritten,
                         void (uint64_t, uint64_t, uint64_t, uint64_t,
                               uint64_t));
            MOCK_METHOD2(prepare_copyup,
                         int (uint64_t, SnapshotSparseBufferlist *));
        };
