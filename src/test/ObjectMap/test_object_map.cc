  ...
  public:
    ...
    void verify_keys(const std::string & obj, ostream & out) {
        ...
        ObjectMap::ObjectMapIterator iter =
            db->
            get_iterator(ghobject_t(hobject_t(sobject_t(obj, CEPH_NOSNAP))));
...
class ObjectMapTest:public::testing::Test {
  public:
    ...
    void SetUp() override {
        ...
        KeyValueDB *store =
            KeyValueDB::create(g_ceph_context, "leveldb", strpath);
...
{
    ghobject_t hoid(hobject_t(sobject_t("foo", CEPH_NOSNAP)), 100,
                    shard_id_t(0));
...
{
    ghobject_t hoid(hobject_t(sobject_t("foo", CEPH_NOSNAP)), 200,
                    shard_id_t(0));
    ghobject_t hoid2(hobject_t(sobject_t("foo2", CEPH_NOSNAP)), 201,
                     shard_id_t(1));
