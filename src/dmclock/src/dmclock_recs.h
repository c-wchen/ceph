...
namespace crimson {
    namespace dmclock {
        ...
        inline std::ostream & operator<<(std::ostream & out,
            ...
            out << (PhaseType::reservation ==
                    phase ? "reservation" : "priority");
            return out;
        } struct ReqParams {
            ...
            } ReqParams():ReqParams(1, 1) {
                // empty
            } ReqParams(const ReqParams & other):delta(other.delta),
                rho(other.rho) {
                // empty
            }
            ...
            friend std::ostream & operator<<(std::ostream & out,
                                             const ReqParams & rp) {
                out << "ReqParams{ delta:" << rp.delta << ", rho:" << rp.
                    rho << " }";
                return out;
            }
        };                      // class ReqParams
