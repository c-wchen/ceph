        ...
        namespace luks {
            ...
            class Header {
              public:
                ...
                int read_volume_key(const char *passphrase,
                                    size_t passphrase_size, char *volume_key,
              ...
              private:
                ...
                static void libcryptsetup_log_wrapper(int level,
                                                      const char *msg,
                                                      void *header);
...
} // namespace luks } // namespace crypto } // namespace librbd
