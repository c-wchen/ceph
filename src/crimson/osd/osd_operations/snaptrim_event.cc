...
PG::interruptible_future < > PG::BackgroundProcessLock::lock_with_op(SnapTrimEvent &st_event) noexcept
{
...
SnapTrimEvent::snap_trim_event_ret_t SnapTrimEvent::start()
{
...
SnapTrimObjSubEvent::snap_trim_obj_subevent_ret_t SnapTrimObjSubEvent::remove_clone(
...
SnapTrimObjSubEvent::interruptible_future < > SnapTrimObjSubEvent::adjust_snaps(
    ObjectContextRef obc,
    ObjectContextRef head_obc,
...
SnapTrimObjSubEvent::remove_or_update_iertr::future < ceph::os::Transaction > SnapTrimObjSubEvent::remove_or_update(
    ObjectContextRef obc,
    ObjectContextRef head_obc)
{
...
SnapTrimObjSubEvent::snap_trim_obj_subevent_ret_t SnapTrimObjSubEvent::start()
{
    return enter_stage < interruptor > (
               client_pp().wait_for_active
    ).then_interruptible([this] {
