...
class HeapFixture1:public::testing::Test {
  ...
  public:
    ...
    crimson::IndIntruHeap < std::shared_ptr < Elem >,
        Elem, &Elem::heap_data, ElemCompare > heap;
...
{
    crimson::IndIntruHeap < std::shared_ptr < Elem >,
        Elem, &Elem::heap_data, ElemCompare, 3 > heap;
...
{
    crimson::IndIntruHeap < std::shared_ptr < Elem >,
        Elem, &Elem::heap_data, ElemCompare, 4 > heap;
...
{
    crimson::IndIntruHeap < std::shared_ptr < Elem >,
        Elem, &Elem::heap_data, ElemCompare, 10 > heap;
...
{
    crimson::IndIntruHeap < std::shared_ptr < Elem >,
        Elem, &Elem::heap_data, ElemCompare, 2 > heap2;

    crimson::IndIntruHeap < std::shared_ptr < Elem >,
        Elem, &Elem::heap_data, ElemCompare, 3 > heap3;

    crimson::IndIntruHeap < std::shared_ptr < Elem >,
        Elem, &Elem::heap_data, ElemCompare, 4 > heap4;

    crimson::IndIntruHeap < std::shared_ptr < Elem >,
        Elem, &Elem::heap_data, ElemCompare, 10 > heap10;
...
TEST(IndIntruHeap, remove_careful)
{
    ...
    crimson::IndIntruHeap < std::shared_ptr < Elem >,
        Elem, &Elem::heap_data, ElemCompare, 2 > heap;
...
TEST_F(HeapFixture1, shared_data)
{
    ...
    crimson::IndIntruHeap < std::shared_ptr < Elem >, Elem,
        &Elem::heap_data_alt, ElemCompareAlt > heap2;
