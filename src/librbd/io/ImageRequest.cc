...
template <typename I> ImageReadRequest<I>::ImageReadRequest(I &image_ctx, AioCompletion *aio_comp,
        Extents &&image_extents, ImageArea area,
...
template <typename I> ImageListSnapsRequest<I>::ImageListSnapsRequest(
