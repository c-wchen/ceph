      ...
      public:
        ...
        TestIoCtxImpl *do_create_ioctx(int64_t pool_id,
            ...
            return new::testing::NiceMock < MockTestMemIoCtxImpl > (this, this,
                                                                    ...
                                                                    get_pool
                                                                    (pool_name));
        } MOCK_METHOD2(blacklist_add,
                       int (const std::string & client_address,
                            uint32_t expire_seconds));
        int do_blacklist_add(const std::string & client_address,
                             uint32_t expire_seconds) {
            return TestMemRadosClient::blacklist_add(client_address,
                                                     expire_seconds);
        }
        ...
        int do_service_daemon_update_status(const std::map < std::string,
                                            std::string > &status) {
        ...
        void default_to_dispatch() {
            ...
            ON_CALL(*this,
                    create_ioctx(_, _)).WillByDefault(Invoke(this,
                                                             ...
                                                             do_create_ioctx));
            ON_CALL(*this,
                    blacklist_add(_, _)).WillByDefault(Invoke(this,
                                                              &MockTestMemRadosClient::
                                                              do_blacklist_add));
            ON_CALL(*this,
            ...
            ON_CALL(*this,
                    service_daemon_update_status(_)).WillByDefault(Invoke(this,
                                                                          &MockTestMemRadosClient::
                                                                          do_service_daemon_update_status));
        }
    };
