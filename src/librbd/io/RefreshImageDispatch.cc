...
namespace librbd {
    namespace io {
        ...
        :m_image_ctx(image_ctx) {
            ...
            bool RefreshImageDispatch < I >::read(AioCompletion * aio_comp,
                                                  Extents
        ...
        template < typename I >
            bool RefreshImageDispatch < I >::write(AioCompletion * aio_comp,
                                                   Extents
        ...
        template < typename I >
            bool RefreshImageDispatch < I >::discard(AioCompletion * aio_comp,
                                                     Extents
                                                     && image_extents,
                                                     uint32_t
        ...
        template < typename I >
            bool RefreshImageDispatch <
            I >::needs_refresh(DispatchResult * dispatch_result,
                               Context * on_dispatched) {
            auto cct = m_image_ctx->cct;
