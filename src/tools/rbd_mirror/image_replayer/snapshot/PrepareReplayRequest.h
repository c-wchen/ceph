...
{
public:
    static PrepareReplayRequest *create(const std::
                                        string &
                                        local_mirror_uuid,
                                        ProgressContext *
                                        progress_ctx,
                                        ...
                                        *state_builder,
                                        ...
                                        Context *on_finish)
    {
        return new PrepareReplayRequest(local_mirror_uuid,
                                        progress_ctx,
                                        state_builder,
                                        resync_requested,
                                        syncing, on_finish);
    } PrepareReplayRequest(const std::
...
PrepareReplayRequest < librbd::ImageCtx >;
