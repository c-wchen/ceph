...
public:
    ...
    std::cv_status wait_until(std::unique_lock < mutex_debug > &lock,
                              ...
                              Duration > &when)
    {
        ...
        (Clock::is_steady) {
            ...
            real_when +=
                std::chrono::ceil < typename Clock::duration > (delta);
    ...
    std::cv_status wait_for(std::unique_lock < mutex_debug > &lock,
    ...
    bool wait_for(std::unique_lock < mutex_debug > &lock,
