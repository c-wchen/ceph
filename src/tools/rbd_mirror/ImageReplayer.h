 ...
 */ template < typename ImageCtxT = librbd::ImageCtx >
            class ImageReplayer {
          public:
            static ImageReplayer *create(Threads < ImageCtxT > *threads,
                                         ImageDeleter < ImageCtxT >
                                         *image_deleter,
                                         InstanceWatcher < ImageCtxT >
                                         *instance_watcher, RadosRef local,
                                         const std::string & local_mirror_uuid,
                                         int64_t local_pool_id,
                                         const std::string & global_image_id) {
                return new ImageReplayer(threads, image_deleter,
                                         instance_watcher, local,
            ...
            void add_peer(const std::string & peer_uuid,
   ...
   */
            ...
            virtual void on_stop_journal_replay(int r =
                                                0, const std::string & desc =
                                                "");

            virtual void on_flush_local_replay_flush_start(Context * on_flush);
            virtual void on_flush_local_replay_flush_finish(Context * on_flush,
                                                            int r);
            virtual void on_flush_flush_commit_position_start(Context *
                                                              on_flush);
            virtual void on_flush_flush_commit_position_finish(Context *
                                                               on_flush, int r);
          ...
          private:
            ...
            image_replayer::EventPreprocessor < ImageCtxT >
                *m_event_preprocessor = nullptr;
            image_replayer::ReplayStatusFormatter < ImageCtxT >
            ...
            image_replayer::BootstrapRequest < ImageCtxT >
            ...
            struct RemoteJournalerListener:public::journal::
                JournalMetadataListener {
                ImageReplayer *replayer;

                 RemoteJournalerListener(ImageReplayer *
            ...
            bool is_stopped_() const {
                ...
                return !is_stopped_() && m_state != STATE_STOPPING
                    && !m_stop_requested;
            } bool is_replaying_() const {
                return (m_state == STATE_REPLAYING ||
                        m_state == STATE_REPLAY_FLUSHING);
            } bool update_mirror_image_status(bool force,
