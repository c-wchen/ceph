...
namespace librados {
    ...
    int IoCtx::create(const std::string & oid, bool exclusive) {
        ...
        return ctx->execute_operation(oid,
                                      boost::bind(&TestIoCtxImpl::create, _1,
                                                  _2, exclusive));
    }
    ...
    int IoCtx::exec(const std::string & oid, const char *cls,
        ...
        TestIoCtxImpl *ctx = reinterpret_cast < TestIoCtxImpl * >(io_ctx_impl);
        return ctx->execute_operation(oid,
                                      boost::bind(&TestIoCtxImpl::exec, _1, _2,
    ...
    int IoCtx::read(const std::string & oid, bufferlist & bl, size_t len,
        ...
        TestIoCtxImpl *ctx = reinterpret_cast < TestIoCtxImpl * >(io_ctx_impl);
        return ctx->execute_operation(oid,
                                      boost::bind(&TestIoCtxImpl::read, _1, _2,
                                                  len, off, &bl));
    }
    ...
    int IoCtx::remove(const std::string & oid) {
        TestIoCtxImpl *ctx = reinterpret_cast < TestIoCtxImpl * >(io_ctx_impl);
        return ctx->execute_operation(oid,
                                      boost::bind(&TestIoCtxImpl::remove, _1,
                                                  _2, ctx->get_snap_context()));
    }
    ...
    int IoCtx::stat(const std::string & oid, uint64_t * psize, time_t * pmtime) {
        TestIoCtxImpl *ctx = reinterpret_cast < TestIoCtxImpl * >(io_ctx_impl);
        return ctx->execute_operation(oid,
                                      boost::bind(&TestIoCtxImpl::stat, _1, _2,
                                                  psize, pmtime));
    }
    ...
    int IoCtx::trunc(const std::string & oid, uint64_t off) {
        TestIoCtxImpl *ctx = reinterpret_cast < TestIoCtxImpl * >(io_ctx_impl);
        return ctx->execute_operation(oid,
                                      boost::bind(&TestIoCtxImpl::truncate, _1,
                                                  _2, off,
                                                  ctx->get_snap_context()));
    }
    ...
    int IoCtx::write(const std::string & oid, bufferlist & bl, size_t len,
        ...
        TestIoCtxImpl *ctx = reinterpret_cast < TestIoCtxImpl * >(io_ctx_impl);
        return ctx->execute_operation(oid,
                                      boost::bind(&TestIoCtxImpl::write, _1, _2,
                                                  bl, len, off,
                                                  ctx->get_snap_context()));
    }
    ...
    int IoCtx::writesame(const std::string & oid, bufferlist & bl, size_t len,
        ...
        TestIoCtxImpl *ctx = reinterpret_cast < TestIoCtxImpl * >(io_ctx_impl);
        return ctx->execute_operation(oid,
                                      boost::bind(&TestIoCtxImpl::writesame, _1,
                                                  _2, bl, len, off,
                                                  ctx->get_snap_context()));
    }
    ...
    int IoCtx::cmpext(const std::string & oid, uint64_t off,
        ...
        TestIoCtxImpl *ctx = reinterpret_cast < TestIoCtxImpl * >(io_ctx_impl);
        return ctx->execute_operation(oid,
                                      boost::bind(&TestIoCtxImpl::cmpext, _1,
                                                  _2, off, cmp_bl));
    }
    ...
    void ObjectOperation::exec(const char *cls, const char *method,
        ...
        o->ops.
            push_back(boost::
                      bind(&TestIoCtxImpl::exec, _1, _2, get_class_handler(),
    ...
    void ObjectOperation::cmpext(uint64_t off, bufferlist & cmp_bl, int *prval) {
        ...
        ObjectOperationTestImpl op =
            boost::bind(&TestIoCtxImpl::cmpext, _1, _2, off, cmp_bl);
        if (prval != NULL) {
    ...
    void ObjectReadOperation::list_snaps(snap_set_t * out_snaps, int *prval) {
        ...
        ObjectOperationTestImpl op =
            boost::bind(&TestIoCtxImpl::list_snaps, _1, _2,
                        out_snaps);
        if (prval != NULL) {
            op = boost::bind(save_operation_result,
                             boost::bind(op, _1, _2, _3, _4), prval);
    ...
    void ObjectReadOperation::list_watchers(std::list < obj_watch_t >
        ...
        ObjectOperationTestImpl op =
            boost::bind(&TestIoCtxImpl::list_watchers, _1,
                        _2, out_watchers);
        if (prval != NULL) {
            op = boost::bind(save_operation_result,
                             boost::bind(op, _1, _2, _3, _4), prval);
    ...
    void ObjectReadOperation::sparse_read(uint64_t off, uint64_t len,
        ...
        ObjectOperationTestImpl op;
        if (pbl != NULL) {
            op = boost::bind(&TestIoCtxImpl::sparse_read, _1, _2, off, len, m,
                             pbl);
        }
        else {
            op = boost::bind(&TestIoCtxImpl::sparse_read, _1, _2, off, len, m,
    ...
    void ObjectWriteOperation::create(bool exclusive) {
        TestObjectOperationImpl *o =
            reinterpret_cast < TestObjectOperationImpl * >(impl);
        o->ops.
            push_back(boost::bind(&TestIoCtxImpl::create, _1, _2, exclusive));
    }
    ...
    void ObjectWriteOperation::tmap_update(const bufferlist & cmdbl) {
        TestObjectOperationImpl *o =
            reinterpret_cast < TestObjectOperationImpl * >(impl);
        o->ops.
            push_back(boost::bind(&TestIoCtxImpl::tmap_update, _1, _2, cmdbl));
    }
    ...
    void ObjectWriteOperation::truncate(uint64_t off) {
        TestObjectOperationImpl *o =
            reinterpret_cast < TestObjectOperationImpl * >(impl);
        o->ops.
            push_back(boost::bind(&TestIoCtxImpl::truncate, _1, _2, off, _4));
    }
    ...
    void ObjectWriteOperation::write_full(const bufferlist & bl) {
        TestObjectOperationImpl *o =
            reinterpret_cast < TestObjectOperationImpl * >(impl);
        o->ops.
            push_back(boost::bind(&TestIoCtxImpl::write_full, _1, _2, bl, _4));
    }
    ...
    void ObjectWriteOperation::zero(uint64_t off, uint64_t len) {
        TestObjectOperationImpl *o =
            reinterpret_cast < TestObjectOperationImpl * >(impl);
        o->ops.
            push_back(boost::bind(&TestIoCtxImpl::zero, _1, _2, off, len, _4));
    }
  ...
  Rados::Rados():client(NULL) {
    ...
    int Rados::service_daemon_update_status(const std::map < std::string,
                                            std::string > &status) {
        TestRadosClient *impl = reinterpret_cast < TestRadosClient * >(client);
