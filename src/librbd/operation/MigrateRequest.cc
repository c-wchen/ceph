...
namespace librbd {
    namespace operation {
        ...
        using util::create_async_context_callback;
         ...
         namespace {
          ...
          template < typename I > class C_MigrateObject:public C_AsyncObjectThrottle < I >
            {
              public:
                C_MigrateObject(AsyncObjectThrottle < I > &throttle,
                                I * image_ctx, IOContext io_context,
                                uint64_t object_no)
              :    C_AsyncObjectThrottle < I > (throttle, *image_ctx),
                    ...
                    if (image_ctx.exclusive_lock != nullptr &&
                        ...
                        ldout(cct,
                              1) << "lost exclusive lock during migrate" <<
                            dendl;
                        return -ERESTART;
                    } start_async_op();
                    return 0;
              ...
              private:
                ...
                void handle_start_async_op(int r) {
                    ...
                    if (r < 0) {
                        lderr(cct) << "failed to start async op: " <<
                ...
                bool is_within_overlap_bounds() {
                    ...
                    auto overlap =
                        std::min(image_ctx.size,
                                 image_ctx.migration_info.overlap);
                    return overlap > 0
                ...
                void migrate_object() {
                    ...
                    auto ctx = create_context_callback <
                        C_MigrateObject < I >,
                        &C_MigrateObject < I >::handle_migrate_object > (this);

                    if (is_within_overlap_bounds()) {
                        bufferlist bl;
                        auto req =
                            new io::ObjectWriteRequest < I > (&image_ctx,
                                                              m_object_no, 0,
                                                              std::move(bl),
                                                              m_io_context, 0,
                                                              0, std::nullopt, { }
                        ...
                        auto req =
                            ...
                            I >::create(image_ctx.parent, &image_ctx, 0, 0,
        ...
        template < typename I > void MigrateRequest < I >::migrate_objects() {
            ...
            auto ctx = create_context_callback <
                MigrateRequest < I >,
                &MigrateRequest < I >::handle_migrate_objects > (this);
        ...
        template < typename I >
            ...
            if (r < 0) {
                lderr(cct) << "failed to migrate objects: " << cpp_strerror(r)
                    << dendl;
            }
