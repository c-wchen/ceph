...
public:
    ...
    struct Action {
        typedef void (*GetArguments)(boost::program_options::
                                     options_description *,
                                     boost::program_options::
                                     options_description *);
        typedef int (*Execute)(const boost::program_options::
                               variables_map &,
        ...
        template < typename Args, typename Execute > Action(const std::initializer_list < std::string >
                &command_spec,
                const std::initializer_list < std::string >
                &alias_command_spec, const std::string &description,
                const std::string &help, Args args, Execute execute,
                bool visible = true)
    ...
    struct SwitchArguments {
        SwitchArguments(const std::initializer_list < std::string >
                        &arguments)
        {
            Shell::get_switch_arguments().insert(arguments.begin(),
                                                 arguments.end());
        }
    };
...
private:
    ...
    void get_global_options(boost::program_options::options_description *
                            opts);
    ...
    void print_bash_completion_options(const boost::program_options::
