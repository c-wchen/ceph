        ...
        namespace http {
            ...
            template < typename Body >
                bool operator==(const boost::beast::http::request < Body > &lhs,
                                const boost::beast::http::request < Body >
                                &rhs) {
                return (lhs.method() == rhs.method()
                        && lhs.target() == rhs.target());
            } template < typename Body >
                bool operator==(const boost::beast::http::response < Body >
                                &lhs,
                                const boost::beast::http::response < Body >
                                &rhs) {
                return (lhs.result() == rhs.result()
                        && lhs.body() == rhs.body());
}} // namespace http } // namespace beast } // namespace boost namespace librbd {
    namespace migration {
        ...
        class TestMockMigrationHttpClient:public TestMockFixture {
          public:
            ...
            // if we have a racing where another thread manages to bind and listen the// port picked by this acceptor, try again.
            ...
            void client_accept(boost::asio::ip::tcp::socket * socket,
                               bool close, Context * on_connect) {
                m_acceptor->
                    async_accept(boost::asio::
                                 make_strand(m_image_ctx->asio_engine->
                                             get_executor()),[socket, close,
                                                              on_connect]
                                 (auto ec,
                                  boost::asio::ip::tcp::socket in_socket) {
                                 if (close) {
                                 in_socket.
                                 shutdown(boost::asio::ip::tcp::socket::
                                          shutdown_both);}
                                 else {
            ...
            void client_write_response(boost::asio::ip::tcp::socket & socket,
                ...
                expected_res.set(boost::beast::http::field::content_type,
                                 "text/plain");
            ...
            template < typename Stream >
                void client_ssl_shutdown(Stream & stream,
                                         Context * on_shutdown) {
                stream.async_shutdown([on_shutdown] (auto ec) {
                                      ASSERT_FALSE(ec) << "Unexpected error: "
                                      << ec;
            ...
            void load_server_certificate(boost::asio::ssl::context & ctx) {
                ...
                ctx.use_certificate_chain(boost::asio::
        ...
        TEST_F(TestMockMigrationHttpClient, IssueHead) {
            ...
            C_SaferCond ctx2;
            HttpResponse res;
            http_client.issue(EmptyHttpRequest {
                              req},
                              [&ctx2, &res] (int r, HttpResponse
                                             && response)mutable {
                              res = std::move(response); ctx2.complete(r);});
        ...
        TEST_F(TestMockMigrationHttpClient, IssueSendFailed) {
            ...
            C_SaferCond ctx2;
            http_client.issue(EmptyHttpRequest {
                              req},[&ctx2] (int r, HttpResponse &&)mutable {
                              ctx2.complete(r);});
        ...
        TEST_F(TestMockMigrationHttpClient, IssueResetFailed) {
            ...
            C_SaferCond ctx3;
            http_client.issue(EmptyHttpRequest {
                              req},[&ctx3] (int r, HttpResponse &&)mutable {
                              ctx3.complete(r);});
            ...
            C_SaferCond ctx4;
            http_client.issue(EmptyHttpRequest {
                              req},[&ctx4] (int r, HttpResponse &&)mutable {
                              ctx4.complete(r);});
        ...
        TEST_F(TestMockMigrationHttpClient, IssuePipelined) {
            ...
            http_client.issue(EmptyHttpRequest {
                              req1},
                              [&ctx2, &res1] (int r, HttpResponse
                                              && response)mutable {
                              res1 = std::move(response); ctx2.complete(r);});
            ...
            http_client.issue(EmptyHttpRequest {
                              req2},
                              [&ctx3, &res2] (int r, HttpResponse
                                              && response)mutable {
                              res2 = std::move(response); ctx3.complete(r);});
        ...
        TEST_F(TestMockMigrationHttpClient, Read) {
            ...
            expected_req2.set(boost::beast::http::field::range,
                              "bytes=256-319");
