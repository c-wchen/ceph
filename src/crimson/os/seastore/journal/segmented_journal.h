 ...
 */
    class SegmentedJournal:public Journal {
      ...
      private:
        submit_record_ret do_submit_record(record_t && record,
        ...
        using prep_replay_segments_fut = replay_ertr::future <
            replay_segments_t >;
        prep_replay_segments_fut prep_replay_segments(std::vector < std::pair <
                                                      segment_id_t,
                                                      segment_header_t >>
                                                      segments);
        ...
        scan_last_segment_ertr::
            future <> scan_last_segment(const segment_id_t &,
