...
void RGWOLHInfo::dump(Formatter * f) const const
{
    encode_json("target", target, f);
}

void RGWOLHPendingInfo::dump(Formatter * f) const const
{
    utime_t ut(time);
    encode_json("time", ut, f);
}

void RGWObjManifestPart::dump(Formatter * f) const const
{
...
void RGWObjManifestRule::dump(Formatter * f) const const
{
...
void RGWObjManifest::dump(Formatter * f) const const
{
...
void ACLPermission::dump(Formatter * f) const const
{
    f->dump_int("flags", flags);
}

void ACLGranteeType::dump(Formatter * f) const const
{
    f->dump_unsigned("type", type);
}

void ACLGrant::dump(Formatter * f) const const
{
...
void RGWAccessControlList::dump(Formatter * f) const const
{
    ...
    map < uint32_t, int >::const_iterator acl_group_iter =
        acl_group_map.begin();
...
void ACLOwner::dump(Formatter * f) const const
{
...
void RGWAccessControlPolicy::dump(Formatter * f) const const
{
    encode_json("acl", acl, f);
    encode_json("owner", owner, f);
}

void ObjectMetaInfo::dump(Formatter * f) const const
{
    encode_json("size", size, f);
    encode_json("mtime", utime_t(mtime), f);
}

void ObjectCacheInfo::dump(Formatter * f) const const
{
...
void RGWCacheNotifyInfo::dump(Formatter * f) const const
{
    encode_json("op", op, f);
...
static void mask_to_str(rgw_flags_desc * mask_list, uint32_t mask, char *buf,
                        int len)
{
    const char *sep = "";
    int pos = 0;
...
void rgw_data_placement_target::dump(Formatter * f) const const
{
...
void rgw_bucket::dump(Formatter * f) const const
{
...
void rgw_bucket::decode_json(JSONObj * obj)
{
    ...
    if (explicit_placement.data_pool.empty()) {
        ...
        JSONDecoder::decode_json("data_extra_pool",
                                 explicit_placement.data_extra_pool, obj);
        JSONDecoder::decode_json("index_pool", explicit_placement.index_pool,
                                 obj);
    }
}

void RGWBucketEntryPoint::dump(Formatter * f) const const
{
    encode_json("bucket", bucket, f);
    encode_json("owner", owner, f);
...
void RGWRedirectInfo::dump(Formatter * f) const const
{
...
void RGWBWRedirectInfo::dump(Formatter * f) const const
{
...
void RGWBWRedirectInfo::decode_json(JSONObj * obj)
{
    ...
    JSONDecoder::decode_json("replace_key_prefix_with", replace_key_prefix_with,
                             obj);
    JSONDecoder::decode_json("replace_key_with", replace_key_with, obj);
}

void RGWBWRoutingRuleCondition::dump(Formatter * f) const const
{
    encode_json("key_prefix_equals", key_prefix_equals, f);
    encode_json("http_error_code_returned_equals",
                (int)http_error_code_returned_equals, f);
}
...
void RGWBWRoutingRule::dump(Formatter * f) const const
{
...
void RGWBWRoutingRules::dump(Formatter * f) const const
{
    encode_json("rules", rules, f);
}
...
void RGWBucketWebsiteConf::dump(Formatter * f) const const
{
...
void RGWBucketInfo::dump(Formatter * f) const const
{
    ...
    encode_json("bi_shard_hash_type", (uint32_t) bucket_index_shard_hash_type,
                f);
...
void RGWBucketInfo::decode_json(JSONObj * obj)
{
    ...
    JSONDecoder::decode_json("new_bucket_instance_id", new_bucket_instance_id,
                             obj);
}
...
void RGWRegionMap::dump(Formatter * f) const const
{
...
void RGWZoneGroupMap::dump(Formatter * f) const const
{
...
void RGWMetadataLogInfo::dump(Formatter * f) const const
{
    encode_json("marker", marker, f);
...
void RGWDataChangesLogInfo::dump(Formatter * f) const const
{
    encode_json("marker", marker, f);
    utime_t ut(last_update);
    encode_json("last_update", ut, f);
...
void RGWRealm::dump(Formatter * f) const const
{
    RGWSystemMetaObj::dump(f);
...
void rgw::keystone::AdminTokenRequestVer2::dump(Formatter * const f) const const
{
...
void rgw::keystone::AdminTokenRequestVer3::dump(Formatter * const f) const const
{
    f->open_object_section("token_request");
    f->open_object_section("auth");
...
void rgw::keystone::BarbicanTokenRequestVer2::dump(Formatter * const f) const const
{
    f->open_object_section("token_request");
    f->open_object_section("auth");
    f->open_object_section("passwordCredentials");
...
void rgw::keystone::BarbicanTokenRequestVer3::dump(Formatter * const f) const const
{
    f->open_object_section("token_request");
    f->open_object_section("auth");
    f->open_object_section("identity");
...
void RGWOrphanSearchStage::dump(Formatter * f) const const
{
...
void RGWOrphanSearchInfo::dump(Formatter * f) const const
{
...
void RGWOrphanSearchState::dump(Formatter * f) const const
{
