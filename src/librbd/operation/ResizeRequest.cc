...
namespace librbd {
    namespace operation {
        ...
        using util::create_rados_callback;
         ...
         template < typename I >
            ResizeRequest < I >::ResizeRequest(I & image_ctx,
                                               Context * on_finish,
                                               uint64_t new_size,
                                               bool allow_shrink,
        ...
        :Request < I > (image_ctx, on_finish, journal_op_tid),
            ...
            m_allow_shrink(allow_shrink), m_prog_ctx(prog_ctx),
        ...
        template < typename I >
            ...
            image_ctx.io_image_dispatcher->
                block_writes(create_context_callback < ResizeRequest < I >,
                             &ResizeRequest < I >::handle_pre_block_writes >
                             (this));
        }

        template < typename I >
            Context * ResizeRequest <
            I >::handle_pre_block_writes(int *result) {
            I & image_ctx = this->m_image_ctx;
            CephContext *cct = image_ctx.cct;
        ...
        template < typename I >
            ...
            if (m_disable_journal || !this->template append_op_event <
                ResizeRequest < I >,
                &ResizeRequest < I >::handle_append_op_event > (this)) {
        ...
        template < typename I >
            ...
            if (*result == -ERESTART) {
                ...
                lderr(cct) << "failed to trim image: " << cpp_strerror(*result)
                    << dendl;
                return this->create_context_finisher(*result);
            }
        ...
        template < typename I > void ResizeRequest < I >::send_flush_cache() {
            ...
            auto ctx = create_context_callback <
                ResizeRequest < I >,
                &ResizeRequest < I >::handle_flush_cache > (this);
            auto aio_comp =
        ...
        template < typename I >
            ...
            if (*result < 0) {
                lderr(cct) << "failed to flush cache: " << cpp_strerror(*result)
                    << dendl;
                return this->create_context_finisher(*result);
            }
        ...
        template < typename I >
            ...
            image_ctx.io_image_dispatcher->
                invalidate_cache(create_context_callback < ResizeRequest < I >,
                                 &ResizeRequest < I >::handle_invalidate_cache >
                                 (this));
        }
        ...
        template < typename I >
            Context * ResizeRequest <
            I >::handle_shrink_object_map(int *result) {
            I & image_ctx = this->m_image_ctx;
            CephContext *cct = image_ctx.cct;
            ldout(cct, 5) << "r=" << *result << dendl;
        ...
        template < typename I >
            ...
            image_ctx.io_image_dispatcher->
                block_writes(create_context_callback < ResizeRequest < I >,
                             &ResizeRequest < I >::handle_post_block_writes >
                             (this));
        }

        template < typename I >
            Context * ResizeRequest <
            I >::handle_post_block_writes(int *result) {
            I & image_ctx = this->m_image_ctx;
            CephContext *cct = image_ctx.cct;
            ldout(cct, 5) << "r=" << *result << dendl;
        ...
        template < typename I > void ResizeRequest < I >::send_update_header() {
            ...
            if (image_ctx.old_format) {
                ...
                bufferlist bl;
                bl.append(reinterpret_cast < const char *>(&new_size),
                          sizeof(new_size));
            ...
            librados::AioCompletion * rados_completion = create_rados_callback <
                ResizeRequest < I >,
                &ResizeRequest < I >::handle_update_header > (this);
        ...
        template < typename I >
            ...
            if (*result < 0) {
                lderr(cct) << "failed to update image header: " <<
                    cpp_strerror(*result)
                    << dendl;
                image_ctx.io_image_dispatcher->unblock_writes();
                return this->create_context_finisher(*result);
        ...
        template < typename I >
            ...
            if (image_ctx.parent == NULL) {
                ...
                m_new_parent_overlap =
                    std::min(m_new_size, image_ctx.parent_md.overlap);
            }
        }
