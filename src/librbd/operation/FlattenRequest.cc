    ...
    namespace operation {
        ...
        template < typename I >
          ...
          :    C_AsyncObjectThrottle < I > (throttle, *image_ctx),
                m_object_size(object_size), m_snapc(snapc),
                ...
                auto req =
                    new io::ObjectWriteRequest < I > (&image_ctx, oid,
                                                      m_object_no, 0,
                                                      bl, m_snapc, 0, { }
                                                      , this);
                if (!req->has_parent()) {
        ...
        template < typename I > bool FlattenRequest < I >::send_update_header() {
            I & image_ctx = this->m_image_ctx;
            assert(image_ctx.owner_lock.is_locked());
            CephContext *cct = image_ctx.cct;
