    ...
    namespace object_map {
        ...
        template <> struct UpdateRequest <MockTestImageCtx > {
            ...
            static UpdateRequest *create(MockTestImageCtx & image_ctx,
                ...
                ceph_assert(s_instance != nullptr);
                s_instance->on_finish = on_finish;
                s_instance->construct(snap_id, start_object_no, end_object_no,
                                      new_state, current_state, ignore_enoent);
                return s_instance;
            } MOCK_METHOD6(construct,
                           void (uint64_t snap_id, uint64_t start_object_no,
                                 uint64_t end_object_no, uint8_t new_state,
                                 const boost::optional < uint8_t >
                                 &current_state, bool ignore_enoent));
            MOCK_METHOD0(send, void ());
            UpdateRequest() {
                s_instance = this;
            }
        ...
        RefreshRequest < MockTestImageCtx > *RefreshRequest <
            MockTestImageCtx >::s_instance = nullptr;
        UnlockRequest < MockTestImageCtx > *UnlockRequest <
            MockTestImageCtx >::s_instance = nullptr;
        UpdateRequest < MockTestImageCtx > *UpdateRequest <
            MockTestImageCtx >::s_instance = nullptr;
...
namespace librbd {
    ...
    class TestMockObjectMap:public TestMockFixture {
      public:
        ...
        typedef object_map::RefreshRequest < MockTestImageCtx >
            MockRefreshRequest;
        typedef object_map::UnlockRequest < MockTestImageCtx >
            MockUnlockRequest;
        typedef object_map::UpdateRequest < MockTestImageCtx >
            MockUpdateRequest;
        ...
        void expect_refresh(MockTestImageCtx & mock_image_ctx,
            ...
            EXPECT_CALL(mock_refresh_request, send())
                .
                WillOnce(Invoke
                         ([&mock_image_ctx, &mock_refresh_request, &object_map,
                           r] () {
                          *mock_refresh_request.object_map = object_map;
                          mock_image_ctx.image_ctx->op_work_queue->
                          queue(mock_refresh_request.on_finish, r);}));
            ...
            EXPECT_CALL(mock_unlock_request, send())
                .WillOnce(Invoke([&mock_image_ctx, &mock_unlock_request, r] () {
                                 mock_image_ctx.image_ctx->op_work_queue->
                                 queue(mock_unlock_request.on_finish, r);}));
        }
    ...
    TEST_F(TestMockObjectMap, NonDetainedUpdate) {
        ...
        expect_update(mock_image_ctx, mock_update_request, CEPH_NOSNAP, 0, 1, 1, {
                      }, false, &finish_update_1);
        Context *finish_update_2;
        expect_update(mock_image_ctx, mock_update_request, CEPH_NOSNAP, 1, 2, 1, {
                      }, false, &finish_update_2);
        ...
        BOOST_SCOPE_EXIT(&mock_object_map) {
            mock_object_map->put();
        } BOOST_SCOPE_EXIT_END C_SaferCond open_ctx;
        ...
        C_SaferCond update_ctx2;
        {
            ...
            mock_object_map->aio_update(CEPH_NOSNAP, 0, 1, {
                                        }, {
                                        }, false, &update_ctx1);
            mock_object_map->aio_update(CEPH_NOSNAP, 1, 1, {
                                        }, {
                                        }, false, &update_ctx2);
        }
    ...
    TEST_F(TestMockObjectMap, DetainedUpdate) {
        ...
        MockUpdateRequest mock_update_request;
        Context *finish_update_1;
        expect_update(mock_image_ctx, mock_update_request, CEPH_NOSNAP, 1, 4, 1, {
                      }, false, &finish_update_1);
        Context *finish_update_2 = nullptr;
        expect_update(mock_image_ctx, mock_update_request, CEPH_NOSNAP, 1, 3, 1, {
                      }, false, &finish_update_2);
        Context *finish_update_3 = nullptr;
        expect_update(mock_image_ctx, mock_update_request, CEPH_NOSNAP, 2, 3, 1, {
                      }, false, &finish_update_3);
        Context *finish_update_4 = nullptr;
        expect_update(mock_image_ctx, mock_update_request, CEPH_NOSNAP, 0, 2, 1, {
                      }, false, &finish_update_4);
        ...
        C_SaferCond update_ctx4;
        {
            std::shared_lock image_locker {
            mock_image_ctx.image_lock};
            mock_object_map->aio_update(CEPH_NOSNAP, 1, 4, 1, {
                                        }, {
                                        }, false, &update_ctx1);
            mock_object_map->aio_update(CEPH_NOSNAP, 1, 3, 1, {
                                        }, {
                                        }, false, &update_ctx2);
            mock_object_map->aio_update(CEPH_NOSNAP, 2, 3, 1, {
                                        }, {
                                        }, false, &update_ctx3);
            mock_object_map->aio_update(CEPH_NOSNAP, 0, 2, 1, {
                                        }, {
                                        }, false, &update_ctx4);
        }
