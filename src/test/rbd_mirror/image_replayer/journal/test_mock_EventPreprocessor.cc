...
class TestMockImageReplayerJournalEventPreprocessor: public
    TestMockFixture
{
public:
       ...
       IsNotRequired)
{
    ...
    event_preprocessor(mock_local_image_ctx,
                       ...
                       "local mirror uuid", &m_client_meta,
       ...
       PreprocessSnapMapPrune)
{
    ...
    mock_local_image_ctx.snap_info = {
        {
            6, librbd::SnapInfo {
                "snap", cls::rbd::UserSnapshotNamespace(), 0U, {
                }, 0U, 0U, utime_t()}
        }
    };
    m_client_meta.snap_seqs = { {
    ...
    librbd::SnapSeqs expected_snap_seqs = { {
            5, 6
        }
    };
       ...
       PreprocessSnapRename)
{
    ...
    librbd::journal::SnapRenameEvent *event =
        boost::get < librbd::journal::SnapRenameEvent >
        (&event_entry.event);
