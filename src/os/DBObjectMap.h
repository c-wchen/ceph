...
public:
    ...
    int get_keys(const ghobject_t &oid,
    ...
    int get_all_xattrs(const ghobject_t &oid,
                       std::set < std::string > *out) override;
