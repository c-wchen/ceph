        ...
        namespace ns {
            ...
            void get_create_arguments(po::options_description * positional,
                ...
                if (r < 0) {
                    ...
                    std::
                        cerr << "rbd: namespace name was not specified" << std::
                        endl;
                    return -EINVAL;
                ...
                if (r < 0) {
                    std::
                        cerr << "rbd: failed to created namespace: " <<
                        cpp_strerror(r)
                        << std::endl;
                    return r;
                }
            ...
            int execute_remove(const po::variables_map & vm,
                ...
                if (r == -EBUSY) {
                    ...
                    std::
                        cerr << "rbd: failed to remove namespace: " <<
                        cpp_strerror(r)
                        << std::endl;
                    return r;
                }
            ...
            int execute_list(const po::variables_map & vm,
                ...
                if (r < 0 && r != -ENOENT) {
                    std::
                        cerr << "rbd: failed to list namespaces: " <<
                        cpp_strerror(r)
                        << std::endl;
                    return r;
                }
