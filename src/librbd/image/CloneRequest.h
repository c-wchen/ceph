...
{
public:
    static CloneRequest *create(ConfigProxy &config,
                                IoCtx &parent_io_ctx,
                                ...
                                Context *on_finish)
    {
        return new CloneRequest(config, parent_io_ctx, parent_image_id,
                                ...
                                parent_snap_id, c_ioctx, c_name, c_id,
                                c_options, mirror_image_mode,
                   ...
                   const std::string &parent_snap_name,
                   const cls::rbd::
                   SnapshotNamespace &parent_snap_namespace,
                   uint64_t parent_snap_id, IoCtx &c_ioctx,
                   const std::string &c_name, const std::string &c_id,
                   ImageOptions c_options,
