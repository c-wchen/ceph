...
namespace neorados {
    class IOContext;
    class RADOS;
} // namespace neorados namespace librbd {
     ...
     */
        ...
        std::unique_ptr < crypto::EncryptionFormat <
     ...
     */
        ...
        void snap_unset();
        librados::snap_t get_snap_id(const cls::rbd::
        ...
        const ParentImageInfo *get_parent_info(librados::
                                               snap_t in_snap_id) const;
        ...
        std::pair < uint64_t,
            io::ImageArea > reduce_parent_overlap(uint64_t raw_overlap,
                                                  bool migration_write) const;
        uint64_t prune_parent_extents(std::vector < std::pair < uint64_t,
                                      uint64_t >> &image_extents,
                                      io::ImageArea area, uint64_t raw_overlap,
                                      bool migration_write) const;
