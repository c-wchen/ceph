...
class LogMissingRequestReply final: public PhasedOperationT <
    LogMissingRequestReply >
{
public:
    static constexpr OperationTypeCode type =
        OperationTypeCode::logmissing_request_reply;
    LogMissingRequestReply(crimson::net::ConnectionRef
...
template <> struct fmt::formatter <
    crimson::osd::LogMissingRequestReply > : fmt::ostream_formatter {
};
#endif
