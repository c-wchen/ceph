...
void add_device_specific_options(po::options_description *
                                 options)
{
    options->add_options()
    ("options,o",
...
const DeviceOperations *get_device_operations(const po::
        variables_map &
        vm)
{
...
{
    return (*get_device_operations(vm)->execute_list)(vm,
            ceph_global_init_args);
}
                       ...
                       po::options_description *options)
{
    ...
    ("quiesce-hook", po::value < std::string > (),
     "quiesce hook path");
...
int execute_map(const po::variables_map &vm,
                ...
                &ceph_global_init_args)
{
    return (*get_device_operations(vm)->execute_map)(vm,
            ceph_global_init_args);
}
...
int execute_unmap(const po::variables_map &vm,
                  ...
                  &ceph_global_init_args)
{
    return (*get_device_operations(vm)->execute_unmap)(vm,
            ceph_global_init_args);
}
                          ...
                          po::options_description *options)
{
    ...
    at::add_image_or_snap_spec_options(positional, options,
                                       at::ARGUMENT_MODIFIER_NONE);
    options->add_options()
    ("device", po::value < std::string > ()->required(),
     "specify device path")
    ("show-cookie", po::bool_switch(), "show device cookie")
    ("cookie", po::value < std::string > (),
     "specify device cookie")
...
int execute_attach(const po::variables_map &vm,
                   ...
                   &ceph_global_init_args)
{
    return (*get_device_operations(vm)->execute_attach)(vm,
            ceph_global_init_args);
}
...
int execute_detach(const po::variables_map &vm,
                   ...
                   &ceph_global_init_args)
{
    return (*get_device_operations(vm)->execute_detach)(vm,
            ceph_global_init_args);
}
