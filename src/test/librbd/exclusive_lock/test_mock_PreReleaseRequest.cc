...
template class librbd::exclusive_lock::PreReleaseRequest <
    librbd::MockImageCtx >;
    ...
    namespace exclusive_lock {
          ...
          public:
            ...
            void expect_block_writes(MockImageCtx & mock_image_ctx, int r) {
                ...
                if (mock_image_ctx.clone_copy_on_read
                    || (mock_image_ctx.features & RBD_FEATURE_JOURNALING) !=
                    0) {
                    expect_set_require_lock(mock_image_ctx,
                                            librbd::io::DIRECTION_BOTH, true);
                }
                else {
                    expect_set_require_lock(mock_image_ctx,
                                            librbd::io::DIRECTION_WRITE, true);
                }
            ...
            void expect_is_cache_empty(MockImageCtx & mock_image_ctx,
                                       bool empty) {
                if (mock_image_ctx.object_cacher != nullptr) {
            ...
            void expect_handle_prepare_lock_complete(MockImageCtx &
                                                     mock_image_ctx) {
        ...
        TEST_F(TestMockExclusiveLockPreReleaseRequest, Success) {
            ...
            MockPreReleaseRequest *req =
                MockPreReleaseRequest::create(mock_image_ctx, false,
        ...
        TEST_F(TestMockExclusiveLockPreReleaseRequest, SuccessObjectMapDisabled) {
            ...
            C_SaferCond ctx;
            MockPreReleaseRequest *req =
                MockPreReleaseRequest::create(mock_image_ctx, true,
                                              m_async_op_tracker, &ctx);
            req->send();
            ASSERT_EQ(0, ctx.wait());
        }
