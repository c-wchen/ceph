...
namespace ceph {
    namespace crypto {
        ...
        PK11SymKey *PK11_ImportSymKey_FIPS(PK11SlotInfo * slot,
                                           CK_MECHANISM_TYPE type,
                                           PK11Origin origin,
                                           CK_ATTRIBUTE_TYPE operation,
                                           SECItem * key, void *wincx);
} // namespace crypto } // namespace namespace ceph {
    namespace crypto {
        void assert_init();
        void init(CephContext * cct);
        void shutdown(bool shared = true);
        class Digest {
          private:
            ...
            size_t digest_size;
          public:
             Digest(SECOidTag _type,
                    size_t _digest_size):digest_size(_digest_size) {
          ...
          public:
             HMAC(CK_MECHANISM_TYPE cktype, unsigned int digestsize,
                ...
                SECItem keyItem;
                 ...
                 keyItem.len = length;
                 symkey =
                    PK11_ImportSymKey_FIPS(slot, cktype, PK11_OriginUnwrap,
                ...
                SECItem param;
                 ...
                 param.len = 0;
                 ctx =
                    PK11_CreateContextBySymKey(cktype, CKA_SIGN, symkey,
                                               &param);
                 assert(ctx);
                 Restart();
            } ~HMAC();
        ...
        class HMACSHA1:public HMAC {
          public:
            HMACSHA1(const byte * key, size_t length):HMAC(CKM_SHA_1_HMAC,
        ...
        class HMACSHA256:public HMAC {
          public:
            HMACSHA256(const byte * key, size_t length):HMAC(CKM_SHA256_HMAC,
