...
OpsExecuter::osd_op_errorator > OpsExecuter::execute_op(OSDOp &osd_op)
{
...
OpsExecuter::interruptible_errorated_future <
OpsExecuter::osd_op_errorator > OpsExecuter::do_execute_op(OSDOp &osd_op)
{
...
static PG::interruptible_future < hobject_t > pgls_filter(const PGLSFilter &filter,
...
ceph::bufferlist > do_pgnls_common(const hobject_t &pg_start,
...
static PG::interruptible_future <
ceph::bufferlist > do_pgls_common(const hobject_t &pg_start,
                                  const hobject_t &pg_end,
                                  const PGBackend &backend,
                                  const hobject_t &lower_bound,
                                  const std::string &nspace,
