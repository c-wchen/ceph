...
virtual int check_bucket_shards(uint64_t max_objs_per_shard,
                                uint64_t num_shards,
...
virtual void update_stats(const rgw_user & bucket_owner, rgw_bucket & bucket,
                          int obj_delta, uint64_t added_bytes,
