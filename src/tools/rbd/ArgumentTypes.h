...
// optional arguments
        ...
        void add_special_pool_option(boost::program_options::
                                     options_description * opt,
                                     std::string prefix);
        ...
        void add_journal_option(boost::program_options::options_description *
        ...
        void add_group_spec_options(boost::program_options::
                                    options_description * pos,
                                    boost::program_options::
                                    options_description * opt,
                                    ArgumentModifier modifier);
        ...
        void add_journal_spec_options(boost::program_options::
                                      options_description * pos,
                                      boost::program_options::
                                      options_description * opt,
                                      ArgumentModifier modifier);
