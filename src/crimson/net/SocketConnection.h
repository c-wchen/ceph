    ...
    class SocketConnection:public Connection {
      ...
      public:
        ...
        bool has_user_private() const override {
            ...
            return *user_private;
        } void set_user_private(std::unique_ptr < user_private_t >
                                new_user_private) override {
            assert(!has_user_private());
      ...
      private:
        ...
        void set_peer_type(entity_type_t peer_type) {
            ...
            assert(!(peer_type != 0 &&
                     peer_name.type() != 0 && peer_type != peer_name.type()));
...
template <> struct fmt::formatter <
    crimson::net::SocketConnection >:fmt::ostream_formatter {
};
#endif
