...
class KineticStore:public KeyValueDB {
  ...
  public:
    ...
    struct KineticOp {
        ...
        } KineticOp(KineticOpType type, const string & key,
    ...
    class KineticTransactionImpl:public KeyValueDB::TransactionImpl {
      public:
        ...
        explicit KineticTransactionImpl(KineticStore * db):db(db) {
                   ...
                   const string & k, const bufferlist & bl);
        void rmkey(const string & prefix, const string & k);
    ...
    class KineticWholeSpaceIteratorImpl:public KeyValueDB::
      ...
      public:
        explicit KineticWholeSpaceIteratorImpl(kinetic::
