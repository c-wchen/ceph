    ...
    namespace mirror {
         ...
         namespace {
            ...
            struct C_GetInstances:public Context {
                ...
                :instance_ids(instance_ids), on_finish(on_finish) {
                    ...
                    dout(20) << "C_GetInstances: " << this << " " << __func__ <<
                        ": r=" << r << dendl;
            ...
            template < typename I >
                ...
                :instance_watcher(io_ctx, work_queue, nullptr, instance_id),
                    ...
                    dout(20) << "C_RemoveInstanceRequest: " << this << " " <<
                        __func__ << dendl;
        ...
        template < typename I >
            ...
            :instance_watcher(instance_watcher), instance_id(instance_id),
                ...
                dout(20) << "C_NotifyInstanceRequest: " << this << " " <<
        ...
        template < typename I >
            ...
            :instance_watcher(instance_watcher), sync_id(sync_id),
                on_start(on_start) {
                dout(20) << "C_SyncRequest: " << this << " " << __func__ <<
...
#define dout_prefix *_dout << "rbd::mirror::InstanceWatcher: " \
        ...
        template < typename I >
            ...
            I >::remove_instance(librados::IoCtx & io_ctx,
                                 ...
                                 Context * on_finish) {
            auto req =
                new C_RemoveInstanceRequest < I > (io_ctx, work_queue,
                                                   instance_id,
                                                   on_finish);
            req->send();
        }
        ...
        template < typename I >
            ...
            I >::create(librados::IoCtx & io_ctx, ContextWQ * work_queue,
                        InstanceReplayer < I > *instance_replayer) {
            return new InstanceWatcher < I > (io_ctx, work_queue,
                                              instance_replayer,
                                              stringify(io_ctx.
                                                        get_instance_id()));
        }
      ...
      :    Watcher(io_ctx, work_queue,
            ...
            m_instance_lock(librbd::ManagedLock <
                            I >::create(m_ioctx, m_work_queue, m_oid, this,
        ...
        template < typename I >
            ...
            if (instance_id == m_instance_id) {
                handle_peer_image_removed(global_image_id, peer_mirror_uuid,
                                          on_notify_ack);
            }
            else {
                uint64_t request_id = ++m_request_seq;
        ...
        template < typename I >
            ...
            auto ctx = new FunctionContext([this, sync_id] (int r){
                                           dout(20) << "finish: sync_id=" <<
                                           sync_id << ", r=" << r << dendl;
                                           Mutex::Locker locker(m_lock);
                                           if (r != -ESTALE
        ...
        template < typename I >
            void InstanceWatcher < I >::print_sync_status(Formatter * f,
                                                          stringstream * ss) {
            dout(20) << dendl;
        ...
        template < typename I >
            ...
            dout(20) << "instance_id=" << instance_id << ", request_id=" <<
                request_id << dendl;
        ...
        template < typename I >
            ...
            auto ctx = new FunctionContext([this, global_image_id,
                                            on_finish] (int r){
                                           m_instance_replayer->
        ...
        template < typename I >
            ...
            auto ctx = new FunctionContext([this, peer_mirror_uuid,
