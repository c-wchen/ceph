...
extern "C" int rados_aio_get_return_value(rados_completion_t c)
{
    return reinterpret_cast <
           librados::AioCompletionImpl * >(c)->get_return_value();
}
...
{
    std::list < librados::TestRadosClient::Object > *list =
        reinterpret_cast < std::list < librados::TestRadosClient::Object >
        *>(ctx);
    if (!list->empty()) {
        list->pop_front();
    }
...
IoCtx::IoCtx(const IoCtx &rhs)
{
    ...
    if (io_ctx_impl) {
        TestIoCtxImpl *ctx =
            reinterpret_cast < TestIoCtxImpl * >(io_ctx_impl);
        ctx->get();
    }
}
...
int IoCtx::aio_notify(const std::string &oid, AioCompletion *c,
...
int IoCtx::aio_watch(const std::string &o, AioCompletion *c,
...
int IoCtx::create(const std::string &oid, bool exclusive)
{
    ...
    return ctx->execute_operation(oid,
                                  std::bind(&TestIoCtxImpl::create, _1, _2,
                                            exclusive,
...
void IoCtx::dup(const IoCtx &rhs)
{
    close();
    TestIoCtxImpl *ctx =
        reinterpret_cast < TestIoCtxImpl * >(rhs.io_ctx_impl);
    io_ctx_impl = reinterpret_cast < IoCtxImpl * >(ctx->clone());
}

int IoCtx::exec(const std::string &oid, const char *cls,
                const char *method, bufferlist &inbl, bufferlist &outbl)
{
    TestIoCtxImpl *ctx = reinterpret_cast < TestIoCtxImpl * >(io_ctx_impl);
    return ctx->execute_operation(oid,
                                  std::bind(&TestIoCtxImpl::exec, _1, _2,
                                            librados_test_stub::
...
{
    TestIoCtxImpl *ctx = reinterpret_cast < TestIoCtxImpl * >(io_ctx_impl);
    return ctx->execute_operation(o,
                                  std::bind(&TestIoCtxImpl::list_snaps, _1,
                                            _2, out_snaps));
}
                         ...
                         std::list < obj_watch_t > *out_watchers)
{
    TestIoCtxImpl *ctx = reinterpret_cast < TestIoCtxImpl * >(io_ctx_impl);
    return ctx->execute_operation(o,
                                  std::bind(&TestIoCtxImpl::list_watchers,
                                            _1, _2, out_watchers));
}
                         ...
                         std::map < std::string, bufferlist > *out_vals)
{
    TestIoCtxImpl *ctx = reinterpret_cast < TestIoCtxImpl * >(io_ctx_impl);
    return ctx->execute_operation(oid,
                                  std::bind(&TestIoCtxImpl::omap_get_vals,
                                            _1, _2, start_after, "",
                                            max_return, out_vals));
}
                ...
                uint64_t off)
{
    TestIoCtxImpl *ctx = reinterpret_cast < TestIoCtxImpl * >(io_ctx_impl);
    return ctx->execute_operation(oid,
                                  std::bind(&TestIoCtxImpl::read, _1, _2,
                                            len, off, &bl,
                                            ctx->get_snap_read(), nullptr));
}
...
int IoCtx::remove(const std::string &oid)
{
    TestIoCtxImpl *ctx = reinterpret_cast < TestIoCtxImpl * >(io_ctx_impl);
    return ctx->execute_operation(oid,
                                  std::bind(&TestIoCtxImpl::remove, _1, _2,
                                            ctx->get_snap_context()));
}
...
void IoCtx::aio_selfmanaged_snap_create(uint64_t *snapid,
                                        AioCompletion *c)
{
    TestIoCtxImpl *ctx = reinterpret_cast < TestIoCtxImpl * >(io_ctx_impl);
...
int IoCtx::sparse_read(const std::string &oid, std::map < uint64_t,
                       uint64_t > &m, bufferlist &bl, size_t len,
                       uint64_t off)
{
    TestIoCtxImpl *ctx = reinterpret_cast < TestIoCtxImpl * >(io_ctx_impl);
    return ctx->execute_operation(oid,
                                  std::bind(&TestIoCtxImpl::sparse_read, _1,
                                            _2, off, len, &m, &bl,
                                            ctx->get_snap_read()));
}
...
int IoCtx::stat(const std::string &oid, uint64_t *psize, time_t *pmtime)
{
    TestIoCtxImpl *ctx = reinterpret_cast < TestIoCtxImpl * >(io_ctx_impl);
    return ctx->execute_operation(oid,
                                  std::bind(&TestIoCtxImpl::stat, _1, _2,
                                            psize, pmtime));
}
...
int IoCtx::tmap_update(const std::string &oid, bufferlist &cmdbl)
{
    TestIoCtxImpl *ctx = reinterpret_cast < TestIoCtxImpl * >(io_ctx_impl);
    return ctx->execute_operation(oid,
                                  std::bind(&TestIoCtxImpl::tmap_update, _1,
                                            _2, cmdbl));
}
...
int IoCtx::trunc(const std::string &oid, uint64_t off)
{
    TestIoCtxImpl *ctx = reinterpret_cast < TestIoCtxImpl * >(io_ctx_impl);
    return ctx->execute_operation(oid,
                                  std::bind(&TestIoCtxImpl::truncate, _1,
                                            _2, off,
                                            ctx->get_snap_context()));
}
                 ...
                 uint64_t off)
{
    TestIoCtxImpl *ctx = reinterpret_cast < TestIoCtxImpl * >(io_ctx_impl);
    return ctx->execute_operation(oid,
                                  std::bind(&TestIoCtxImpl::write, _1, _2,
                                            bl, len, off,
                                            ctx->get_snap_context()));
}
...
int IoCtx::write_full(const std::string &oid, bufferlist &bl)
{
    TestIoCtxImpl *ctx = reinterpret_cast < TestIoCtxImpl * >(io_ctx_impl);
    return ctx->execute_operation(oid,
                                  std::bind(&TestIoCtxImpl::write_full, _1,
                                            _2, bl,
                                            ctx->get_snap_context()));
}
                     ...
                     uint64_t off)
{
    TestIoCtxImpl *ctx = reinterpret_cast < TestIoCtxImpl * >(io_ctx_impl);
    return ctx->execute_operation(oid,
                                  std::bind(&TestIoCtxImpl::writesame, _1,
                                            _2, bl, len, off,
                                            ctx->get_snap_context()));
}

int IoCtx::cmpext(const std::string &oid, uint64_t off,
                  bufferlist &cmp_bl)
{
    TestIoCtxImpl *ctx = reinterpret_cast < TestIoCtxImpl * >(io_ctx_impl);
    return ctx->execute_operation(oid,
                                  std::bind(&TestIoCtxImpl::cmpext, _1, _2,
                                            off, cmp_bl,
                                            ctx->get_snap_read()));
}
...
ObjectOperation::~ObjectOperation()
{
    TestObjectOperationImpl *o =
        reinterpret_cast < TestObjectOperationImpl * >(impl);
    if (o) {
        o->put();
        o = NULL;
    }
...
void ObjectOperation::assert_version(uint64_t ver)
{
    TestObjectOperationImpl *o =
        reinterpret_cast < TestObjectOperationImpl * >(impl);
    o->ops.
    push_back(std::bind(&TestIoCtxImpl::assert_version, _1, _2, ver));
}
                           ...
                           bufferlist &inbl)
{
    ...
    o->ops.
    push_back(std::
              bind(&TestIoCtxImpl::exec, _1, _2,
                   librados_test_stub::get_class_handler(), cls, method,
                   inbl, _3, _4, _5));
}
                             ...
                             int *prval)
{
    ...
    ObjectOperationTestImpl op =
        std::bind(&TestIoCtxImpl::cmpext, _1, _2, off,
                  cmp_bl, _4);
    if (prval != NULL) {
...
void ObjectReadOperation::list_snaps(snap_set_t *out_snaps, int *prval)
{
    ...
    ObjectOperationTestImpl op =
        std::bind(&TestIoCtxImpl::list_snaps, _1, _2,
                  out_snaps);
    if (prval != NULL) {
        op = std::bind(save_operation_result,
                       std::bind(op, _1, _2, _3, _4, _5, _6), prval);
...
void ObjectReadOperation::list_watchers(std::list < obj_watch_t >
                                        *out_watchers, int *prval)
{
    ...
    ObjectOperationTestImpl op =
        std::bind(&TestIoCtxImpl::list_watchers, _1,
                  _2, out_watchers);
    if (prval != NULL) {
        op = std::bind(save_operation_result,
                       std::bind(op, _1, _2, _3, _4, _5, _6), prval);
                                      ...
                                      uint32_t truncate_seq)
{
    ...
    ObjectOperationTestImpl op;
    if (pbl != NULL) {
        op = std::bind(&TestIoCtxImpl::sparse_read, _1, _2, off, len, m,
                       pbl, _4);
    } else {
        op = std::bind(&TestIoCtxImpl::sparse_read, _1, _2, off, len, m, _3,
                       _4);
    }
...
void ObjectReadOperation::stat(uint64_t *psize, time_t *pmtime,
                               int *prval)
{
    TestObjectOperationImpl *o =
        reinterpret_cast < TestObjectOperationImpl * >(impl);
...
void ObjectWriteOperation::create(bool exclusive)
{
    TestObjectOperationImpl *o =
        reinterpret_cast < TestObjectOperationImpl * >(impl);
    o->ops.
    push_back(std::bind(&TestIoCtxImpl::create, _1, _2, exclusive, _5));
}

void ObjectWriteOperation::omap_set(const std::map < std::string,
                                    bufferlist > &map)
{
    TestObjectOperationImpl *o =
        reinterpret_cast < TestObjectOperationImpl * >(impl);
    o->ops.
    push_back(std::
              bind(&TestIoCtxImpl::omap_set, _1, _2, boost::ref(map)));
}
...
void ObjectWriteOperation::selfmanaged_snap_rollback(uint64_t snapid)
{
    ...
    o->ops.
    push_back(std::
              bind(&TestIoCtxImpl::selfmanaged_snap_rollback, _1, _2,
                   snapid));
}
        ...
        uint64_t expected_write_size)
{
    ...
    o->ops.
    push_back(std::
              bind(&TestIoCtxImpl::set_alloc_hint, _1, _2,
                   expected_object_size, expected_write_size, 0, _5));
}
...
void ObjectWriteOperation::write(uint64_t off, const bufferlist &bl)
{
    ...
    o->ops.
    push_back(std::
              bind(&TestIoCtxImpl::write, _1, _2, bl, bl.length(), off,
                   _5));
}
                                     ...
                                     const bufferlist &bl)
{
    ...
    o->ops.
    push_back(std::
              bind(&TestIoCtxImpl::writesame, _1, _2, bl, len, off,
                   _5));
}
...
{
    TestIoCtxImpl *ctx =
        reinterpret_cast < TestIoCtxImpl * >(ioctx.io_ctx_impl);
...
{
    return rados_conf_set(reinterpret_cast < rados_t >(client), option,
                          value);
}
...
{
    return rados_conf_read_file(reinterpret_cast < rados_t >(client),
                                path);
} int Rados::connect()
{
...
{
    return rados_create_with_context(reinterpret_cast <
                                     rados_t * >(&client), cct_);
}
...
int Rados::ioctx_create(const char *name, IoCtx &io)
{
    rados_ioctx_t p;
    int ret =
        rados_ioctx_create(reinterpret_cast < rados_t >(client), name, &p);
    if (ret) {
        return ret;
    }
...
int Rados::ioctx_create2(int64_t pool_id, IoCtx &io)
{
    rados_ioctx_t p;
    int ret =
        rados_ioctx_create2(reinterpret_cast < rados_t >(client), pool_id,
                            &p);
    if (ret) {
        return ret;
    }
...
int Rados::service_daemon_update_status(std::map < std::string,
                                        std::string > &&status)
{
    TestRadosClient *impl = reinterpret_cast < TestRadosClient * >(client);
...
int cls_cxx_remove(cls_method_context_t hctx)
{
    librados::TestClassHandler::MethodContext *ctx =
        reinterpret_cast < librados::TestClassHandler::MethodContext * >(hctx);
    return ctx->io_ctx_impl->remove(ctx->oid,
                                    ctx->io_ctx_impl->get_snap_context());
}
...
int cls_get_request_origin(cls_method_context_t hctx, entity_inst_t *origin)
{
    ...
    *origin =
        entity_inst_t(entity_name_t::CLIENT(rados_client->get_instance_id()),
                      entity_addr);
    return 0;
}
...
int cls_cxx_getxattrs(cls_method_context_t hctx, std::map < string,
                      bufferlist > *attrset)
{
    librados::TestClassHandler::MethodContext *ctx =
        reinterpret_cast < librados::TestClassHandler::MethodContext * >(hctx);
                         ...
                         bool *more)
{
    ...
    int r =
        ctx->io_ctx_impl->omap_get_vals2(ctx->oid, start_obj, "", max_to_get,
                                         &vals, more);
    if (r < 0) {
        return r;
    }
...
int cls_register_cxx_filter(cls_handle_t hclass,
                            ...
                            cls_cxx_filter_factory_t fn, cls_filter_handle_t *)
{
    librados::TestClassHandler *cls = librados_test_stub::get_class_handler();
...
int cls_cxx_chunk_write_and_set(cls_method_handle_t, int,
                                int, bufferlist *, uint32_t, bufferlist *, int)
{
    return -ENOTSUP;
}
