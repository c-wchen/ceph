...
namespace journal {
    ...
    namespace mirror {
        ...
        namespace image_sync {
          ...
          template < typename ImageCtxT = librbd::ImageCtx > class ImageCopyRequest:public BaseRequest
            {
              public:
                ...
                static ImageCopyRequest *create(ImageCtxT * local_image_ctx,
                                                ...
                                                nullptr) {
                    return new ImageCopyRequest(local_image_ctx,
                                                remote_image_ctx, timer,
                                                timer_lock, journaler,
                                                client_meta, sync_point,
                                                on_finish, progress_ctx);
                } ImageCopyRequest(ImageCtxT * local_image_ctx,
                                   ImageCtxT * remote_image_ctx,
   ...
   */
    ...
    // namespace rbd
    extern template class rbd::mirror::image_sync::ImageCopyRequest <
    librbd::ImageCtx >;
