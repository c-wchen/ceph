...
// returns true if the request time is within RGW_AUTH_GRACE of the current time
            ...
            class ExternalAuthStrategy:public rgw::auth::Strategy,
                ...
                :store(store), implicit_tenant_context(implicit_tenant_context),
          ...
          template < class AbstractorT, bool AllowAnonAccessT = false > class AWSAuthStrategy:public rgw::auth::Strategy,
                ...
                std::vector < std::string >
                    ...
                    const std::set < boost::string_view > allowed_auth =
                        { "external", "local" };
                ...
                AWSAuthStrategy(CephContext * const cct,
                                ...
                                ImplicitTenants & implicit_tenant_context,
                                RGWRados * const store)
              :    store(store), ver_abstractor(cct), anonymous_engine(cct,
                                                                        static_cast
                                                                        <
                                                                        rgw::
                                                                        auth::
                                                                        ...
                                                                        *
                                                                        >
                                                                        (this)),
                    external_engines(cct, store, implicit_tenant_context,
                                     &ver_abstractor), local_engine(cct, store,
                                                                    ver_abstractor,
                                                                    static_cast
                                                                    <
                                                                    rgw::auth::
            ...
            class AWSv4ComplMulti:public rgw::auth::Completer,
                ...
                class ChunkMeta {
                     ...
                     * in a stream. */
                        static ChunkMeta create_first(const boost::
                                                      string_view &
                                                      seed_signature) {
...
void rgw_create_s3_canonical_header(const char *method,
                                    ...
                                    std::string & dest_str);
bool rgw_create_s3_canonical_header(const req_info & info, utime_t * header_time,   /* out */
                                    std::string & dest, /* out */
                                    bool qsr);
...
rgw_create_s3_canonical_header(const req_info & info, const bool qsr)
{
    ...
    const bool ok =
        rgw_create_s3_canonical_header(info, &header_time, dest, qsr);
