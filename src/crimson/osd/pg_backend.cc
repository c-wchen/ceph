...
< PGBackend::loaded_object_md_t::ref > PGBackend::load_metadata(const hobject_t &oid)
{
...
PGBackend::rep_op_fut_t PGBackend::mutate_object(std::set < pg_shard_t > pg_shards,
...
template < class CSum >
PGBackend::checksum_errorator::future <> do_checksum(ceph::bufferlist &init_value_bl,
        size_t chunk_size,
...
PGBackend::stat_ierrorator::future <> PGBackend::stat(const ObjectState &os,
...
PGBackend::get_attr_ierrorator::future < ceph::bufferlist > PGBackend::getxattr(const hobject_t &soid,
        std::string_view key) constconst {
...
PGBackend::rm_xattr_iertr::future <> PGBackend::rm_xattr(ObjectState &os,
...
crimson::os::FuturizedStore::Shard::omap_values_t > maybe_get_omap_vals_by_keys(crimson::os::FuturizedStore::Shard
        *store,
...
std::tuple < bool, crimson::os::FuturizedStore::Shard::omap_values_t >> maybe_get_omap_vals(
...
PGBackend::ll_read_ierrorator::future < ceph::bufferlist > PGBackend::omap_get_header(
...
PGBackend::ll_read_ierrorator::future <> PGBackend::omap_get_header(const ObjectState &os,
        OSDOp &osd_op,
        object_stat_sum_t &delta_stats) constconst {
...
PGBackend::ll_read_ierrorator::future <> PGBackend::omap_get_keys(const ObjectState &os,
        OSDOp &osd_op,
        object_stat_sum_t &delta_stats) constconst {
    if (!os.exists || os.oi.is_whiteout())
    {
...
PGBackend::omap_cmp_iertr::future <> PGBackend::omap_cmp(const ObjectState &os,
        OSDOp &osd_op,
        object_stat_sum_t &delta_stats) constconst {
    if (!os.exists || os.oi.is_whiteout())
    {
...
PGBackend::ll_read_ierrorator::future <> PGBackend::omap_get_vals(const ObjectState &os,
        OSDOp &osd_op,
        object_stat_sum_t &delta_stats) constconst {
    if (!os.exists || os.oi.is_whiteout())
    {
...
PGBackend::ll_read_ierrorator::future <> PGBackend::omap_get_vals_by_keys(const ObjectState &os,
        OSDOp &osd_op,
        object_stat_sum_t &delta_stats) constconst {
    if (!os.exists || os.oi.is_whiteout())
    {
...
PGBackend::interruptible_future <> PGBackend::omap_set_vals(ObjectState &os,
        const OSDOp &osd_op,
        ceph::os::Transaction &txn,
...
PGBackend::interruptible_future <> PGBackend::omap_set_header(ObjectState &os,
        const OSDOp &osd_op,
        ceph::os::Transaction &txn,
        osd_op_params_t &osd_op_params,
        object_stat_sum_t &delta_stats)
...
PGBackend::omap_clear_iertr::future <> PGBackend::omap_clear(ObjectState &os,
        OSDOp &osd_op,
        ceph::os::Transaction &txn,
        osd_op_params_t &osd_op_params,
        object_stat_sum_t &delta_stats)
        ...
        delta_stats)
{
    ...
    return _read(oi.soid, 0, oi.size, 0).safe_then_interruptible_tuple([&delta_stats,
    &osd_op](auto && bl)->read_errorator::future <> {
        logger().
        debug
