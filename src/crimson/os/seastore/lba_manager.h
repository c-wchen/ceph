 ...
 */
   ...
   */
        ...
        virtual get_mappings_ret get_mappings(Transaction & t,
                                              laddr_t offset,
   ...
   */
        ...
        virtual alloc_extent_ret alloc_extent(Transaction & t,
                                              laddr_t hint,
                                              extent_len_t len,
                                              paddr_t addr,
   ...
   */
        virtual ref_ret decref_extent(Transaction & t, laddr_t addr) = 0;
   ...
   */
        ...
        virtual scan_mappings_ret scan_mappings(Transaction & t,
                                                laddr_t begin,
                                                laddr_t end,
   ...
   */
        ...
        virtual update_mapping_ret update_mapping(Transaction & t,
                                                  laddr_t laddr,
                                                  paddr_t prev_addr,
                                                  paddr_t paddr,
                                                  LogicalCachedExtent *
   ...
   */
        ...
        update_mappings_ret update_mappings(Transaction & t,
                                            const std::list <
                                            LogicalCachedExtentRef > &extents);
   ...
   */
        ...
        virtual get_physical_extent_if_live_ret
            get_physical_extent_if_live(Transaction & t, extent_types_t type,
