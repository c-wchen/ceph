...
struct BufferedRecoveryMessages {
    ...
    void accept_buffered_messages(BufferedRecoveryMessages &m)
    {
        for (auto &[target, ls] : m.message_map) {
            ...
            ls.insert(ls.end(), std::make_move_iterator(ovec.begin()),
...
struct PeeringCtxWrapper {
    ...
    PeeringCtxWrapper(PeeringCtx &wrapped):
        msgs(wrapped),
        transaction(wrapped.transaction), handle(wrapped.handle)
    {
...
public:
    struct PeeringListener: public EpochSource {
        ...
        virtual void prepare_write(pg_info_t &info,
        ...
        virtual void on_primary_status_change(bool was_primary,
                                              bool now_primary) = 0;
...
#if defined(WITH_SEASTAR)
        virtual void send_cluster_message(int osd, MessageURef m, epoch_t epoch,
                                          bool share_map_update = false) = 0;
#else
        virtual void send_cluster_message(int osd, MessageRef m, epoch_t epoch,
                                          bool share_map_update = false) = 0;
#endif
        ...
        virtual void schedule_renew_lease(epoch_t plr, ceph::timespan delay) =
            0;
        virtual void queue_check_readable(epoch_t lpr, ceph::timespan delay) =
            0;
        ...
        virtual void start_flush_on_transaction(ObjectStore::Transaction &t) =
            0;
        ...
        virtual void schedule_event_after(PGPeeringEventRef event,
                                          float delay) = 0;
        /**
         ...
         */
        virtual void request_local_background_io_reservation(unsigned priority,
                PGPeeringEventURef
                on_grant,
                PGPeeringEventURef
                on_preempt) = 0;
         ...
         * and on_preempt on preempt
         */
        virtual void request_remote_recovery_reservation(unsigned priority,
                PGPeeringEventURef
                on_grant,
                PGPeeringEventURef
                on_preempt) = 0;
        ...
        virtual void schedule_event_on_commit(ObjectStore::Transaction &t,
        ...
        virtual void set_probe_targets(const std::set < pg_shard_t >
                                       &probe_set) = 0;
        ...
        virtual std::pair < ghobject_t,
                bool > do_delete_work(ObjectStore::Transaction &t,
                                      ghobject_t _next) = 0;
        ...
        virtual void set_ready_to_merge_target(eversion_t lu, epoch_t les,
                                               epoch_t lec) = 0;
        ...
        virtual bool try_reserve_recovery_space(int64_t primary_num_bytes,
                                                int64_t local_num_bytes) = 0;
        virtual void unreserve_recovery_space() = 0;

        // ================== Peering log events ====================
        /// Get handler for rolling forward/back log entries
        virtual PGLog::LogEntryHandlerRef get_log_handler(ObjectStore::
                Transaction &t) = 0;
        ...
        virtual void log_state_exit(const char *state_name, utime_t enter_time,
    ...
    struct AdvMap: boost::statechart::event < AdvMap > {
        ...
        AdvMap(OSDMapRef osdmap, OSDMapRef lastmap,
               std::vector < int > &newup, int up_primary,
               std::vector < int > &newacting,
               int acting_primary): osdmap(osdmap), lastmap(lastmap),
            newup(newup), newacting(newacting), up_primary(up_primary),
...
public:
    ...
    struct RequestScrub: boost::statechart::event < RequestScrub > {
        scrub_level_t deep;
        scrub_type_t repair;
        explicit RequestScrub(bool d, bool r): deep(scrub_level_t(d)),
            repair(scrub_type_t(r))
        {
        } void print(std::ostream *out) const
        {
            *out << "RequestScrub(" << ((deep == scrub_level_t::deep) ? "deep" :
                                        "shallow")
...
private:
    ...
    public:
        ...
        PeeringMachine(PeeringState *state, CephContext *cct, spg_t spgid, DoutPrefixProvider *dpp, PeeringListener *pl,
            ...
            cct(cct), spgid(spgid), dpp(dpp), pl(pl), event_count(0)
        {
        }
    ...
    struct Start: boost::statechart::state < Start, Started >, NamedState {
        ...
        boost::statechart::transition < MakePrimary, Primary >,
              boost::statechart::transition < MakeStray, Stray > > reactions;
    };
    ...
    struct Primary: boost::statechart::state < Primary, Started, Peering >,
        ...
        boost::statechart::custom_reaction < ActMap >,
              ...
              boost::statechart::custom_reaction < SetForceBackfill >,
              boost::statechart::custom_reaction < UnsetForceBackfill >,
              boost::statechart::custom_reaction < RequestScrub > > reactions;
        boost::statechart::result react(const ActMap &);
        boost::statechart::result react(const MNotifyRec &);
    ...
    struct WaitActingChange: boost::statechart::state < WaitActingChange,
        Primary >, NamedState {
        typedef boost::mpl::list < boost::statechart::custom_reaction <
        QueryState >, boost::statechart::custom_reaction < QueryUnfound >,
                   boost::statechart::custom_reaction < AdvMap >,
                   boost::statechart::custom_reaction < MLogRec >,
                   boost::statechart::custom_reaction < MInfoRec >,
                   boost::statechart::custom_reaction < MNotifyRec > >reactions;
    ...
    struct Peering: boost::statechart::state < Peering, Primary, GetInfo >,
        ...
        boost::statechart::custom_reaction < QueryState >,
              ...
              boost::statechart::custom_reaction < AdvMap > > reactions;
        boost::statechart::result react(const QueryState &q);
        boost::statechart::result react(const QueryUnfound &q);
    ...
    struct Active: boost::statechart::state < Active, Primary, Activating >,
        ...
        boost::statechart::custom_reaction < QueryState >,
              ...
              boost::statechart::custom_reaction < CheckReadable > > reactions;
        boost::statechart::result react(const QueryState &q);
        boost::statechart::result react(const QueryUnfound &q);
        boost::statechart::result react(const ActMap &);
        boost::statechart::result react(const AdvMap &);
    ...
    struct Clean: boost::statechart::state < Clean, Active >, NamedState {
        typedef boost::mpl::list <
        boost::statechart::transition < DoRecovery,
              WaitLocalRecoveryReserved >,
              boost::statechart::custom_reaction < SetForceRecovery >,
              boost::statechart::custom_reaction < SetForceBackfill > > reactions;
    ...
    struct Backfilling: boost::statechart::state < Backfilling, Active >,
        NamedState {
        typedef boost::mpl::list < boost::statechart::custom_reaction <
        Backfilled >, boost::statechart::custom_reaction < DeferBackfill >,
                   boost::statechart::custom_reaction < UnfoundBackfill >,
                   boost::statechart::custom_reaction <
        ...
        boost::statechart::
        result react(const RemoteReservationRejectedTooFull &evt)
        {
        ...
        boost::statechart::
        result react(const RemoteReservationRevokedTooFull &evt);
    ...
    struct WaitRemoteBackfillReserved: boost::statechart::state <
        WaitRemoteBackfillReserved, Active >, NamedState {
        typedef boost::mpl::list < boost::statechart::custom_reaction <
        RemoteBackfillReserved >,
                               boost::statechart::custom_reaction <
                               RemoteReservationRejectedTooFull >,
                               boost::statechart::custom_reaction < RemoteReservationRevoked >,
                               boost::statechart::transition < AllBackfillsReserved,
    ...
    struct WaitLocalBackfillReserved: boost::statechart::state <
        WaitLocalBackfillReserved, Active >, NamedState {
    ...
    struct NotBackfilling: boost::statechart::state < NotBackfilling, Active >,
        NamedState {
        typedef boost::mpl::list < boost::statechart::custom_reaction <
        QueryUnfound >, boost::statechart::transition < RequestBackfill,
                     WaitLocalBackfillReserved >,
                     boost::statechart::custom_reaction < RemoteBackfillReserved >,
                     boost::statechart::custom_reaction <
                     RemoteReservationRejectedTooFull > >reactions;
    ...
    struct NotRecovering: boost::statechart::state < NotRecovering, Active >,
        NamedState {
        typedef boost::mpl::list < boost::statechart::custom_reaction <
        QueryUnfound >, boost::statechart::transition < DoRecovery,
                     WaitLocalRecoveryReserved >,
                     boost::statechart::custom_reaction < DeferRecovery >,
                     boost::statechart::custom_reaction < UnfoundRecovery > >reactions;
    ...
    struct ReplicaActive: boost::statechart::state < ReplicaActive, Started,
        ...
        boost::statechart::custom_reaction < QueryState >,
              ...
              boost::statechart::custom_reaction < MLease > > reactions;
        boost::statechart::result react(const QueryState &q);
        boost::statechart::result react(const QueryUnfound &q);
        boost::statechart::result react(const MInfoRec &infoevt);
        boost::statechart::result react(const MLogRec &logevt);
    ...
    struct RepRecovering: boost::statechart::state < RepRecovering,
        ReplicaActive >, NamedState {
        typedef boost::mpl::list < boost::statechart::transition < RecoveryDone,
                RepNotRecovering >,
                // for compat with old peers
                boost::statechart::transition < RemoteReservationRejectedTooFull,
                RepNotRecovering >,
                boost::statechart::transition < RemoteReservationCanceled,
                RepNotRecovering >,
    ...
    struct RepWaitBackfillReserved: boost::statechart::state <
        RepWaitBackfillReserved, ReplicaActive >, NamedState {
        typedef boost::mpl::list < boost::statechart::custom_reaction <
        RemoteBackfillReserved >,
                               boost::statechart::custom_reaction <
        ...
        boost::statechart::result react(const RemoteBackfillReserved &evt);
        boost::statechart::
        result react(const RejectTooFullRemoteReservation &evt);
        boost::statechart::
        result react(const RemoteReservationRejectedTooFull &evt);
        boost::statechart::result react(const RemoteReservationCanceled &evt);
    };

    struct RepWaitRecoveryReserved: boost::statechart::state <
        RepWaitRecoveryReserved, ReplicaActive >, NamedState {
        typedef boost::mpl::list < boost::statechart::custom_reaction <
        ...
        result react(const RemoteReservationCanceled &evt);
    };

    struct RepNotRecovering: boost::statechart::state < RepNotRecovering,
        ReplicaActive >, NamedState {
        typedef boost::mpl::list
        < boost::statechart::custom_reaction < RequestRecoveryPrio >, boost::statechart::custom_reaction < RequestBackfillPrio >, boost::statechart::custom_reaction < RejectTooFullRemoteReservation >, boost::statechart::transition < RemoteReservationRejectedTooFull, RepNotRecovering >, boost::statechart::transition < RemoteReservationCanceled, RepNotRecovering >, boost::statechart::custom_reaction < RemoteRecoveryReserved >, boost::statechart::custom_reaction < RemoteBackfillReserved >, boost::statechart::transition < RecoveryDone, RepNotRecovering >   // for compat with pre-reservation peers
        >reactions;
    ...
    struct Recovering: boost::statechart::state < Recovering, Active >,
        NamedState {
        typedef boost::mpl::list < boost::statechart::custom_reaction <
        AllReplicasRecovered >,
                             boost::statechart::custom_reaction < DeferRecovery >,
                             boost::statechart::custom_reaction < UnfoundRecovery >,
                             boost::statechart::custom_reaction < RequestBackfill > >reactions;
    ...
    struct WaitRemoteRecoveryReserved: boost::statechart::state <
        WaitRemoteRecoveryReserved, Active >, NamedState {
        typedef boost::mpl::list < boost::statechart::custom_reaction <
        RemoteRecoveryReserved >,
                               boost::statechart::transition < AllRemotesReserved,
    ...
    struct WaitLocalRecoveryReserved: boost::statechart::state <
        WaitLocalRecoveryReserved, Active >, NamedState {
        typedef boost::mpl::list < boost::statechart::transition <
        LocalRecoveryReserved, WaitRemoteRecoveryReserved >,
                               boost::statechart::custom_reaction < RecoveryTooFull > >reactions;
    ...
    struct Activating: boost::statechart::state < Activating, Active >,
        ...
        AllReplicasRecovered, Recovered >,
                              boost::statechart::transition < DoRecovery,
                              WaitLocalRecoveryReserved >,
                              boost::statechart::transition < RequestBackfill,
                              WaitLocalBackfillReserved > >reactions;
    ...
    struct Stray: boost::statechart::state < Stray, Started >, NamedState {
        ...
        boost::statechart::custom_reaction < MQuery >,
              ...
              boost::statechart::custom_reaction < ActMap >,
              boost::statechart::custom_reaction < RecoveryDone >,
              boost::statechart::transition < DeleteStart, ToDelete > > reactions;
    ...
    struct ToDelete: boost::statechart::state < ToDelete, Started,
        WaitDeleteReserved >, NamedState {
        unsigned priority = 0;
        typedef boost::mpl::list <
        boost::statechart::custom_reaction < ActMap >,
              boost::statechart::custom_reaction < ActivateCommitted >,
              boost::statechart::custom_reaction < DeleteSome > > reactions;
    ...
    struct Deleting: boost::statechart::state < Deleting, ToDelete >, NamedState {
        ...
        boost::statechart::custom_reaction < DeleteSome >,
              boost::statechart::transition < DeleteInterrupted,
              WaitDeleteReserved > > reactions;
        ghobject_t next;
    ...
    struct GetInfo: boost::statechart::state < GetInfo, Peering >, NamedState {
        ...
        boost::statechart::custom_reaction < QueryState >,
              ...
              boost::statechart::custom_reaction < MNotifyRec >,
              boost::statechart::transition < IsDown, Down > > reactions;
        boost::statechart::result react(const QueryState &q);
        boost::statechart::result react(const QueryUnfound &q);
    ...
    struct GetLog: boost::statechart::state < GetLog, Peering >, NamedState {
        ...
        boost::statechart::custom_reaction < QueryState >,
              ...
              WaitActingChange >, boost::statechart::transition < IsIncomplete,
    ...
    struct GetMissing: boost::statechart::state < GetMissing, Peering >,
        ...
        boost::statechart::custom_reaction < QueryState >,
              boost::statechart::custom_reaction < QueryUnfound >,
              boost::statechart::custom_reaction < MLogRec >,
              boost::statechart::transition < NeedUpThru, WaitUpThru > > reactions;
        boost::statechart::result react(const QueryState &q);
        boost::statechart::result react(const QueryUnfound &q);
        boost::statechart::result react(const MLogRec &logevt);
    };
    ...
    struct WaitUpThru: boost::statechart::state < WaitUpThru, Peering >,
        ...
        boost::statechart::custom_reaction < QueryState >,
              boost::statechart::custom_reaction < QueryUnfound >,
              boost::statechart::custom_reaction < ActMap >,
              boost::statechart::custom_reaction < MLogRec > > reactions;
        boost::statechart::result react(const QueryState &q);
        boost::statechart::result react(const QueryUnfound &q);
    ...
    struct Incomplete: boost::statechart::state < Incomplete, Peering >,
        NamedState {
        typedef boost::mpl::list < boost::statechart::custom_reaction <
        AdvMap >, boost::statechart::custom_reaction < MNotifyRec >,
               boost::statechart::custom_reaction < QueryUnfound >,
               boost::statechart::custom_reaction < QueryState > >reactions;
    ...
    bool proc_replica_info(pg_shard_t from, const pg_info_t &oinfo,
                           epoch_t send_epoch);
    void remove_down_peer_info(const OSDMapRef &osdmap);
    void check_recovery_sources(const OSDMapRef &map);
    void set_last_peering_reset();
    void check_full_transition(OSDMapRef lastmap, OSDMapRef osdmap);
    bool should_restart_peering(int newupprimary,
...
private:
    ...
    // acting std::set
    std::map < pg_shard_t,
        pg_info_t >::const_iterator find_best_info(const std::map < pg_shard_t,
                pg_info_t > &infos,
                bool restrict_to_up_acting,
                bool *
                history_les_bound) const;

    static void calc_ec_acting(std::map < pg_shard_t,
                               pg_info_t >::const_iterator auth_log_shard,
                               unsigned size, const std::vector < int > &acting,
    ...
    static std::pair < std::map < pg_shard_t, pg_info_t >::const_iterator,
           eversion_t > select_replicated_primary(std::map < pg_shard_t,
                   pg_info_t >::
    ...
    static void calc_replicated_acting(std::map < pg_shard_t,
                                       pg_info_t >::
    ...
    static void calc_replicated_acting_stretch(std::map < pg_shard_t,
            pg_info_t >::
            const_iterator primary_shard,
            eversion_t oldest_auth_log_entry,
            unsigned size,
    ...
    void choose_async_recovery_ec(const std::map < pg_shard_t,
                                  pg_info_t > &all_info,
                                  const pg_info_t &auth_info,
                                  std::vector < int > *want,
                                  std::set < pg_shard_t > *async_recovery,
                                  const OSDMapRef osdmap) const;
    void choose_async_recovery_replicated(const std::map < pg_shard_t,
                                          pg_info_t > &all_info,
                                          const pg_info_t &auth_info,
                                          std::vector < int > *want,
                                          std::set < pg_shard_t >
    ...
    bool search_for_missing(const pg_info_t &oinfo,
                            const pg_missing_t &omissing, pg_shard_t fromosd,
    ...
    void proc_primary_info(ObjectStore::Transaction &t,
                           const pg_info_t &info);
    void proc_master_log(ObjectStore::Transaction &t, pg_info_t &oinfo,
                         pg_log_t && olog, pg_missing_t
                         && omissing, pg_shard_t from);
    void proc_replica_log(pg_info_t &oinfo, const pg_log_t &olog, pg_missing_t
                          && omissing, pg_shard_t from);
    ...
    void calc_min_last_complete_ondisk()
    {
        ...
        for (std::set < pg_shard_t >::iterator i =
    ...
    void fulfill_log(pg_shard_t from, const pg_query_t &query,
                     epoch_t query_epoch);
...
public:
    ...
    template < typename F >
    auto init_from_disk_state(pg_info_t && info_from_disk,
    ...
    void init_primary_up_acting(const std::vector < int > &newup,
                                const std::vector < int > &newacting,
                                int new_up_primary, int new_acting_primary);
    void init_hb_stamps();
    ...
    void set_backend_predicates(IsPGReadablePredicate *is_readable,
    ...
    void start_split_stats(const std::set < spg_t > &childpgs,
    ...
    void merge_from(std::map < spg_t, PeeringState * > &sources,
                    PeeringCtx &rctx,
                    unsigned split_bits,
     ...
     * to the osd.
     */
    void update_stats(std::function < bool(pg_history_t &, pg_stat_t &) > f,
                      ObjectStore::Transaction *t = nullptr);

    void update_stats_wo_resched(std::function <
                                 void (pg_history_t &, pg_stat_t &) > f);
     ...
     */
    void adjust_purged_snaps(std::function <
                             void (interval_set < snapid_t > &snaps) > f);
     ...
     *         @c pg_stats_publish
     */
    std::optional < pg_stat_t > prepare_stats_for_publish(const std::optional <
            pg_stat_t >
            &pg_stats_publish,
            const
     ...
     */
    bool append_log_entries_update_missing(const mempool::osd_pglog::list <
    ...
    void append_log_with_trim_to_updated(std::vector < pg_log_entry_t >
                                         &&log_entries,
     ...
     */
    void append_log(std::vector < pg_log_entry_t > &&logv,
                    eversion_t trim_to,
                    eversion_t roll_forward_to,
                    eversion_t min_last_complete_ondisk,
                    ObjectStore::Transaction &t,
     ...
     */
    void merge_new_log_entries(const mempool::osd_pglog::list < pg_log_entry_t >
    ...
    void object_recovered(const hobject_t &hoid,
    ...
    void update_backfill_progress(const hobject_t &updated_backfill,
    ...
    void update_peer_last_backfill(pg_shard_t peer,
                                   const hobject_t &new_last_backfill);

    /// Update info.stats with delta_stats for operation on soid
    void apply_op_stats(const hobject_t &soid,
     ...
     */
    void force_object_missing(const pg_shard_t &peer,
                              const hobject_t &oid, eversion_t version)
    {
        force_object_missing(std::set < pg_shard_t > {
            peer
        }, oid, version);
    }
    void force_object_missing(const std::set < pg_shard_t > &peer,
                              const hobject_t &oid, eversion_t version);

    /// Update state prior to backfilling soid on targets
    void prepare_backfill_for_missing(const hobject_t &soid,
                                      const eversion_t &version,
                                      const std::vector < pg_shard_t >
                                      &targets);

    /// Std::set targets with the right version for revert (see recover_primary)
    void set_revert_with_targets(const hobject_t &soid,
    ...
    {
        return pg_lease_t(readable_until, readable_until_ub_sent,
                          readable_interval);
    }
    ...
    /// Returns reference to current osdmap const OSDMapRef & get_osdmap() const {
    ceph_assert(osdmap_ref);
    return osdmap_ref;
}
/// Returns epoch of current osdmap epoch_t get_osdmap_epoch() const {
...
static bool has_shard(bool ec, const std::vector < int > &v,
                      pg_shard_t osd)
{
    if (ec) {
...
/// acting osd that is not the primary bool is_nonprimary() const {
return role >= 0 && pg_whoami != primary;
}
/// primary osd bool is_primary() const {
...
{
    return get_state() & (PG_STATE_FORCED_RECOVERY |
...
bool can_serve_replica_read(const hobject_t &hoid)
{
    ...
    return !pg_log.get_log().has_write_since(hoid,
...
// Flush control interface private:
/**
...
/// Must be called once per start_flush void complete_flush();
