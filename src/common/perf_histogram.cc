...
void PerfHistogramCommon::dump_formatted_axis(ceph::Formatter *f,
...
int64_t PerfHistogramCommon::get_bucket_for_axis(int64_t value,
        const PerfHistogramCommon::
        axis_config_d &ac)
{
    if (value < ac.m_min) {
...
std::vector < std::pair < int64_t, int64_t >>
        PerfHistogramCommon::get_axis_bucket_ranges(const PerfHistogramCommon::
                axis_config_d &ac)
{
